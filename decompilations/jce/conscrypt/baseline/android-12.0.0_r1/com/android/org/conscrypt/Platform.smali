...
.method static blacklist countTlsHandshake(ZLjava/lang/String;Ljava/lang/String;J)V
    .registers 11
    .param p0, "success"    # Z
    .param p1, "protocol"    # Ljava/lang/String;
    .param p2, "cipherSuite"    # Ljava/lang/String;
    .param p3, "duration"    # J

    .line 554
    invoke-static {p1}, Lcom/android/org/conscrypt/metrics/Protocol;->forName(Ljava/lang/String;)Lcom/android/org/conscrypt/metrics/Protocol;

    move-result-object v0

    .line 555
    .local v0, "proto":Lcom/android/org/conscrypt/metrics/Protocol;
    invoke-static {p2}, Lcom/android/org/conscrypt/metrics/CipherSuite;->forName(Ljava/lang/String;)Lcom/android/org/conscrypt/metrics/CipherSuite;

    move-result-object v1

    .line 556
    .local v1, "suite":Lcom/android/org/conscrypt/metrics/CipherSuite;
    long-to-int v2, p3

    .line 558
    .local v2, "dur":I
    invoke-virtual {v0}, Lcom/android/org/conscrypt/metrics/Protocol;->getId()I

    move-result v3

    .line 559
    invoke-virtual {v1}, Lcom/android/org/conscrypt/metrics/CipherSuite;->getId()I
    ...
    invoke-static {v5, p0, v3, v4, v2}, Lcom/android/org/conscrypt/metrics/ConscryptStatsLog;->write(IZIII)V
...
.method public static blacklist getDefaultHostnameVerifier()Lcom/android/org/conscrypt/ConscryptHostnameVerifier;
    .registers 1
    ...
    invoke-static {v0}, Lcom/android/org/conscrypt/Conscrypt;->wrapHostnameVerifier(Ljavax/net/ssl/HostnameVerifier;)Lcom/android/org/conscrypt/ConscryptHostnameVerifier;
...
.method static blacklist getMillisSinceBoot()J
    .registers 2
...
.method public static blacklist isJavaxCertificateSupported()Z
    .registers 1
...
.method static blacklist newDefaultBlocklist()Lcom/android/org/conscrypt/CertBlocklist;
    .registers 1

    .line 513
    invoke-static {}, Lcom/android/org/conscrypt/CertBlocklistImpl;->getDefault()Lcom/android/org/conscrypt/CertBlocklist;
