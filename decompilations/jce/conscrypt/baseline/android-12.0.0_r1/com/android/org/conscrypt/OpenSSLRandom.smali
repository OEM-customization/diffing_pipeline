...
# virtual methods
.method protected whitelist test-api engineGenerateSeed(I)[B
    .registers 3
    .param p1, "numBytes"    # I
...
.method protected whitelist test-api engineNextBytes([B)V
    .registers 2
    .param p1, "bytes"    # [B
...
.method protected whitelist test-api engineSetSeed([B)V
    .registers 4
    .param p1, "seed"    # [B
