...
# virtual methods
.method public whitelist core-platform-api test-api addHandshakeCompletedListener(Ljavax/net/ssl/HandshakeCompletedListener;)V
    .registers 4
...
.method public final whitelist core-platform-api test-api connect(Ljava/net/SocketAddress;)V
    .registers 3
...
.method public final whitelist core-platform-api test-api connect(Ljava/net/SocketAddress;I)V
    .registers 4
    .param p1, "endpoint"    # Ljava/net/SocketAddress;
    .param p2, "timeout"    # I
    .annotation system Ldalvik/annotation/Throws;
...
.method abstract greylist getChannelId()[B
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljavax/net/ssl/SSLException;
        }
...
.method greylist getHostname()Ljava/lang/String;
    .registers 2
...
.method greylist getHostnameOrIP()Ljava/lang/String;
    .registers 3
...
.method greylist getNpnSelectedProtocol()[B
    .registers 2
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public final whitelist core-platform-api test-api getPort()I
    .registers 3
...
.method public final whitelist core-platform-api test-api getSoTimeout()I
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method greylist getSoWriteTimeout()I
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public whitelist core-platform-api test-api removeHandshakeCompletedListener(Ljavax/net/ssl/HandshakeCompletedListener;)V
    .registers 4
    .param p1, "listener"    # Ljavax/net/ssl/HandshakeCompletedListener;
...
.method public final whitelist core-platform-api test-api sendUrgentData(I)V
    .registers 4
    .param p1, "data"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method abstract greylist setChannelIdEnabled(Z)V
.end method

.method abstract greylist setChannelIdPrivateKey(Ljava/security/PrivateKey;)V
.end method

.method greylist setHandshakeTimeout(I)V
    .registers 4
...
.method greylist setNpnProtocols([B)V
    .registers 2
...
.method public final whitelist core-platform-api test-api setOOBInline(Z)V
    .registers 4
    .param p1, "on"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final whitelist core-platform-api test-api setSoTimeout(I)V
    .registers 3
...
.method greylist setSoWriteTimeout(I)V
    .registers 4
