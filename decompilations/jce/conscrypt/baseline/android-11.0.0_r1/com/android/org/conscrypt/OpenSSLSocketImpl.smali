...
# virtual methods
.method public bridge synthetic whitelist core-platform-api test-api addHandshakeCompletedListener(Ljavax/net/ssl/HandshakeCompletedListener;)V
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api bind(Ljava/net/SocketAddress;)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final greylist-max-q core-platform-api getAlpnSelectedProtocol()[B
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getChannel()Ljava/nio/channels/SocketChannel;
    .registers 2
...
.method public abstract greylist getChannelId()[B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public greylist-max-o core-platform-api getFileDescriptor$()Ljava/io/FileDescriptor;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api getHandshakeSession()Ljavax/net/ssl/SSLSession;
.end method
...
.method public greylist getHostnameOrIP()Ljava/lang/String;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getInetAddress()Ljava/net/InetAddress;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getKeepAlive()Z
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public bridge synthetic whitelist core-platform-api test-api getLocalAddress()Ljava/net/InetAddress;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getLocalPort()I
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getLocalSocketAddress()Ljava/net/SocketAddress;
    .registers 2
...
.method public final greylist core-platform-api getNpnSelectedProtocol()[B
    .registers 2
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public bridge synthetic whitelist core-platform-api test-api getOOBInline()Z
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api getReceiveBufferSize()I
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api getRemoteSocketAddress()Ljava/net/SocketAddress;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getReuseAddress()Z
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api getSendBufferSize()I
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api getSoLinger()I
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public greylist getSoWriteTimeout()I
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api getTcpNoDelay()Z
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api getTrafficClass()I
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api isBound()Z
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api isClosed()Z
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api isConnected()Z
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api isInputShutdown()Z
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api isOutputShutdown()Z
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api removeHandshakeCompletedListener(Ljavax/net/ssl/HandshakeCompletedListener;)V
    .registers 2
...
.method public final greylist-max-q core-platform-api setAlpnProtocols([B)V
    .registers 3
...
.method public abstract greylist setChannelIdEnabled(Z)V
.end method

.method public abstract greylist core-platform-api setChannelIdPrivateKey(Ljava/security/PrivateKey;)V
.end method

.method public greylist core-platform-api setHandshakeTimeout(I)V
    .registers 2
...
.method public greylist-max-q core-platform-api setHostname(Ljava/lang/String;)V
    .registers 2
    .param p1, "hostname"    # Ljava/lang/String;
...
.method public bridge synthetic whitelist core-platform-api test-api setKeepAlive(Z)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public final greylist core-platform-api setNpnProtocols([B)V
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api setPerformancePreferences(III)V
    .registers 4
...
.method public bridge synthetic whitelist core-platform-api test-api setReceiveBufferSize(I)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api setReuseAddress(Z)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api setSendBufferSize(I)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api setSoLinger(ZI)V
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public greylist core-platform-api setSoWriteTimeout(I)V
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api setTcpNoDelay(Z)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public bridge synthetic whitelist core-platform-api test-api setTrafficClass(I)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public abstract greylist-max-q core-platform-api setUseSessionTickets(Z)V
.end method

.method public bridge synthetic whitelist core-platform-api test-api shutdownInput()V
    .registers 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public bridge synthetic whitelist core-platform-api test-api shutdownOutput()V
    .registers 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
