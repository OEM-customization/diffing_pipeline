...
.method public blacklist read(Lcom/android/okhttp/okio/Buffer;J)J
    ...
    .line 150
    sget-boolean v3, Lcom/android/okhttp/internal/http/MultiratLog;->MRATLOGVV:Z
    ...
    const-string v5, "Source.read(sink, byteCount), maxToCopy="
    ...
    const-string v5, ", sink.size="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v5, p1, Lcom/android/okhttp/okio/Buffer;->size:J

    invoke-virtual {v4, v5, v6}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v5, ", tail.limit="
    ...
    invoke-static {v3}, Lcom/android/okhttp/internal/http/MultiratLog;->debug(Ljava/lang/Throwable;)V
    :try_end_74
    .catch Ljava/lang/AssertionError; {:try_start_b .. :try_end_74} :catch_76
