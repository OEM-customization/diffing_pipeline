...
.method private constructor blacklist <init>(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)V
    ...
    iput-wide v0, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->unacknowledgedBytesRead:J
    ...
    iput-boolean v0, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->receivedInitialPeerSettings:Z
    ...
    iput-object v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->currentPushRequests:Ljava/util/Set;

    .line 134
    # getter for: Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->protocol:Lcom/android/okhttp/Protocol;
    invoke-static {p1}, Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->access$000(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)Lcom/android/okhttp/Protocol;

    move-result-object v1

    iput-object v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->protocol:Lcom/android/okhttp/Protocol;
    ...
    invoke-static {p1}, Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->access$100(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)Lcom/android/okhttp/internal/framed/PushObserver;

    move-result-object v1

    iput-object v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->pushObserver:Lcom/android/okhttp/internal/framed/PushObserver;

    .line 136
    # getter for: Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->client:Z
    invoke-static {p1}, Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->access$200(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)Z

    move-result v1

    iput-boolean v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->client:Z
    ...
    invoke-static {p1}, Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->access$300(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)Lcom/android/okhttp/internal/framed/FramedConnection$Listener;

    move-result-object v1

    iput-object v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->listener:Lcom/android/okhttp/internal/framed/FramedConnection$Listener;
    ...
    :goto_4f
    iput v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->nextStreamId:I
    ...
    invoke-virtual {v1, v2, v0, v4}, Lcom/android/okhttp/internal/framed/Settings;->set(III)Lcom/android/okhttp/internal/framed/Settings;

    .line 154
    :cond_79
    # getter for: Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->hostName:Ljava/lang/String;
    invoke-static {p1}, Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->access$400(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->hostName:Ljava/lang/String;
    ...
    .line 157
    new-instance v1, Lcom/android/okhttp/internal/framed/Http2;

    invoke-direct {v1}, Lcom/android/okhttp/internal/framed/Http2;-><init>()V

    iput-object v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->variant:Lcom/android/okhttp/internal/framed/Variant;
    ...
    iget-object v6, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->hostName:Ljava/lang/String;
    ...
    invoke-static {v4, v3}, Lcom/android/okhttp/internal/Util;->threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    .line 163
    iget-object v1, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->peerSettings:Lcom/android/okhttp/internal/framed/Settings;

    const v3, 0xffff

    invoke-virtual {v1, v2, v0, v3}, Lcom/android/okhttp/internal/framed/Settings;->set(III)Lcom/android/okhttp/internal/framed/Settings;
    ...
    .line 167
    iput-object v5, p0, Lcom/android/okhttp/internal/framed/FramedConnection;->pushExecutor:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {p1}, Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->access$500(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)Ljava/net/Socket;
    ...
    invoke-static {p1}, Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->access$600(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)Lcom/android/okhttp/okio/BufferedSink;
    ...
    invoke-static {p1}, Lcom/android/okhttp/internal/framed/FramedConnection$Builder;->access$700(Lcom/android/okhttp/internal/framed/FramedConnection$Builder;)Lcom/android/okhttp/okio/BufferedSource;
    ...
    invoke-direct {v0, p0, v1, v5}, Lcom/android/okhttp/internal/framed/FramedConnection$Reader;-><init>(Lcom/android/okhttp/internal/framed/FramedConnection;Lcom/android/okhttp/internal/framed/FrameReader;Lcom/android/okhttp/internal/framed/FramedConnection$1;)V
...
.method private blacklist close(Lcom/android/okhttp/internal/framed/ErrorCode;Lcom/android/okhttp/internal/framed/ErrorCode;)V
    ...
    monitor-exit p0
    :try_end_4e
    .catchall {:try_start_b .. :try_end_4e} :catchall_84
...
.method private blacklist newStream(ILjava/util/List;ZZ)Lcom/android/okhttp/internal/framed/FramedStream;
    ...
    .line 267
    .local v0, "streamId":I
    iget v1, v7, Lcom/android/okhttp/internal/framed/FramedConnection;->nextStreamId:I

    add-int/lit8 v1, v1, 0x2

    iput v1, v7, Lcom/android/okhttp/internal/framed/FramedConnection;->nextStreamId:I

    .line 268
    new-instance v8, Lcom/android/okhttp/internal/framed/FramedStream;
    ...
    .line 269
    .local v1, "stream":Lcom/android/okhttp/internal/framed/FramedStream;
    invoke-virtual {v1}, Lcom/android/okhttp/internal/framed/FramedStream;->isOpen()Z
    ...
    .line 270
    iget-object v2, v7, Lcom/android/okhttp/internal/framed/FramedConnection;->streams:Ljava/util/Map;
    ...
    invoke-direct {v7, v2}, Lcom/android/okhttp/internal/framed/FramedConnection;->setIdle(Z)V

    .line 273
    :cond_37
    monitor-exit p0
    :try_end_38
    .catchall {:try_start_c .. :try_end_38} :catchall_71
    ...
    :try_end_4f
    .catchall {:try_start_3a .. :try_end_4f} :catchall_78

    move-object/from16 v3, p2

    :try_start_51
    invoke-interface {v2, v14, v0, v3}, Lcom/android/okhttp/internal/framed/FrameWriter;->pushPromise(IILjava/util/List;)V
    ...
    .end local v1    # "stream":Lcom/android/okhttp/internal/framed/FramedStream;
