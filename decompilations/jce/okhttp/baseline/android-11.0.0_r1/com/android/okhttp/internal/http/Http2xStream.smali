...
.method static constructor blacklist <clinit>()V
    ...
    new-array v1, v0, [Lcom/android/okhttp/okio/ByteString;

    sget-object v2, Lcom/android/okhttp/internal/http/Http2xStream;->CONNECTION:Lcom/android/okhttp/okio/ByteString;

    const/4 v3, 0x0

    aput-object v2, v1, v3

    sget-object v2, Lcom/android/okhttp/internal/http/Http2xStream;->HOST:Lcom/android/okhttp/okio/ByteString;

    const/4 v4, 0x1

    aput-object v2, v1, v4

    sget-object v2, Lcom/android/okhttp/internal/http/Http2xStream;->KEEP_ALIVE:Lcom/android/okhttp/okio/ByteString;

    const/4 v5, 0x2

    aput-object v2, v1, v5

    sget-object v2, Lcom/android/okhttp/internal/http/Http2xStream;->PROXY_CONNECTION:Lcom/android/okhttp/okio/ByteString;

    const/4 v6, 0x3

    aput-object v2, v1, v6

    sget-object v2, Lcom/android/okhttp/internal/http/Http2xStream;->TRANSFER_ENCODING:Lcom/android/okhttp/okio/ByteString;
    ...
    sget-object v2, Lcom/android/okhttp/internal/framed/Header;->TARGET_HOST:Lcom/android/okhttp/okio/ByteString;

    const/16 v12, 0x9

    aput-object v2, v1, v12

    sget-object v2, Lcom/android/okhttp/internal/framed/Header;->VERSION:Lcom/android/okhttp/okio/ByteString;
    ...
    sput-object v1, Lcom/android/okhttp/internal/http/Http2xStream;->SPDY_3_SKIPPED_REQUEST_HEADERS:Ljava/util/List;

    .line 77
    new-array v1, v8, [Lcom/android/okhttp/okio/ByteString;
    ...
    sput-object v1, Lcom/android/okhttp/internal/http/Http2xStream;->SPDY_3_SKIPPED_RESPONSE_HEADERS:Ljava/util/List;

    .line 85
    const/16 v1, 0xe

    new-array v1, v1, [Lcom/android/okhttp/okio/ByteString;
    ...
    sget-object v2, Lcom/android/okhttp/internal/http/Http2xStream;->TE:Lcom/android/okhttp/okio/ByteString;
    ...
    sget-object v2, Lcom/android/okhttp/internal/http/Http2xStream;->ENCODING:Lcom/android/okhttp/okio/ByteString;

    aput-object v2, v1, v9

    sget-object v2, Lcom/android/okhttp/internal/http/Http2xStream;->UPGRADE:Lcom/android/okhttp/okio/ByteString;
    ...
    sget-object v0, Lcom/android/okhttp/internal/framed/Header;->TARGET_HOST:Lcom/android/okhttp/okio/ByteString;

    const/16 v2, 0xc

    aput-object v0, v1, v2

    sget-object v0, Lcom/android/okhttp/internal/framed/Header;->VERSION:Lcom/android/okhttp/okio/ByteString;
    ...
    .line 100
    new-array v0, v11, [Lcom/android/okhttp/okio/ByteString;
