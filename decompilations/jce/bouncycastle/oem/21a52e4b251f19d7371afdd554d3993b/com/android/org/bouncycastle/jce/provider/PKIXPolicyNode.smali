...
# virtual methods
.method public blacklist addChild(Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .registers 3
...
.method public blacklist copy()Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    .registers 13
    ...
    iget-object v2, p0, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;->policyQualifiers:Ljava/util/Set;
    ...
    .line 154
    :cond_41
    new-instance v11, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iget v3, p0, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;->depth:I

    const/4 v5, 0x0

    new-instance v7, Ljava/lang/String;

    iget-object v1, p0, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;->validPolicy:Ljava/lang/String;

    invoke-direct {v7, v1}, Ljava/lang/String;-><init>(Ljava/lang/String;)V

    iget-boolean v8, p0, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;->critical:Z
    ...
    .line 162
    .local v1, "_node":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;->copy()Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;

    move-result-object v3

    .line 166
    .local v3, "_child":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    invoke-virtual {v3, v1}, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;->setParent(Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;)V

    .line 167
    invoke-virtual {v1, v3}, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;->addChild(Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;)V

    .line 168
    .end local v3    # "_child":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    goto :goto_60
...
.method public whitelist core-platform-api test-api getChildren()Ljava/util/Iterator;
    .registers 2
...
.method public whitelist core-platform-api test-api getDepth()I
    .registers 2
...
.method public whitelist core-platform-api test-api getExpectedPolicies()Ljava/util/Set;
    .registers 2
...
.method public whitelist core-platform-api test-api getParent()Ljava/security/cert/PolicyNode;
    .registers 2
...
.method public whitelist core-platform-api test-api getPolicyQualifiers()Ljava/util/Set;
    .registers 2
...
.method public whitelist core-platform-api test-api getValidPolicy()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api isCritical()Z
    .registers 2
...
.method public blacklist removeChild(Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .registers 3
    .param p1, "_child"    # Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
...
.method public blacklist setParent(Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .registers 2
