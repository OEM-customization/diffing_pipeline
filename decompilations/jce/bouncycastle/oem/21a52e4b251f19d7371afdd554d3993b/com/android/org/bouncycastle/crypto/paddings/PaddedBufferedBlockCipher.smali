...
# instance fields
.field blacklist padding:Lcom/android/org/bouncycastle/crypto/paddings/BlockCipherPadding;
...
.method public constructor blacklist <init>(Lcom/android/org/bouncycastle/crypto/BlockCipher;Lcom/android/org/bouncycastle/crypto/paddings/BlockCipherPadding;)V
    .registers 4
    .param p1, "cipher"    # Lcom/android/org/bouncycastle/crypto/BlockCipher;
...
.method public blacklist doFinal([BI)I
    ...
    .line 249
    iget-object v0, p0, Lcom/android/org/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->cipher:Lcom/android/org/bouncycastle/crypto/BlockCipher;
    ...
    invoke-interface {v2, v4, v3, p1, p2}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-interface {v2, v4, v5}, Lcom/android/org/bouncycastle/crypto/paddings/BlockCipherPadding;->addPadding([BI)I
    ...
    invoke-interface {v2, v4, v3, p1, v5}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-interface {v2, v4, v3, v5, v3}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-interface {v2, v4}, Lcom/android/org/bouncycastle/crypto/paddings/BlockCipherPadding;->padCount([B)I
    ...
    :try_end_62
    .catchall {:try_start_54 .. :try_end_62} :catchall_67
...
.method public blacklist getOutputSize(I)I
    ...
    .line 98
    iget v0, p0, Lcom/android/org/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->bufOff:I
...
.method public blacklist init(ZLcom/android/org/bouncycastle/crypto/CipherParameters;)V
    ...
    .line 81
    :cond_1f
    iget-object v0, p0, Lcom/android/org/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->padding:Lcom/android/org/bouncycastle/crypto/paddings/BlockCipherPadding;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Lcom/android/org/bouncycastle/crypto/paddings/BlockCipherPadding;->init(Ljava/security/SecureRandom;)V
