...
.method public static blacklist decode(Ljava/lang/String;)[B
    ...
    :try_start_5
    sget-object v1, Lcom/android/org/bouncycastle/util/encoders/Hex;->encoder:Lcom/android/org/bouncycastle/util/encoders/Encoder;

    invoke-interface {v1, p0, v0}, Lcom/android/org/bouncycastle/util/encoders/Encoder;->decode(Ljava/lang/String;Ljava/io/OutputStream;)I
    :try_end_a
...
.method public static blacklist decode([B)[B
    ...
    invoke-interface {v1, p0, v2, v3, v0}, Lcom/android/org/bouncycastle/util/encoders/Encoder;->decode([BIILjava/io/OutputStream;)I
    :try_end_c
...
.method public static blacklist encode([BII)[B
    ...
    invoke-interface {v1, p0, p1, p2, v0}, Lcom/android/org/bouncycastle/util/encoders/Encoder;->encode([BIILjava/io/OutputStream;)I
    :try_end_a
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_a} :catch_10
