...
# static fields
.field static final blacklist INSTANCE:Lcom/android/org/bouncycastle/crypto/generators/DHKeyGeneratorHelper;
...
# virtual methods
.method blacklist calculatePrivate(Lcom/android/org/bouncycastle/crypto/params/DHParameters;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    .registers 11
    ...
    :goto_8
    invoke-static {v0, p2}, Lcom/android/org/bouncycastle/util/BigIntegers;->createRandomBigInteger(ILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Lcom/android/org/bouncycastle/math/ec/WNafUtil;->getNafWeight(Ljava/math/BigInteger;)I
    ...
    :cond_1a
    sget-object v1, Lcom/android/org/bouncycastle/crypto/generators/DHKeyGeneratorHelper;->TWO:Ljava/math/BigInteger;
    ...
    .line 43
    sget-object v3, Lcom/android/org/bouncycastle/crypto/generators/DHKeyGeneratorHelper;->ONE:Ljava/math/BigInteger;
    ...
    .line 51
    :cond_34
    sget-object v4, Lcom/android/org/bouncycastle/crypto/generators/DHKeyGeneratorHelper;->TWO:Ljava/math/BigInteger;
    ...
    :goto_40
    invoke-static {v1, v4, p2}, Lcom/android/org/bouncycastle/util/BigIntegers;->createRandomInRange(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method blacklist calculatePublic(Lcom/android/org/bouncycastle/crypto/params/DHParameters;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .registers 5
    .param p1, "dhParams"    # Lcom/android/org/bouncycastle/crypto/params/DHParameters;
