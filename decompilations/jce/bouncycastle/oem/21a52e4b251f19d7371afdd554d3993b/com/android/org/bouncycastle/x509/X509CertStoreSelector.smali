...
.method public static blacklist getInstance(Ljava/security/cert/X509CertSelector;)Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;
    .registers 6
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setAuthorityKeyIdentifier([B)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setBasicConstraints(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setCertificate(Ljava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setCertificateValid(Ljava/util/Date;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setMatchAllSubjectAltNames(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setPathToNames(Ljava/util/Collection;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setExtendedKeyUsage(Ljava/util/Set;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setNameConstraints([B)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setPolicy(Ljava/util/Set;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setSubjectPublicKeyAlgID(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setSubjectAlternativeNames(Ljava/util/Collection;)V
    :try_end_54
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setIssuer(Ljavax/security/auth/x500/X500Principal;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setKeyUsage([Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setPrivateKeyValid(Ljava/util/Date;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setSerialNumber(Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setSubject(Ljavax/security/auth/x500/X500Principal;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setSubjectKeyIdentifier([B)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->setSubjectPublicKey(Ljava/security/PublicKey;)V
    ...
    .line 59
    .end local v0    # "cs":Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;
