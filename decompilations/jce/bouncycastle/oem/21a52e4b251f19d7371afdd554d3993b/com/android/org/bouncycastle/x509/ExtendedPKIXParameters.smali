...
.field private blacklist selector:Lcom/android/org/bouncycastle/util/Selector;
...
.method public static blacklist getInstance(Ljava/security/cert/PKIXParameters;)Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;
    .registers 4
    .param p0, "pkixParams"    # Ljava/security/cert/PKIXParameters;

    .line 87
    :try_start_0
    new-instance v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;

    invoke-virtual {p0}, Ljava/security/cert/PKIXParameters;->getTrustAnchors()Ljava/util/Set;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;-><init>(Ljava/util/Set;)V
    :try_end_9
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_9} :catch_e

    .line 93
    .local v0, "params":Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;
    nop

    .line 94
    invoke-virtual {v0, p0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setParams(Ljava/security/cert/PKIXParameters;)V

    .line 95
    return-object v0

    .line 89
    .end local v0    # "params":Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;
    :catch_e
    move-exception v0
...
# virtual methods
.method public blacklist addAddionalStore(Lcom/android/org/bouncycastle/util/Store;)V
    .registers 2
...
.method public blacklist addAdditionalStore(Lcom/android/org/bouncycastle/util/Store;)V
    .registers 3
    .param p1, "store"    # Lcom/android/org/bouncycastle/util/Store;
...
.method public blacklist addStore(Lcom/android/org/bouncycastle/util/Store;)V
    .registers 3
    .param p1, "store"    # Lcom/android/org/bouncycastle/util/Store;
...
.method public blacklist getTargetConstraints()Lcom/android/org/bouncycastle/util/Selector;
    .registers 2
...
.method protected blacklist setParams(Ljava/security/cert/PKIXParameters;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setDate(Ljava/util/Date;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setCertPathCheckers(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setCertStores(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setAnyPolicyInhibited(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setExplicitPolicyRequired(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setPolicyMappingInhibited(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setRevocationEnabled(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setInitialPolicies(Ljava/util/Set;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setPolicyQualifiersRejected(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setSigProvider(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setTargetCertConstraints(Ljava/security/cert/CertSelector;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->setTrustAnchors(Ljava/util/Set;)V
    :try_end_54
    ...
    .line 127
    instance-of v0, p1, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;
    ...
    iget v1, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->validityModel:I

    iput v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->validityModel:I

    .line 131
    iget-boolean v1, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->useDeltas:Z

    iput-boolean v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->useDeltas:Z

    .line 132
    iget-boolean v1, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->additionalLocationsEnabled:Z

    iput-boolean v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->additionalLocationsEnabled:Z

    .line 133
    iget-object v1, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->selector:Lcom/android/org/bouncycastle/util/Selector;
    ...
    .line 134
    :cond_6e
    invoke-interface {v1}, Lcom/android/org/bouncycastle/util/Selector;->clone()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/android/org/bouncycastle/util/Selector;

    :goto_74
    iput-object v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->selector:Lcom/android/org/bouncycastle/util/Selector;

    .line 135
    new-instance v1, Ljava/util/ArrayList;

    iget-object v2, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->stores:Ljava/util/List;
    ...
    iget-object v2, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->additionalStores:Ljava/util/List;

    invoke-direct {v1, v2}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iput-object v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->additionalStores:Ljava/util/List;

    .line 137
    new-instance v1, Ljava/util/HashSet;

    iget-object v2, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->trustedACIssuers:Ljava/util/Set;

    invoke-direct {v1, v2}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->trustedACIssuers:Ljava/util/Set;

    .line 138
    new-instance v1, Ljava/util/HashSet;

    iget-object v2, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->prohibitedACAttributes:Ljava/util/Set;

    invoke-direct {v1, v2}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->prohibitedACAttributes:Ljava/util/Set;

    .line 139
    new-instance v1, Ljava/util/HashSet;

    iget-object v2, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->necessaryACAttributes:Ljava/util/Set;

    invoke-direct {v1, v2}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->necessaryACAttributes:Ljava/util/Set;

    .line 140
    new-instance v1, Ljava/util/HashSet;

    iget-object v2, v0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->attrCertCheckers:Ljava/util/Set;

    invoke-direct {v1, v2}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v1, p0, Lcom/android/org/bouncycastle/x509/ExtendedPKIXParameters;->attrCertCheckers:Ljava/util/Set;
...
.method public blacklist setStores(Ljava/util/List;)V
    ...
    const-string v2, "All elements of list must be of type com.android.org.bouncycastle.util.Store."
...
.method public whitelist core-platform-api test-api setTargetCertConstraints(Ljava/security/cert/CertSelector;)V
    ...
    .line 472
    invoke-static {v0}, Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;->getInstance(Ljava/security/cert/X509CertSelector;)Lcom/android/org/bouncycastle/x509/X509CertStoreSelector;
...
.method public blacklist setTargetConstraints(Lcom/android/org/bouncycastle/util/Selector;)V
    .registers 3
