...
# instance fields
.field private blacklist key:Lcom/android/org/bouncycastle/crypto/params/ECPrivateKeyParameters;
...
.method public blacklist calculateAgreement(Lcom/android/org/bouncycastle/crypto/CipherParameters;)Ljava/math/BigInteger;
    ...
    .line 50
    .local v0, "pub":Lcom/android/org/bouncycastle/crypto/params/ECPublicKeyParameters;
    iget-object v1, p0, Lcom/android/org/bouncycastle/crypto/agreement/ECDHBasicAgreement;->key:Lcom/android/org/bouncycastle/crypto/params/ECPrivateKeyParameters;

    invoke-virtual {v1}, Lcom/android/org/bouncycastle/crypto/params/ECPrivateKeyParameters;->getParameters()Lcom/android/org/bouncycastle/crypto/params/ECDomainParameters;

    move-result-object v1

    .line 51
    .local v1, "params":Lcom/android/org/bouncycastle/crypto/params/ECDomainParameters;
    invoke-virtual {v0}, Lcom/android/org/bouncycastle/crypto/params/ECPublicKeyParameters;->getParameters()Lcom/android/org/bouncycastle/crypto/params/ECDomainParameters;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/android/org/bouncycastle/crypto/params/ECDomainParameters;->equals(Ljava/lang/Object;)Z
    ...
    .line 56
    iget-object v2, p0, Lcom/android/org/bouncycastle/crypto/agreement/ECDHBasicAgreement;->key:Lcom/android/org/bouncycastle/crypto/params/ECPrivateKeyParameters;

    invoke-virtual {v2}, Lcom/android/org/bouncycastle/crypto/params/ECPrivateKeyParameters;->getD()Ljava/math/BigInteger;
    ...
    invoke-static {v3, v4}, Lcom/android/org/bouncycastle/math/ec/ECAlgorithms;->cleanPoint(Lcom/android/org/bouncycastle/math/ec/ECCurve;Lcom/android/org/bouncycastle/math/ec/ECPoint;)Lcom/android/org/bouncycastle/math/ec/ECPoint;

    move-result-object v3

    .line 60
    .local v3, "Q":Lcom/android/org/bouncycastle/math/ec/ECPoint;
    ...
    .line 65
    invoke-virtual {v1}, Lcom/android/org/bouncycastle/crypto/params/ECDomainParameters;->getH()Ljava/math/BigInteger;
    ...
    .line 68
    invoke-virtual {v1}, Lcom/android/org/bouncycastle/crypto/params/ECDomainParameters;->getHInv()Ljava/math/BigInteger;
    ...
    invoke-virtual {v1}, Lcom/android/org/bouncycastle/crypto/params/ECDomainParameters;->getN()Ljava/math/BigInteger;
    ...
    .line 69
    invoke-static {v3, v4}, Lcom/android/org/bouncycastle/math/ec/ECAlgorithms;->referenceMultiply(Lcom/android/org/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECPoint;

    move-result-object v3

    .line 72
    :cond_4b
    invoke-virtual {v3, v2}, Lcom/android/org/bouncycastle/math/ec/ECPoint;->multiply(Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECPoint;
    ...
    .end local v3    # "Q":Lcom/android/org/bouncycastle/math/ec/ECPoint;
    :cond_72
...
.method public blacklist init(Lcom/android/org/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object v0, p0, Lcom/android/org/bouncycastle/crypto/agreement/ECDHBasicAgreement;->key:Lcom/android/org/bouncycastle/crypto/params/ECPrivateKeyParameters;
