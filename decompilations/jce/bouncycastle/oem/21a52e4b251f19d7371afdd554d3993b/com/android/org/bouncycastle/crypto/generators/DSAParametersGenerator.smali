...
.method private static blacklist calculateGenerator_FIPS186_2(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    .line 210
    sget-object v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->ONE:Ljava/math/BigInteger;
    ...
    sget-object v1, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->TWO:Ljava/math/BigInteger;
    ...
    :goto_10
    sget-object v2, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->TWO:Ljava/math/BigInteger;
...
.method private static blacklist calculateGenerator_FIPS186_3_Verifiable(Lcom/android/org/bouncycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;[BI)Ljava/math/BigInteger;
    .registers 15
    ...
    .line 373
    invoke-static {v2}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->inc([B)V

    .line 374
    invoke-static {p0, v2, v4, v5}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lcom/android/org/bouncycastle/crypto/Digest;[B[BI)V
    ...
    sget-object v9, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->TWO:Ljava/math/BigInteger;
...
.method private blacklist generateParameters_FIPS186_2()Lcom/android/org/bouncycastle/crypto/params/DSAParameters;
    .registers 17
    ...
    .line 133
    .local v1, "u":[B
    iget v5, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->L:I
    ...
    .line 138
    .local v5, "w":[B
    iget-object v7, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->digest:Lcom/android/org/bouncycastle/crypto/Digest;

    invoke-interface {v7}, Lcom/android/org/bouncycastle/crypto/Digest;->getAlgorithmName()Ljava/lang/String;
    ...
    .line 145
    :goto_24
    iget-object v7, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->random:Ljava/security/SecureRandom;
    ...
    invoke-static {v7, v2, v3, v8}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lcom/android/org/bouncycastle/crypto/Digest;[B[BI)V
    ...
    .line 149
    invoke-static {v4}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->inc([B)V

    .line 150
    iget-object v7, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->digest:Lcom/android/org/bouncycastle/crypto/Digest;

    invoke-static {v7, v4, v4, v8}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lcom/android/org/bouncycastle/crypto/Digest;[B[BI)V
    ...
    invoke-direct {v0, v7}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->isProbablePrime(Ljava/math/BigInteger;)Z
    ...
    .line 176
    iget-object v13, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->digest:Lcom/android/org/bouncycastle/crypto/Digest;
    ...
    invoke-static {v13, v9, v5, v14}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lcom/android/org/bouncycastle/crypto/Digest;[B[BI)V
    ...
    invoke-static {v13, v9, v3, v8}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lcom/android/org/bouncycastle/crypto/Digest;[B[BI)V
    ...
    sget-object v14, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->ONE:Ljava/math/BigInteger;
    ...
    iget v8, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->L:I
    ...
    .line 198
    :cond_bc
    invoke-direct {v0, v14}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->isProbablePrime(Ljava/math/BigInteger;)Z
    ...
    .line 200
    iget-object v8, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->random:Ljava/security/SecureRandom;

    invoke-static {v14, v7, v8}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->calculateGenerator_FIPS186_2(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;

    move-result-object v8

    .line 202
    .local v8, "g":Ljava/math/BigInteger;
    new-instance v10, Lcom/android/org/bouncycastle/crypto/params/DSAParameters;

    new-instance v15, Lcom/android/org/bouncycastle/crypto/params/DSAValidationParameters;

    invoke-direct {v15, v2, v11}, Lcom/android/org/bouncycastle/crypto/params/DSAValidationParameters;-><init>([BI)V

    invoke-direct {v10, v14, v7, v8, v15}, Lcom/android/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lcom/android/org/bouncycastle/crypto/params/DSAValidationParameters;)V
...
.method private blacklist generateParameters_FIPS186_3()Lcom/android/org/bouncycastle/crypto/params/DSAParameters;
    .registers 23

    .line 232
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->digest:Lcom/android/org/bouncycastle/crypto/Digest;

    .line 233
    .local v1, "d":Lcom/android/org/bouncycastle/crypto/Digest;
    ...
    .line 241
    .local v2, "outlen":I
    iget v3, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->N:I
    ...
    .local v8, "output":[B
    :goto_22
    iget-object v9, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->random:Ljava/security/SecureRandom;
    ...
    invoke-static {v1, v4, v8, v9}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lcom/android/org/bouncycastle/crypto/Digest;[B[BI)V
    ...
    sget-object v12, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->ONE:Ljava/math/BigInteger;

    iget v13, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->N:I
    ...
    invoke-direct {v0, v12}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->isProbablePrime(Ljava/math/BigInteger;)Z
    ...
    .line 277
    .local v13, "offset":[B
    iget v14, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->L:I
    ...
    invoke-static {v1, v13, v5, v9}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lcom/android/org/bouncycastle/crypto/Digest;[B[BI)V
    ...
    invoke-static {v1, v13, v8, v9}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lcom/android/org/bouncycastle/crypto/Digest;[B[BI)V
    ...
    sget-object v11, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->ONE:Ljava/math/BigInteger;
    ...
    .local v19, "seedlen":I
    iget v3, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->L:I
    ...
    .line 314
    :cond_b5
    invoke-direct {v0, v11}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->isProbablePrime(Ljava/math/BigInteger;)Z
    ...
    .line 318
    iget v2, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->usageIndex:I

    if-ltz v2, :cond_db

    .line 320
    invoke-static {v1, v11, v12, v4, v2}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->calculateGenerator_FIPS186_3_Verifiable(Lcom/android/org/bouncycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;[BI)Ljava/math/BigInteger;
    ...
    .end local v1    # "d":Lcom/android/org/bouncycastle/crypto/Digest;
    .local v20, "d":Lcom/android/org/bouncycastle/crypto/Digest;
    new-instance v1, Lcom/android/org/bouncycastle/crypto/params/DSAValidationParameters;

    move-object/from16 v21, v5

    .end local v5    # "w":[B
    .local v21, "w":[B
    iget v5, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->usageIndex:I

    invoke-direct {v1, v4, v15, v5}, Lcom/android/org/bouncycastle/crypto/params/DSAValidationParameters;-><init>([BII)V

    invoke-direct {v3, v11, v12, v2, v1}, Lcom/android/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lcom/android/org/bouncycastle/crypto/params/DSAValidationParameters;)V

    return-object v3

    .line 321
    .end local v20    # "d":Lcom/android/org/bouncycastle/crypto/Digest;
    .end local v21    # "w":[B
    .restart local v1    # "d":Lcom/android/org/bouncycastle/crypto/Digest;
    ...
    .end local v1    # "d":Lcom/android/org/bouncycastle/crypto/Digest;
    .end local v5    # "w":[B
    .restart local v20    # "d":Lcom/android/org/bouncycastle/crypto/Digest;
    ...
    .restart local v21    # "w":[B
    :goto_df
    iget-object v1, v0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->random:Ljava/security/SecureRandom;

    invoke-static {v11, v12, v1}, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->calculateGenerator_FIPS186_3_Unverifiable(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-direct {v3, v4, v15}, Lcom/android/org/bouncycastle/crypto/params/DSAValidationParameters;-><init>([BI)V

    invoke-direct {v2, v11, v12, v1, v3}, Lcom/android/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lcom/android/org/bouncycastle/crypto/params/DSAValidationParameters;)V
...
# virtual methods
.method public blacklist generateParameters()Lcom/android/org/bouncycastle/crypto/params/DSAParameters;
    .registers 2
...
.method public blacklist init(Lcom/android/org/bouncycastle/crypto/params/DSAParameterGenerationParameters;)V
    .registers 7
    ...
    .line 109
    iput-boolean v4, p0, Lcom/android/org/bouncycastle/crypto/generators/DSAParametersGenerator;->use186_3:Z
