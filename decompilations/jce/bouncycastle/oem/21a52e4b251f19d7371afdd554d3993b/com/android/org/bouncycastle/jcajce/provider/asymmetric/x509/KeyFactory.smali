...
.method protected whitelist core-platform-api test-api engineGeneratePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    ...
    .end local p0    # "this":Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/KeyFactory;
    .end local p1    # "keySpec":Ljava/security/spec/KeySpec;
    throw v2
    :try_end_35
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_35} :catch_35

    .line 43
    .end local v0    # "info":Lcom/android/org/bouncycastle/asn1/pkcs/PrivateKeyInfo;
    .end local v1    # "key":Ljava/security/PrivateKey;
    .restart local p0    # "this":Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/KeyFactory;
