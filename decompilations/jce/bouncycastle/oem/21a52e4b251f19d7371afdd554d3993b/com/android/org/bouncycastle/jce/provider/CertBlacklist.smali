...
# instance fields
.field public final blacklist pubkeyBlacklist:Ljava/util/Set;
...
.field public final blacklist serialBlacklist:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.method private static blacklist readFileAsBytes(Ljava/lang/String;)Ljava/io/ByteArrayOutputStream;
    ...
    .line 111
    invoke-static {v0}, Lcom/android/org/bouncycastle/jce/provider/CertBlacklist;->closeQuietly(Ljava/io/Closeable;)V
...
.method private static final blacklist readPublicKeyBlackList(Ljava/lang/String;)Ljava/util/Set;
    .registers 11
    .param p0, "path"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private static final blacklist readSerialBlackList(Ljava/lang/String;)Ljava/util/Set;
    .registers 13
    .param p0, "path"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    sget-object v8, Lcom/android/org/bouncycastle/jce/provider/CertBlacklist;->logger:Ljava/util/logging/Logger;
...
.method public blacklist isPublicKeyBlackListed(Ljava/security/PublicKey;)Z
    ...
    .line 225
    iget-object v4, p0, Lcom/android/org/bouncycastle/jce/provider/CertBlacklist;->pubkeyBlacklist:Ljava/util/Set;
