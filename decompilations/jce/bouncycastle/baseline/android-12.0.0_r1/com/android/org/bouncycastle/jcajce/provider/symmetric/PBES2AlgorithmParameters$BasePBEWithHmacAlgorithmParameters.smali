...
# instance fields
.field private final blacklist cipherAlgorithm:Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;

.field private final blacklist cipherAlgorithmShortName:Ljava/lang/String;

.field private final blacklist kdf:Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;

.field private final blacklist kdfShortName:Ljava/lang/String;

.field private final blacklist keySize:I

.field private blacklist params:Lcom/android/org/bouncycastle/asn1/pkcs/PBES2Parameters;


# direct methods
.method private constructor blacklist <init>(Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/lang/String;ILcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/lang/String;)V
    .registers 8
...
.method synthetic constructor blacklist <init>(Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/lang/String;ILcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/lang/String;Lcom/android/org/bouncycastle/jcajce/provider/symmetric/PBES2AlgorithmParameters$1;)V
    .registers 7
    .param p1, "x0"    # Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .param p2, "x1"    # Ljava/lang/String;
    .param p3, "x2"    # I
    .param p4, "x3"    # Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .param p5, "x4"    # Ljava/lang/String;
    .param p6, "x5"    # Lcom/android/org/bouncycastle/jcajce/provider/symmetric/PBES2AlgorithmParameters$1;
...
.method protected whitelist test-api engineGetEncoded()[B
    ...
    .line 77
    invoke-virtual {v0}, Lcom/android/org/bouncycastle/asn1/DERSequence;->getEncoded()[B
...
.method protected whitelist test-api engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    invoke-direct {v7, v2}, Lcom/android/org/bouncycastle/asn1/DEROctetString;-><init>([B)V
...
.method protected blacklist localEngineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    .line 102
    iget-object v0, p0, Lcom/android/org/bouncycastle/jcajce/provider/symmetric/PBES2AlgorithmParameters$BasePBEWithHmacAlgorithmParameters;->params:Lcom/android/org/bouncycastle/asn1/pkcs/PBES2Parameters;
    ...
    invoke-virtual {v0}, Lcom/android/org/bouncycastle/asn1/pkcs/KeyDerivationFunc;->getParameters()Lcom/android/org/bouncycastle/asn1/ASN1Encodable;

    move-result-object v0

    check-cast v0, Lcom/android/org/bouncycastle/asn1/pkcs/PBKDF2Params;

    .line 104
    .local v0, "pbeParamSpec":Lcom/android/org/bouncycastle/asn1/pkcs/PBKDF2Params;
    iget-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/symmetric/PBES2AlgorithmParameters$BasePBEWithHmacAlgorithmParameters;->params:Lcom/android/org/bouncycastle/asn1/pkcs/PBES2Parameters;

    invoke-virtual {v1}, Lcom/android/org/bouncycastle/asn1/pkcs/PBES2Parameters;->getEncryptionScheme()Lcom/android/org/bouncycastle/asn1/pkcs/EncryptionScheme;
    ...
    .line 106
    .local v1, "iv":[B
    invoke-virtual {v0}, Lcom/android/org/bouncycastle/asn1/pkcs/PBKDF2Params;->getSalt()[B

    move-result-object v2

    .line 107
    invoke-virtual {v0}, Lcom/android/org/bouncycastle/asn1/pkcs/PBKDF2Params;->getIterationCount()Ljava/math/BigInteger;
    ...
    .line 106
    # invokes: Lcom/android/org/bouncycastle/jcajce/provider/symmetric/PBES2AlgorithmParameters;->createPBEParameterSpec([BI[B)Ljavax/crypto/spec/PBEParameterSpec;
    invoke-static {v2, v3, v1}, Lcom/android/org/bouncycastle/jcajce/provider/symmetric/PBES2AlgorithmParameters;->access$000([BI[B)Ljavax/crypto/spec/PBEParameterSpec;
    ...
    .line 111
    .end local v0    # "pbeParamSpec":Lcom/android/org/bouncycastle/asn1/pkcs/PBKDF2Params;
    .end local v1    # "iv":[B
    :cond_31
    new-instance v0, Ljava/security/spec/InvalidParameterSpecException;

    const-string v1, "unknown parameter spec passed to PBES2 parameters object."
