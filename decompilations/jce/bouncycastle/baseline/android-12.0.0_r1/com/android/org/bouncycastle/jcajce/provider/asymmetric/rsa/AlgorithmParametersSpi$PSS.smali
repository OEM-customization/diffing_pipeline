...
.method protected whitelist test-api engineGetEncoded()[B
    ...
    invoke-static {v2}, Lcom/android/org/bouncycastle/jcajce/provider/util/DigestFactory;->getOID(Ljava/lang/String;)Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v6}, Lcom/android/org/bouncycastle/jcajce/provider/util/DigestFactory;->getOID(Ljava/lang/String;)Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    .line 194
    .local v3, "maskGenAlgorithm":Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    new-instance v4, Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;
    ...
    invoke-direct {v6, v7, v8}, Lcom/android/org/bouncycastle/asn1/ASN1Integer;-><init>(J)V

    invoke-direct {v4, v1, v3, v5, v6}, Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;-><init>(Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;Lcom/android/org/bouncycastle/asn1/ASN1Integer;Lcom/android/org/bouncycastle/asn1/ASN1Integer;)V

    .line 196
    .local v4, "pssP":Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;
    const-string v5, "DER"

    invoke-virtual {v4, v5}, Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;->getEncoded(Ljava/lang/String;)[B
...
.method protected whitelist test-api engineInit([B)V
    ...
    .line 244
    .local v1, "pssP":Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;
    invoke-virtual {v1}, Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;->getMaskGenAlgorithm()Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    sget-object v3, Lcom/android/org/bouncycastle/asn1/pkcs/PKCSObjectIdentifiers;->id_mgf1:Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v3}, Lcom/android/org/bouncycastle/jcajce/util/MessageDigestUtils;->getDigestName(Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    ...
    .line 253
    invoke-virtual {v1}, Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;->getSaltLength()Ljava/math/BigInteger;
    ...
    .line 254
    invoke-virtual {v1}, Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;->getTrailerField()Ljava/math/BigInteger;
    ...
    iput-object v2, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/rsa/AlgorithmParametersSpi$PSS;->currentSpec:Ljava/security/spec/PSSParameterSpec;

    .line 263
    .end local v1    # "pssP":Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;
    nop
    ...
    .line 246
    .restart local v1    # "pssP":Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;
    :cond_5b
    ...
    .end local p0    # "this":Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/rsa/AlgorithmParametersSpi$PSS;
    .end local p1    # "params":[B
    throw v2
    :try_end_7a
    .catch Ljava/lang/ClassCastException; {:try_start_2 .. :try_end_7a} :catch_81
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_2 .. :try_end_7a} :catch_7a

    .line 260
    .end local v1    # "pssP":Lcom/android/org/bouncycastle/asn1/pkcs/RSASSAPSSparams;
    .restart local p0    # "this":Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/rsa/AlgorithmParametersSpi$PSS;
