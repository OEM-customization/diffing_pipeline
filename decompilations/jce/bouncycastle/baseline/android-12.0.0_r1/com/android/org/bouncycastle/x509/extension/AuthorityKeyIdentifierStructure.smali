...
.method public constructor blacklist <init>(Lcom/android/org/bouncycastle/asn1/x509/X509Extension;)V
    .registers 3
...
.method private static blacklist fromCertificate(Ljava/security/cert/X509Certificate;)Lcom/android/org/bouncycastle/asn1/ASN1Sequence;
    .registers 8
    ...
    invoke-direct {v0, v1}, Lcom/android/org/bouncycastle/asn1/x509/GeneralName;-><init>(Lcom/android/org/bouncycastle/asn1/x509/X509Name;)V

    .line 73
    .local v0, "genName":Lcom/android/org/bouncycastle/asn1/x509/GeneralName;
    ...
    invoke-direct {v3, v0}, Lcom/android/org/bouncycastle/asn1/x509/GeneralNames;-><init>(Lcom/android/org/bouncycastle/asn1/x509/GeneralName;)V
    ...
    invoke-direct {v2, v1, v3, v4}, Lcom/android/org/bouncycastle/asn1/x509/AuthorityKeyIdentifier;-><init>(Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;Lcom/android/org/bouncycastle/asn1/x509/GeneralNames;Ljava/math/BigInteger;)V
    ...
    .line 80
    .end local v0    # "genName":Lcom/android/org/bouncycastle/asn1/x509/GeneralName;
    ...
    .line 82
    .restart local v0    # "genName":Lcom/android/org/bouncycastle/asn1/x509/GeneralName;
    sget-object v1, Lcom/android/org/bouncycastle/asn1/x509/Extension;->subjectKeyIdentifier:Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    .line 88
    .local v2, "str":Lcom/android/org/bouncycastle/asn1/ASN1OctetString;
    new-instance v3, Lcom/android/org/bouncycastle/asn1/x509/AuthorityKeyIdentifier;
    ...
    invoke-direct {v5, v0}, Lcom/android/org/bouncycastle/asn1/x509/GeneralNames;-><init>(Lcom/android/org/bouncycastle/asn1/x509/GeneralName;)V

    invoke-virtual {p0}, Ljava/security/cert/X509Certificate;->getSerialNumber()Ljava/math/BigInteger;

    move-result-object v6

    invoke-direct {v3, v4, v5, v6}, Lcom/android/org/bouncycastle/asn1/x509/AuthorityKeyIdentifier;-><init>([BLcom/android/org/bouncycastle/asn1/x509/GeneralNames;Ljava/math/BigInteger;)V

    invoke-virtual {v3}, Lcom/android/org/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->toASN1Primitive()Lcom/android/org/bouncycastle/asn1/ASN1Primitive;
    ...
    .line 93
    .end local v2    # "str":Lcom/android/org/bouncycastle/asn1/ASN1OctetString;
    :cond_65
    invoke-virtual {p0}, Ljava/security/cert/X509Certificate;->getPublicKey()Ljava/security/PublicKey;
    ...
    invoke-direct {v4, v0}, Lcom/android/org/bouncycastle/asn1/x509/GeneralNames;-><init>(Lcom/android/org/bouncycastle/asn1/x509/GeneralName;)V
    ...
    invoke-direct {v3, v2, v4, v5}, Lcom/android/org/bouncycastle/asn1/x509/AuthorityKeyIdentifier;-><init>(Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;Lcom/android/org/bouncycastle/asn1/x509/GeneralNames;Ljava/math/BigInteger;)V
...
.method private static blacklist fromKey(Ljava/security/PublicKey;)Lcom/android/org/bouncycastle/asn1/ASN1Sequence;
    .registers 5
    ...
    new-instance v1, Lcom/android/org/bouncycastle/asn1/x509/AuthorityKeyIdentifier;

    invoke-direct {v1, v0}, Lcom/android/org/bouncycastle/asn1/x509/AuthorityKeyIdentifier;-><init>(Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)V

    invoke-virtual {v1}, Lcom/android/org/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->toASN1Primitive()Lcom/android/org/bouncycastle/asn1/ASN1Primitive;
