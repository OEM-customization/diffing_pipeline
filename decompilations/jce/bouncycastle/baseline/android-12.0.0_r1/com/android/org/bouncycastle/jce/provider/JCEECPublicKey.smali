...
.method public constructor blacklist <init>(Ljava/lang/String;Lcom/android/org/bouncycastle/jce/spec/ECPublicKeySpec;)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/org/bouncycastle/math/ec/ECCurve;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECPoint;
...
.method public constructor blacklist <init>(Ljava/lang/String;Ljava/security/spec/ECPublicKeySpec;)V
    ...
    invoke-static {v0, v1}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertPoint(Ljava/security/spec/ECParameterSpec;Ljava/security/spec/ECPoint;)Lcom/android/org/bouncycastle/math/ec/ECPoint;
...
.method private blacklist populateFromPubKeyInfo(Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)V
    ...
    invoke-static {v1}, Lcom/android/org/bouncycastle/asn1/x9/X962Parameters;->getInstance(Ljava/lang/Object;)Lcom/android/org/bouncycastle/asn1/x9/X962Parameters;
    ...
    .line 247
    .local v3, "ecP":Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;->getCurve()Lcom/android/org/bouncycastle/math/ec/ECCurve;

    move-result-object v4

    .line 248
    .local v4, "curve":Lcom/android/org/bouncycastle/math/ec/ECCurve;
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;->getSeed()[B
    ...
    new-instance v12, Lcom/android/org/bouncycastle/jce/spec/ECNamedCurveSpec;

    .line 251
    invoke-static {v2}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/util/ECUtil;->getCurveName(Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;

    move-result-object v7

    .line 253
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;->getG()Lcom/android/org/bouncycastle/math/ec/ECPoint;

    move-result-object v6

    invoke-static {v6}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertPoint(Lcom/android/org/bouncycastle/math/ec/ECPoint;)Ljava/security/spec/ECPoint;

    move-result-object v9

    .line 254
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;->getN()Ljava/math/BigInteger;

    move-result-object v10

    .line 255
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;->getH()Ljava/math/BigInteger;
    ...
    invoke-direct/range {v6 .. v11}, Lcom/android/org/bouncycastle/jce/spec/ECNamedCurveSpec;-><init>(Ljava/lang/String;Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    iput-object v12, p0, Lcom/android/org/bouncycastle/jce/provider/JCEECPublicKey;->ecSpec:Ljava/security/spec/ECParameterSpec;

    .line 256
    .end local v2    # "oid":Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .end local v3    # "ecP":Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;
    goto :goto_89

    .line 257
    .end local v4    # "curve":Lcom/android/org/bouncycastle/math/ec/ECCurve;
    .end local v5    # "ellipticCurve":Ljava/security/spec/EllipticCurve;
    :cond_46
    invoke-virtual {v1}, Lcom/android/org/bouncycastle/asn1/x9/X962Parameters;->isImplicitlyCA()Z
    ...
    .restart local v4    # "curve":Lcom/android/org/bouncycastle/math/ec/ECCurve;
    goto :goto_89
    ...
    invoke-static {v4, v3}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertCurve(Lcom/android/org/bouncycastle/math/ec/ECCurve;[B)Ljava/security/spec/EllipticCurve;
    ...
    iput-object v5, p0, Lcom/android/org/bouncycastle/jce/provider/JCEECPublicKey;->ecSpec:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v5, v3}, Lcom/android/org/bouncycastle/asn1/DEROctetString;-><init>([B)V
    ...
    .line 286
    :cond_ad
    new-instance v6, Lcom/android/org/bouncycastle/asn1/x9/X9IntegerConverter;

    invoke-direct {v6}, Lcom/android/org/bouncycastle/asn1/x9/X9IntegerConverter;-><init>()V

    invoke-virtual {v6, v4}, Lcom/android/org/bouncycastle/asn1/x9/X9IntegerConverter;->getByteLength(Lcom/android/org/bouncycastle/math/ec/ECCurve;)I
    ...
    invoke-direct {v6, v4, v5}, Lcom/android/org/bouncycastle/asn1/x9/X9ECPoint;-><init>(Lcom/android/org/bouncycastle/math/ec/ECCurve;Lcom/android/org/bouncycastle/asn1/ASN1OctetString;)V

    .line 302
    .local v6, "derQ":Lcom/android/org/bouncycastle/asn1/x9/X9ECPoint;
    invoke-virtual {v6}, Lcom/android/org/bouncycastle/asn1/x9/X9ECPoint;->getPoint()Lcom/android/org/bouncycastle/math/ec/ECPoint;

    move-result-object v7

    iput-object v7, p0, Lcom/android/org/bouncycastle/jce/provider/JCEECPublicKey;->q:Lcom/android/org/bouncycastle/math/ec/ECPoint;

    .line 304
    .end local v1    # "params":Lcom/android/org/bouncycastle/asn1/x9/X962Parameters;
    .end local v2    # "bits":Lcom/android/org/bouncycastle/asn1/DERBitString;
    .end local v3    # "data":[B
    .end local v4    # "curve":Lcom/android/org/bouncycastle/math/ec/ECCurve;
    .end local v5    # "key":Lcom/android/org/bouncycastle/asn1/ASN1OctetString;
    .end local v6    # "derQ":Lcom/android/org/bouncycastle/asn1/x9/X9ECPoint;
    return-void
.end method
...
.method public whitelist test-api getEncoded()[B
    ...
    invoke-direct {v2, v3, v1}, Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;-><init>(Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;[B)V
