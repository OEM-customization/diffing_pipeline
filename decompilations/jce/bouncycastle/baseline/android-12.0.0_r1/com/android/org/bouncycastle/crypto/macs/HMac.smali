...
.field private blacklist ipadState:Lcom/android/org/bouncycastle/util/Memoable;

.field private blacklist opadState:Lcom/android/org/bouncycastle/util/Memoable;
...
.method private constructor blacklist <init>(Lcom/android/org/bouncycastle/crypto/Digest;I)V
    .registers 5
    .param p1, "digest"    # Lcom/android/org/bouncycastle/crypto/Digest;
    ...
    iput-object v1, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->inputPad:[B
...
.method private static blacklist getByteLength(Lcom/android/org/bouncycastle/crypto/Digest;)I
    .registers 5
    .param p0, "digest"    # Lcom/android/org/bouncycastle/crypto/Digest;

    .line 69
    instance-of v0, p0, Lcom/android/org/bouncycastle/crypto/ExtendedDigest;
...
.method public blacklist doFinal([BI)I
    ...
    iget-object v1, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->outputBuf:[B

    iget v2, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->blockLength:I

    invoke-interface {v0, v1, v2}, Lcom/android/org/bouncycastle/crypto/Digest;->doFinal([BI)I

    .line 187
    iget-object v0, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->opadState:Lcom/android/org/bouncycastle/util/Memoable;
    ...
    invoke-interface {v2, v0}, Lcom/android/org/bouncycastle/util/Memoable;->reset(Lcom/android/org/bouncycastle/util/Memoable;)V
    ...
    invoke-interface {v0, v2, v3, v4}, Lcom/android/org/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v0, v2, v1, v3}, Lcom/android/org/bouncycastle/crypto/Digest;->update([BII)V

    .line 197
    :goto_2b
    iget-object v0, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->digest:Lcom/android/org/bouncycastle/crypto/Digest;

    invoke-interface {v0, p1, p2}, Lcom/android/org/bouncycastle/crypto/Digest;->doFinal([BI)I
    ...
    check-cast v1, Lcom/android/org/bouncycastle/util/Memoable;

    invoke-interface {v1, v2}, Lcom/android/org/bouncycastle/util/Memoable;->reset(Lcom/android/org/bouncycastle/util/Memoable;)V
    ...
    invoke-interface {v2, v3, v1, v4}, Lcom/android/org/bouncycastle/crypto/Digest;->update([BII)V
...
.method public blacklist getUnderlyingDigest()Lcom/android/org/bouncycastle/crypto/Digest;
    .registers 2
...
.method public blacklist init(Lcom/android/org/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v2, v0, v3, v1}, Lcom/android/org/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v2, v4, v3}, Lcom/android/org/bouncycastle/crypto/Digest;->doFinal([BI)I
    ...
    invoke-static {v2, v4, v5}, Lcom/android/org/bouncycastle/crypto/macs/HMac;->xorPad([BIB)V
    ...
    instance-of v4, v2, Lcom/android/org/bouncycastle/util/Memoable;
    ...
    invoke-interface {v2}, Lcom/android/org/bouncycastle/util/Memoable;->copy()Lcom/android/org/bouncycastle/util/Memoable;

    move-result-object v2

    iput-object v2, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->opadState:Lcom/android/org/bouncycastle/util/Memoable;

    .line 151
    check-cast v2, Lcom/android/org/bouncycastle/crypto/Digest;

    iget-object v4, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->outputBuf:[B

    iget v5, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->blockLength:I

    invoke-interface {v2, v4, v3, v5}, Lcom/android/org/bouncycastle/crypto/Digest;->update([BII)V
    ...
    instance-of v3, v2, Lcom/android/org/bouncycastle/util/Memoable;
    ...
    iput-object v2, p0, Lcom/android/org/bouncycastle/crypto/macs/HMac;->ipadState:Lcom/android/org/bouncycastle/util/Memoable;
