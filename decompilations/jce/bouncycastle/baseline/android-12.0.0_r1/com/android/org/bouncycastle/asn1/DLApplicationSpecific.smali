.class public Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;
...
.method public constructor blacklist <init>(ILcom/android/org/bouncycastle/asn1/ASN1Encodable;)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;-><init>(ZILcom/android/org/bouncycastle/asn1/ASN1Encodable;)V

    .line 48
    return-void
.end method

.method public constructor blacklist <init>(ILcom/android/org/bouncycastle/asn1/ASN1EncodableVector;)V
    .registers 5
    .param p1, "tagNo"    # I
    .param p2, "vec"    # Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;

    .line 92
    invoke-static {p2}, Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;->getEncodedVector(Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;)[B
...
.method public constructor blacklist <init>(I[B)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;-><init>(ZI[B)V
...
.method public constructor blacklist <init>(ZILcom/android/org/bouncycastle/asn1/ASN1Encodable;)V
    ...
    :goto_10
    invoke-static {p1, p3}, Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;->getEncoding(ZLcom/android/org/bouncycastle/asn1/ASN1Encodable;)[B
...
.method private static blacklist getEncodedVector(Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;)[B
    .registers 7
    ...
    .line 103
    :try_start_c
    invoke-virtual {p0, v1}, Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;->get(I)Lcom/android/org/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-direct {v3, v4, v2}, Lcom/android/org/bouncycastle/asn1/ASN1ParsingException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static blacklist getEncoding(ZLcom/android/org/bouncycastle/asn1/ASN1Encodable;)[B
    .registers 7
    .param p0, "explicit"    # Z
    ...
    .line 77
    :cond_d
    invoke-static {v0}, Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;->getLengthOfHeader([B)I
...
.method blacklist encode(Lcom/android/org/bouncycastle/asn1/ASN1OutputStream;Z)V
    ...
    .line 119
    .local v0, "flags":I
    iget-boolean v1, p0, Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;->isConstructed:Z
    ...
    .line 124
    :cond_8
    iget v1, p0, Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;->tag:I

    iget-object v2, p0, Lcom/android/org/bouncycastle/asn1/DLApplicationSpecific;->octets:[B

    invoke-virtual {p1, p2, v0, v1, v2}, Lcom/android/org/bouncycastle/asn1/ASN1OutputStream;->writeEncoded(ZII[B)V
