.class public Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;
...
.method static constructor blacklist <clinit>()V
    ...
    .line 41
    const-class v0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;
    ...
    sput-object v0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->logger:Ljava/util/logging/Logger;
...
.method public constructor blacklist <init>()V
    ...
    invoke-static {v2}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->readPublicKeyBlockList(Ljava/lang/String;)Ljava/util/Set;

    move-result-object v4

    iput-object v4, p0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->pubkeyBlocklist:Ljava/util/Set;

    .line 55
    invoke-static {v3}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->readSerialBlockList(Ljava/lang/String;)Ljava/util/Set;

    move-result-object v4

    iput-object v4, p0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->serialBlocklist:Ljava/util/Set;
...
.method public constructor blacklist <init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 60
    invoke-static {p1}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->readPublicKeyBlockList(Ljava/lang/String;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->pubkeyBlocklist:Ljava/util/Set;

    .line 61
    invoke-static {p2}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->readSerialBlockList(Ljava/lang/String;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->serialBlocklist:Ljava/util/Set;
...
.method private static blacklist isHex(Ljava/lang/String;)Z
    ...
    sget-object v1, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->logger:Ljava/util/logging/Logger;
...
.method private static blacklist isPubkeyHash(Ljava/lang/String;)Z
    ...
    .line 76
    sget-object v0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->logger:Ljava/util/logging/Logger;
    ...
    .line 79
    :cond_26
    invoke-static {p0}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->isHex(Ljava/lang/String;)Z
...
.method private static blacklist readBlocklist(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 84
    :try_start_0
    invoke-static {p0}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->readFileAsString(Ljava/lang/String;)Ljava/lang/String;
...
.method private static blacklist readFileAsBytes(Ljava/lang/String;)Ljava/io/ByteArrayOutputStream;
    ...
    .line 112
    invoke-static {v0}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->closeQuietly(Ljava/io/Closeable;)V
...
.method private static blacklist readFileAsString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 94
    invoke-static {p0}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->readFileAsBytes(Ljava/lang/String;)Ljava/io/ByteArrayOutputStream;
...
.method private static blacklist readPublicKeyBlockList(Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->readBlocklist(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 209
    invoke-static {v5}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->isPubkeyHash(Ljava/lang/String;)Z
    ...
    .line 212
    :cond_88
    sget-object v6, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->logger:Ljava/util/logging/Logger;
...
.method private static blacklist readSerialBlockList(Ljava/lang/String;)Ljava/util/Set;
    ...
    sget-object v8, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->logger:Ljava/util/logging/Logger;
...
.method public blacklist isPublicKeyBlockListed(Ljava/security/PublicKey;)Z
    ...
    invoke-interface {v1, v0, v3, v2}, Lcom/android/org/bouncycastle/crypto/Digest;->update([BII)V
    ...
    .line 226
    iget-object v4, p0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->pubkeyBlocklist:Ljava/util/Set;
...
.method public blacklist isSerialNumberBlockListed(Ljava/math/BigInteger;)Z
    ...
    .line 235
    iget-object v0, p0, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->serialBlocklist:Ljava/util/Set;
