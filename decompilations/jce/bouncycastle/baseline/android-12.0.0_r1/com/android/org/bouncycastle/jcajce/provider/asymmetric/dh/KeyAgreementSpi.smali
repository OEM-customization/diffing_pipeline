...
.field private final blacklist mqvAgreement:Lcom/android/org/bouncycastle/crypto/BasicAgreement;
...
.method public constructor blacklist <init>()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;-><init>(Ljava/lang/String;Lcom/android/org/bouncycastle/crypto/DerivationFunction;)V

    .line 74
    return-void
.end method

.method public constructor blacklist <init>(Ljava/lang/String;Lcom/android/org/bouncycastle/crypto/BasicAgreement;Lcom/android/org/bouncycastle/crypto/DerivationFunction;)V
    .registers 4
    .param p1, "kaAlgorithm"    # Ljava/lang/String;
    .param p2, "mqvAgreement"    # Lcom/android/org/bouncycastle/crypto/BasicAgreement;
    ...
    .line 108
    iput-object p2, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->mqvAgreement:Lcom/android/org/bouncycastle/crypto/BasicAgreement;
...
.method public constructor blacklist <init>(Ljava/lang/String;Lcom/android/org/bouncycastle/crypto/DerivationFunction;)V
    ...
    iput-object v0, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->mqvAgreement:Lcom/android/org/bouncycastle/crypto/BasicAgreement;

    .line 84
    return-void
.end method

.method private blacklist generatePrivateKeyParameter(Ljava/security/PrivateKey;)Lcom/android/org/bouncycastle/crypto/params/DHPrivateKeyParameters;
    .registers 11
    ...
    .line 400
    instance-of v0, p1, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;
    ...
    check-cast v0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;

    invoke-virtual {v0}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->engineGetKeyParameters()Lcom/android/org/bouncycastle/crypto/params/DHPrivateKeyParameters;
...
.method private blacklist generatePublicKeyParameter(Ljava/security/PublicKey;)Lcom/android/org/bouncycastle/crypto/params/DHPublicKeyParameters;
    .registers 11
    ...
    .line 424
    instance-of v0, p1, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;
    ...
    .line 434
    .local v1, "params":Ljavax/crypto/spec/DHParameterSpec;
    instance-of v2, v1, Lcom/android/org/bouncycastle/jcajce/spec/DHDomainParameterSpec;
    ...
    check-cast v4, Lcom/android/org/bouncycastle/jcajce/spec/DHDomainParameterSpec;

    invoke-virtual {v4}, Lcom/android/org/bouncycastle/jcajce/spec/DHDomainParameterSpec;->getDomainParameters()Lcom/android/org/bouncycastle/crypto/params/DHParameters;
...
.method protected blacklist bigIntToBytes(Ljava/math/BigInteger;)[B
    ...
    .line 118
    iget-object v0, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->p:Ljava/math/BigInteger;
...
.method protected blacklist calcSecret()[B
    ...
    .line 392
    iget-object v0, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->result:[B
...
.method protected whitelist test-api engineDoPhase(Ljava/security/Key;Z)Ljava/security/Key;
    ...
    iget-object v4, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->p:Ljava/math/BigInteger;
    ...
    .line 216
    invoke-virtual {p0, v2}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->bigIntToBytes(Ljava/math/BigInteger;)[B

    move-result-object v3

    iput-object v3, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->result:[B
    ...
    .line 223
    :cond_62
    new-instance v3, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;

    invoke-interface {v0}, Ljavax/crypto/interfaces/DHPublicKey;->getParams()Ljavax/crypto/spec/DHParameterSpec;

    move-result-object v4

    invoke-direct {v3, v2, v4}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;-><init>(Ljava/math/BigInteger;Ljavax/crypto/spec/DHParameterSpec;)V
...
.method protected whitelist test-api engineGenerateSecret(Ljava/lang/String;)Ljavax/crypto/SecretKey;
    ...
    iget-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->result:[B

    invoke-static {v1}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->trimZeroes([B)[B
...
.method protected whitelist test-api engineInit(Ljava/security/Key;Ljava/security/SecureRandom;)V
    ...
    iput-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->result:[B
...
.method protected whitelist test-api engineInit(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    .line 347
    iget-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->kdf:Lcom/android/org/bouncycastle/crypto/DerivationFunction;
    ...
    iput-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi;->ukmParameters:[B
