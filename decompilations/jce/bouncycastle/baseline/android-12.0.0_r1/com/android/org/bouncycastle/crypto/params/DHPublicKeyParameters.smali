...
.method private static blacklist legendre(Ljava/math/BigInteger;Ljava/math/BigInteger;)I
    ...
    .line 135
    invoke-static {v4, v1, v5}, Lcom/android/org/bouncycastle/math/raw/Nat;->shiftDownWord(I[II)I
    ...
    invoke-static {v6}, Lcom/android/org/bouncycastle/util/Integers;->numberOfTrailingZeros(I)I
    ...
    .line 141
    invoke-static {v4, v1, v6, v5}, Lcom/android/org/bouncycastle/math/raw/Nat;->shiftDownBits(I[III)I
    ...
    .end local v7    # "bits":I
    :cond_2b
    invoke-static {v4, v1, v2}, Lcom/android/org/bouncycastle/math/raw/Nat;->compare(I[I[I)I
    ...
    .line 163
    :cond_51
    invoke-static {v4, v1, v2, v1}, Lcom/android/org/bouncycastle/math/raw/Nat;->sub(I[I[I[I)I
...
.method private blacklist validate(Ljava/math/BigInteger;Lcom/android/org/bouncycastle/crypto/params/DHParameters;)Ljava/math/BigInteger;
    ...
    .line 55
    invoke-static {p1, v0}, Lcom/android/org/bouncycastle/crypto/params/DHPublicKeyParameters;->legendre(Ljava/math/BigInteger;Ljava/math/BigInteger;)I
    ...
    .line 62
    :cond_43
    sget-object v2, Lcom/android/org/bouncycastle/crypto/params/DHPublicKeyParameters;->ONE:Ljava/math/BigInteger;
