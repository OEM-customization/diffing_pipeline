...
.method private static blacklist implRandomFieldElementMult(Ljava/security/SecureRandom;I)Ljava/math/BigInteger;
    ...
    .line 1055
    :goto_0
    invoke-static {p1, p0}, Lcom/android/org/bouncycastle/util/BigIntegers;->createRandomBigInteger(ILjava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method public blacklist createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECPoint;
    ...
    .line 887
    :goto_34
    invoke-virtual {p0, v0, v1}, Lcom/android/org/bouncycastle/math/ec/ECCurve$AbstractF2m;->createRawPoint(Lcom/android/org/bouncycastle/math/ec/ECFieldElement;Lcom/android/org/bouncycastle/math/ec/ECFieldElement;)Lcom/android/org/bouncycastle/math/ec/ECPoint;
...
.method public blacklist randomFieldElement(Ljava/security/SecureRandom;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    ...
    .line 898
    .local v0, "m":I
    invoke-static {v0, p1}, Lcom/android/org/bouncycastle/util/BigIntegers;->createRandomBigInteger(ILjava/security/SecureRandom;)Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/android/org/bouncycastle/math/ec/ECCurve$AbstractF2m;->fromBigInteger(Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
...
.method public blacklist randomFieldElementMult(Ljava/security/SecureRandom;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    ...
    .line 908
    .local v0, "m":I
    invoke-static {p1, v0}, Lcom/android/org/bouncycastle/math/ec/ECCurve$AbstractF2m;->implRandomFieldElementMult(Ljava/security/SecureRandom;I)Ljava/math/BigInteger;
    ...
    invoke-virtual {p0, v2}, Lcom/android/org/bouncycastle/math/ec/ECCurve$AbstractF2m;->fromBigInteger(Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
...
.method protected blacklist solveQuadraticEquation(Lcom/android/org/bouncycastle/math/ec/ECFieldElement;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    ...
    check-cast v0, Lcom/android/org/bouncycastle/math/ec/ECFieldElement$AbstractF2m;

    .line 978
    .local v0, "betaF2m":Lcom/android/org/bouncycastle/math/ec/ECFieldElement$AbstractF2m;
    invoke-virtual {v0}, Lcom/android/org/bouncycastle/math/ec/ECFieldElement$AbstractF2m;->hasFastTrace()Z
    ...
    invoke-virtual {v0}, Lcom/android/org/bouncycastle/math/ec/ECFieldElement$AbstractF2m;->trace()I
    ...
    .line 989
    invoke-virtual {v0}, Lcom/android/org/bouncycastle/math/ec/ECFieldElement$AbstractF2m;->halfTrace()Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    ...
    invoke-virtual {p0, v4}, Lcom/android/org/bouncycastle/math/ec/ECCurve$AbstractF2m;->fromBigInteger(Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;

    move-result-object v4

    .line 1004
    .local v4, "zeroElement":Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    ...
    invoke-virtual {p0, v6}, Lcom/android/org/bouncycastle/math/ec/ECCurve$AbstractF2m;->fromBigInteger(Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    ...
    .line 1010
    .local v8, "w":Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    const/4 v9, 0x1
    ...
    .line 1013
    .local v10, "w2":Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    ...
    invoke-virtual {v10, v6}, Lcom/android/org/bouncycastle/math/ec/ECFieldElement;->multiply(Lcom/android/org/bouncycastle/math/ec/ECFieldElement;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;

    move-result-object v12

    invoke-virtual {v11, v12}, Lcom/android/org/bouncycastle/math/ec/ECFieldElement;->add(Lcom/android/org/bouncycastle/math/ec/ECFieldElement;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;

    move-result-object v7

    .line 1014
    invoke-virtual {v10, p1}, Lcom/android/org/bouncycastle/math/ec/ECFieldElement;->add(Lcom/android/org/bouncycastle/math/ec/ECFieldElement;)Lcom/android/org/bouncycastle/math/ec/ECFieldElement;

    move-result-object v8

    .line 1010
    .end local v10    # "w2":Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    ...
    .line 1022
    .end local v8    # "w":Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
    .local v6, "gamma":Lcom/android/org/bouncycastle/math/ec/ECFieldElement;
