...
.method private blacklist createPoint([J[J)Lcom/android/org/bouncycastle/math/ec/ECPoint;
    .registers 8
    .param p1, "x"    # [J
    .param p2, "y"    # [J
    ...
    iget-object v1, p0, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->this$0:Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;

    # getter for: Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;->m:I
    invoke-static {v1}, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;->access$000(Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;)I

    move-result v1

    iget-object v2, p0, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->val$ks:[I

    new-instance v3, Lcom/android/org/bouncycastle/math/ec/LongArray;

    invoke-direct {v3, p1}, Lcom/android/org/bouncycastle/math/ec/LongArray;-><init>([J)V
    ...
    .line 1400
    .local v0, "X":Lcom/android/org/bouncycastle/math/ec/ECFieldElement$F2m;
    new-instance v1, Lcom/android/org/bouncycastle/math/ec/ECFieldElement$F2m;

    iget-object v2, p0, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->this$0:Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;

    # getter for: Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;->m:I
    invoke-static {v2}, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;->access$000(Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;)I

    move-result v2

    iget-object v3, p0, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->val$ks:[I

    new-instance v4, Lcom/android/org/bouncycastle/math/ec/LongArray;

    invoke-direct {v4, p2}, Lcom/android/org/bouncycastle/math/ec/LongArray;-><init>([J)V

    invoke-direct {v1, v2, v3, v4}, Lcom/android/org/bouncycastle/math/ec/ECFieldElement$F2m;-><init>(I[ILcom/android/org/bouncycastle/math/ec/LongArray;)V

    .line 1401
    .local v1, "Y":Lcom/android/org/bouncycastle/math/ec/ECFieldElement$F2m;
    iget-object v2, p0, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->this$0:Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;

    invoke-virtual {v2, v0, v1}, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m;->createRawPoint(Lcom/android/org/bouncycastle/math/ec/ECFieldElement;Lcom/android/org/bouncycastle/math/ec/ECFieldElement;)Lcom/android/org/bouncycastle/math/ec/ECPoint;
...
.method public blacklist lookup(I)Lcom/android/org/bouncycastle/math/ec/ECPoint;
    ...
    .end local v3    # "i":I
    :cond_3e
    invoke-direct {p0, v0, v1}, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->createPoint([J[J)Lcom/android/org/bouncycastle/math/ec/ECPoint;
...
.method public blacklist lookupVar(I)Lcom/android/org/bouncycastle/math/ec/ECPoint;
    ...
    .line 1386
    .local v1, "y":[J
    iget v2, p0, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->val$FE_LONGS:I
    ...
    .local v3, "j":I
    :goto_12
    iget v4, p0, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->val$FE_LONGS:I

    if-ge v3, v4, :cond_27

    .line 1390
    iget-object v5, p0, Lcom/android/org/bouncycastle/math/ec/ECCurve$F2m$1;->val$table:[J
