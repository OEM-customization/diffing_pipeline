.class Lcom/android/org/bouncycastle/jcajce/util/ECKeyUtil$ECPublicKeyWithCompression;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/android/org/bouncycastle/jcajce/util/ECKeyUtil;
.end annotation
...
.method public constructor blacklist <init>(Ljava/security/interfaces/ECPublicKey;)V
    ...
    .line 43
    iput-object p1, p0, Lcom/android/org/bouncycastle/jcajce/util/ECKeyUtil$ECPublicKeyWithCompression;->ecPublicKey:Ljava/security/interfaces/ECPublicKey;
...
.method public whitelist test-api getAlgorithm()Ljava/lang/String;
    ...
    .line 53
    iget-object v0, p0, Lcom/android/org/bouncycastle/jcajce/util/ECKeyUtil$ECPublicKeyWithCompression;->ecPublicKey:Ljava/security/interfaces/ECPublicKey;
...
.method public whitelist test-api getEncoded()[B
    ...
    .line 65
    .local v0, "publicKeyInfo":Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;
    ...
    .line 74
    .local v3, "x9":Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;
    if-nez v3, :cond_2c
    ...
    .line 79
    .end local v3    # "x9":Lcom/android/org/bouncycastle/asn1/x9/X9ECParameters;
    ...
    invoke-virtual {v2, v3}, Lcom/android/org/bouncycastle/math/ec/ECCurve;->decodePoint([B)Lcom/android/org/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v4, v3, v5}, Lcom/android/org/bouncycastle/asn1/x9/X9ECPoint;-><init>(Lcom/android/org/bouncycastle/math/ec/ECPoint;Z)V

    invoke-virtual {v4}, Lcom/android/org/bouncycastle/asn1/x9/X9ECPoint;->toASN1Primitive()Lcom/android/org/bouncycastle/asn1/ASN1Primitive;
    ...
    .line 95
    .local v4, "pEnc":Lcom/android/org/bouncycastle/asn1/ASN1OctetString;
    :try_start_5e
    new-instance v5, Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;
    ...
    invoke-direct {v5, v6, v7}, Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;-><init>(Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;[B)V

    invoke-virtual {v5}, Lcom/android/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;->getEncoded()[B
    ...
    const-string v8, "unable to encode EC public key: "
    ...
    .end local v4    # "pEnc":Lcom/android/org/bouncycastle/asn1/ASN1OctetString;
    .end local v5    # "e":Ljava/io/IOException;
    :cond_8c
    new-instance v2, Ljava/lang/IllegalStateException;

    const-string v3, "unable to identify implictlyCA"
