...
.method protected whitelist test-api engineDoFinal([BII)[B
    ...
    move-result-object v0
    :try_end_43
    .catch Lcom/android/org/bouncycastle/crypto/InvalidCipherTextException; {:try_start_31 .. :try_end_43} :catch_49
...
.method protected whitelist test-api engineInit(ILjava/security/Key;Ljava/security/AlgorithmParameters;Ljava/security/SecureRandom;)V
    ...
    .line 293
    iget-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->availableSpecs:[Ljava/lang/Class;
...
.method protected whitelist test-api engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    .line 253
    :pswitch_7d
    iget-object v3, p0, Lcom/android/org/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Lcom/android/org/bouncycastle/crypto/Wrapper;

    invoke-interface {v3, v2, v1}, Lcom/android/org/bouncycastle/crypto/Wrapper;->init(ZLcom/android/org/bouncycastle/crypto/CipherParameters;)V

    .line 254
    iput-object v0, p0, Lcom/android/org/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapStream:Lcom/android/org/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$ErasableOutputStream;

    .line 255
    iput-boolean v2, p0, Lcom/android/org/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->forWrapping:Z
    ...
    invoke-interface {v0, v2, v1}, Lcom/android/org/bouncycastle/crypto/Wrapper;->init(ZLcom/android/org/bouncycastle/crypto/CipherParameters;)V
...
.method protected whitelist test-api engineUnwrap([BLjava/lang/String;I)Ljava/security/Key;
    ...
    move-result-object v1
    :try_end_12
    .catch Lcom/android/org/bouncycastle/crypto/InvalidCipherTextException; {:try_start_2 .. :try_end_12} :catch_de
    .catch Ljavax/crypto/BadPaddingException; {:try_start_2 .. :try_end_12} :catch_d3
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_2 .. :try_end_12} :catch_c8
    ...
    move-result-object v0
    :try_end_7d
    .catch Ljava/security/NoSuchProviderException; {:try_start_5f .. :try_end_7d} :catch_ae
    .catch Ljava/security/spec/InvalidKeySpecException; {:try_start_5f .. :try_end_7d} :catch_94
