...
.method public blacklist init(ZLcom/android/org/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->getMacSize(ZI)I
...
.method public blacklist processPacket([BII[BI)I
    ...
    :cond_28
    :goto_28
    iget v9, v0, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->blockSize:I
    ...
    invoke-direct {v6, v10}, Lcom/android/org/bouncycastle/crypto/modes/SICBlockCipher;-><init>(Lcom/android/org/bouncycastle/crypto/BlockCipher;)V
    ...
    invoke-direct {v11, v13, v9}, Lcom/android/org/bouncycastle/crypto/params/ParametersWithIV;-><init>(Lcom/android/org/bouncycastle/crypto/CipherParameters;[B)V

    invoke-interface {v6, v10, v11}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->init(ZLcom/android/org/bouncycastle/crypto/CipherParameters;)V
    ...
    .line 280
    iget-object v12, v0, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->macBlock:[B

    invoke-direct {v0, v1, v2, v3, v12}, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->calculateMac([BII[B)I

    .line 282
    iget v12, v0, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->blockSize:I
    ...
    invoke-interface {v6, v14, v15, v12, v15}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .line 288
    invoke-interface {v6, v1, v10, v4, v11}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .line 297
    invoke-interface {v6, v14, v7, v14, v7}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .end local v8    # "q":I
    .local v17, "q":I
    iget v8, v0, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->macSize:I
    ...
    new-instance v7, Lcom/android/org/bouncycastle/crypto/OutputLengthException;

    invoke-direct {v7, v14}, Lcom/android/org/bouncycastle/crypto/OutputLengthException;-><init>(Ljava/lang/String;)V
    ...
    invoke-interface {v6, v7, v14, v7, v14}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .local v7, "i":I
    :goto_bf
    iget-object v8, v0, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->macBlock:[B
    ...
    .line 335
    invoke-interface {v6, v7, v12, v7, v12}, Lcom/android/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-direct {v0, v4, v5, v13, v8}, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->calculateMac([BII[B)I

    .line 343
    iget-object v12, v0, Lcom/android/org/bouncycastle/crypto/modes/CCMBlockCipher;->macBlock:[B

    invoke-static {v12, v8}, Lcom/android/org/bouncycastle/util/Arrays;->constantTimeAreEqual([B[B)Z
    ...
    invoke-direct {v12, v14}, Lcom/android/org/bouncycastle/crypto/InvalidCipherTextException;-><init>(Ljava/lang/String;)V
    ...
    .line 247
    .end local v6    # "ctrCipher":Lcom/android/org/bouncycastle/crypto/BlockCipher;
    .end local v9    # "iv":[B
