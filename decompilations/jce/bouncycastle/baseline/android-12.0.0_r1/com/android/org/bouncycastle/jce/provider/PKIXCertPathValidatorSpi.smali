...
.method public constructor blacklist <init>()V
    ...
    invoke-direct {p0, v0}, Lcom/android/org/bouncycastle/jce/provider/PKIXCertPathValidatorSpi;-><init>(Z)V
...
.method public constructor blacklist <init>(Z)V
    ...
    .line 58
    iput-boolean p1, p0, Lcom/android/org/bouncycastle/jce/provider/PKIXCertPathValidatorSpi;->isForCRLCheck:Z
...
.method public whitelist test-api engineValidate(Ljava/security/cert/CertPath;Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathValidatorResult;
    ...
    # getter for: Lcom/android/org/bouncycastle/jce/provider/PKIXCertPathValidatorSpi$NoPreloadHolder;->blocklist:Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;
    invoke-static {}, Lcom/android/org/bouncycastle/jce/provider/PKIXCertPathValidatorSpi$NoPreloadHolder;->access$000()Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;

    move-result-object v6

    invoke-virtual {v6, v5}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->isSerialNumberBlockListed(Ljava/math/BigInteger;)Z
    ...
    invoke-static {v2, v9}, Lcom/android/org/bouncycastle/jce/provider/CertPathValidatorUtilities;->getValidityDate(Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/Date;)Ljava/util/Date;
    ...
    :try_end_cb
    .catch Lcom/android/org/bouncycastle/jce/provider/AnnotatedException; {:try_start_aa .. :try_end_cb} :catch_4ef
    ...
    invoke-virtual {v4, v6}, Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->setTrustAnchor(Ljava/security/cert/TrustAnchor;)Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters$Builder;
    ...
    .local v20, "paramsPKIX":Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;
    const/4 v2, 0x0
    ...
    .line 197
    new-instance v8, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-direct/range {v21 .. v28}, Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;-><init>(Ljava/util/List;ILjava/util/Set;Ljava/security/cert/PolicyNode;Ljava/util/Set;Ljava/lang/String;Z)V

    .line 200
    .local v8, "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    aget-object v13, v5, v0

    invoke-interface {v13, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 205
    new-instance v13, Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;

    invoke-direct {v13}, Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;-><init>()V
    ...
    .local v29, "nameConstraintValidator":Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;
    move-object/from16 v13, v16

    .line 212
    .local v13, "acceptablePolicies":Ljava/util/Set;
    invoke-virtual/range {v20 .. v20}, Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;->isExplicitPolicyRequired()Z
    ...
    :goto_12f
    invoke-virtual/range {v20 .. v20}, Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;->isAnyPolicyInhibited()Z
    ...
    :goto_13a
    invoke-virtual/range {v20 .. v20}, Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;->isPolicyMappingInhibited()Z
    ...
    .line 260
    :try_start_14b
    invoke-static/range {v22 .. v22}, Lcom/android/org/bouncycastle/jce/provider/PrincipalUtils;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)Lcom/android/org/bouncycastle/asn1/x500/X500Name;

    move-result-object v23

    .line 261
    .local v23, "workingIssuerName":Lcom/android/org/bouncycastle/asn1/x500/X500Name;
    invoke-virtual/range {v22 .. v22}, Ljava/security/cert/X509Certificate;->getPublicKey()Ljava/security/PublicKey;

    move-result-object v24
    :try_end_153
    .catch Ljava/lang/RuntimeException; {:try_start_14b .. :try_end_153} :catch_154

    .local v24, "workingPublicKey":Ljava/security/PublicKey;
    goto :goto_16e

    .line 269
    .end local v23    # "workingIssuerName":Lcom/android/org/bouncycastle/asn1/x500/X500Name;
    ...
    :cond_166
    :try_start_166
    invoke-static {v6}, Lcom/android/org/bouncycastle/jce/provider/PrincipalUtils;->getCA(Ljava/security/cert/TrustAnchor;)Lcom/android/org/bouncycastle/asn1/x500/X500Name;

    move-result-object v23

    .line 266
    .restart local v23    # "workingIssuerName":Lcom/android/org/bouncycastle/asn1/x500/X500Name;
    invoke-virtual {v6}, Ljava/security/cert/TrustAnchor;->getCAPublicKey()Ljava/security/PublicKey;

    move-result-object v24
    :try_end_16e
    .catch Ljava/lang/RuntimeException; {:try_start_166 .. :try_end_16e} :catch_4c4
    ...
    .line 278
    .local v25, "workingAlgId":Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    :try_start_171
    invoke-static/range {v24 .. v24}, Lcom/android/org/bouncycastle/jce/provider/CertPathValidatorUtilities;->getAlgorithmIdentifier(Ljava/security/PublicKey;)Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;

    move-result-object v3
    :try_end_175
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_171 .. :try_end_175} :catch_4aa

    .line 284
    .end local v25    # "workingAlgId":Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    .line 286
    .local v25, "workingPublicKeyAlgorithm":Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    .line 291
    .local v26, "workingPublicKeyParameters":Lcom/android/org/bouncycastle/asn1/ASN1Encodable;
    move/from16 v27, v11

    .line 297
    .local v27, "maxPathLength":I
    invoke-virtual/range {v20 .. v20}, Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;->getTargetConstraints()Lcom/android/org/bouncycastle/jcajce/PKIXCertStoreSelector;
    ...
    invoke-virtual {v7, v0}, Lcom/android/org/bouncycastle/jcajce/PKIXCertStoreSelector;->match(Ljava/security/cert/Certificate;)Z
    ...
    .local v30, "index":I
    invoke-direct {v0, v7, v10, v15, v2}, Lcom/android/org/bouncycastle/jce/exception/ExtCertPathValidatorException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ljava/security/cert/CertPath;I)V
    ...
    :goto_1a8
    invoke-virtual/range {v20 .. v20}, Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;->getCertPathCheckers()Ljava/util/List;
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;->isRevocationEnabled()Z
    ...
    .line 320
    new-instance v0, Lcom/android/org/bouncycastle/jce/provider/ProvCrlRevocationChecker;

    iget-object v2, v1, Lcom/android/org/bouncycastle/jce/provider/PKIXCertPathValidatorSpi;->helper:Lcom/android/org/bouncycastle/jcajce/util/JcaJceHelper;

    invoke-direct {v0, v2}, Lcom/android/org/bouncycastle/jce/provider/ProvCrlRevocationChecker;-><init>(Lcom/android/org/bouncycastle/jcajce/util/JcaJceHelper;)V

    move-object/from16 v33, v0

    .local v0, "revocationChecker":Lcom/android/org/bouncycastle/jce/provider/ProvCrlRevocationChecker;
    goto :goto_1d5

    .line 324
    .end local v0    # "revocationChecker":Lcom/android/org/bouncycastle/jce/provider/ProvCrlRevocationChecker;
    :cond_1d2
    const/4 v0, 0x0
    ...
    .line 327
    .local v33, "revocationChecker":Lcom/android/org/bouncycastle/jce/provider/ProvCrlRevocationChecker;
    :goto_1d5
    const/4 v0, 0x0
    ...
    .local v21, "workingAlgId":Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    .local v22, "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    .local v23, "sign":Ljava/security/cert/X509Certificate;
    .local v24, "workingIssuerName":Lcom/android/org/bouncycastle/asn1/x500/X500Name;
    .local v26, "acceptablePolicies":Ljava/util/Set;
    .local v27, "workingPublicKeyParameters":Lcom/android/org/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-virtual {v10, v13}, Lcom/android/org/bouncycastle/jce/provider/CertBlocklist;->isPublicKeyBlockListed(Ljava/security/PublicKey;)Z
    ...
    :try_start_21c
    invoke-static {v14}, Lcom/android/org/bouncycastle/jce/provider/PKIXCertPathValidatorSpi;->checkCertificate(Ljava/security/cert/X509Certificate;)V
    :try_end_21f
    .catch Lcom/android/org/bouncycastle/jce/provider/AnnotatedException; {:try_start_21c .. :try_end_21f} :catch_396
    ...
    invoke-static/range {v2 .. v10}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCertA(Ljava/security/cert/CertPath;Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/Date;Lcom/android/org/bouncycastle/jcajce/PKIXCertRevocationChecker;ILjava/security/PublicKey;ZLcom/android/org/bouncycastle/asn1/x500/X500Name;Ljava/security/cert/X509Certificate;)V

    .line 372
    iget-boolean v2, v1, Lcom/android/org/bouncycastle/jce/provider/PKIXCertPathValidatorSpi;->isForCRLCheck:Z

    move-object/from16 v9, v29

    move/from16 v10, v30

    .end local v29    # "nameConstraintValidator":Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;
    .end local v30    # "index":I
    .local v9, "nameConstraintValidator":Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;
    .local v10, "index":I
    invoke-static {v15, v10, v9, v2}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCertBC(Ljava/security/cert/CertPath;ILcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;Z)V
    ...
    .local v13, "acceptablePolicies":Ljava/util/Set;
    invoke-static/range {v11 .. v17}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCertD(Ljava/security/cert/CertPath;ILjava/util/Set;Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;IZ)Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;

    move-result-object v2

    .line 377
    .end local v22    # "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    .local v2, "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    invoke-static {v6, v10, v2}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCertE(Ljava/security/cert/CertPath;ILcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;)Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {v6, v10, v2, v4}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCertF(Ljava/security/cert/CertPath;ILcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;I)V
    ...
    .line 397
    :cond_29f
    invoke-static {v6, v10}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertA(Ljava/security/cert/CertPath;I)V
    ...
    invoke-static {v6, v10, v12, v2, v15}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareCertB(Ljava/security/cert/CertPath;I[Ljava/util/List;Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;I)Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;

    move-result-object v2

    .line 402
    invoke-static {v6, v10, v9}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertG(Ljava/security/cert/CertPath;ILcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;)V

    .line 405
    invoke-static {v6, v10, v4}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertH1(Ljava/security/cert/CertPath;II)I

    move-result v4

    .line 406
    invoke-static {v6, v10, v15}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertH2(Ljava/security/cert/CertPath;II)I
    ...
    invoke-static {v6, v10, v14}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertH3(Ljava/security/cert/CertPath;II)I

    move-result v14

    .line 412
    invoke-static {v6, v10, v4}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertI1(Ljava/security/cert/CertPath;II)I

    move-result v4

    .line 413
    invoke-static {v6, v10, v15}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertI2(Ljava/security/cert/CertPath;II)I

    move-result v15

    .line 416
    invoke-static {v6, v10, v14}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertJ(Ljava/security/cert/CertPath;II)I

    move-result v14

    .line 419
    invoke-static {v6, v10}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertK(Ljava/security/cert/CertPath;I)V
    ...
    .local v26, "nameConstraintValidator":Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;
    invoke-static {v6, v10, v9}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertL(Ljava/security/cert/CertPath;II)I

    move-result v9

    .line 425
    invoke-static {v6, v10, v9}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertM(Ljava/security/cert/CertPath;II)I

    move-result v9

    .line 428
    invoke-static {v6, v10}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertN(Ljava/security/cert/CertPath;I)V
    ...
    .end local v2    # "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    .local v17, "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    .line 436
    sget-object v2, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->KEY_USAGE:Ljava/lang/String;

    invoke-interface {v0, v2}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .line 437
    sget-object v2, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;

    invoke-interface {v0, v2}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .line 438
    sget-object v2, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->POLICY_MAPPINGS:Ljava/lang/String;

    invoke-interface {v0, v2}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .line 439
    sget-object v2, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->INHIBIT_ANY_POLICY:Ljava/lang/String;
    ...
    .line 442
    sget-object v2, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->POLICY_CONSTRAINTS:Ljava/lang/String;

    invoke-interface {v0, v2}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .line 443
    sget-object v2, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->BASIC_CONSTRAINTS:Ljava/lang/String;

    invoke-interface {v0, v2}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .line 444
    sget-object v2, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->SUBJECT_ALTERNATIVE_NAME:Ljava/lang/String;

    invoke-interface {v0, v2}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .line 445
    sget-object v2, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->NAME_CONSTRAINTS:Ljava/lang/String;
    ...
    .line 449
    .end local v17    # "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    .restart local v2    # "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    :cond_31b
    move-object/from16 v17, v2

    .end local v2    # "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    .restart local v17    # "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    new-instance v2, Ljava/util/HashSet;
    ...
    invoke-static {v6, v10, v2, v9}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->prepareNextCertO(Ljava/security/cert/CertPath;ILjava/util/Set;Ljava/util/List;)V

    .line 456
    move-object/from16 v23, v3

    .line 459
    invoke-static/range {v23 .. v23}, Lcom/android/org/bouncycastle/jce/provider/PrincipalUtils;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)Lcom/android/org/bouncycastle/asn1/x500/X500Name;
    ...
    move-result-object v0
    :try_end_334
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_330 .. :try_end_334} :catch_35a
    ...
    invoke-static {v0, v10, v2}, Lcom/android/org/bouncycastle/jce/provider/CertPathValidatorUtilities;->getNextWorkingKey(Ljava/util/List;ILcom/android/org/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/security/PublicKey;

    move-result-object v0
    :try_end_33c
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_336 .. :try_end_33c} :catch_358
    ...
    .line 473
    .end local v21    # "workingAlgId":Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    .local v2, "workingAlgId":Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    .line 475
    .end local v25    # "workingPublicKeyAlgorithm":Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .local v5, "workingPublicKeyAlgorithm":Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    .end local v27    # "workingPublicKeyParameters":Lcom/android/org/bouncycastle/asn1/ASN1Encodable;
    .local v21, "workingPublicKeyParameters":Lcom/android/org/bouncycastle/asn1/ASN1Encodable;
    goto :goto_37a

    .line 466
    .end local v0    # "workingPublicKey":Ljava/security/PublicKey;
    .end local v2    # "workingAlgId":Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    .local v5, "workingPublicKey":Ljava/security/PublicKey;
    .local v21, "workingAlgId":Lcom/android/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    .restart local v25    # "workingPublicKeyAlgorithm":Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .restart local v27    # "workingPublicKeyParameters":Lcom/android/org/bouncycastle/asn1/ASN1Encodable;
    :catch_358
    move-exception v0
    ...
    .end local v26    # "nameConstraintValidator":Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;
    .local v2, "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    .local v9, "nameConstraintValidator":Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;
    .local v28, "inhibitAnyPolicy":I
    ...
    .restart local v26    # "nameConstraintValidator":Lcom/android/org/bouncycastle/jce/provider/PKIXNameConstraintValidator;
    :goto_371
    move/from16 v35, v1
    ...
    invoke-direct {v2, v1}, Lcom/android/org/bouncycastle/jce/provider/AnnotatedException;-><init>(Ljava/lang/String;)V

    .line 337
    .local v2, "e":Lcom/android/org/bouncycastle/jce/provider/AnnotatedException;
    new-instance v3, Ljava/security/cert/CertPathValidatorException;

    invoke-virtual {v2}, Lcom/android/org/bouncycastle/jce/provider/AnnotatedException;->getMessage()Ljava/lang/String;
    ...
    .restart local v38    # "trust":Ljava/security/cert/TrustAnchor;
    .restart local v40    # "currentDate":Ljava/util/Date;
    invoke-static {v4, v0}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->wrapupCertA(ILjava/security/cert/X509Certificate;)I
    ...
    invoke-static {v6, v3, v1}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->wrapupCertB(Ljava/security/cert/CertPath;II)I
    ...
    .line 500
    sget-object v3, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->KEY_USAGE:Ljava/lang/String;
    ...
    .line 504
    sget-object v3, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->ISSUING_DISTRIBUTION_POINT:Ljava/lang/String;

    invoke-interface {v2, v3}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .line 505
    sget-object v3, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->DELTA_CRL_INDICATOR:Ljava/lang/String;
    ...
    .line 508
    sget-object v3, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->SUBJECT_ALTERNATIVE_NAME:Ljava/lang/String;
    ...
    .line 511
    sget-object v3, Lcom/android/org/bouncycastle/asn1/x509/Extension;->extendedKeyUsage:Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v6, v3, v9, v11}, Lcom/android/org/bouncycastle/jce/provider/RFC3280CertPathUtilities;->wrapupCertF(Ljava/security/cert/CertPath;ILjava/util/List;Ljava/util/Set;)V
    ...
    .end local v33    # "revocationChecker":Lcom/android/org/bouncycastle/jce/provider/ProvCrlRevocationChecker;
    .end local v34    # "n":I
    .end local v39    # "pathCheckers":Ljava/util/List;
    .end local v40    # "currentDate":Ljava/util/Date;
    .local v2, "index":I
    ...
    .end local v8    # "validPolicyTree":Lcom/android/org/bouncycastle/jce/provider/PKIXPolicyNode;
    .end local v13    # "acceptablePolicies":Ljava/util/Set;
    .end local v16    # "explicitPolicy":I
    .end local v17    # "inhibitAnyPolicy":I
    .end local v20    # "paramsPKIX":Lcom/android/org/bouncycastle/jcajce/PKIXExtendedParameters;
    .end local v21    # "policyMapping":I
    ...
    throw v0
    :try_end_4ed
    .catch Lcom/android/org/bouncycastle/jce/provider/AnnotatedException; {:try_start_4e4 .. :try_end_4ed} :catch_4ed
