...
.method protected constructor blacklist <init>(Lcom/android/org/bouncycastle/crypto/digests/LongDigest;)V
    .registers 3
...
.method private blacklist adjustByteCounts()V
    ...
    .line 238
    iget-wide v4, p0, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->byteCount2:J
...
# virtual methods
.method protected blacklist copyIn(Lcom/android/org/bouncycastle/crypto/digests/LongDigest;)V
    .registers 6
    .param p1, "t"    # Lcom/android/org/bouncycastle/crypto/digests/LongDigest;
...
.method public blacklist finish()V
    ...
    .line 190
    :cond_17
    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->processLength(JJ)V
...
.method protected blacklist populateState([B)V
    ...
    invoke-static {v1, v2, p1, v3}, Lcom/android/org/bouncycastle/util/Pack;->longToBigEndian(J[BI)V
...
.method protected blacklist processBlock()V
    ...
    .line 265
    iget-object v1, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->W:[J

    add-int/lit8 v2, v0, -0x2

    aget-wide v2, v1, v2

    invoke-direct {v7, v2, v3}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sigma1(J)J

    move-result-wide v2

    iget-object v4, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->W:[J
    ...
    invoke-direct {v7, v4, v5}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sigma0(J)J
    ...
    .end local v0    # "t":I
    :cond_31
    iget-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H1:J

    .line 272
    .local v0, "a":J
    iget-wide v2, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H2:J

    .line 273
    .local v2, "b":J
    iget-wide v4, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H3:J

    .line 274
    .local v4, "c":J
    iget-wide v8, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H4:J

    .line 275
    .local v8, "d":J
    iget-wide v10, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H5:J

    .line 276
    .local v10, "e":J
    iget-wide v12, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H6:J

    .line 277
    .local v12, "f":J
    iget-wide v14, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H7:J
    ...
    .end local v0    # "a":J
    .local v16, "a":J
    iget-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H8:J
    ...
    .line 284
    invoke-direct {v7, v5, v6}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum1(J)J
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Ch(JJJ)J

    move-result-wide v0

    add-long v23, v23, v0

    sget-object v28, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->K:[J

    aget-wide v0, v28, v16

    add-long v23, v23, v0

    iget-object v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->W:[J
    ...
    .end local v17    # "d":J
    .local v5, "d":J
    invoke-direct {v7, v8, v9}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum0(J)J
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Maj(JJJ)J
    ...
    .line 289
    invoke-direct {v7, v12, v13}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum1(J)J
    ...
    .line 291
    invoke-direct {v7, v10, v11}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum0(J)J
    ...
    .end local v21    # "g":J
    .local v5, "g":J
    invoke-direct {v7, v14, v15}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum1(J)J
    ...
    .end local v23    # "b":J
    .local v5, "b":J
    invoke-direct {v7, v12, v13}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum0(J)J
    ...
    .end local v19    # "f":J
    .local v5, "f":J
    invoke-direct {v7, v10, v11}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum1(J)J
    ...
    .line 301
    invoke-direct {v7, v14, v15}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum0(J)J
    ...
    .end local v16    # "e":J
    .local v5, "e":J
    invoke-direct {v7, v8, v9}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->Sum1(J)J
    ...
    iput-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H1:J

    .line 325
    iget-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H2:J

    add-long v0, v0, v23

    iput-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H2:J

    .line 326
    iget-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H3:J

    add-long/2addr v0, v14

    iput-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H3:J

    .line 327
    iget-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H4:J

    add-long v0, v0, v17

    iput-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H4:J

    .line 328
    iget-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H5:J

    add-long v0, v0, v26

    iput-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H5:J

    .line 329
    iget-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H6:J

    add-long v0, v0, v19

    iput-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H6:J

    .line 330
    iget-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H7:J

    add-long v0, v0, v21

    iput-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H7:J
    ...
    iput-wide v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->H8:J

    .line 336
    const/4 v0, 0x0

    iput v0, v7, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->wOff:I
...
.method public blacklist reset()V
    ...
    .local v3, "i":I
    :goto_a
    iget-object v4, p0, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->xBuf:[B
    ...
    .local v2, "i":I
    :goto_17
    iget-object v3, p0, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->W:[J
...
.method public blacklist update(B)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->processWord([BI)V
...
.method public blacklist update([BII)V
    ...
    .line 158
    iget-wide v1, p0, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->byteCount1:J
    ...
    iput-wide v1, p0, Lcom/android/org/bouncycastle/crypto/digests/LongDigest;->byteCount1:J
