...
.method protected blacklist multiplyPositive(Lcom/android/org/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lcom/android/org/bouncycastle/math/ec/ECPoint;
    ...
    invoke-static {v0}, Lcom/android/org/bouncycastle/math/ec/WNafUtil;->getWindowSize(I)I
    ...
    invoke-static {v2, v0, v1}, Lcom/android/org/bouncycastle/math/ec/WNafUtil;->precompute(Lcom/android/org/bouncycastle/math/ec/ECPoint;IZ)Lcom/android/org/bouncycastle/math/ec/WNafPreCompInfo;

    move-result-object v3

    .line 27
    .local v3, "info":Lcom/android/org/bouncycastle/math/ec/WNafPreCompInfo;
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/math/ec/WNafPreCompInfo;->getPreComp()[Lcom/android/org/bouncycastle/math/ec/ECPoint;

    move-result-object v4

    .line 28
    .local v4, "preComp":[Lcom/android/org/bouncycastle/math/ec/ECPoint;
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/math/ec/WNafPreCompInfo;->getPreCompNeg()[Lcom/android/org/bouncycastle/math/ec/ECPoint;

    move-result-object v5

    .line 29
    .local v5, "preCompNeg":[Lcom/android/org/bouncycastle/math/ec/ECPoint;
    invoke-virtual {v3}, Lcom/android/org/bouncycastle/math/ec/WNafPreCompInfo;->getWidth()I
    ...
    invoke-static {v6, v7}, Lcom/android/org/bouncycastle/math/ec/WNafUtil;->generateCompactWindowNaf(ILjava/math/BigInteger;)[I
    ...
    .line 52
    invoke-static {v15}, Lcom/android/org/bouncycastle/util/Integers;->numberOfLeadingZeros(I)I
    ...
    .line 71
    .end local v9    # "R":Lcom/android/org/bouncycastle/math/ec/ECPoint;
    .restart local v0    # "R":Lcom/android/org/bouncycastle/math/ec/ECPoint;
    :goto_76
    ...
    .line 83
    .local v15, "r":Lcom/android/org/bouncycastle/math/ec/ECPoint;
    invoke-virtual {v9, v15}, Lcom/android/org/bouncycastle/math/ec/ECPoint;->twicePlus(Lcom/android/org/bouncycastle/math/ec/ECPoint;)Lcom/android/org/bouncycastle/math/ec/ECPoint;

    move-result-object v9

    .line 84
    invoke-virtual {v9, v12}, Lcom/android/org/bouncycastle/math/ec/ECPoint;->timesPow2(I)Lcom/android/org/bouncycastle/math/ec/ECPoint;
    ...
    .end local v13    # "n":I
    .end local v14    # "table":[Lcom/android/org/bouncycastle/math/ec/ECPoint;
    .end local v15    # "r":Lcom/android/org/bouncycastle/math/ec/ECPoint;
    goto :goto_7d
