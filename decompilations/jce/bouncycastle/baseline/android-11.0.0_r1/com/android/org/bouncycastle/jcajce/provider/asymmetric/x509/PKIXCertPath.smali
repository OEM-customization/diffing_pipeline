...
.method constructor blacklist <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->helper:Lcom/android/org/bouncycastle/jcajce/util/JcaJceHelper;
    ...
    invoke-direct {v1, p1}, Lcom/android/org/bouncycastle/asn1/ASN1InputStream;-><init>(Ljava/io/InputStream;)V

    .line 182
    .local v1, "derInStream":Lcom/android/org/bouncycastle/asn1/ASN1InputStream;
    ...
    iput-object v4, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->certificates:Ljava/util/List;

    .line 189
    iget-object v4, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->helper:Lcom/android/org/bouncycastle/jcajce/util/JcaJceHelper;

    invoke-interface {v4, v0}, Lcom/android/org/bouncycastle/jcajce/util/JcaJceHelper;->createCertificateFactory(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    .line 193
    .local v4, "element":Lcom/android/org/bouncycastle/asn1/ASN1Encodable;
    ...
    .line 194
    .local v5, "encoded":[B
    iget-object v6, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->certificates:Ljava/util/List;
    ...
    .line 196
    .end local v4    # "element":Lcom/android/org/bouncycastle/asn1/ASN1Encodable;
    .end local v5    # "encoded":[B
    goto :goto_35

    .line 197
    .end local v0    # "certFactory":Ljava/security/cert/CertificateFactory;
    .end local v1    # "derInStream":Lcom/android/org/bouncycastle/asn1/ASN1InputStream;
    ...
    .line 185
    .restart local v1    # "derInStream":Lcom/android/org/bouncycastle/asn1/ASN1InputStream;
    .restart local v2    # "derObject":Lcom/android/org/bouncycastle/asn1/ASN1Primitive;
    :cond_5c
    ...
    .end local p0    # "this":Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;
    ...
    .end local v1    # "derInStream":Lcom/android/org/bouncycastle/asn1/ASN1InputStream;
    .end local v2    # "derObject":Lcom/android/org/bouncycastle/asn1/ASN1Primitive;
    .restart local p0    # "this":Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;
    ...
    iput-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->certificates:Ljava/util/List;

    .line 202
    iget-object v1, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->helper:Lcom/android/org/bouncycastle/jcajce/util/JcaJceHelper;

    invoke-interface {v1, v0}, Lcom/android/org/bouncycastle/jcajce/util/JcaJceHelper;->createCertificateFactory(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    :try_end_ab
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_ab} :catch_d3
    ...
    .line 223
    iget-object v0, p0, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->certificates:Ljava/util/List;
...
.method private blacklist toASN1Object(Ljava/security/cert/X509Certificate;)Lcom/android/org/bouncycastle/asn1/ASN1Primitive;
    .registers 6
...
.method private blacklist toDEREncoded(Lcom/android/org/bouncycastle/asn1/ASN1Encodable;)[B
    .registers 6
...
.method public whitelist core-platform-api test-api getEncoded()[B
    ...
    invoke-virtual {p0, v2}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->getEncoded(Ljava/lang/String;)[B
...
.method public whitelist core-platform-api test-api getEncoded(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v2}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)Lcom/android/org/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-direct {p0, v2}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toDEREncoded(Lcom/android/org/bouncycastle/asn1/ASN1Encodable;)[B
    ...
    invoke-direct {v4, v0, v1}, Lcom/android/org/bouncycastle/asn1/pkcs/ContentInfo;-><init>(Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;Lcom/android/org/bouncycastle/asn1/ASN1Encodable;)V

    .line 290
    .local v4, "encInfo":Lcom/android/org/bouncycastle/asn1/pkcs/ContentInfo;
    new-instance v0, Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;

    invoke-direct {v0}, Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;-><init>()V

    .line 291
    .restart local v0    # "v":Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;
    const/4 v1, 0x0
    ...
    .end local v1    # "i":I
    :cond_65
    new-instance v8, Lcom/android/org/bouncycastle/asn1/pkcs/SignedData;

    new-instance v2, Lcom/android/org/bouncycastle/asn1/ASN1Integer;

    const-wide/16 v5, 0x1

    invoke-direct {v2, v5, v6}, Lcom/android/org/bouncycastle/asn1/ASN1Integer;-><init>(J)V

    new-instance v3, Lcom/android/org/bouncycastle/asn1/DERSet;

    invoke-direct {v3}, Lcom/android/org/bouncycastle/asn1/DERSet;-><init>()V

    new-instance v5, Lcom/android/org/bouncycastle/asn1/DERSet;

    invoke-direct {v5, v0}, Lcom/android/org/bouncycastle/asn1/DERSet;-><init>(Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;)V

    const/4 v6, 0x0

    new-instance v7, Lcom/android/org/bouncycastle/asn1/DERSet;

    invoke-direct {v7}, Lcom/android/org/bouncycastle/asn1/DERSet;-><init>()V

    move-object v1, v8

    invoke-direct/range {v1 .. v7}, Lcom/android/org/bouncycastle/asn1/pkcs/SignedData;-><init>(Lcom/android/org/bouncycastle/asn1/ASN1Integer;Lcom/android/org/bouncycastle/asn1/ASN1Set;Lcom/android/org/bouncycastle/asn1/pkcs/ContentInfo;Lcom/android/org/bouncycastle/asn1/ASN1Set;Lcom/android/org/bouncycastle/asn1/ASN1Set;Lcom/android/org/bouncycastle/asn1/ASN1Set;)V

    .line 304
    .local v1, "sd":Lcom/android/org/bouncycastle/asn1/pkcs/SignedData;
    new-instance v2, Lcom/android/org/bouncycastle/asn1/pkcs/ContentInfo;

    sget-object v3, Lcom/android/org/bouncycastle/asn1/pkcs/PKCSObjectIdentifiers;->signedData:Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-direct {v2, v3, v1}, Lcom/android/org/bouncycastle/asn1/pkcs/ContentInfo;-><init>(Lcom/android/org/bouncycastle/asn1/ASN1ObjectIdentifier;Lcom/android/org/bouncycastle/asn1/ASN1Encodable;)V
    ...
    .line 334
    .end local v0    # "v":Lcom/android/org/bouncycastle/asn1/ASN1EncodableVector;
    .end local v1    # "sd":Lcom/android/org/bouncycastle/asn1/pkcs/SignedData;
    .end local v4    # "encInfo":Lcom/android/org/bouncycastle/asn1/pkcs/ContentInfo;
    :cond_8e
