...
# instance fields
.field private blacklist attrCertChecking:Lcom/android/org/bouncycastle/x509/X509AttributeCertificate;
...
.method public static blacklist getInstance(Ljava/security/cert/X509CRLSelector;)Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;
    .registers 5
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->setCertificateChecking(Ljava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->setDateAndTime(Ljava/util/Date;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->setIssuerNames(Ljava/util/Collection;)V
    :try_end_1c
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->setIssuers(Ljava/util/Collection;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->setMaxCRLNumber(Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->setMinCRLNumber(Ljava/math/BigInteger;)V
    ...
    .line 209
    .end local v0    # "cs":Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;
...
.method public blacklist getAttrCertificateChecking()Lcom/android/org/bouncycastle/x509/X509AttributeCertificate;
    .registers 2
...
.method public blacklist match(Ljava/lang/Object;)Z
    ...
    .line 109
    invoke-static {v3}, Lcom/android/org/bouncycastle/x509/extension/X509ExtensionUtil;->fromExtensionValue([B)Lcom/android/org/bouncycastle/asn1/ASN1Primitive;
    ...
    .line 133
    iget-object v3, p0, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->maxBaseCRLNumber:Ljava/math/BigInteger;
    ...
    iget-object v4, p0, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->maxBaseCRLNumber:Ljava/math/BigInteger;
    ...
    .line 141
    :cond_47
    iget-boolean v3, p0, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->issuingDistributionPointEnabled:Z
    ...
    .line 146
    .local v3, "idp":[B
    iget-object v4, p0, Lcom/android/org/bouncycastle/x509/X509CRLStoreSelector;->issuingDistributionPoint:[B
...
.method public blacklist setAttrCertificateChecking(Lcom/android/org/bouncycastle/x509/X509AttributeCertificate;)V
    .registers 2
