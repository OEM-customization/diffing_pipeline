...
.method public static blacklist enhancedMRProbablePrimeTest(Ljava/math/BigInteger;Ljava/security/SecureRandom;I)Lcom/android/org/bouncycastle/math/Primes$MROutput;
    ...
    sget-object v9, Lcom/android/org/bouncycastle/math/Primes;->ONE:Ljava/math/BigInteger;
    ...
    .line 226
    sget-object v11, Lcom/android/org/bouncycastle/math/Primes;->TWO:Ljava/math/BigInteger;
...
.method private static blacklist implSTRandomPrime(Lcom/android/org/bouncycastle/crypto/Digest;I[B)Lcom/android/org/bouncycastle/math/Primes$STOutput;
    ...
    sget-object v5, Lcom/android/org/bouncycastle/math/Primes;->ONE:Ljava/math/BigInteger;
    ...
    .line 545
    sget-object v6, Lcom/android/org/bouncycastle/math/Primes;->ONE:Ljava/math/BigInteger;

    move-object/from16 p2, v3

    .end local v3    # "c":Ljava/math/BigInteger;
    .local p2, "c":Ljava/math/BigInteger;
    ...
    .end local p2    # "c":Ljava/math/BigInteger;
    ...
    invoke-static {v0, v2, v6}, Lcom/android/org/bouncycastle/math/Primes;->hashGen(Lcom/android/org/bouncycastle/crypto/Digest;[BI)Ljava/math/BigInteger;

    move-result-object v6

    .line 560
    .local v6, "a":Ljava/math/BigInteger;
    sget-object v0, Lcom/android/org/bouncycastle/math/Primes;->THREE:Ljava/math/BigInteger;
    ...
    .local p2, "a":Ljava/math/BigInteger;
    sget-object v6, Lcom/android/org/bouncycastle/math/Primes;->TWO:Ljava/math/BigInteger;
    ...
    .end local v7    # "rec":Lcom/android/org/bouncycastle/math/Primes$STOutput;
    .local v18, "rec":Lcom/android/org/bouncycastle/math/Primes$STOutput;
    int-to-long v6, v15
    ...
    .restart local p2    # "a":Ljava/math/BigInteger;
    ...
    invoke-direct {v0, v3, v2, v9, v7}, Lcom/android/org/bouncycastle/math/Primes$STOutput;-><init>(Ljava/math/BigInteger;[BILcom/android/org/bouncycastle/math/Primes$1;)V
    ...
    .line 574
    .end local v18    # "rec":Lcom/android/org/bouncycastle/math/Primes$STOutput;
    .restart local v7    # "rec":Lcom/android/org/bouncycastle/math/Primes$STOutput;
    :cond_13d
    move-object/from16 v18, v7
    ...
    .end local v7    # "rec":Lcom/android/org/bouncycastle/math/Primes$STOutput;
    .restart local v18    # "rec":Lcom/android/org/bouncycastle/math/Primes$STOutput;
    add-int/lit8 v0, v11, 0x1

    invoke-static {v2, v0}, Lcom/android/org/bouncycastle/math/Primes;->inc([BI)V
...
.method public static blacklist isMRProbablePrimeToBase(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    invoke-static {v0, v1, v3, v2, p1}, Lcom/android/org/bouncycastle/math/Primes;->implMRProbablePrimeToBase(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;ILjava/math/BigInteger;)Z
