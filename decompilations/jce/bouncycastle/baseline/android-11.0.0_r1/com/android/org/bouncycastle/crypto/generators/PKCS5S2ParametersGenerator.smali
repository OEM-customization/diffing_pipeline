...
# instance fields
.field private blacklist hMac:Lcom/android/org/bouncycastle/crypto/Mac;
...
.method private blacklist F([BI[B[BI)V
    ...
    .line 61
    iget-object v1, p0, Lcom/android/org/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->hMac:Lcom/android/org/bouncycastle/crypto/Mac;

    array-length v2, p1

    invoke-interface {v1, p1, v0, v2}, Lcom/android/org/bouncycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {v1, p3, v0, v2}, Lcom/android/org/bouncycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {v1, v2, v0}, Lcom/android/org/bouncycastle/crypto/Mac;->doFinal([BI)I

    .line 67
    iget-object v1, p0, Lcom/android/org/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->state:[B
    ...
    invoke-interface {v2, v3, v0, v4}, Lcom/android/org/bouncycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {v2, v3, v0}, Lcom/android/org/bouncycastle/crypto/Mac;->doFinal([BI)I
...
.method private blacklist generateDerivedKey(I)[B
    ...
    iget-object v5, p0, Lcom/android/org/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->password:[B

    invoke-direct {v4, v5}, Lcom/android/org/bouncycastle/crypto/params/KeyParameter;-><init>([B)V
    ...
    invoke-interface {v4, v10}, Lcom/android/org/bouncycastle/crypto/Mac;->init(Lcom/android/org/bouncycastle/crypto/CipherParameters;)V
    ...
    .line 103
    :cond_33
    iget-object v4, p0, Lcom/android/org/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->salt:[B

    iget v5, p0, Lcom/android/org/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->iterationCount:I
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/org/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->F([BI[B[BI)V
...
.method public blacklist generateDerivedParameters(I)Lcom/android/org/bouncycastle/crypto/CipherParameters;
    ...
    invoke-static {v0, v1, p1}, Lcom/android/org/bouncycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    invoke-direct {v2, v0, v1, p1}, Lcom/android/org/bouncycastle/crypto/params/KeyParameter;-><init>([BII)V
...
.method public blacklist generateDerivedParameters(II)Lcom/android/org/bouncycastle/crypto/CipherParameters;
    ...
    invoke-direct {p0, v0}, Lcom/android/org/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->generateDerivedKey(I)[B
