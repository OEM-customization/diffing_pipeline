...
.method public blacklist configure(Lcom/android/org/bouncycastle/jcajce/provider/config/ConfigurableProvider;)V
    ...
    .line 43
    # getter for: Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/DH;->generalDhAttributes:Ljava/util/Map;
    invoke-static {}, Lcom/android/org/bouncycastle/jcajce/provider/asymmetric/DH;->access$000()Ljava/util/Map;

    move-result-object v0

    const-string v2, "KeyAgreement.DH"

    invoke-interface {p1, v2, v0}, Lcom/android/org/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAttributes(Ljava/lang/String;Ljava/util/Map;)V

    .line 44
    const-string v0, "com.android.org.bouncycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi"
