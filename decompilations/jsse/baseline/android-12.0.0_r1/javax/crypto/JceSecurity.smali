...
.method static declared-synchronized blacklist getVerificationResult(Ljava/security/Provider;)Ljava/lang/Exception;
    ...
    invoke-direct {v1, v3}, Ljava/security/NoSuchProviderException;-><init>(Ljava/lang/String;)V
    :try_end_26
    .catchall {:try_start_17 .. :try_end_26} :catchall_57
    ...
    invoke-static {v6}, Ljavax/crypto/JceSecurity;->getCodeBase(Ljava/lang/Class;)Ljava/net/URL;

    move-result-object v6

    .line 196
    .local v6, "providerURL":Ljava/net/URL;
    invoke-static {v6}, Ljavax/crypto/JceSecurity;->verifyProviderJar(Ljava/net/URL;)V
    ...
    .line 204
    .end local v6    # "providerURL":Ljava/net/URL;
    :catchall_41
    move-exception v1
