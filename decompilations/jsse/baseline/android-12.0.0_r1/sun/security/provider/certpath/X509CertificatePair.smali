...
.method public static declared-synchronized blacklist generateCertificatePair([B)Lsun/security/provider/certpath/X509CertificatePair;
    ...
    check-cast v3, Lsun/security/provider/certpath/X509CertificatePair;
    :try_end_10
    .catchall {:try_start_3 .. :try_end_10} :catchall_27

    .line 143
    .local v3, "pair":Lsun/security/provider/certpath/X509CertificatePair;
    if-eqz v3, :cond_14
    ...
    :cond_14
    :try_start_14
    new-instance v4, Lsun/security/provider/certpath/X509CertificatePair;

    invoke-direct {v4, p0}, Lsun/security/provider/certpath/X509CertificatePair;-><init>([B)V

    move-object v3, v4

    .line 147
    new-instance v4, Lsun/security/util/Cache$EqualByteArray;

    iget-object v5, v3, Lsun/security/provider/certpath/X509CertificatePair;->encoded:[B

    invoke-direct {v4, v5}, Lsun/security/util/Cache$EqualByteArray;-><init>([B)V

    move-object v1, v4

    .line 148
    invoke-virtual {v2, v1, v3}, Lsun/security/util/Cache;->put(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_25
    ...
    .end local v3    # "pair":Lsun/security/provider/certpath/X509CertificatePair;
