...
.method static blacklist check(Ljava/util/List;Ljava/net/URI;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/util/List;)Lsun/security/provider/certpath/OCSPResponse;
    ...
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_4} :catch_142
    ...
    move-result-object v0
    :try_end_10
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_10} :catch_140
    ...
    sget v8, Lsun/security/provider/certpath/OCSP;->CONNECT_TIMEOUT:I
    ...
    const-string v11, "application/ocsp-request"
    ...
    :try_end_60
    .catch Ljava/io/IOException; {:try_start_15 .. :try_end_60} :catch_11c
    .catchall {:try_start_15 .. :try_end_60} :catchall_11a
    ...
    .line 239
    invoke-virtual {v6, v4}, Lsun/security/util/Debug;->println(Ljava/lang/String;)V
    ...
    move-result-object v4
    :try_end_99
    .catch Ljava/io/IOException; {:try_start_61 .. :try_end_99} :catch_116
    .catchall {:try_start_61 .. :try_end_99} :catchall_113
    ...
    new-array v4, v4, [B
    :try_end_ac
    .catch Ljava/io/IOException; {:try_start_9a .. :try_end_ac} :catch_10e
    .catchall {:try_start_9a .. :try_end_ac} :catchall_10a
    ...
    invoke-virtual {v12, v4, v5, v6}, Ljava/io/InputStream;->read([BII)I
    ...
    :try_end_ca
    .catch Ljava/io/IOException; {:try_start_af .. :try_end_ca} :catch_104
    .catchall {:try_start_af .. :try_end_ca} :catchall_ff
    ...
    :try_end_e5
    .catch Ljava/io/IOException; {:try_start_e0 .. :try_end_e5} :catch_f8
    ...
    throw v0
    :try_end_12b
    .catchall {:try_start_11e .. :try_end_12b} :catchall_11a
