...
.method private blacklist buildToNewKey(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Set;)V
    ...
    :try_end_3f
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_3a .. :try_end_3f} :catch_2b0
    ...
    move-result-object v0
    :try_end_ef
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_e9 .. :try_end_ef} :catch_2a9
    ...
    sget-object v0, Lsun/security/provider/certpath/RevocationChecker;->debug:Lsun/security/util/Debug;
    :try_end_f4
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_f2 .. :try_end_f4} :catch_2a0
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_f2 .. :try_end_f4} :catch_28f
    ...
    :try_end_fb
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_f6 .. :try_end_fb} :catch_101
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_f6 .. :try_end_fb} :catch_fc
    ...
    :try_end_10d
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_107 .. :try_end_10d} :catch_2a0
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_107 .. :try_end_10d} :catch_28f
    ...
    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V
    :try_end_11d
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_111 .. :try_end_11d} :catch_101
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_111 .. :try_end_11d} :catch_fc
    ...
    move-result-object v0
    :try_end_12f
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_122 .. :try_end_12f} :catch_287
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_122 .. :try_end_12f} :catch_27f
    ...
    move-result-object v1
    :try_end_139
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_131 .. :try_end_139} :catch_141
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_131 .. :try_end_139} :catch_13b
    ...
    move-result-object v0
    :try_end_152
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_14a .. :try_end_152} :catch_287
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_14a .. :try_end_152} :catch_27f
    ...
    move-result v0
    :try_end_157
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_153 .. :try_end_157} :catch_25d
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_153 .. :try_end_157} :catch_287
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_153 .. :try_end_157} :catch_27f
    ...
    :try_end_167
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_15e .. :try_end_167} :catch_1e3
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_15e .. :try_end_167} :catch_287
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_15e .. :try_end_167} :catch_27f
    ...
    :try_end_16e
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_169 .. :try_end_16e} :catch_195
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_169 .. :try_end_16e} :catch_141
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_169 .. :try_end_16e} :catch_13b
    ...
    :try_end_185
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_16e .. :try_end_185} :catch_186
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_16e .. :try_end_185} :catch_141
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_16e .. :try_end_185} :catch_13b
    ...
    move-result-object v1
    :try_end_1cb
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_1be .. :try_end_1cb} :catch_1da
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_1be .. :try_end_1cb} :catch_27b
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_1be .. :try_end_1cb} :catch_277
    ...
    :try_end_22f
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_1fb .. :try_end_22f} :catch_27b
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_1fb .. :try_end_22f} :catch_277
    ...
    :try_end_239
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_233 .. :try_end_239} :catch_24a
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_233 .. :try_end_239} :catch_27b
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_233 .. :try_end_239} :catch_277
    ...
    invoke-direct/range {v1 .. v8}, Lsun/security/provider/certpath/RevocationChecker;->checkCRLs(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/security/cert/X509Certificate;ZZLjava/util/Set;Ljava/util/Set;)V
    :try_end_247
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_244 .. :try_end_247} :catch_248
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_244 .. :try_end_247} :catch_27b
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_244 .. :try_end_247} :catch_277
    ...
    :try_end_26d
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_24e .. :try_end_26d} :catch_27b
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_24e .. :try_end_26d} :catch_277
...
.method private blacklist check(Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/security/PublicKey;Z)V
    ...
    :cond_38
    :try_start_38
    iget-boolean v1, p0, Lsun/security/provider/certpath/RevocationChecker;->onlyEE:Z
    ...
    invoke-virtual {v0, v1}, Lsun/security/util/Debug;->println(Ljava/lang/String;)V
    :try_end_4a
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_38 .. :try_end_4a} :catch_72
    .catchall {:try_start_38 .. :try_end_4a} :catchall_6f
    ...
    :try_end_69
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_4e .. :try_end_69} :catch_72
    .catchall {:try_start_4e .. :try_end_69} :catchall_6f
    ...
    .line 376
    .local v1, "eSoftFail":Z
    if-eqz v1, :cond_91

    .line 377
    iget-object v2, p0, Lsun/security/provider/certpath/RevocationChecker;->mode:Lsun/security/provider/certpath/RevocationChecker$Mode;
    ...
    sget-object v3, Lsun/security/provider/certpath/RevocationChecker$Mode;->ONLY_CRLS:Lsun/security/provider/certpath/RevocationChecker$Mode;
    :try_end_8b
    .catchall {:try_start_73 .. :try_end_8b} :catchall_6f
    ...
    .line 387
    .local v2, "cause":Ljava/security/cert/CertPathValidatorException;
    sget-object v3, Lsun/security/provider/certpath/RevocationChecker;->debug:Lsun/security/util/Debug;
    :try_end_a0
    .catchall {:try_start_91 .. :try_end_a0} :catchall_6f

    const-string v4, "RevocationChecker.check() "
    ...
    .line 389
    const-string v5, "RevocationChecker.check() preparing to failover"

    invoke-virtual {v3, v5}, Lsun/security/util/Debug;->println(Ljava/lang/String;)V
    :try_end_bf
    .catchall {:try_start_a4 .. :try_end_bf} :catchall_6f
    ...
    iget-object v5, p0, Lsun/security/provider/certpath/RevocationChecker;->mode:Lsun/security/provider/certpath/RevocationChecker$Mode;
    ...
    invoke-direct/range {v5 .. v10}, Lsun/security/provider/certpath/RevocationChecker;->checkCRLs(Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/util/Set;Ljava/security/PublicKey;Z)V
    :try_end_da
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_bf .. :try_end_da} :catch_dc
    .catchall {:try_start_bf .. :try_end_da} :catchall_6f
    ...
    .line 402
    .local v3, "x":Ljava/security/cert/CertPathValidatorException;
    :try_start_dd
    ...
    .line 403
    const-string v6, "RevocationChecker.check() failover failed"
    ...
    invoke-virtual {v5, v4}, Lsun/security/util/Debug;->println(Ljava/lang/String;)V
    ...
    .line 409
    invoke-direct {p0, v3}, Lsun/security/provider/certpath/RevocationChecker;->isSoftFailException(Ljava/security/cert/CertPathValidatorException;)Z
    ...
    .end local v1    # "eSoftFail":Z
    .end local v2    # "cause":Ljava/security/cert/CertPathValidatorException;
    .end local v3    # "x":Ljava/security/cert/CertPathValidatorException;
    :goto_10e
    return-void

    .line 415
    .restart local v0    # "e":Ljava/security/cert/CertPathValidatorException;
    .restart local v1    # "eSoftFail":Z
    .restart local v2    # "cause":Ljava/security/cert/CertPathValidatorException;
    .restart local v3    # "x":Ljava/security/cert/CertPathValidatorException;
    :cond_10f
    nop
    ...
    :cond_111
    invoke-virtual {v2, v3}, Ljava/security/cert/CertPathValidatorException;->addSuppressed(Ljava/lang/Throwable;)V
    ...
    throw v0
    :try_end_11c
    .catchall {:try_start_dd .. :try_end_11c} :catchall_6f
...
.method private blacklist checkApprovedCRLs(Ljava/security/cert/X509Certificate;Ljava/util/Set;)V
    ...
    .line 613
    .local v1, "sn":Ljava/math/BigInteger;
    ...
    .line 619
    .end local v1    # "sn":Ljava/math/BigInteger;
    :cond_25
    ...
    move-result-object v0
    :try_end_47
    .catch Ljava/security/cert/CRLException; {:try_start_43 .. :try_end_47} :catch_c9
...
.method private blacklist checkCRLs(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/security/cert/X509Certificate;ZZLjava/util/Set;Ljava/util/Set;)V
    ...
    :try_end_7d
    .catch Ljava/security/cert/CertStoreException; {:try_start_63 .. :try_end_7d} :catch_80
    ...
    :try_end_126
    .catch Ljava/security/cert/CertStoreException; {:try_start_124 .. :try_end_126} :catch_194
    ...
    :try_end_130
    .catch Ljava/security/cert/CertStoreException; {:try_start_128 .. :try_end_130} :catch_14f
    ...
    :try_end_148
    .catch Ljava/security/cert/CertStoreException; {:try_start_141 .. :try_end_148} :catch_149
    ...
    :try_end_175
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_172 .. :try_end_175} :catch_176
...
.method private blacklist checkOCSP(Ljava/security/cert/X509Certificate;Ljava/util/Collection;)V
    ...
    move-result-object v1
    :try_end_5
    .catch Ljava/security/cert/CertificateException; {:try_start_1 .. :try_end_5} :catch_118
    ...
    :try_end_48
    .catch Ljava/io/IOException; {:try_start_9 .. :try_end_48} :catch_109
    ...
    :try_end_7f
    .catch Ljava/io/IOException; {:try_start_49 .. :try_end_7f} :catch_81
    ...
    move-result-object v5
    :try_end_a2
    .catch Ljava/io/IOException; {:try_start_86 .. :try_end_a2} :catch_109
    ...
    throw v5
    :try_end_109
    .catch Ljava/io/IOException; {:try_start_ff .. :try_end_109} :catch_109
...
.method private blacklist verifyPossibleCRLs(Ljava/util/Set;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Z[ZLjava/util/Set;)Ljava/util/Collection;
    ...
    sget-object v0, Lsun/security/provider/certpath/RevocationChecker;->ALL_REASONS:[Z
    :try_end_a7
    .catch Ljava/security/cert/CertificateException; {:try_start_2 .. :try_end_a7} :catch_ba
    .catch Ljava/security/cert/CRLException; {:try_start_2 .. :try_end_a7} :catch_ba
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_a7} :catch_ba
    ...
    move-result v0
    :try_end_ad
    .catch Ljava/security/cert/CertificateException; {:try_start_a9 .. :try_end_ad} :catch_b3
    .catch Ljava/security/cert/CRLException; {:try_start_a9 .. :try_end_ad} :catch_b3
    .catch Ljava/io/IOException; {:try_start_a9 .. :try_end_ad} :catch_b3
...
.method public bridge synthetic whitelist test-api clone()Ljava/security/cert/PKIXRevocationChecker;
    .registers 2
...
.method public whitelist test-api getSoftFailExceptions()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method blacklist init(Ljava/security/cert/TrustAnchor;Lsun/security/provider/certpath/PKIX$ValidatorParams;)V
    ...
    sget-object v6, Lsun/security/provider/certpath/RevocationChecker$2;->$SwitchMap$java$security$cert$PKIXRevocationChecker$Option:[I
    ...
    :try_end_e5
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_d3 .. :try_end_e5} :catch_e6
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_d3 .. :try_end_e5} :catch_e6
