...
.method private blacklist checkBasicConstraints(Ljava/security/cert/X509Certificate;)V
    ...
    iget v3, p0, Lsun/security/provider/certpath/ConstraintsChecker;->certPathLength:I
    ...
    iput v3, p0, Lsun/security/provider/certpath/ConstraintsChecker;->maxPathLength:I
    ...
    sget-object v9, Ljava/security/cert/PKIXReason;->PATH_TOO_LONG:Ljava/security/cert/PKIXReason;
    ...
    sget-object v9, Ljava/security/cert/PKIXReason;->NOT_CA_CERT:Ljava/security/cert/PKIXReason;
    ...
    .line 278
    .end local v2    # "pathLenConstraint":I
    :cond_b2
    :goto_b2
    if-eqz v1, :cond_de
...
.method static blacklist mergeNameConstraints(Ljava/security/cert/X509Certificate;Lsun/security/x509/NameConstraintsExtension;)Lsun/security/x509/NameConstraintsExtension;
    ...
    move-result-object v0
    :try_end_4
    .catch Ljava/security/cert/CertificateException; {:try_start_0 .. :try_end_4} :catch_74
    ...
    :try_end_57
    .catch Ljava/io/IOException; {:try_start_54 .. :try_end_57} :catch_6d
...
.method private blacklist verifyNameConstraints(Ljava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {v2, p1}, Lsun/security/x509/NameConstraintsExtension;->verify(Ljava/security/cert/X509Certificate;)Z
    ...
    sget-object v8, Ljava/security/cert/PKIXReason;->INVALID_NAME:Ljava/security/cert/PKIXReason;
    ...
    throw v1
    :try_end_79
    .catch Ljava/io/IOException; {:try_start_53 .. :try_end_79} :catch_79
    ...
    invoke-static {p1, v2}, Lsun/security/provider/certpath/ConstraintsChecker;->mergeNameConstraints(Ljava/security/cert/X509Certificate;Lsun/security/x509/NameConstraintsExtension;)Lsun/security/x509/NameConstraintsExtension;

    move-result-object v2

    iput-object v2, p0, Lsun/security/provider/certpath/ConstraintsChecker;->prevNC:Lsun/security/x509/NameConstraintsExtension;
