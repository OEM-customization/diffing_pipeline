...
.method static blacklist get(I)Lsun/nio/ch/IOVecWrapper;
    ...
    check-cast v1, Lsun/nio/ch/IOVecWrapper;

    .line 97
    .local v1, "wrapper":Lsun/nio/ch/IOVecWrapper;
    if-eqz v1, :cond_14

    iget v2, v1, Lsun/nio/ch/IOVecWrapper;->size:I

    if-ge v2, p0, :cond_14

    .line 99
    iget-object v2, v1, Lsun/nio/ch/IOVecWrapper;->vecArray:Lsun/nio/ch/AllocatedNativeObject;
    ...
    .line 103
    new-instance v2, Lsun/nio/ch/IOVecWrapper;

    invoke-direct {v2, p0}, Lsun/nio/ch/IOVecWrapper;-><init>(I)V

    move-object v1, v2

    .line 104
    new-instance v2, Lsun/nio/ch/IOVecWrapper$Deallocator;

    iget-object v3, v1, Lsun/nio/ch/IOVecWrapper;->vecArray:Lsun/nio/ch/AllocatedNativeObject;

    invoke-direct {v2, v3}, Lsun/nio/ch/IOVecWrapper$Deallocator;-><init>(Lsun/nio/ch/AllocatedNativeObject;)V
