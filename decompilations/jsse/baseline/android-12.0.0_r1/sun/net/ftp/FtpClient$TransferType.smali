...
.method static constructor blacklist <clinit>()V
    ...
    new-instance v1, Lsun/net/ftp/FtpClient$TransferType;

    const-string v3, "BINARY"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lsun/net/ftp/FtpClient$TransferType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lsun/net/ftp/FtpClient$TransferType;->BINARY:Lsun/net/ftp/FtpClient$TransferType;

    new-instance v3, Lsun/net/ftp/FtpClient$TransferType;

    const-string v5, "EBCDIC"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lsun/net/ftp/FtpClient$TransferType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lsun/net/ftp/FtpClient$TransferType;->EBCDIC:Lsun/net/ftp/FtpClient$TransferType;

    .line 79
    const/4 v5, 0x3

    new-array v5, v5, [Lsun/net/ftp/FtpClient$TransferType;
    ...
    sput-object v5, Lsun/net/ftp/FtpClient$TransferType;->$VALUES:[Lsun/net/ftp/FtpClient$TransferType;
