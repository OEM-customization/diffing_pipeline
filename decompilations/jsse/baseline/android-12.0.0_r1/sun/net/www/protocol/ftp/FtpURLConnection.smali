...
# virtual methods
.method public declared-synchronized whitelist test-api connect()V
    .registers 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_10f
    ...
    :try_end_ae
    .catchall {:try_start_8 .. :try_end_ae} :catchall_10f
    ...
    invoke-virtual {v1, v2}, Lsun/net/ftp/FtpClient;->connect(Ljava/net/SocketAddress;)Lsun/net/ftp/FtpClient;
    :try_end_e0
    .catch Ljava/net/UnknownHostException; {:try_start_ae .. :try_end_e0} :catch_10d
    .catch Lsun/net/ftp/FtpProtocolException; {:try_start_ae .. :try_end_e0} :catch_106
    .catchall {:try_start_ae .. :try_end_e0} :catchall_10f
    ...
    :try_end_f2
    .catch Lsun/net/ftp/FtpProtocolException; {:try_start_e1 .. :try_end_f2} :catch_f8
    .catchall {:try_start_e1 .. :try_end_f2} :catchall_10f
    ...
    :try_end_f6
    .catchall {:try_start_f4 .. :try_end_f6} :catchall_10f
    ...
    throw v1
    :try_end_10f
    .catchall {:try_start_f9 .. :try_end_10f} :catchall_10f
...
.method public whitelist test-api getInputStream()Ljava/io/InputStream;
    ...
    iget-object v10, p0, Lsun/net/www/protocol/ftp/FtpURLConnection;->filename:Ljava/lang/String;

    invoke-virtual {v9, v10}, Lsun/net/ftp/FtpClient;->getFileStream(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-virtual {v9, v7}, Lsun/net/ftp/FtpClient;->list(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    .line 454
    :cond_73
    new-instance v9, Lsun/net/www/protocol/ftp/FtpURLConnection$FtpInputStream;

    iget-object v10, p0, Lsun/net/www/protocol/ftp/FtpURLConnection;->ftp:Lsun/net/ftp/FtpClient;

    invoke-virtual {v10, v8}, Lsun/net/ftp/FtpClient;->nameList(Ljava/lang/String;)Ljava/io/InputStream;

    move-result-object v8

    invoke-direct {v9, p0, v10, v8}, Lsun/net/www/protocol/ftp/FtpURLConnection$FtpInputStream;-><init>(Lsun/net/www/protocol/ftp/FtpURLConnection;Lsun/net/ftp/FtpClient;Ljava/io/InputStream;)V

    iput-object v9, p0, Lsun/net/www/protocol/ftp/FtpURLConnection;->is:Ljava/io/InputStream;
    :try_end_80
    .catch Ljava/io/FileNotFoundException; {:try_start_21 .. :try_end_80} :catch_ed
    .catch Lsun/net/ftp/FtpProtocolException; {:try_start_21 .. :try_end_80} :catch_e6
    ...
    iput-object v0, p0, Lsun/net/www/protocol/ftp/FtpURLConnection;->is:Ljava/io/InputStream;
    :try_end_b6
    .catch Ljava/lang/Exception; {:try_start_80 .. :try_end_b6} :catch_b7
    .catch Ljava/io/FileNotFoundException; {:try_start_80 .. :try_end_b6} :catch_ed
    .catch Lsun/net/ftp/FtpProtocolException; {:try_start_80 .. :try_end_b6} :catch_e6
    ...
    :try_end_e5
    .catch Ljava/io/FileNotFoundException; {:try_start_b8 .. :try_end_e5} :catch_ed
    .catch Lsun/net/ftp/FtpProtocolException; {:try_start_b8 .. :try_end_e5} :catch_e6
    ...
    invoke-virtual {v5, v3, v1}, Lsun/net/www/MessageHeader;->add(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_10b
    .catch Ljava/io/IOException; {:try_start_ee .. :try_end_10b} :catch_11c
    .catch Lsun/net/ftp/FtpProtocolException; {:try_start_ee .. :try_end_10b} :catch_113
...
.method public whitelist test-api getOutputStream()Ljava/io/OutputStream;
    ...
    invoke-virtual {v1, v2, v3}, Lsun/net/ftp/FtpClient;->putFileStream(Ljava/lang/String;Z)Ljava/io/OutputStream;
    ...
    iput-object v0, p0, Lsun/net/www/protocol/ftp/FtpURLConnection;->os:Ljava/io/OutputStream;
    :try_end_4a
    .catch Lsun/net/ftp/FtpProtocolException; {:try_start_23 .. :try_end_4a} :catch_4c
