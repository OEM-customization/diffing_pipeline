...
.method public static whitelist test-api allocate(I)Ljava/nio/DoubleBuffer;
    .registers 2
    .param p0, "capacity"    # I
...
.method public static whitelist test-api wrap([D)Ljava/nio/DoubleBuffer;
    .registers 3
    .param p0, "array"    # [D
...
.method public static whitelist test-api wrap([DII)Ljava/nio/DoubleBuffer;
    .registers 5
    .param p0, "array"    # [D
    .param p1, "offset"    # I
    .param p2, "length"    # I
...
.method public final whitelist test-api array()[D
    .registers 3
...
.method public abstract whitelist test-api asReadOnlyBuffer()Ljava/nio/DoubleBuffer;
.end method
...
.method public bridge synthetic whitelist test-api clear()Ljava/nio/DoubleBuffer;
    .registers 2
...
.method public abstract whitelist test-api compact()Ljava/nio/DoubleBuffer;
.end method
...
.method public whitelist test-api compareTo(Ljava/nio/DoubleBuffer;)I
    .registers 9
...
.method public abstract whitelist test-api duplicate()Ljava/nio/DoubleBuffer;
.end method
...
.method public bridge synthetic whitelist test-api flip()Ljava/nio/DoubleBuffer;
    .registers 2
...
.method public abstract whitelist test-api get()D
.end method

.method public abstract whitelist test-api get(I)D
.end method

.method public whitelist test-api get([D)Ljava/nio/DoubleBuffer;
    .registers 4
    .param p1, "dst"    # [D
...
.method public bridge synthetic whitelist test-api limit(I)Ljava/nio/DoubleBuffer;
    .registers 2
...
.method public bridge synthetic whitelist test-api mark()Ljava/nio/DoubleBuffer;
    .registers 2
...
.method public bridge synthetic whitelist test-api position(I)Ljava/nio/DoubleBuffer;
    .registers 2
...
.method public abstract whitelist test-api put(D)Ljava/nio/DoubleBuffer;
.end method

.method public abstract whitelist test-api put(ID)Ljava/nio/DoubleBuffer;
.end method
...
.method public final whitelist test-api put([D)Ljava/nio/DoubleBuffer;
    .registers 4
    .param p1, "src"    # [D
...
.method public bridge synthetic whitelist test-api reset()Ljava/nio/DoubleBuffer;
    .registers 2
...
.method public bridge synthetic whitelist test-api rewind()Ljava/nio/DoubleBuffer;
    .registers 2
...
.method public abstract whitelist test-api slice()Ljava/nio/DoubleBuffer;
.end method
