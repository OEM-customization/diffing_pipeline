...
.method static constructor blacklist <clinit>()V
    ...
    .line 117
    new-instance v1, Ljava/nio/file/FileTreeWalker$EventType;

    const-string v3, "END_DIRECTORY"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Ljava/nio/file/FileTreeWalker$EventType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Ljava/nio/file/FileTreeWalker$EventType;->END_DIRECTORY:Ljava/nio/file/FileTreeWalker$EventType;

    .line 121
    new-instance v3, Ljava/nio/file/FileTreeWalker$EventType;

    const-string v5, "ENTRY"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Ljava/nio/file/FileTreeWalker$EventType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Ljava/nio/file/FileTreeWalker$EventType;->ENTRY:Ljava/nio/file/FileTreeWalker$EventType;

    .line 109
    const/4 v5, 0x3

    new-array v5, v5, [Ljava/nio/file/FileTreeWalker$EventType;
    ...
    sput-object v5, Ljava/nio/file/FileTreeWalker$EventType;->$VALUES:[Ljava/nio/file/FileTreeWalker$EventType;
