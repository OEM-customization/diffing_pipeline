...
.method protected constructor blacklist <init>([IIIIII)V
    .registers 15
    .param p1, "buf"    # [I
    .param p2, "mark"    # I
    .param p3, "pos"    # I
...
.method protected constructor blacklist <init>([IIIIIIZ)V
    .registers 15
    .param p1, "buf"    # [I
    .param p2, "mark"    # I
    .param p3, "pos"    # I
...
.method constructor blacklist <init>([IIIZ)V
    .registers 12
    .param p1, "buf"    # [I
    .param p2, "off"    # I
    .param p3, "len"    # I
...
# virtual methods
.method public whitelist test-api asReadOnlyBuffer()Ljava/nio/IntBuffer;
    .registers 10

    .line 97
    new-instance v8, Ljava/nio/HeapIntBuffer;
...
.method public whitelist test-api compact()Ljava/nio/IntBuffer;
    .registers 6
...
.method public whitelist test-api duplicate()Ljava/nio/IntBuffer;
    .registers 10
...
.method public whitelist test-api get()I
    .registers 3
...
.method public whitelist test-api put(I)Ljava/nio/IntBuffer;
    .registers 4
    .param p1, "x"    # I
...
.method public whitelist test-api put(II)Ljava/nio/IntBuffer;
    .registers 5
    .param p1, "i"    # I
    .param p2, "x"    # I
...
.method public whitelist test-api put(Ljava/nio/IntBuffer;)Ljava/nio/IntBuffer;
    ...
    .line 169
    instance-of v0, p1, Ljava/nio/HeapIntBuffer;
    ...
    check-cast v0, Ljava/nio/HeapIntBuffer;

    .line 171
    .local v0, "sb":Ljava/nio/HeapIntBuffer;
    invoke-virtual {v0}, Ljava/nio/HeapIntBuffer;->remaining()I
    ...
    .line 174
    iget-object v2, v0, Ljava/nio/HeapIntBuffer;->hb:[I

    invoke-virtual {v0}, Ljava/nio/HeapIntBuffer;->position()I

    move-result v3

    invoke-virtual {v0, v3}, Ljava/nio/HeapIntBuffer;->ix(I)I
    ...
    invoke-virtual {v0, v2}, Ljava/nio/HeapIntBuffer;->position(I)Ljava/nio/Buffer;
    ...
    .line 178
    .end local v0    # "sb":Ljava/nio/HeapIntBuffer;
    .end local v1    # "n":I
    goto :goto_74

    .line 173
    .restart local v0    # "sb":Ljava/nio/HeapIntBuffer;
    ...
    invoke-virtual {p0, v2}, Ljava/nio/HeapIntBuffer;->ix(I)I
    ...
    invoke-virtual {p0, v1}, Ljava/nio/HeapIntBuffer;->position(I)Ljava/nio/Buffer;
...
.method public whitelist test-api slice()Ljava/nio/IntBuffer;
    .registers 10
    ...
    iget v2, p0, Ljava/nio/HeapIntBuffer;->offset:I
