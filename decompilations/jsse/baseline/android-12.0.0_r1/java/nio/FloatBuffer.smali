...
.method public static whitelist test-api allocate(I)Ljava/nio/FloatBuffer;
    .registers 2
    .param p0, "capacity"    # I
...
.method public static whitelist test-api wrap([F)Ljava/nio/FloatBuffer;
    .registers 3
    .param p0, "array"    # [F
...
.method public static whitelist test-api wrap([FII)Ljava/nio/FloatBuffer;
    .registers 5
    .param p0, "array"    # [F
    .param p1, "offset"    # I
    .param p2, "length"    # I
...
.method public final whitelist test-api array()[F
    .registers 3
...
.method public abstract whitelist test-api asReadOnlyBuffer()Ljava/nio/FloatBuffer;
.end method
...
.method public bridge synthetic whitelist test-api clear()Ljava/nio/FloatBuffer;
    .registers 2
...
.method public abstract whitelist test-api compact()Ljava/nio/FloatBuffer;
.end method
...
.method public whitelist test-api compareTo(Ljava/nio/FloatBuffer;)I
    .registers 7
...
.method public abstract whitelist test-api duplicate()Ljava/nio/FloatBuffer;
.end method
...
.method public bridge synthetic whitelist test-api flip()Ljava/nio/FloatBuffer;
    .registers 2
...
.method public abstract whitelist test-api get()F
.end method

.method public abstract whitelist test-api get(I)F
.end method

.method public whitelist test-api get([F)Ljava/nio/FloatBuffer;
    .registers 4
    .param p1, "dst"    # [F
...
.method public bridge synthetic whitelist test-api limit(I)Ljava/nio/FloatBuffer;
    .registers 2
...
.method public bridge synthetic whitelist test-api mark()Ljava/nio/FloatBuffer;
    .registers 2
...
.method public bridge synthetic whitelist test-api position(I)Ljava/nio/FloatBuffer;
    .registers 2
...
.method public abstract whitelist test-api put(F)Ljava/nio/FloatBuffer;
.end method

.method public abstract whitelist test-api put(IF)Ljava/nio/FloatBuffer;
.end method

.method public whitelist test-api put(Ljava/nio/FloatBuffer;)Ljava/nio/FloatBuffer;
    .registers 5
...
.method public final whitelist test-api put([F)Ljava/nio/FloatBuffer;
    .registers 4
    .param p1, "src"    # [F
...
.method public bridge synthetic whitelist test-api reset()Ljava/nio/FloatBuffer;
    .registers 2
...
.method public bridge synthetic whitelist test-api rewind()Ljava/nio/FloatBuffer;
    .registers 2
...
.method public abstract whitelist test-api slice()Ljava/nio/FloatBuffer;
.end method
