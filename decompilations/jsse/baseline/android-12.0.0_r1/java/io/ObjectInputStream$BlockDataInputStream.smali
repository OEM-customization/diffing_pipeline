...
.method private greylist-max-o readBlockHeader(Z)I
    ...
    iget-object v6, p0, Ljava/io/ObjectInputStream$BlockDataInputStream;->hbuf:[B

    invoke-virtual {v2, v6, v5, v1}, Ljava/io/ObjectInputStream$PeekInputStream;->readFully([BII)V

    .line 2640
    iget-object v1, p0, Ljava/io/ObjectInputStream$BlockDataInputStream;->hbuf:[B

    invoke-static {v1, v4}, Ljava/io/Bits;->getInt([BI)I
    ...
    throw v1
    :try_end_8d
    .catch Ljava/io/EOFException; {:try_start_10 .. :try_end_8d} :catch_8e
...
.method private greylist-max-o readUTFSpan(Ljava/lang/StringBuilder;J)J
    ...
    :try_end_50
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_21 .. :try_end_50} :catch_d6
    .catchall {:try_start_21 .. :try_end_50} :catchall_bf
    ...
    :try_end_62
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_60 .. :try_end_62} :catch_67
    ...
    iput v12, v1, Ljava/io/ObjectInputStream$BlockDataInputStream;->pos:I
    ...
    iget-object v11, v1, Ljava/io/ObjectInputStream$BlockDataInputStream;->cbuf:[C
    :try_end_7d
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_6b .. :try_end_7d} :catch_d6
    .catchall {:try_start_6b .. :try_end_7d} :catchall_bf
    ...
    :try_end_8a
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_88 .. :try_end_8a} :catch_8f
    ...
    :try_end_9a
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_92 .. :try_end_9a} :catch_d6
    .catchall {:try_start_92 .. :try_end_9a} :catchall_bf
    ...
    :try_end_9f
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_9d .. :try_end_9f} :catch_a5
    .catchall {:try_start_9d .. :try_end_9f} :catchall_a2
    ...
    throw v10
    :try_end_ac
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_a8 .. :try_end_ac} :catch_d6
    .catchall {:try_start_a8 .. :try_end_ac} :catchall_bf
...
.method private greylist-max-o refill()V
    ...
    invoke-virtual {v3, v4, v1, v2}, Ljava/io/ObjectInputStream$PeekInputStream;->read([BII)I
    ...
    :try_end_3c
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_3c} :catch_40
