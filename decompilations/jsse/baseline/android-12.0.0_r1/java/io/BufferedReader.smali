...
.method public whitelist test-api lines()Ljava/util/stream/Stream;
    .registers 4
...
.method greylist-max-o readLine(Z)Ljava/lang/String;
    ...
    invoke-direct {v2, v9, v8, v11}, Ljava/lang/String;-><init>([CII)V
    ...
    invoke-virtual {v0, v2, v8, v9}, Ljava/lang/StringBuffer;->append([CII)Ljava/lang/StringBuffer;
    ...
    invoke-virtual {v0, v9, v8, v10}, Ljava/lang/StringBuffer;->append([CII)Ljava/lang/StringBuffer;
    ...
    .end local v8    # "startChar":I
    :catchall_98
    move-exception v2

    monitor-exit v1
    :try_end_9a
    .catchall {:try_start_4 .. :try_end_9a} :catchall_98
...
.method public whitelist test-api skip(J)J
    ...
    .line 425
    :cond_21
    iget-boolean v7, p0, Ljava/io/BufferedReader;->skipLF:Z
    ...
    iput-boolean v7, p0, Ljava/io/BufferedReader;->skipLF:Z
    ...
    .line 439
    iput v6, p0, Ljava/io/BufferedReader;->nextChar:I
