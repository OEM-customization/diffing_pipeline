...
.method public static whitelist test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 2
...
.method public static whitelist test-api now()Ljava/time/chrono/ThaiBuddhistDate;
    .registers 1
...
.method public static whitelist test-api now(Ljava/time/Clock;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 3
...
.method public static whitelist test-api now(Ljava/time/ZoneId;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 2
...
.method public static whitelist test-api of(III)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 5
...
.method public whitelist test-api getChronology()Ljava/time/chrono/ThaiBuddhistChronology;
    .registers 2
...
.method public whitelist test-api getEra()Ljava/time/chrono/ThaiBuddhistEra;
    .registers 3
...
.method public whitelist test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 5
...
.method public whitelist test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 3
...
.method public whitelist test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 5
    .param p1, "amountToAdd"    # J
    .param p3, "unit"    # Ljava/time/temporal/TemporalUnit;
...
.method public whitelist test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 3
    .param p1, "amount"    # Ljava/time/temporal/TemporalAmount;
...
.method public whitelist test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 3
...
.method public whitelist test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 9
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
    ...
    .line 319
    .local v1, "nvalue":I
    sget-object v2, Ljava/time/chrono/ThaiBuddhistDate$1;->$SwitchMap$java$time$temporal$ChronoField:[I
