...
# direct methods
.method constructor blacklist <init>(Ljava/util/concurrent/CountedCompleter;[D[DIIII)V
    .registers 8
    .param p2, "a"    # [D
    .param p3, "w"    # [D
    .param p4, "base"    # I
...
.method public final whitelist test-api compute()V
    ...
    iget-object v15, v0, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;->a:[D

    .local v15, "a":[D
    iget-object v14, v0, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;->w:[D

    .line 914
    .local v14, "w":[D
    iget v13, v0, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;->base:I

    .local v13, "b":I
    iget v2, v0, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;->size:I

    .local v2, "n":I
    iget v12, v0, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;->wbase:I

    .local v12, "wb":I
    iget v11, v0, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;->gran:I
    ...
    new-instance v8, Ljava/util/ArraysParallelSortHelpers$FJDouble$Merger;
    ...
    invoke-direct/range {v4 .. v11}, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;-><init>(Ljava/util/concurrent/CountedCompleter;[D[DIIII)V

    invoke-virtual {v0}, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;->fork()Ljava/util/concurrent/ForkJoinTask;
    ...
    invoke-direct/range {v6 .. v13}, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;-><init>(Ljava/util/concurrent/CountedCompleter;[D[DIIII)V
    ...
    invoke-direct/range {v6 .. v15}, Ljava/util/ArraysParallelSortHelpers$FJDouble$Merger;-><init>(Ljava/util/concurrent/CountedCompleter;[D[DIIIIII)V
    ...
    invoke-virtual {v2}, Ljava/util/ArraysParallelSortHelpers$FJDouble$Sorter;->fork()Ljava/util/concurrent/ForkJoinTask;
    ...
    .restart local v23    # "w":[D
    .restart local v24    # "a":[D
    add-int v13, v1, v20
    ...
    invoke-static/range {v2 .. v7}, Ljava/util/DualPivotQuicksort;->sort([DII[DII)V
