...
.field public static final whitelist test-api OPEN_DELETE:I = 0x4

.field public static final whitelist test-api OPEN_READ:I = 0x1
...
.field private greylist-max-r jzfile:J
...
.method public constructor whitelist test-api <init>(Ljava/io/File;ILjava/nio/charset/Charset;)V
    .registers 9
    .param p1, "file"    # Ljava/io/File;
    .param p2, "mode"    # I
    ...
    iput-object v1, p0, Ljava/util/zip/ZipFile;->streams:Ljava/util/Map;
    ...
    iput-object v1, p0, Ljava/util/zip/ZipFile;->inflaterCache:Ljava/util/Deque;
...
.method public constructor whitelist test-api <init>(Ljava/io/File;Ljava/nio/charset/Charset;)V
    .registers 4
    .param p1, "file"    # Ljava/io/File;
...
.method public constructor whitelist test-api <init>(Ljava/lang/String;Ljava/nio/charset/Charset;)V
    .registers 5
    .param p1, "name"    # Ljava/lang/String;
    .param p2, "charset"    # Ljava/nio/charset/Charset;
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist test-api close()V
    ...
    monitor-enter v0
    :try_end_15
    .catchall {:try_start_10 .. :try_end_15} :catchall_87
    ...
    monitor-enter v0
    :try_end_5c
    .catchall {:try_start_56 .. :try_end_5c} :catchall_87
...
.method public whitelist test-api getInputStream(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    .registers 11
    ...
    monitor-enter v7
    :try_end_74
    .catchall {:try_start_6 .. :try_end_74} :catchall_93
    ...
    monitor-exit p0
    :try_end_7b
    .catchall {:try_start_7a .. :try_end_7b} :catchall_93
    ...
    monitor-enter v3
    :try_end_82
    .catchall {:try_start_7e .. :try_end_82} :catchall_93
    ...
    monitor-exit v3
    :try_end_88
    .catchall {:try_start_82 .. :try_end_88} :catchall_8a
