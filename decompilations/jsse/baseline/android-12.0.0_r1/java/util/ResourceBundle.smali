...
.field protected whitelist test-api parent:Ljava/util/ResourceBundle;
...
.method public static final whitelist test-api clearCache()V
    .registers 1
...
.method public static final whitelist test-api clearCache(Ljava/lang/ClassLoader;)V
    .registers 5
...
.method private static greylist-max-o findBundle(Ljava/util/ResourceBundle$CacheKey;Ljava/util/List;Ljava/util/List;ILjava/util/ResourceBundle$Control;Ljava/util/ResourceBundle;)Ljava/util/ResourceBundle;
    ...
    check-cast v6, Ljava/util/ResourceBundle$BundleReference;

    .line 1452
    .local v6, "bundleRef":Ljava/util/ResourceBundle$BundleReference;
    if-eqz v6, :cond_66

    invoke-virtual {v6}, Ljava/util/ResourceBundle$BundleReference;->get()Ljava/lang/Object;
    ...
    .line 1453
    invoke-interface {v5, p0, v6}, Ljava/util/concurrent/ConcurrentMap;->remove(Ljava/lang/Object;Ljava/lang/Object;)Z

    .line 1458
    .end local v6    # "bundleRef":Ljava/util/ResourceBundle$BundleReference;
    :cond_66
    ...
    check-cast v6, Ljava/util/ResourceBundle$CacheKey;

    .line 1462
    .local v6, "constKey":Ljava/util/ResourceBundle$CacheKey;
    :try_start_70
    ...
    move-result-object v5
    :try_end_84
    .catchall {:try_start_70 .. :try_end_84} :catchall_a9
    ...
    invoke-static {v6}, Ljava/util/ResourceBundle$CacheKey;->access$400(Ljava/util/ResourceBundle$CacheKey;)Ljava/lang/Throwable;
    ...
    :cond_96
    :try_start_96
    invoke-static {p0, v5, p4}, Ljava/util/ResourceBundle;->putBundleInCache(Ljava/util/ResourceBundle$CacheKey;Ljava/util/ResourceBundle;Ljava/util/ResourceBundle$Control;)Ljava/util/ResourceBundle;
    :try_end_99
    ...
    .line 1481
    .end local v6    # "constKey":Ljava/util/ResourceBundle$CacheKey;
    :cond_ba
    :goto_ba
    return-object v1
.end method
...
.method private static greylist-max-o findBundleInCache(Ljava/util/ResourceBundle$CacheKey;Ljava/util/ResourceBundle$Control;)Ljava/util/ResourceBundle;
    ...
    check-cast v4, Ljava/util/ResourceBundle;
    ...
    .line 1588
    :cond_17
    iget-object v13, v4, Ljava/util/ResourceBundle;->parent:Ljava/util/ResourceBundle;
    ...
    iget-boolean v5, v13, Ljava/util/ResourceBundle;->expired:Z
    ...
    iput-boolean v5, v4, Ljava/util/ResourceBundle;->expired:Z

    .line 1626
    iput-object v3, v4, Ljava/util/ResourceBundle;->cacheKey:Ljava/util/ResourceBundle$CacheKey;
    ...
    iget-boolean v7, v4, Ljava/util/ResourceBundle;->expired:Z
    ...
    .line 1635
    sget-object v9, Ljava/util/ResourceBundle;->NONEXISTENT_BUNDLE:Ljava/util/ResourceBundle;
    ...
    move-result-wide v9
    :try_end_51
    .catchall {:try_start_4d .. :try_end_51} :catchall_a6
    ...
    :try_start_52
    iget-boolean v0, v4, Ljava/util/ResourceBundle;->expired:Z
    ...
    move-result-wide v5
    :try_end_5e
    .catchall {:try_start_52 .. :try_end_5e} :catchall_a1
    ...
    invoke-virtual/range {v5 .. v12}, Ljava/util/ResourceBundle$Control;->needsReload(Ljava/lang/String;Ljava/util/Locale;Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/util/ResourceBundle;J)Z

    move-result v0

    iput-boolean v0, v4, Ljava/util/ResourceBundle;->expired:Z
    :try_end_7f
    .catch Ljava/lang/Exception; {:try_start_62 .. :try_end_7f} :catch_80
    .catchall {:try_start_62 .. :try_end_7f} :catchall_a1
    ...
    invoke-interface {v0, v1, v2}, Ljava/util/concurrent/ConcurrentMap;->remove(Ljava/lang/Object;Ljava/lang/Object;)Z
    :try_end_8f
    .catchall {:try_start_81 .. :try_end_8f} :catchall_a1
    ...
    .restart local v5    # "expirationTime":J
    :catchall_a6
    move-exception v0
    ...
    monitor-exit v4
    :try_end_aa
    .catchall {:try_start_a9 .. :try_end_aa} :catchall_ab
...
.method public static final whitelist test-api getBundle(Ljava/lang/String;)Ljava/util/ResourceBundle;
    .registers 4
...
.method public static final whitelist test-api getBundle(Ljava/lang/String;Ljava/util/Locale;)Ljava/util/ResourceBundle;
    .registers 4
    .param p0, "baseName"    # Ljava/lang/String;
...
.method public static whitelist test-api getBundle(Ljava/lang/String;Ljava/util/Locale;Ljava/lang/ClassLoader;)Ljava/util/ResourceBundle;
    .registers 4
    .param p0, "baseName"    # Ljava/lang/String;
    .param p1, "locale"    # Ljava/util/Locale;
...
.method public static whitelist test-api getBundle(Ljava/lang/String;Ljava/util/Locale;Ljava/lang/ClassLoader;Ljava/util/ResourceBundle$Control;)Ljava/util/ResourceBundle;
    .registers 5
    .param p0, "baseName"    # Ljava/lang/String;
...
.method public static final whitelist test-api getBundle(Ljava/lang/String;Ljava/util/Locale;Ljava/util/ResourceBundle$Control;)Ljava/util/ResourceBundle;
    .registers 4
    .param p0, "baseName"    # Ljava/lang/String;
    .param p1, "targetLocale"    # Ljava/util/Locale;
...
.method public static final whitelist test-api getBundle(Ljava/lang/String;Ljava/util/ResourceBundle$Control;)Ljava/util/ResourceBundle;
    .registers 4
    .param p0, "baseName"    # Ljava/lang/String;
    .param p1, "control"    # Ljava/util/ResourceBundle$Control;
    .annotation runtime Lsun/reflect/CallerSensitive;
...
.method private static greylist-max-o putBundleInCache(Ljava/util/ResourceBundle$CacheKey;Ljava/util/ResourceBundle;Ljava/util/ResourceBundle$Control;)Ljava/util/ResourceBundle;
    ...
    iget-boolean v5, v4, Ljava/util/ResourceBundle;->expired:Z
    ...
    iput-object v2, p1, Ljava/util/ResourceBundle;->cacheKey:Ljava/util/ResourceBundle$CacheKey;
    ...
    .end local v4    # "rb":Ljava/util/ResourceBundle;
    :cond_3d
    :goto_3d
    return-object p1
.end method
...
.method public whitelist test-api getBaseBundleName()Ljava/lang/String;
    .registers 2
...
.method public abstract whitelist test-api getKeys()Ljava/util/Enumeration;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final whitelist test-api getObject(Ljava/lang/String;)Ljava/lang/Object;
    .registers 6
    .param p1, "key"    # Ljava/lang/String;
...
.method public final whitelist test-api getStringArray(Ljava/lang/String;)[Ljava/lang/String;
    .registers 3
    .param p1, "key"    # Ljava/lang/String;
...
.method protected abstract whitelist test-api handleGetObject(Ljava/lang/String;)Ljava/lang/Object;
.end method
...
.method protected whitelist test-api setParent(Ljava/util/ResourceBundle;)V
    .registers 2
