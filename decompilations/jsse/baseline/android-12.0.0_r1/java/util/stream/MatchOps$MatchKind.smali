...
.method static constructor blacklist <clinit>()V
    ...
    .line 55
    new-instance v1, Ljava/util/stream/MatchOps$MatchKind;

    const-string v4, "ALL"

    invoke-direct {v1, v4, v3, v2, v2}, Ljava/util/stream/MatchOps$MatchKind;-><init>(Ljava/lang/String;IZZ)V

    sput-object v1, Ljava/util/stream/MatchOps$MatchKind;->ALL:Ljava/util/stream/MatchOps$MatchKind;

    .line 58
    new-instance v4, Ljava/util/stream/MatchOps$MatchKind;

    const-string v5, "NONE"

    const/4 v6, 0x2

    invoke-direct {v4, v5, v6, v3, v2}, Ljava/util/stream/MatchOps$MatchKind;-><init>(Ljava/lang/String;IZZ)V

    sput-object v4, Ljava/util/stream/MatchOps$MatchKind;->NONE:Ljava/util/stream/MatchOps$MatchKind;

    .line 50
    const/4 v5, 0x3

    new-array v5, v5, [Ljava/util/stream/MatchOps$MatchKind;
    ...
    sput-object v5, Ljava/util/stream/MatchOps$MatchKind;->$VALUES:[Ljava/util/stream/MatchOps$MatchKind;
