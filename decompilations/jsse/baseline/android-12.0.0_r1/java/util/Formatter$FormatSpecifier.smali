...
.method private greylist-max-o checkNumeric()V
    ...
    invoke-direct {v0, v2}, Ljava/util/IllegalFormatPrecisionException;-><init>(I)V
...
.method private greylist-max-o print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    packed-switch p3, :pswitch_data_330
    ...
    iget v6, p0, Ljava/util/Formatter$FormatSpecifier;->width:I
    ...
    invoke-direct {p0, p1, p2, v2, p4}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4354
    invoke-direct {p0, p1, p2, v3, p4}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4355
    invoke-direct {p0, p1, p2, v0, p4}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    invoke-direct {p0, v0, p2, v2, p4}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4323
    .local v6, "flags":Ljava/util/Formatter$Flags;
    const/4 v3, 0x0
    ...
    invoke-direct/range {v2 .. v8}, Ljava/util/Formatter$FormatSpecifier;->localizedMagnitude(Ljava/lang/StringBuilder;JLjava/util/Formatter$Flags;ILjava/util/Locale;)Ljava/lang/StringBuilder;
    ...
    .line 4363
    .end local v0    # "i":I
    .end local v6    # "flags":Ljava/util/Formatter$Flags;
    :pswitch_13b
    const/16 v0, 0x20
    ...
    invoke-direct {p0, p1, p2, v1, p4}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4366
    invoke-direct {p0, p1, p2, v7, p4}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4369
    invoke-direct {p0, p1, p2, v4, p4}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4262
    invoke-interface {p2, v2}, Ljava/time/temporal/TemporalAccessor;->isSupported(Ljava/time/temporal/TemporalField;)Z
    ...
    invoke-virtual {v4, v2}, Ljava/time/zone/ZoneRules;->isDaylightSavings(Ljava/time/Instant;)Z
    ...
    .line 4265
    :goto_19d
    invoke-virtual {v3, v4, v1, v5}, Ljava/util/TimeZone;->getDisplayName(ZILjava/util/Locale;)Ljava/lang/String;
    ...
    iget v9, p0, Ljava/util/Formatter$FormatSpecifier;->width:I
    ...
    .line 4382
    invoke-direct {p0, p1, p2, v5, p4}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/time/temporal/TemporalAccessor;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4302
    .local v1, "size":I
    sparse-switch p3, :sswitch_data_3a8
    ...
    invoke-virtual {p1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    :try_end_321
    .catch Ljava/time/DateTimeException; {:try_start_1b .. :try_end_321} :catch_322
    ...
    .line 4391
    .end local v0    # "x":Ljava/time/DateTimeException;
    :cond_32d
    :goto_32d
    nop
...
.method private greylist-max-o print(Ljava/lang/StringBuilder;Ljava/util/Calendar;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    invoke-direct {v7, v0, v8, v2, v10}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/util/Calendar;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4136
    invoke-direct {v7, v11, v8, v6, v10}, Ljava/util/Formatter$FormatSpecifier;->print(Ljava/lang/StringBuilder;Ljava/util/Calendar;CLjava/util/Locale;)Ljava/lang/Appendable;
    ...
    .line 4034
    :goto_17a
    invoke-virtual {v0, v12, v14, v1}, Ljava/util/TimeZone;->getDisplayName(ZILjava/util/Locale;)Ljava/lang/String;
    ...
    .restart local v12    # "i":I
    :goto_238
    if-eq v9, v4, :cond_241

    if-ne v9, v15, :cond_23d
