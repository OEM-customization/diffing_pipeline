...
.method final greylist-max-o find(ILjava/lang/Object;)Ljava/util/concurrent/ConcurrentHashMap$Node;
    ...
    sget-wide v10, Ljava/util/concurrent/ConcurrentHashMap$TreeBin;->LOCKSTATE:J
    ...
    :try_start_35
    iget-object v5, p0, Ljava/util/concurrent/ConcurrentHashMap$TreeBin;->root:Ljava/util/concurrent/ConcurrentHashMap$TreeNode;
    ...
    .line 2913
    :cond_3b
    invoke-virtual {v6, p1, p2, v0}, Ljava/util/concurrent/ConcurrentHashMap$TreeNode;->findTreeNode(ILjava/lang/Object;Ljava/lang/Class;)Ljava/util/concurrent/ConcurrentHashMap$TreeNode;

    move-result-object v0
    :try_end_3f
    .catchall {:try_start_35 .. :try_end_3f} :catchall_50
    ...
    invoke-virtual {v2, p0, v10, v11, v4}, Lsun/misc/Unsafe;->getAndAddInt(Ljava/lang/Object;JI)I
    ...
    invoke-virtual {v2, p0, v5, v6, v4}, Lsun/misc/Unsafe;->getAndAddInt(Ljava/lang/Object;JI)I
