...
.method static constructor blacklist <clinit>()V
    ...
    sput-wide v3, Ljava/util/concurrent/ThreadLocalRandom;->SEED:J
    ...
    sput-wide v3, Ljava/util/concurrent/ThreadLocalRandom;->PROBE:J
    ...
    :try_end_4d
    .catch Ljava/lang/ReflectiveOperationException; {:try_start_23 .. :try_end_4d} :catch_ac
...
.method public static whitelist test-api current()Ljava/util/concurrent/ThreadLocalRandom;
    .registers 4
...
.method static final greylist-max-o localInit()V
    ...
    sget-object v11, Ljava/util/concurrent/ThreadLocalRandom;->U:Lsun/misc/Unsafe;
    ...
    .line 163
    sget-wide v4, Ljava/util/concurrent/ThreadLocalRandom;->PROBE:J

    invoke-virtual {v11, v10, v4, v5, v1}, Lsun/misc/Unsafe;->putInt(Ljava/lang/Object;JI)V
...
.method static final greylist-max-o nextSecondarySeed()I
    ...
    :cond_19
    sget-object v4, Ljava/util/concurrent/ThreadLocalRandom;->seeder:Ljava/util/concurrent/atomic/AtomicLong;

    const-wide v6, -0x4498517a7b3558c5L    # -1.5671250923562117E-22

    invoke-virtual {v4, v6, v7}, Ljava/util/concurrent/atomic/AtomicLong;->getAndAdd(J)J

    move-result-wide v6

    invoke-static {v6, v7}, Ljava/util/concurrent/ThreadLocalRandom;->mix32(J)I
...
.method public whitelist test-api nextDouble(D)D
    .registers 9
    .param p1, "bound"    # D
...
.method public whitelist test-api nextDouble(DD)D
    .registers 7
    .param p1, "origin"    # D
    .param p3, "bound"    # D
...
.method public whitelist test-api nextGaussian()D
    .registers 14
...
.method public whitelist test-api nextInt(II)I
    .registers 5
    .param p1, "origin"    # I
    .param p2, "bound"    # I
...
.method public whitelist test-api nextLong(J)J
    .registers 16
    .param p1, "bound"    # J
...
.method public whitelist test-api nextLong(JJ)J
    .registers 7
    .param p1, "origin"    # J
    .param p3, "bound"    # J
...
.method final greylist-max-o nextSeed()J
    ...
    .line 192
    invoke-virtual {v0, v6, v2, v3}, Lsun/misc/Unsafe;->getLong(Ljava/lang/Object;J)J
