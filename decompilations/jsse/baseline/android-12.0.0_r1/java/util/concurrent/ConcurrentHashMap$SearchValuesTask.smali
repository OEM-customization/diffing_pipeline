...
.method public final whitelist test-api compute()V
    ...
    .line 5272
    .local p0, "this":Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;, "Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask<TK;TV;TU;>;"
    iget-object v0, p0, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->searchFunction:Ljava/util/function/Function;
    ...
    .line 5274
    iget v0, p0, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->baseIndex:I
    ...
    iget v1, p0, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->baseLimit:I
    ...
    .line 5278
    :cond_20
    invoke-virtual {p0, v2}, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->addToPendingCount(I)V

    .line 5279
    new-instance v12, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;

    iget v1, p0, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->batch:I

    ushr-int/lit8 v3, v1, 0x1

    iput v3, p0, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->batch:I

    iput v11, p0, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->baseLimit:I

    iget-object v6, p0, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->tab:[Ljava/util/concurrent/ConcurrentHashMap$Node;
    ...
    invoke-direct/range {v1 .. v8}, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;-><init>(Ljava/util/concurrent/ConcurrentHashMap$BulkTask;III[Ljava/util/concurrent/ConcurrentHashMap$Node;Ljava/util/function/Function;Ljava/util/concurrent/atomic/AtomicReference;)V

    .line 5281
    invoke-virtual {v12}, Ljava/util/concurrent/ConcurrentHashMap$SearchValuesTask;->fork()Ljava/util/concurrent/ForkJoinTask;
