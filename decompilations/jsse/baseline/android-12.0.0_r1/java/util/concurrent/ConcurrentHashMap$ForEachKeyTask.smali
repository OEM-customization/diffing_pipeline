...
.method public final whitelist test-api compute()V
    ...
    .line 4983
    .local p0, "this":Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;, "Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask<TK;TV;>;"
    iget-object v0, p0, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->action:Ljava/util/function/Consumer;
    ...
    .line 4984
    iget v0, p0, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->baseIndex:I
    ...
    iget v1, p0, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->baseLimit:I
    ...
    .line 4986
    invoke-virtual {p0, v2}, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->addToPendingCount(I)V

    .line 4987
    new-instance v10, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;

    iget v1, p0, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->batch:I

    ushr-int/lit8 v3, v1, 0x1

    iput v3, p0, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->batch:I

    iput v9, p0, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->baseLimit:I

    iget-object v6, p0, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->tab:[Ljava/util/concurrent/ConcurrentHashMap$Node;
    ...
    invoke-direct/range {v1 .. v7}, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;-><init>(Ljava/util/concurrent/ConcurrentHashMap$BulkTask;III[Ljava/util/concurrent/ConcurrentHashMap$Node;Ljava/util/function/Consumer;)V

    .line 4989
    invoke-virtual {v10}, Ljava/util/concurrent/ConcurrentHashMap$ForEachKeyTask;->fork()Ljava/util/concurrent/ForkJoinTask;
