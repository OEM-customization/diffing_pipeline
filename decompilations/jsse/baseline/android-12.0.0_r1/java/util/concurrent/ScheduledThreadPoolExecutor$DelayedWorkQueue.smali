...
.method public whitelist test-api clear()V
    ...
    .line 1195
    .local v3, "t":Ljava/util/concurrent/RunnableScheduledFuture;, "Ljava/util/concurrent/RunnableScheduledFuture<*>;"
    if-eqz v3, :cond_17
    ...
    invoke-direct {p0, v3, v2}, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->setIndex(Ljava/util/concurrent/RunnableScheduledFuture;I)V

    .line 1193
    .end local v3    # "t":Ljava/util/concurrent/RunnableScheduledFuture;, "Ljava/util/concurrent/RunnableScheduledFuture<*>;"
    :cond_17
    add-int/lit8 v1, v1, 0x1
...
.method public bridge synthetic whitelist test-api offer(Ljava/lang/Object;)Z
    .registers 2
...
.method public bridge synthetic whitelist test-api offer(Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;)Z
    .registers 5
...
.method public greylist-max-o offer(Ljava/lang/Runnable;)Z
    ...
    .line 1060
    :cond_23
    invoke-direct {p0, v2, v0}, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->siftUp(ILjava/util/concurrent/RunnableScheduledFuture;)V
...
.method public bridge synthetic whitelist test-api peek()Ljava/lang/Object;
    .registers 2
...
.method public bridge synthetic whitelist test-api poll()Ljava/lang/Object;
    .registers 2
...
.method public bridge synthetic whitelist test-api poll(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/InterruptedException;
...
.method public blacklist poll(JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/RunnableScheduledFuture;
    ...
    :try_end_14
    .catchall {:try_start_10 .. :try_end_14} :catchall_a5
    ...
    invoke-interface {v9, v0}, Ljava/util/concurrent/RunnableScheduledFuture;->getDelay(Ljava/util/concurrent/TimeUnit;)J
    ...
    .line 1163
    invoke-direct {v1, v9}, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->finishPoll(Ljava/util/concurrent/RunnableScheduledFuture;)Ljava/util/concurrent/RunnableScheduledFuture;

    move-result-object v0
    :try_end_46
    .catchall {:try_start_2f .. :try_end_46} :catchall_a5
    ...
    :try_end_82
    .catchall {:try_start_76 .. :try_end_82} :catchall_a5

    .line 1173
    :try_start_82
    iget-object v0, v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->available:Ljava/util/concurrent/locks/Condition;

    invoke-interface {v0, v13, v14}, Ljava/util/concurrent/locks/Condition;->awaitNanos(J)J

    move-result-wide v15
    :try_end_88
    .catchall {:try_start_82 .. :try_end_88} :catchall_93

    .line 1174
    .local v15, "timeLeft":J
    sub-long v17, v13, v15

    sub-long v5, v5, v17

    .line 1176
    .end local v15    # "timeLeft":J
    :try_start_8c
    iget-object v0, v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->leader:Ljava/lang/Thread;
    ...
    .line 1177
    iput-object v12, v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->leader:Ljava/lang/Thread;
    ...
    iget-object v11, v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->leader:Ljava/lang/Thread;
    ...
    move-result-wide v10
    :try_end_a2
    .catchall {:try_start_8c .. :try_end_a2} :catchall_a5
...
.method public bridge synthetic whitelist test-api put(Ljava/lang/Object;)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/InterruptedException;
...
.method public whitelist test-api remove(Ljava/lang/Object;)Z
    ...
    .line 1005
    .local v5, "replacement":Ljava/util/concurrent/RunnableScheduledFuture;, "Ljava/util/concurrent/RunnableScheduledFuture<*>;"
    const/4 v6, 0x0
    ...
    .line 1007
    invoke-direct {p0, v1, v5}, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->siftDown(ILjava/util/concurrent/RunnableScheduledFuture;)V
    ...
    .line 1009
    invoke-direct {p0, v1, v5}, Ljava/util/concurrent/ScheduledThreadPoolExecutor$DelayedWorkQueue;->siftUp(ILjava/util/concurrent/RunnableScheduledFuture;)V
    :try_end_33
    ...
    .end local v1    # "i":I
    .end local v2    # "s":I
    .end local v5    # "replacement":Ljava/util/concurrent/RunnableScheduledFuture;, "Ljava/util/concurrent/RunnableScheduledFuture<*>;"
    :catchall_38
    move-exception v1
...
.method public bridge synthetic whitelist test-api take()Ljava/lang/Object;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/InterruptedException;
