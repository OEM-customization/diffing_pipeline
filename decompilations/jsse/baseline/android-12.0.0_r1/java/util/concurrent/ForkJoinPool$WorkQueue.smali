...
.method static constructor blacklist <clinit>()V
    ...
    sput-wide v1, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->QLOCK:J
    ...
    sput v1, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->ABASE:I
    ...
    throw v1
    :try_end_39
    .catch Ljava/lang/ReflectiveOperationException; {:try_start_6 .. :try_end_39} :catch_39
...
.method final greylist-max-o growArray()[Ljava/util/concurrent/ForkJoinTask;
    ...
    .line 904
    .local v5, "offset":J
    sget-object v15, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->U:Lsun/misc/Unsafe;

    .line 905
    invoke-virtual {v15, v7, v5, v6}, Lsun/misc/Unsafe;->getObjectVolatile(Ljava/lang/Object;J)Ljava/lang/Object;
    ...
    .line 906
    .local v16, "x":Ljava/util/concurrent/ForkJoinTask;, "Ljava/util/concurrent/ForkJoinTask<*>;"
    if-eqz v16, :cond_5a
    ...
    .end local v16    # "x":Ljava/util/concurrent/ForkJoinTask;, "Ljava/util/concurrent/ForkJoinTask<*>;"
    :cond_5c
    :goto_5c
    ...
    .line 910
    invoke-virtual {v15}, Lsun/misc/Unsafe;->storeFence()V
...
.method final greylist-max-o poll()Ljava/util/concurrent/ForkJoinTask;
    ...
    .end local v1    # "b":I
    .local v9, "b":I
    iget v5, v0, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->base:I
...
.method final greylist-max-o popCC(Ljava/util/concurrent/CountedCompleter;I)Ljava/util/concurrent/CountedCompleter;
    ...
    .local v1, "r":Ljava/util/concurrent/CountedCompleter;, "Ljava/util/concurrent/CountedCompleter<*>;"
    move-object v10, v15
    ...
    iput v0, v6, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->top:I

    goto :goto_79

    .line 1261
    .end local v1    # "r":Ljava/util/concurrent/CountedCompleter;, "Ljava/util/concurrent/CountedCompleter<*>;"
    ...
    .end local v13    # "o":Ljava/util/concurrent/ForkJoinTask;, "Ljava/util/concurrent/ForkJoinTask<*>;"
    .end local v14    # "index":I
    .restart local v1    # "r":Ljava/util/concurrent/CountedCompleter;, "Ljava/util/concurrent/CountedCompleter<*>;"
    ...
    invoke-virtual {v9, v6, v10, v11, v0}, Lsun/misc/Unsafe;->putOrderedInt(Ljava/lang/Object;JI)V
    ...
    .restart local v4    # "o":Ljava/util/concurrent/ForkJoinTask;, "Ljava/util/concurrent/ForkJoinTask<*>;"
    .restart local v5    # "index":I
    iget-object v0, v1, Ljava/util/concurrent/CountedCompleter;->completer:Ljava/util/concurrent/CountedCompleter;
...
.method final greylist-max-o push(Ljava/util/concurrent/ForkJoinTask;)V
    ...
    .line 879
    invoke-virtual {v2}, Ljava/util/concurrent/ForkJoinPool;->signalWork()V
...
.method final greylist-max-o tryRemoveAndExec(Ljava/util/concurrent/ForkJoinTask;)Z
    ...
    iget v8, v0, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->top:I
    ...
    iget v7, v11, Ljava/util/concurrent/ForkJoinTask;->status:I
...
.method final greylist-max-o trySharedUnpush(Ljava/util/concurrent/ForkJoinTask;)Z
    ...
    .line 1069
    .local v11, "offset":J
    sget-object v13, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->U:Lsun/misc/Unsafe;
    ...
    check-cast v10, Ljava/util/concurrent/ForkJoinTask;

    .line 1070
    .local v10, "t":Ljava/util/concurrent/ForkJoinTask;, "Ljava/util/concurrent/ForkJoinTask<*>;"
    move-object/from16 v9, p1
    ...
    .end local v10    # "t":Ljava/util/concurrent/ForkJoinTask;, "Ljava/util/concurrent/ForkJoinTask<*>;"
    .local v1, "t":Ljava/util/concurrent/ForkJoinTask;, "Ljava/util/concurrent/ForkJoinTask<*>;"
    move-object v10, v15
    ...
    .local v0, "popped":Z
    iput v8, v6, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->top:I
    ...
    .restart local v10    # "t":Ljava/util/concurrent/ForkJoinTask;, "Ljava/util/concurrent/ForkJoinTask<*>;"
    .restart local v11    # "offset":J
    .restart local v14    # "index":I
    :cond_60
    move-object v1, v10
