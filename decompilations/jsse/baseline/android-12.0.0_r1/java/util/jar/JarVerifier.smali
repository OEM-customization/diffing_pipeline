...
.method private greylist-max-o processEntry(Lsun/security/util/ManifestEntryVerifier;)V
    ...
    iget-object v1, p0, Ljava/util/jar/JarVerifier;->baos:Ljava/io/ByteArrayOutputStream;
    ...
    .line 273
    :cond_7a
    invoke-virtual {v4, v1}, Lsun/security/util/SignatureFileVerifier;->setSignatureFile([B)V
    ...
    iput-object v3, p0, Ljava/util/jar/JarVerifier;->signerCache:Ljava/util/ArrayList;
    ...
    .line 288
    iget-object v3, p0, Ljava/util/jar/JarVerifier;->manifestRawBytes:[B

    monitor-enter v3
    :try_end_a2
    .catch Ljava/io/IOException; {:try_start_23 .. :try_end_a2} :catch_13c
    .catch Ljava/security/SignatureException; {:try_start_23 .. :try_end_a2} :catch_122
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_23 .. :try_end_a2} :catch_108
    .catch Ljava/security/cert/CertificateException; {:try_start_23 .. :try_end_a2} :catch_ee
    ...
    .line 290
    new-instance v4, Lsun/security/util/ManifestDigester;

    iget-object v5, p0, Ljava/util/jar/JarVerifier;->manifestRawBytes:[B

    invoke-direct {v4, v5}, Lsun/security/util/ManifestDigester;-><init>([B)V

    iput-object v4, p0, Ljava/util/jar/JarVerifier;->manDig:Lsun/security/util/ManifestDigester;

    .line 291
    const/4 v4, 0x0

    iput-object v4, p0, Ljava/util/jar/JarVerifier;->manifestRawBytes:[B
    ...
    monitor-exit v3
    :try_end_b6
    .catchall {:try_start_a2 .. :try_end_b6} :catchall_b4
    ...
    :cond_b7
    :goto_b7
    new-instance v3, Lsun/security/util/SignatureFileVerifier;

    iget-object v4, p0, Ljava/util/jar/JarVerifier;->signerCache:Ljava/util/ArrayList;

    iget-object v5, p0, Ljava/util/jar/JarVerifier;->manDig:Lsun/security/util/ManifestDigester;

    iget-object v6, p0, Ljava/util/jar/JarVerifier;->baos:Ljava/io/ByteArrayOutputStream;
    ...
    invoke-direct {v3, v4, v5, v2, v6}, Lsun/security/util/SignatureFileVerifier;-><init>(Ljava/util/ArrayList;Lsun/security/util/ManifestDigester;Ljava/lang/String;[B)V

    .line 300
    .local v3, "sfv":Lsun/security/util/SignatureFileVerifier;
    invoke-virtual {v3}, Lsun/security/util/SignatureFileVerifier;->needSignatureFileBytes()Z
    ...
    .line 302
    iget-object v4, p0, Ljava/util/jar/JarVerifier;->sigFileData:Ljava/util/Hashtable;
    ...
    .line 311
    :cond_dd
    iget-object v1, p0, Ljava/util/jar/JarVerifier;->pendingBlocks:Ljava/util/ArrayList;
    ...
    .line 314
    :cond_e3
    invoke-virtual {v3, v4}, Lsun/security/util/SignatureFileVerifier;->setSignatureFile([B)V
    ...
    invoke-virtual {v3, v1, v4}, Lsun/security/util/SignatureFileVerifier;->process(Ljava/util/Hashtable;Ljava/util/List;)V
    :try_end_ed
    .catch Ljava/io/IOException; {:try_start_b6 .. :try_end_ed} :catch_13c
    .catch Ljava/security/SignatureException; {:try_start_b6 .. :try_end_ed} :catch_122
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_b6 .. :try_end_ed} :catch_108
    .catch Ljava/security/cert/CertificateException; {:try_start_b6 .. :try_end_ed} :catch_ee

    .end local v0    # "key":Ljava/lang/String;
    .end local v2    # "uname":Ljava/lang/String;
    .end local v3    # "sfv":Lsun/security/util/SignatureFileVerifier;
    goto :goto_155
