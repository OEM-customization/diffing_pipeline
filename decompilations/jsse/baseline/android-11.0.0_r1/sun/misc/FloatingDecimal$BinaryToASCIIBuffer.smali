...
.method private blacklist dtoa(IJIZ)V
    ...
    sget-object v1, Lsun/misc/FloatingDecimal$BinaryToASCIIBuffer;->N_5_BITS:[I
    ...
    if-ge v7, v11, :cond_21b

    if-ge v9, v11, :cond_21b
    ...
    .line 600
    .local v20, "s":I
    sget-object v24, Lsun/misc/FDBigInteger;->SMALL_5_POW:[I
    ...
    if-lt v10, v4, :cond_10a

    const/16 v4, 0x8

    if-lt v10, v4, :cond_105
    ...
    .end local v5    # "high":Z
    .end local v6    # "nFractBits":I
    .restart local v27    # "nFractBits":I
    .restart local p2    # "high":Z
    ...
    .end local v24    # "low":Z
    .end local v25    # "q":I
    .end local v26    # "tailZeros":I
    .end local v27    # "nFractBits":I
    .end local p2    # "high":Z
    .local v5, "tailZeros":I
    .restart local v6    # "nFractBits":I
    :cond_16d
    move/from16 v26, v5
    ...
    if-lt v10, v4, :cond_1c2

    const/16 v4, 0x8

    if-lt v10, v4, :cond_1c7
    ...
    if-lt v10, v4, :cond_291

    const/16 v4, 0x8

    if-lt v10, v4, :cond_28a
    ...
    .end local v1    # "lowDigitDifference":J
    .local v29, "lowDigitDifference":J
    sget-object v1, Lsun/misc/FDBigInteger;->ZERO:Lsun/misc/FDBigInteger;

    invoke-virtual {v5, v1}, Lsun/misc/FDBigInteger;->cmp(Lsun/misc/FDBigInteger;)I
    ...
    .end local v3    # "ndigit":I
    .end local v7    # "q":I
    .end local v19    # "high":Z
    .end local v28    # "shiftBias":I
    .end local p2    # "Sval":Lsun/misc/FDBigInteger;
    .end local p3    # "tenSval":Lsun/misc/FDBigInteger;
    .local v1, "ndigit":I
    .local v5, "high":Z
    ...
    iput v2, v0, Lsun/misc/FloatingDecimal$BinaryToASCIIBuffer;->decExponent:I

    .line 761
    const/4 v2, 0x0

    iput v2, v0, Lsun/misc/FloatingDecimal$BinaryToASCIIBuffer;->firstDigitIndex:I

    .line 762
    iput v1, v0, Lsun/misc/FloatingDecimal$BinaryToASCIIBuffer;->nDigits:I
    ...
    .line 771
    iget-object v2, v0, Lsun/misc/FloatingDecimal$BinaryToASCIIBuffer;->digits:[C
