...
.method public static declared-synchronized greylist registerDirectory(Ljava/io/File;)V
    ...
    move-result v2
    :try_end_e
    .catchall {:try_start_3 .. :try_end_e} :catchall_a8
    ...
    new-instance v11, Lsun/misc/MetaIndex;

    invoke-direct {v11, v6, v5}, Lsun/misc/MetaIndex;-><init>(Ljava/util/List;Z)V
    ...
    invoke-virtual {v2}, Ljava/io/BufferedReader;->close()V
    :try_end_a3
    .catch Ljava/io/IOException; {:try_start_10 .. :try_end_a3} :catch_a5
    .catchall {:try_start_10 .. :try_end_a3} :catchall_a8
