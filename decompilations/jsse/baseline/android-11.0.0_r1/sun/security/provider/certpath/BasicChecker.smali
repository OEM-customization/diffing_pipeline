...
.method private blacklist verifyNameChaining(Ljava/security/cert/X509Certificate;)V
    ...
    .line 222
    .local v2, "currIssuer":Ljavax/security/auth/x500/X500Principal;
    ...
    .line 229
    iget-object v3, v0, Lsun/security/provider/certpath/BasicChecker;->prevSubject:Ljavax/security/auth/x500/X500Principal;
    ...
    .line 235
    sget-object v3, Lsun/security/provider/certpath/BasicChecker;->debug:Lsun/security/util/Debug;
    ...
    .end local v2    # "currIssuer":Ljavax/security/auth/x500/X500Principal;
    :cond_8e
    :goto_8e
    return-void
.end method
...
.method private blacklist verifySignature(Ljava/security/cert/X509Certificate;)V
    ...
    :cond_21
    :try_start_21
    iget-object v2, p0, Lsun/security/provider/certpath/BasicChecker;->sigProvider:Ljava/lang/String;
    ...
    invoke-virtual {p1, v2, v3}, Ljava/security/cert/X509Certificate;->verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    :try_end_32
    .catch Ljava/security/SignatureException; {:try_start_21 .. :try_end_32} :catch_62
    .catch Ljava/security/GeneralSecurityException; {:try_start_21 .. :try_end_32} :catch_4c
...
.method private blacklist verifyTimestamp(Ljava/security/cert/X509Certificate;)V
    ...
    :cond_2f
    :try_start_2f
    iget-object v2, p0, Lsun/security/provider/certpath/BasicChecker;->date:Ljava/util/Date;

    invoke-virtual {p1, v2}, Ljava/security/cert/X509Certificate;->checkValidity(Ljava/util/Date;)V
    :try_end_34
    .catch Ljava/security/cert/CertificateExpiredException; {:try_start_2f .. :try_end_34} :catch_6a
    .catch Ljava/security/cert/CertificateNotYetValidException; {:try_start_2f .. :try_end_34} :catch_4e
