...
.method public constructor blacklist <init>(Ljava/nio/channels/spi/SelectorProvider;)V
    ...
    invoke-static {v0, v1}, Lsun/nio/ch/Net;->socket(Ljava/net/ProtocolFamily;Z)Ljava/io/FileDescriptor;
    ...
    :try_end_5a
    .catch Ljava/io/IOException; {:try_start_2b .. :try_end_5a} :catch_5c
...
.method public constructor blacklist <init>(Ljava/nio/channels/spi/SelectorProvider;Ljava/net/ProtocolFamily;)V
    ...
    invoke-static {p2, v0}, Lsun/nio/ch/Net;->socket(Ljava/net/ProtocolFamily;Z)Ljava/io/FileDescriptor;
...
.method private blacklist innerJoin(Ljava/net/InetAddress;Ljava/net/NetworkInterface;Ljava/net/InetAddress;)Ljava/nio/channels/MembershipKey;
    ...
    iget-object v0, v9, Lsun/nio/ch/DatagramChannelImpl;->registry:Lsun/nio/ch/MembershipRegistry;
    :try_end_82
    .catchall {:try_start_6c .. :try_end_82} :catchall_146
    ...
    monitor-exit v13
    :try_end_14a
    .catchall {:try_start_84 .. :try_end_14a} :catchall_14b
...
# virtual methods
.method public whitelist core-platform-api test-api bind(Ljava/net/SocketAddress;)Ljava/nio/channels/DatagramChannel;
    .registers 11
...
.method public whitelist core-platform-api test-api connect(Ljava/net/SocketAddress;)Ljava/nio/channels/DatagramChannel;
    .registers 14
...
.method public whitelist core-platform-api test-api disconnect()Ljava/nio/channels/DatagramChannel;
    .registers 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public whitelist core-platform-api test-api getOption(Ljava/net/SocketOption;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Lsun/nio/ch/Net;->getInterface4(Ljava/io/FileDescriptor;)I
    ...
    .line 301
    :cond_34
    invoke-static {v2}, Lsun/nio/ch/Net;->inet4FromInt(I)Ljava/net/InetAddress;
    ...
    invoke-static {v2}, Lsun/nio/ch/Net;->getInterface6(Ljava/io/FileDescriptor;)I
    ...
    iget-boolean v0, p0, Lsun/nio/ch/DatagramChannelImpl;->reuseAddressEmulated:Z

    if-eqz v0, :cond_72

    .line 321
    iget-boolean v0, p0, Lsun/nio/ch/DatagramChannelImpl;->isReuseAddress:Z
    ...
    monitor-exit v1
    :try_end_88
    .catchall {:try_start_10 .. :try_end_88} :catchall_86
...
.method public whitelist core-platform-api test-api join(Ljava/net/InetAddress;Ljava/net/NetworkInterface;)Ljava/nio/channels/MembershipKey;
    .registers 4
    .param p1, "group"    # Ljava/net/InetAddress;
    .param p2, "interf"    # Ljava/net/NetworkInterface;
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist core-platform-api test-api join(Ljava/net/InetAddress;Ljava/net/NetworkInterface;Ljava/net/InetAddress;)Ljava/nio/channels/MembershipKey;
    .registers 6
    .param p1, "group"    # Ljava/net/InetAddress;
    .param p2, "interf"    # Ljava/net/NetworkInterface;
    .param p3, "source"    # Ljava/net/InetAddress;
...
.method public whitelist core-platform-api test-api receive(Ljava/nio/ByteBuffer;)Ljava/net/SocketAddress;
    .registers 16
    ...
    monitor-exit v1
    :try_end_16
    .catchall {:try_start_c .. :try_end_16} :catchall_e4
    ...
    :goto_be
    :try_start_be
    iget-object v0, p0, Lsun/nio/ch/DatagramChannelImpl;->sender:Ljava/net/SocketAddress;
    :try_end_c0
...
.method public whitelist core-platform-api test-api send(Ljava/nio/ByteBuffer;Ljava/net/SocketAddress;)I
    .registers 14
...
.method public whitelist core-platform-api test-api setOption(Ljava/net/SocketOption;Ljava/lang/Object;)Ljava/nio/channels/DatagramChannel;
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public whitelist core-platform-api test-api socket()Ljava/net/DatagramSocket;
    .registers 3
