...
.method blacklist processRequests()Z
    ...
    .line 279
    iput-boolean v5, p0, Lsun/nio/fs/AbstractPoller;->shutdown:Z
    ...
    .line 258
    .local v5, "events":Ljava/util/Set;, "Ljava/util/Set<+Ljava/nio/file/WatchEvent$Kind<*>;>;"
    aget-object v4, v1, v4

    check-cast v4, [Ljava/nio/file/WatchEvent$Modifier;

    .line 260
    .local v4, "modifiers":[Ljava/nio/file/WatchEvent$Modifier;
    invoke-virtual {p0, v3, v5, v4}, Lsun/nio/fs/AbstractPoller;->implRegister(Ljava/nio/file/Path;Ljava/util/Set;[Ljava/nio/file/WatchEvent$Modifier;)Ljava/lang/Object;
    ...
    .end local v4    # "modifiers":[Ljava/nio/file/WatchEvent$Modifier;
    .end local v5    # "events":Ljava/util/Set;, "Ljava/util/Set<+Ljava/nio/file/WatchEvent$Kind<*>;>;"
    :cond_6c
    monitor-exit v0
    :try_end_6d
    .catchall {:try_start_3 .. :try_end_6d} :catchall_70
