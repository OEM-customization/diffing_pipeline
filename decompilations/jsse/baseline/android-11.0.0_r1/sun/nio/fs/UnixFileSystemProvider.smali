...
.method public varargs whitelist core-platform-api test-api checkAccess(Ljava/nio/file/Path;[Ljava/nio/file/AccessMode;)V
    .registers 13
    ...
    :try_end_61
    .catch Lsun/nio/fs/UnixException; {:try_start_5e .. :try_end_61} :catch_62
...
.method public varargs whitelist core-platform-api test-api copy(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)V
    .registers 6
...
.method public varargs whitelist core-platform-api test-api createDirectory(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)V
    .registers 8
    .param p1, "obj"    # Ljava/nio/file/Path;
...
.method public whitelist core-platform-api test-api getFileStore(Ljava/nio/file/Path;)Ljava/nio/file/FileStore;
    .registers 4
    .param p1, "obj"    # Ljava/nio/file/Path;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final whitelist core-platform-api test-api getFileSystem(Ljava/net/URI;)Ljava/nio/file/FileSystem;
    .registers 3
    .param p1, "uri"    # Ljava/net/URI;
...
.method public whitelist core-platform-api test-api getPath(Ljava/net/URI;)Ljava/nio/file/Path;
    .registers 3
    .param p1, "uri"    # Ljava/net/URI;
...
.method public final whitelist core-platform-api test-api getScheme()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api isHidden(Ljava/nio/file/Path;)Z
    .registers 7
    .param p1, "obj"    # Ljava/nio/file/Path;
...
.method public whitelist core-platform-api test-api isSameFile(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
    .registers 8
    .param p1, "obj1"    # Ljava/nio/file/Path;
    .param p2, "obj2"    # Ljava/nio/file/Path;
    .annotation system Ldalvik/annotation/Throws;
...
.method public varargs whitelist core-platform-api test-api move(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)V
    .registers 6
    .param p1, "source"    # Ljava/nio/file/Path;
    .param p2, "target"    # Ljava/nio/file/Path;
    .param p3, "options"    # [Ljava/nio/file/CopyOption;
...
.method public varargs whitelist core-platform-api test-api newByteChannel(Ljava/nio/file/Path;Ljava/util/Set;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/SeekableByteChannel;
    .registers 8
    .param p1, "obj"    # Ljava/nio/file/Path;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public whitelist core-platform-api test-api newDirectoryStream(Ljava/nio/file/Path;Ljava/nio/file/DirectoryStream$Filter;)Ljava/nio/file/DirectoryStream;
    .registers 15
    .param p1, "obj"    # Ljava/nio/file/Path;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public final whitelist core-platform-api test-api newFileSystem(Ljava/net/URI;Ljava/util/Map;)Ljava/nio/file/FileSystem;
    .registers 4
    .param p1, "uri"    # Ljava/net/URI;
    .annotation system Ldalvik/annotation/Signature;
        value = {
