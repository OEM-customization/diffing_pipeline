...
.method protected constructor whitelist core-platform-api test-api <init>(Ljavax/crypto/MacSpi;Ljava/security/Provider;Ljava/lang/String;)V
    .registers 5
...
.method private greylist-max-o chooseProvider(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    move-result v4
    :try_end_3c
    .catchall {:try_start_3 .. :try_end_3c} :catchall_94
    ...
    :try_end_51
    .catch Ljava/lang/Exception; {:try_start_40 .. :try_end_51} :catch_53
    .catchall {:try_start_40 .. :try_end_51} :catchall_94
    ...
    monitor-exit v0
    :try_end_96
    .catchall {:try_start_51 .. :try_end_96} :catchall_94

    throw v1
.end method

.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;)Ljavax/crypto/Mac;
    .registers 6
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/Mac;
    .registers 6
    .param p0, "algorithm"    # Ljava/lang/String;
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/security/Provider;)Ljavax/crypto/Mac;
    .registers 6
    .param p0, "algorithm"    # Ljava/lang/String;
...
.method public final whitelist core-platform-api test-api clone()Ljava/lang/Object;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final whitelist core-platform-api test-api doFinal([BI)V
    .registers 6
    .param p1, "output"    # [B
...
.method public greylist-max-o core-platform-api getCurrentSpi()Ljavax/crypto/MacSpi;
    .registers 2
...
.method public final whitelist core-platform-api test-api getMacLength()I
    .registers 2
...
.method public final whitelist core-platform-api test-api init(Ljava/security/Key;)V
    ...
    :try_end_14
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_0 .. :try_end_14} :catch_19
...
.method public final whitelist core-platform-api test-api reset()V
    .registers 2
