...
.method protected constructor whitelist core-platform-api test-api <init>(Ljavax/crypto/KeyGeneratorSpi;Ljava/security/Provider;Ljava/lang/String;)V
    .registers 5
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;)Ljavax/crypto/KeyGenerator;
    .registers 2
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/KeyGenerator;
    .registers 6
    .param p0, "algorithm"    # Ljava/lang/String;
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/security/Provider;)Ljavax/crypto/KeyGenerator;
    .registers 6
    .param p0, "algorithm"    # Ljava/lang/String;
...
.method private greylist-max-o nextSpi(Ljavax/crypto/KeyGeneratorSpi;Z)Ljavax/crypto/KeyGeneratorSpi;
    ...
    move-result v3
    :try_end_2c
    .catchall {:try_start_5 .. :try_end_2c} :catchall_92
    ...
    :try_end_89
    .catch Ljava/lang/Exception; {:try_start_2f .. :try_end_89} :catch_8b
    .catchall {:try_start_2f .. :try_end_89} :catchall_92
...
.method public final whitelist core-platform-api test-api generateKey()Ljavax/crypto/SecretKey;
    .registers 5
...
.method public final whitelist core-platform-api test-api init(Ljava/security/SecureRandom;)V
    .registers 6
