...
.field public static final whitelist core-platform-api test-api DECRYPT_MODE:I = 0x2

.field public static final whitelist core-platform-api test-api ENCRYPT_MODE:I = 0x1

.field private static final greylist-max-o KEY_USAGE_EXTENSION_OID:Ljava/lang/String; = "2.5.29.15"

.field public static final whitelist core-platform-api test-api PRIVATE_KEY:I = 0x2

.field public static final whitelist core-platform-api test-api PUBLIC_KEY:I = 0x1

.field public static final whitelist core-platform-api test-api SECRET_KEY:I = 0x3

.field public static final whitelist core-platform-api test-api UNWRAP_MODE:I = 0x4

.field public static final whitelist core-platform-api test-api WRAP_MODE:I = 0x3
...
# direct methods
.method protected constructor whitelist core-platform-api test-api <init>(Ljavax/crypto/CipherSpi;Ljava/security/Provider;Ljava/lang/String;)V
    .registers 6
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;)Ljavax/crypto/Cipher;
    .registers 2
    .param p0, "transformation"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/Cipher;
    .registers 6
    .param p0, "transformation"    # Ljava/lang/String;
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/security/Provider;)Ljavax/crypto/Cipher;
    .registers 4
    .param p0, "transformation"    # Ljava/lang/String;
    .param p1, "provider"    # Ljava/security/Provider;
    .annotation system Ldalvik/annotation/Throws;
...
.method public static final whitelist core-platform-api test-api getMaxAllowedKeyLength(Ljava/lang/String;)I
    .registers 3
    .param p0, "transformation"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static final whitelist core-platform-api test-api getMaxAllowedParameterSpec(Ljava/lang/String;)Ljava/security/spec/AlgorithmParameterSpec;
    .registers 3
    .param p0, "transformation"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method static greylist-max-o tryTransformWithProvider(Ljavax/crypto/Cipher$InitParams;[Ljava/lang/String;Ljavax/crypto/Cipher$NeedToSet;Ljava/security/Provider$Service;)Ljavax/crypto/Cipher$CipherSpiAndProvider;
    ...
    invoke-virtual {v4, v5}, Ljavax/crypto/CipherSpi;->engineSetMode(Ljava/lang/String;)V

    .line 2968
    :cond_44
    sget-object v5, Ljavax/crypto/Cipher$NeedToSet;->PADDING:Ljavax/crypto/Cipher$NeedToSet;
    ...
    invoke-virtual {v4, v5}, Ljavax/crypto/CipherSpi;->engineSetPadding(Ljava/lang/String;)V
    ...
    .line 2974
    sget-object v5, Ljavax/crypto/Cipher$1;->$SwitchMap$javax$crypto$Cipher$InitType:[I

    iget-object v6, p0, Ljavax/crypto/Cipher$InitParams;->initType:Ljavax/crypto/Cipher$InitType;

    invoke-virtual {v6}, Ljavax/crypto/Cipher$InitType;->ordinal()I
    ...
    :try_end_98
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_1 .. :try_end_98} :catch_9d
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_1 .. :try_end_98} :catch_9b
...
# virtual methods
.method public final whitelist core-platform-api test-api doFinal(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)I
    .registers 5
...
.method public final whitelist core-platform-api test-api doFinal([BI)I
    .registers 9
    .param p1, "output"    # [B
...
.method public final whitelist core-platform-api test-api doFinal([BII[B)I
    .registers 12
    .param p1, "input"    # [B
...
.method public final whitelist core-platform-api test-api doFinal([BII[BI)I
    .registers 13
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method public final whitelist core-platform-api test-api doFinal()[B
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljavax/crypto/IllegalBlockSizeException;,
...
.method public final whitelist core-platform-api test-api doFinal([B)[B
    .registers 5
    .param p1, "input"    # [B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final whitelist core-platform-api test-api doFinal([BII)[B
    .registers 6
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method public final whitelist core-platform-api test-api getBlockSize()I
    .registers 2
...
.method public greylist-max-o core-platform-api getCurrentSpi()Ljavax/crypto/CipherSpi;
    .registers 2
...
.method public final whitelist core-platform-api test-api getExemptionMechanism()Ljavax/crypto/ExemptionMechanism;
    .registers 2
...
.method public final whitelist core-platform-api test-api getIV()[B
    .registers 2
...
.method public final whitelist core-platform-api test-api init(ILjava/security/Key;)V
    .registers 4
    .param p1, "opmode"    # I
...
.method public final whitelist core-platform-api test-api init(ILjava/security/Key;Ljava/security/AlgorithmParameters;)V
    .registers 5
    .param p1, "opmode"    # I
    .param p2, "key"    # Ljava/security/Key;
...
.method public final whitelist core-platform-api test-api init(ILjava/security/Key;Ljava/security/AlgorithmParameters;Ljava/security/SecureRandom;)V
    .registers 13
    .param p1, "opmode"    # I
    .param p2, "key"    # Ljava/security/Key;
    .param p3, "params"    # Ljava/security/AlgorithmParameters;
...
.method public final whitelist core-platform-api test-api init(ILjava/security/Key;Ljava/security/SecureRandom;)V
    .registers 12
    .param p1, "opmode"    # I
    .param p2, "key"    # Ljava/security/Key;
...
.method public final whitelist core-platform-api test-api init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    .registers 5
    .param p1, "opmode"    # I
    .param p2, "key"    # Ljava/security/Key;
...
.method public final whitelist core-platform-api test-api init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    .registers 13
    .param p1, "opmode"    # I
    .param p2, "key"    # Ljava/security/Key;
    .param p3, "params"    # Ljava/security/spec/AlgorithmParameterSpec;
...
.method public final whitelist core-platform-api test-api init(ILjava/security/cert/Certificate;)V
    .registers 4
    .param p1, "opmode"    # I
...
.method public final whitelist core-platform-api test-api init(ILjava/security/cert/Certificate;Ljava/security/SecureRandom;)V
    .registers 13
    .param p1, "opmode"    # I
    .param p2, "certificate"    # Ljava/security/cert/Certificate;
    .param p3, "random"    # Ljava/security/SecureRandom;
...
.method public final whitelist core-platform-api test-api unwrap([BLjava/lang/String;I)Ljava/security/Key;
    .registers 6
...
.method public final whitelist core-platform-api test-api update(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)I
    .registers 5
    .param p1, "input"    # Ljava/nio/ByteBuffer;
    .param p2, "output"    # Ljava/nio/ByteBuffer;
    .annotation system Ldalvik/annotation/Throws;
...
.method public final whitelist core-platform-api test-api update([BII[B)I
    .registers 12
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method public final whitelist core-platform-api test-api update([BII[BI)I
    .registers 13
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method public final whitelist core-platform-api test-api update([B)[B
    .registers 5
    .param p1, "input"    # [B
...
.method public final whitelist core-platform-api test-api update([BII)[B
    .registers 6
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method public final whitelist core-platform-api test-api updateAAD(Ljava/nio/ByteBuffer;)V
    .registers 4
...
.method public final whitelist core-platform-api test-api updateAAD([B)V
    .registers 4
    .param p1, "src"    # [B
...
.method public final whitelist core-platform-api test-api updateAAD([BII)V
    .registers 6
    .param p1, "src"    # [B
    .param p2, "offset"    # I
    .param p3, "len"    # I
...
.method public final whitelist core-platform-api test-api wrap(Ljava/security/Key;)[B
    .registers 4
