...
# static fields
.field public static final whitelist core-platform-api test-api DIRECTION_DEFAULT_LEFT_TO_RIGHT:I = -0x2

.field public static final whitelist core-platform-api test-api DIRECTION_DEFAULT_RIGHT_TO_LEFT:I = -0x1

.field public static final whitelist core-platform-api test-api DIRECTION_LEFT_TO_RIGHT:I = 0x0

.field public static final whitelist core-platform-api test-api DIRECTION_RIGHT_TO_LEFT:I = 0x1
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/text/AttributedCharacterIterator;)V
    .registers 4
...
.method public constructor whitelist core-platform-api test-api <init>([CI[BIII)V
    .registers 20
    .param p1, "text"    # [C
...
.method public static whitelist core-platform-api test-api reorderVisually([BI[Ljava/lang/Object;II)V
    .registers 9
    .param p0, "levels"    # [B
...
.method public static whitelist core-platform-api test-api requiresBidi([CII)Z
    .registers 6
    .param p0, "text"    # [C
    .param p1, "start"    # I
    .param p2, "limit"    # I
...
# virtual methods
.method public whitelist core-platform-api test-api baseIsLeftToRight()Z
    .registers 2
...
.method public whitelist core-platform-api test-api createLineBidi(II)Ljava/text/Bidi;
    .registers 12
...
.method public whitelist core-platform-api test-api getBaseLevel()I
    .registers 2
...
.method public whitelist core-platform-api test-api getLength()I
    .registers 2
...
.method public whitelist core-platform-api test-api getLevelAt(I)I
    .registers 4
    .param p1, "offset"    # I
...
.method public whitelist core-platform-api test-api getRunCount()I
    .registers 3
...
.method public whitelist core-platform-api test-api getRunLevel(I)I
    .registers 3
    .param p1, "run"    # I
...
.method public whitelist core-platform-api test-api getRunLimit(I)I
    .registers 3
    .param p1, "run"    # I
...
.method public whitelist core-platform-api test-api getRunStart(I)I
    .registers 3
    .param p1, "run"    # I
...
.method public whitelist core-platform-api test-api isLeftToRight()Z
    .registers 2
...
.method public whitelist core-platform-api test-api isMixed()Z
    .registers 2
...
.method public whitelist core-platform-api test-api isRightToLeft()Z
    .registers 2
