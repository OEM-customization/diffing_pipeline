...
# static fields
.field public static final whitelist core-platform-api test-api DONE:I = -0x1
...
.method public static whitelist core-platform-api test-api getCharacterInstance()Ljava/text/BreakIterator;
    .registers 1
...
.method public static whitelist core-platform-api test-api getCharacterInstance(Ljava/util/Locale;)Ljava/text/BreakIterator;
    .registers 3
...
.method public static whitelist core-platform-api test-api getLineInstance()Ljava/text/BreakIterator;
    .registers 1
...
.method public static whitelist core-platform-api test-api getLineInstance(Ljava/util/Locale;)Ljava/text/BreakIterator;
    .registers 3
    .param p0, "locale"    # Ljava/util/Locale;
...
.method public static whitelist core-platform-api test-api getSentenceInstance()Ljava/text/BreakIterator;
    .registers 1
...
.method public static whitelist core-platform-api test-api getSentenceInstance(Ljava/util/Locale;)Ljava/text/BreakIterator;
    .registers 3
    .param p0, "locale"    # Ljava/util/Locale;
...
.method public static whitelist core-platform-api test-api getWordInstance()Ljava/text/BreakIterator;
    .registers 1
...
.method public static whitelist core-platform-api test-api getWordInstance(Ljava/util/Locale;)Ljava/text/BreakIterator;
    .registers 3
    .param p0, "locale"    # Ljava/util/Locale;
...
.method public abstract whitelist core-platform-api test-api current()I
.end method

.method public abstract whitelist core-platform-api test-api first()I
.end method

.method public abstract whitelist core-platform-api test-api following(I)I
.end method

.method public abstract whitelist core-platform-api test-api getText()Ljava/text/CharacterIterator;
.end method

.method public whitelist core-platform-api test-api isBoundary(I)Z
    .registers 5
    .param p1, "offset"    # I
...
.method public abstract whitelist core-platform-api test-api last()I
.end method

.method public abstract whitelist core-platform-api test-api next()I
.end method

.method public abstract whitelist core-platform-api test-api next(I)I
.end method

.method public whitelist core-platform-api test-api preceding(I)I
    .registers 4
    .param p1, "offset"    # I
...
.method public abstract whitelist core-platform-api test-api previous()I
.end method
...
.method public abstract whitelist core-platform-api test-api setText(Ljava/text/CharacterIterator;)V
.end method
