...
.method private static greylist-max-o getExtensionObject(Ljava/security/cert/X509Certificate;I)Ljava/security/cert/Extension;
    ...
    invoke-direct {v6, v0}, Lsun/security/util/DerInputStream;-><init>([B)V
    ...
    sget-object v2, Ljava/security/cert/X509CertSelector;->FALSE:Ljava/lang/Boolean;

    invoke-direct {v1, v2, v7}, Lsun/security/x509/ExtendedKeyUsageExtension;-><init>(Ljava/lang/Boolean;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v2, v7}, Lsun/security/x509/CertificatePoliciesExtension;-><init>(Ljava/lang/Boolean;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v2, v7}, Lsun/security/x509/NameConstraintsExtension;-><init>(Ljava/lang/Boolean;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v2, v7}, Lsun/security/x509/SubjectAlternativeNameExtension;-><init>(Ljava/lang/Boolean;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v2, v7}, Lsun/security/x509/PrivateKeyUsageExtension;-><init>(Ljava/lang/Boolean;Ljava/lang/Object;)V
    :try_end_76
    .catch Ljava/security/cert/CertificateException; {:try_start_6f .. :try_end_76} :catch_77
...
.method static greylist-max-o makeGeneralNameInterface(ILjava/lang/Object;)Lsun/security/x509/GeneralNameInterface;
    ...
    invoke-direct {v0, v2}, Lsun/security/x509/OIDName;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v2}, Lsun/security/x509/IPAddressName;-><init>(Ljava/lang/String;)V
    ...
    .line 934
    invoke-virtual {v2, v1}, Lsun/security/util/Debug;->println(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0}, Lsun/security/x509/OIDName;-><init>(Lsun/security/util/DerValue;)V

    .line 971
    .local v2, "result":Lsun/security/x509/GeneralNameInterface;
    goto :goto_11d

    .line 967
    .end local v2    # "result":Lsun/security/x509/GeneralNameInterface;
    :pswitch_ed
    new-instance v2, Lsun/security/x509/IPAddressName;

    invoke-direct {v2, v0}, Lsun/security/x509/IPAddressName;-><init>(Lsun/security/util/DerValue;)V

    .line 968
    .restart local v2    # "result":Lsun/security/x509/GeneralNameInterface;
    goto :goto_11d

    .line 964
    .end local v2    # "result":Lsun/security/x509/GeneralNameInterface;
    :pswitch_f3
    new-instance v2, Lsun/security/x509/URIName;

    invoke-direct {v2, v0}, Lsun/security/x509/URIName;-><init>(Lsun/security/util/DerValue;)V
    ...
    .end local v2    # "result":Lsun/security/x509/GeneralNameInterface;
    :pswitch_f9
    new-instance v2, Lsun/security/x509/EDIPartyName;

    invoke-direct {v2, v0}, Lsun/security/x509/EDIPartyName;-><init>(Lsun/security/util/DerValue;)V
    ...
    invoke-direct {v2, v0}, Lsun/security/x509/X500Name;-><init>(Lsun/security/util/DerValue;)V
    ...
    invoke-direct {v2, v0}, Lsun/security/x509/X400Address;-><init>(Lsun/security/util/DerValue;)V
    ...
    .end local v2    # "result":Lsun/security/x509/GeneralNameInterface;
    :pswitch_10b
    new-instance v2, Lsun/security/x509/DNSName;

    invoke-direct {v2, v0}, Lsun/security/x509/DNSName;-><init>(Lsun/security/util/DerValue;)V
    ...
    .end local v2    # "result":Lsun/security/x509/GeneralNameInterface;
    :pswitch_111
    new-instance v2, Lsun/security/x509/RFC822Name;

    invoke-direct {v2, v0}, Lsun/security/x509/RFC822Name;-><init>(Lsun/security/util/DerValue;)V
    ...
    invoke-direct {v2, v0}, Lsun/security/x509/OtherName;-><init>(Lsun/security/util/DerValue;)V
    ...
    .line 977
    invoke-virtual {v3, v1}, Lsun/security/util/Debug;->println(Ljava/lang/String;)V
...
.method private greylist-max-o matchAuthorityKeyID(Ljava/security/cert/X509Certificate;)Z
    ...
    :try_end_3c
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_3c} :catch_3d
...
.method private greylist-max-o matchExtendedKeyUsage(Ljava/security/cert/X509Certificate;)Z
    ...
    :try_end_37
    .catch Ljava/io/IOException; {:try_start_e .. :try_end_37} :catch_3a
...
.method private greylist-max-o matchNameConstraints(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-virtual {v0, v1}, Lsun/security/util/Debug;->println(Ljava/lang/String;)V
    :try_end_18
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_18} :catch_1b
...
.method private greylist-max-o matchPathToNames(Ljava/security/cert/X509Certificate;)Z
    ...
    const-string v3, "certpath"

    invoke-static {v3}, Lsun/security/util/Debug;->isOn(Ljava/lang/String;)Z
    ...
    move-result v5
    :try_end_6b
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_6b} :catch_70
...
.method private greylist-max-o matchPolicy(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-virtual {v6}, Lsun/security/x509/CertificatePolicySet;->getCertPolicyIds()Ljava/util/List;
    ...
    move-result v6
    :try_end_53
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_53} :catch_94
    ...
    invoke-virtual {v1, v7}, Lsun/security/util/Debug;->println(Ljava/lang/String;)V
    :try_end_91
    .catch Ljava/io/IOException; {:try_start_57 .. :try_end_91} :catch_94
...
.method private greylist-max-o matchSubjectAlternativeNames(Ljava/security/cert/X509Certificate;)Z
    ...
    iget-boolean v7, p0, Ljava/security/cert/X509CertSelector;->matchAllSubjectAltNames:Z
    :try_end_88
    .catch Ljava/io/IOException; {:try_start_f .. :try_end_88} :catch_8e
...
.method private greylist-max-o matchSubjectPublicKeyAlgID(Ljava/security/cert/X509Certificate;)Z
    ...
    throw v1
    :try_end_6e
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_6e} :catch_6e
...
# virtual methods
.method public whitelist core-platform-api test-api addPathToName(ILjava/lang/String;)V
    .registers 3
    .param p1, "type"    # I
...
.method public whitelist core-platform-api test-api addPathToName(I[B)V
    .registers 4
    .param p1, "type"    # I
    .param p2, "name"    # [B
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist core-platform-api test-api addSubjectAlternativeName(ILjava/lang/String;)V
    .registers 3
    .param p1, "type"    # I
    .param p2, "name"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist core-platform-api test-api addSubjectAlternativeName(I[B)V
    .registers 4
    .param p1, "type"    # I
    .param p2, "name"    # [B
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist core-platform-api test-api getAuthorityKeyIdentifier()[B
    .registers 2
...
.method public whitelist core-platform-api test-api getCertificate()Ljava/security/cert/X509Certificate;
    .registers 2
...
.method public whitelist core-platform-api test-api getCertificateValid()Ljava/util/Date;
    .registers 2
...
.method public whitelist core-platform-api test-api getExtendedKeyUsage()Ljava/util/Set;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist core-platform-api test-api getIssuer()Ljavax/security/auth/x500/X500Principal;
    .registers 2
...
.method public whitelist core-platform-api test-api getIssuerAsBytes()[B
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public whitelist core-platform-api test-api getIssuerAsString()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getMatchAllSubjectAltNames()Z
    .registers 2
...
.method public whitelist core-platform-api test-api getNameConstraints()[B
    .registers 2
...
.method public whitelist core-platform-api test-api getPathToNames()Ljava/util/Collection;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist core-platform-api test-api getPolicy()Ljava/util/Set;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist core-platform-api test-api getPrivateKeyValid()Ljava/util/Date;
    .registers 2
...
.method public whitelist core-platform-api test-api getSubject()Ljavax/security/auth/x500/X500Principal;
    .registers 2
...
.method public whitelist core-platform-api test-api getSubjectAsBytes()[B
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public whitelist core-platform-api test-api getSubjectAsString()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getSubjectKeyIdentifier()[B
    .registers 2
...
.method public whitelist core-platform-api test-api getSubjectPublicKey()Ljava/security/PublicKey;
    .registers 2
...
.method public whitelist core-platform-api test-api getSubjectPublicKeyAlgID()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api match(Ljava/security/cert/Certificate;)Z
    ...
    .line 2013
    :cond_48
    iget-object v2, p0, Ljava/security/cert/X509CertSelector;->x509Cert:Ljava/security/cert/X509Certificate;
    ...
    :try_end_ab
    .catch Ljava/security/cert/CertificateException; {:try_start_a8 .. :try_end_ab} :catch_ac
    ...
    :cond_b7
    :goto_b7
    iget-object v2, p0, Ljava/security/cert/X509CertSelector;->subjectPublicKeyBytes:[B
...
.method public whitelist core-platform-api test-api setAuthorityKeyIdentifier([B)V
    .registers 3
...
.method public whitelist core-platform-api test-api setBasicConstraints(I)V
    .registers 4
...
.method public whitelist core-platform-api test-api setCertificate(Ljava/security/cert/X509Certificate;)V
    .registers 2
...
.method public whitelist core-platform-api test-api setCertificateValid(Ljava/util/Date;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setExtendedKeyUsage(Ljava/util/Set;)V
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api setIssuer(Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setIssuer(Ljavax/security/auth/x500/X500Principal;)V
    .registers 2
...
.method public whitelist core-platform-api test-api setIssuer([B)V
    .registers 5
    .param p1, "issuerDN"    # [B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api setKeyUsage([Z)V
    .registers 3
    .param p1, "keyUsage"    # [Z
...
.method public whitelist core-platform-api test-api setMatchAllSubjectAltNames(Z)V
    .registers 2
...
.method public whitelist core-platform-api test-api setNameConstraints([B)V
    .registers 4
    .param p1, "bytes"    # [B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api setPathToNames(Ljava/util/Collection;)V
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api setPolicy(Ljava/util/Set;)V
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api setPrivateKeyValid(Ljava/util/Date;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setSerialNumber(Ljava/math/BigInteger;)V
    .registers 2
...
.method public whitelist core-platform-api test-api setSubject(Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setSubject(Ljavax/security/auth/x500/X500Principal;)V
    .registers 2
...
.method public whitelist core-platform-api test-api setSubject([B)V
    .registers 5
...
.method public whitelist core-platform-api test-api setSubjectAlternativeNames(Ljava/util/Collection;)V
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api setSubjectKeyIdentifier([B)V
    .registers 3
...
.method public whitelist core-platform-api test-api setSubjectPublicKey(Ljava/security/PublicKey;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setSubjectPublicKey([B)V
    .registers 4
    .param p1, "key"    # [B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api setSubjectPublicKeyAlgID(Ljava/lang/String;)V
    .registers 3
