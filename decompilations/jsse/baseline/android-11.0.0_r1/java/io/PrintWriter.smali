...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Z)V
    .registers 5
    .param p1, "out"    # Ljava/io/OutputStream;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/Writer;Z)V
    .registers 5
    .param p1, "out"    # Ljava/io/Writer;
    .param p2, "autoFlush"    # Z
...
# virtual methods
.method public whitelist core-platform-api test-api append(C)Ljava/io/PrintWriter;
    .registers 2
    .param p1, "c"    # C
...
.method public whitelist core-platform-api test-api append(Ljava/lang/CharSequence;)Ljava/io/PrintWriter;
    .registers 3
...
.method public whitelist core-platform-api test-api append(Ljava/lang/CharSequence;II)Ljava/io/PrintWriter;
    .registers 6
    .param p1, "csq"    # Ljava/lang/CharSequence;
    .param p2, "start"    # I
    .param p3, "end"    # I
...
.method public bridge synthetic whitelist core-platform-api test-api append(C)Ljava/io/Writer;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public bridge synthetic whitelist core-platform-api test-api append(Ljava/lang/CharSequence;)Ljava/io/Writer;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public bridge synthetic whitelist core-platform-api test-api append(Ljava/lang/CharSequence;II)Ljava/io/Writer;
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method protected whitelist core-platform-api test-api clearError()V
    .registers 2
...
.method public varargs whitelist core-platform-api test-api format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    .registers 6
    ...
    monitor-enter v0
    :try_end_3
    .catch Ljava/io/InterruptedIOException; {:try_start_0 .. :try_end_3} :catch_39
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_3} :catch_34
    ...
    throw v1
    :try_end_34
    .catch Ljava/io/InterruptedIOException; {:try_start_33 .. :try_end_34} :catch_39
...
.method public varargs whitelist core-platform-api test-api format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    .registers 6
    ...
    monitor-enter v0
    :try_end_3
    .catch Ljava/io/InterruptedIOException; {:try_start_0 .. :try_end_3} :catch_31
    ...
    throw v1
    :try_end_2c
    .catch Ljava/io/InterruptedIOException; {:try_start_2b .. :try_end_2c} :catch_31
...
.method public whitelist core-platform-api test-api print(C)V
    .registers 2
    .param p1, "c"    # C
...
.method public whitelist core-platform-api test-api print(D)V
    .registers 4
    .param p1, "d"    # D
...
.method public whitelist core-platform-api test-api print(F)V
    .registers 3
    .param p1, "f"    # F
...
.method public whitelist core-platform-api test-api print(I)V
    .registers 3
    .param p1, "i"    # I
...
.method public whitelist core-platform-api test-api print(J)V
    .registers 4
    .param p1, "l"    # J
...
.method public whitelist core-platform-api test-api print(Ljava/lang/Object;)V
    .registers 3
...
.method public whitelist core-platform-api test-api print(Ljava/lang/String;)V
    .registers 2
...
.method public whitelist core-platform-api test-api print(Z)V
    .registers 3
    .param p1, "b"    # Z
...
.method public varargs whitelist core-platform-api test-api printf(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    .registers 4
    .param p1, "format"    # Ljava/lang/String;
    .param p2, "args"    # [Ljava/lang/Object;
...
.method public varargs whitelist core-platform-api test-api printf(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    .registers 5
    .param p1, "l"    # Ljava/util/Locale;
    .param p2, "format"    # Ljava/lang/String;
    .param p3, "args"    # [Ljava/lang/Object;
...
.method public whitelist core-platform-api test-api println()V
    .registers 1
...
.method public whitelist core-platform-api test-api println(C)V
    .registers 4
    .param p1, "x"    # C
...
.method public whitelist core-platform-api test-api println(D)V
    .registers 5
    .param p1, "x"    # D
...
.method public whitelist core-platform-api test-api println(F)V
    .registers 4
    .param p1, "x"    # F
...
.method public whitelist core-platform-api test-api println(I)V
    .registers 4
    .param p1, "x"    # I
...
.method public whitelist core-platform-api test-api println(J)V
    .registers 5
    .param p1, "x"    # J
...
.method public whitelist core-platform-api test-api println(Ljava/lang/Object;)V
    .registers 5
...
.method public whitelist core-platform-api test-api println(Ljava/lang/String;)V
    .registers 4
...
.method public whitelist core-platform-api test-api println(Z)V
    .registers 4
    .param p1, "x"    # Z
...
.method public whitelist core-platform-api test-api write(Ljava/lang/String;)V
    .registers 4
    .param p1, "s"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api write([C)V
    .registers 4
    .param p1, "buf"    # [C
