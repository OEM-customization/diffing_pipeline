...
.field public static final whitelist core-platform-api test-api NO_FIELDS:[Ljava/io/ObjectStreamField;
...
.method static constructor blacklist <clinit>()V
    ...
    .line 1924
    sget-object v0, Ljava/io/-$$Lambda$ObjectStreamClass$GVMp_c-BEBrBo_ZKh_HiLSO-fGo;->INSTANCE:Ljava/io/-$$Lambda$ObjectStreamClass$GVMp_c-BEBrBo_ZKh_HiLSO-fGo;
...
.method public static whitelist core-platform-api test-api lookup(Ljava/lang/Class;)Ljava/io/ObjectStreamClass;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static whitelist core-platform-api test-api lookupAny(Ljava/lang/Class;)Ljava/io/ObjectStreamClass;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api forClass()Ljava/lang/Class;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist core-platform-api test-api getField(Ljava/lang/String;)Ljava/io/ObjectStreamField;
    .registers 3
    .param p1, "name"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api getFields()[Ljava/io/ObjectStreamField;
    .registers 2
...
.method public whitelist core-platform-api test-api getSerialVersionUID()J
    .registers 3
...
.method greylist-max-o initNonProxy(Ljava/io/ObjectStreamClass;Ljava/lang/Class;Ljava/lang/ClassNotFoundException;Ljava/io/ObjectStreamClass;)V
    ...
    iget-boolean v5, v2, Ljava/io/ObjectStreamClass;->externalizable:Z
    ...
    .line 661
    iget v4, p1, Ljava/io/ObjectStreamClass;->primDataSize:I

    iput v4, p0, Ljava/io/ObjectStreamClass;->primDataSize:I

    .line 662
    iget v4, p1, Ljava/io/ObjectStreamClass;->numObjFields:I
    ...
    .line 666
    iget-object v4, v2, Ljava/io/ObjectStreamClass;->writeObjectMethod:Ljava/lang/reflect/Method;

    iput-object v4, p0, Ljava/io/ObjectStreamClass;->writeObjectMethod:Ljava/lang/reflect/Method;

    .line 667
    iget-object v4, v2, Ljava/io/ObjectStreamClass;->readObjectMethod:Ljava/lang/reflect/Method;

    iput-object v4, p0, Ljava/io/ObjectStreamClass;->readObjectMethod:Ljava/lang/reflect/Method;

    .line 668
    iget-object v4, v2, Ljava/io/ObjectStreamClass;->readObjectNoDataMethod:Ljava/lang/reflect/Method;

    iput-object v4, p0, Ljava/io/ObjectStreamClass;->readObjectNoDataMethod:Ljava/lang/reflect/Method;

    .line 669
    iget-object v4, v2, Ljava/io/ObjectStreamClass;->writeReplaceMethod:Ljava/lang/reflect/Method;

    iput-object v4, p0, Ljava/io/ObjectStreamClass;->writeReplaceMethod:Ljava/lang/reflect/Method;

    .line 670
    iget-object v4, v2, Ljava/io/ObjectStreamClass;->readResolveMethod:Ljava/lang/reflect/Method;

    iput-object v4, p0, Ljava/io/ObjectStreamClass;->readResolveMethod:Ljava/lang/reflect/Method;

    .line 671
    iget-object v4, p0, Ljava/io/ObjectStreamClass;->deserializeEx:Ljava/io/ObjectStreamClass$ExceptionInfo;

    if-nez v4, :cond_121

    .line 672
    iget-object v4, v2, Ljava/io/ObjectStreamClass;->deserializeEx:Ljava/io/ObjectStreamClass$ExceptionInfo;

    iput-object v4, p0, Ljava/io/ObjectStreamClass;->deserializeEx:Ljava/io/ObjectStreamClass$ExceptionInfo;

    .line 674
    :cond_121
    iget-object v4, p0, Ljava/io/ObjectStreamClass;->localDesc:Ljava/io/ObjectStreamClass;

    iget-object v4, v4, Ljava/io/ObjectStreamClass;->cons:Ljava/lang/reflect/Constructor;

    iput-object v4, p0, Ljava/io/ObjectStreamClass;->cons:Ljava/lang/reflect/Constructor;
...
.method greylist-max-o initProxy(Ljava/lang/Class;Ljava/lang/ClassNotFoundException;Ljava/io/ObjectStreamClass;)V
    ...
    .line 583
    iget-object v2, v0, Ljava/io/ObjectStreamClass;->name:Ljava/lang/String;

    iput-object v2, p0, Ljava/io/ObjectStreamClass;->name:Ljava/lang/String;

    .line 584
    iget-boolean v2, v0, Ljava/io/ObjectStreamClass;->externalizable:Z

    iput-boolean v2, p0, Ljava/io/ObjectStreamClass;->externalizable:Z

    .line 585
    iget-object v2, v0, Ljava/io/ObjectStreamClass;->writeReplaceMethod:Ljava/lang/reflect/Method;

    iput-object v2, p0, Ljava/io/ObjectStreamClass;->writeReplaceMethod:Ljava/lang/reflect/Method;

    .line 586
    iget-object v2, v0, Ljava/io/ObjectStreamClass;->readResolveMethod:Ljava/lang/reflect/Method;

    iput-object v2, p0, Ljava/io/ObjectStreamClass;->readResolveMethod:Ljava/lang/reflect/Method;

    .line 587
    iget-object v2, v0, Ljava/io/ObjectStreamClass;->deserializeEx:Ljava/io/ObjectStreamClass$ExceptionInfo;

    iput-object v2, p0, Ljava/io/ObjectStreamClass;->deserializeEx:Ljava/io/ObjectStreamClass$ExceptionInfo;

    .line 588
    iget-object v2, v0, Ljava/io/ObjectStreamClass;->cons:Ljava/lang/reflect/Constructor;

    iput-object v2, p0, Ljava/io/ObjectStreamClass;->cons:Ljava/lang/reflect/Constructor;
...
.method greylist-max-o readNonProxy(Ljava/io/ObjectInputStream;)V
    ...
    const-string v4, "serializable and externalizable flags conflict"

    invoke-direct {v0, v3, v4}, Ljava/io/InvalidClassException;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Ljava/io/ObjectStreamClass;->suid:Ljava/lang/Long;
    ...
    :try_end_e3
    .catch Ljava/lang/RuntimeException; {:try_start_da .. :try_end_e3} :catch_e7
