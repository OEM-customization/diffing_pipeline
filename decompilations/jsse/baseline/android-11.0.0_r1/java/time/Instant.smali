...
# static fields
.field public static final whitelist core-platform-api test-api EPOCH:Ljava/time/Instant;

.field public static final whitelist core-platform-api test-api MAX:Ljava/time/Instant;

.field private static final greylist-max-o MAX_SECOND:J = 0x701cd2fa9578ffL

.field public static final whitelist core-platform-api test-api MIN:Ljava/time/Instant;
...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/Instant;
    .registers 6
...
.method public static whitelist core-platform-api test-api now()Ljava/time/Instant;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/Instant;
    .registers 2
...
.method public static whitelist core-platform-api test-api ofEpochMilli(J)Ljava/time/Instant;
    .registers 6
...
.method public static whitelist core-platform-api test-api ofEpochSecond(J)Ljava/time/Instant;
    .registers 3
...
.method public static whitelist core-platform-api test-api ofEpochSecond(JJ)Ljava/time/Instant;
    .registers 8
    .param p0, "epochSecond"    # J
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;)Ljava/time/Instant;
    .registers 3
    ...
    sget-object v1, Ljava/time/-$$Lambda$PTL8WkLA4o-1z4zIUBjrvwi808w;->INSTANCE:Ljava/time/-$$Lambda$PTL8WkLA4o-1z4zIUBjrvwi808w;
...
.method public whitelist core-platform-api test-api compareTo(Ljava/time/Instant;)I
    .registers 6
...
.method public whitelist core-platform-api test-api getEpochSecond()J
    .registers 3
...
.method public whitelist core-platform-api test-api isAfter(Ljava/time/Instant;)Z
    .registers 3
    .param p1, "otherInstant"    # Ljava/time/Instant;
...
.method public whitelist core-platform-api test-api isBefore(Ljava/time/Instant;)Z
    .registers 3
    .param p1, "otherInstant"    # Ljava/time/Instant;
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/Instant;
    .registers 7
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/Instant;
    .registers 3
...
.method public whitelist core-platform-api test-api minusMillis(J)Ljava/time/Instant;
    .registers 6
...
.method public whitelist core-platform-api test-api minusNanos(J)Ljava/time/Instant;
    .registers 6
...
.method public whitelist core-platform-api test-api minusSeconds(J)Ljava/time/Instant;
    .registers 6
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/Instant;
    .registers 10
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/Instant;
    .registers 3
...
.method public whitelist core-platform-api test-api plusMillis(J)Ljava/time/Instant;
    .registers 9
...
.method public whitelist core-platform-api test-api plusNanos(J)Ljava/time/Instant;
    .registers 5
...
.method public whitelist core-platform-api test-api plusSeconds(J)Ljava/time/Instant;
    .registers 5
    .param p1, "secondsToAdd"    # J
...
.method public whitelist core-platform-api test-api toEpochMilli()J
    .registers 9
...
.method public whitelist core-platform-api test-api truncatedTo(Ljava/time/temporal/TemporalUnit;)Ljava/time/Instant;
    .registers 11
    .param p1, "unit"    # Ljava/time/temporal/TemporalUnit;
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/Instant;
    .registers 3
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/Instant;
    .registers 8
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
