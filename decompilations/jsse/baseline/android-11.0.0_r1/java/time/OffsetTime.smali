...
# static fields
.field public static final whitelist core-platform-api test-api MAX:Ljava/time/OffsetTime;

.field public static final whitelist core-platform-api test-api MIN:Ljava/time/OffsetTime;
...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/OffsetTime;
    .registers 5
...
.method public static whitelist core-platform-api test-api now()Ljava/time/OffsetTime;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/OffsetTime;
    .registers 3
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/OffsetTime;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(IIIILjava/time/ZoneOffset;)Ljava/time/OffsetTime;
    .registers 7
    .param p0, "hour"    # I
    .param p1, "minute"    # I
    .param p2, "second"    # I
...
.method public static whitelist core-platform-api test-api of(Ljava/time/LocalTime;Ljava/time/ZoneOffset;)Ljava/time/OffsetTime;
    .registers 3
...
.method public static whitelist core-platform-api test-api ofInstant(Ljava/time/Instant;Ljava/time/ZoneId;)Ljava/time/OffsetTime;
    .registers 11
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;)Ljava/time/OffsetTime;
    .registers 2
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;Ljava/time/format/DateTimeFormatter;)Ljava/time/OffsetTime;
    .registers 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    ...
    .line 321
    sget-object v0, Ljava/time/-$$Lambda$I08rBDhAPdxOG_R3AeLRKYX7Z-o;->INSTANCE:Ljava/time/-$$Lambda$I08rBDhAPdxOG_R3AeLRKYX7Z-o;
...
.method public whitelist core-platform-api test-api atDate(Ljava/time/LocalDate;)Ljava/time/OffsetDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api compareTo(Ljava/time/OffsetTime;)I
    .registers 6
...
.method public whitelist core-platform-api test-api isAfter(Ljava/time/OffsetTime;)Z
    .registers 6
    .param p1, "other"    # Ljava/time/OffsetTime;
...
.method public whitelist core-platform-api test-api isBefore(Ljava/time/OffsetTime;)Z
    .registers 6
    .param p1, "other"    # Ljava/time/OffsetTime;
...
.method public whitelist core-platform-api test-api isEqual(Ljava/time/OffsetTime;)Z
    .registers 6
    .param p1, "other"    # Ljava/time/OffsetTime;
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/OffsetTime;
    .registers 7
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/OffsetTime;
    .registers 3
...
.method public whitelist core-platform-api test-api minusHours(J)Ljava/time/OffsetTime;
    .registers 5
    .param p1, "hours"    # J
...
.method public whitelist core-platform-api test-api minusMinutes(J)Ljava/time/OffsetTime;
    .registers 5
    .param p1, "minutes"    # J
...
.method public whitelist core-platform-api test-api minusNanos(J)Ljava/time/OffsetTime;
    .registers 5
    .param p1, "nanos"    # J
...
.method public whitelist core-platform-api test-api minusSeconds(J)Ljava/time/OffsetTime;
    .registers 5
    .param p1, "seconds"    # J
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/OffsetTime;
    .registers 6
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/OffsetTime;
    .registers 3
...
.method public whitelist core-platform-api test-api plusHours(J)Ljava/time/OffsetTime;
    .registers 5
    .param p1, "hours"    # J
...
.method public whitelist core-platform-api test-api plusMinutes(J)Ljava/time/OffsetTime;
    .registers 5
    .param p1, "minutes"    # J
...
.method public whitelist core-platform-api test-api plusNanos(J)Ljava/time/OffsetTime;
    .registers 5
    .param p1, "nanos"    # J
...
.method public whitelist core-platform-api test-api plusSeconds(J)Ljava/time/OffsetTime;
    .registers 5
    .param p1, "seconds"    # J
...
.method public whitelist core-platform-api test-api truncatedTo(Ljava/time/temporal/TemporalUnit;)Ljava/time/OffsetTime;
    .registers 4
    .param p1, "unit"    # Ljava/time/temporal/TemporalUnit;
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/OffsetTime;
    .registers 4
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/OffsetTime;
    .registers 7
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
...
.method public whitelist core-platform-api test-api withHour(I)Ljava/time/OffsetTime;
    .registers 4
    .param p1, "hour"    # I
...
.method public whitelist core-platform-api test-api withMinute(I)Ljava/time/OffsetTime;
    .registers 4
    .param p1, "minute"    # I
...
.method public whitelist core-platform-api test-api withNano(I)Ljava/time/OffsetTime;
    .registers 4
...
.method public whitelist core-platform-api test-api withOffsetSameInstant(Ljava/time/ZoneOffset;)Ljava/time/OffsetTime;
    .registers 6
    .param p1, "offset"    # Ljava/time/ZoneOffset;
...
.method public whitelist core-platform-api test-api withOffsetSameLocal(Ljava/time/ZoneOffset;)Ljava/time/OffsetTime;
    .registers 4
    .param p1, "offset"    # Ljava/time/ZoneOffset;
...
.method public whitelist core-platform-api test-api withSecond(I)Ljava/time/OffsetTime;
    .registers 4
    .param p1, "second"    # I
