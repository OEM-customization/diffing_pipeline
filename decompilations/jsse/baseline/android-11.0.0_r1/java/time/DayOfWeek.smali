...
.field public static final enum whitelist core-platform-api test-api FRIDAY:Ljava/time/DayOfWeek;

.field public static final enum whitelist core-platform-api test-api MONDAY:Ljava/time/DayOfWeek;

.field public static final enum whitelist core-platform-api test-api SATURDAY:Ljava/time/DayOfWeek;

.field public static final enum whitelist core-platform-api test-api SUNDAY:Ljava/time/DayOfWeek;

.field public static final enum whitelist core-platform-api test-api THURSDAY:Ljava/time/DayOfWeek;

.field public static final enum whitelist core-platform-api test-api TUESDAY:Ljava/time/DayOfWeek;

.field public static final enum whitelist core-platform-api test-api WEDNESDAY:Ljava/time/DayOfWeek;
...
.method static constructor blacklist <clinit>()V
    ...
    invoke-direct {v0, v1, v8}, Ljava/time/DayOfWeek;-><init>(Ljava/lang/String;I)V
    ...
    new-array v1, v1, [Ljava/time/DayOfWeek;

    sget-object v9, Ljava/time/DayOfWeek;->MONDAY:Ljava/time/DayOfWeek;
    ...
    sput-object v1, Ljava/time/DayOfWeek;->$VALUES:[Ljava/time/DayOfWeek;
...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/DayOfWeek;
    .registers 5
...
.method public static whitelist core-platform-api test-api of(I)Ljava/time/DayOfWeek;
    .registers 4
...
.method public static whitelist core-platform-api test-api valueOf(Ljava/lang/String;)Ljava/time/DayOfWeek;
    .registers 2
...
.method public static whitelist core-platform-api test-api values()[Ljava/time/DayOfWeek;
    .registers 1
...
.method public whitelist core-platform-api test-api minus(J)Ljava/time/DayOfWeek;
    .registers 5
    .param p1, "days"    # J
...
.method public whitelist core-platform-api test-api plus(J)Ljava/time/DayOfWeek;
    .registers 7
    .param p1, "days"    # J
