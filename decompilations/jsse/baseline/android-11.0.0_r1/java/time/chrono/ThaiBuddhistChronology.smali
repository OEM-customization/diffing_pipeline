...
.field public static final whitelist core-platform-api test-api INSTANCE:Ljava/time/chrono/ThaiBuddhistChronology;
...
.method public whitelist core-platform-api test-api date(III)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 6
...
.method public whitelist core-platform-api test-api date(Ljava/time/chrono/Era;III)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 6
...
.method public whitelist core-platform-api test-api date(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 4
...
.method public whitelist core-platform-api test-api dateEpochDay(J)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 5
    .param p1, "epochDay"    # J
...
.method public whitelist core-platform-api test-api dateNow()Ljava/time/chrono/ThaiBuddhistDate;
    .registers 2
...
.method public whitelist core-platform-api test-api dateNow(Ljava/time/Clock;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 3
...
.method public whitelist core-platform-api test-api dateNow(Ljava/time/ZoneId;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 3
...
.method public whitelist core-platform-api test-api dateYearDay(II)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 5
    .param p1, "prolepticYear"    # I
...
.method public whitelist core-platform-api test-api dateYearDay(Ljava/time/chrono/Era;II)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 5
    .param p1, "era"    # Ljava/time/chrono/Era;
    .param p2, "yearOfEra"    # I
...
.method public whitelist core-platform-api test-api eraOf(I)Ljava/time/chrono/ThaiBuddhistEra;
    .registers 3
    .param p1, "eraValue"    # I
...
.method public whitelist core-platform-api test-api resolveDate(Ljava/util/Map;Ljava/time/format/ResolverStyle;)Ljava/time/chrono/ThaiBuddhistDate;
    .registers 4
