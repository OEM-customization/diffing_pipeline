...
# static fields
.field public static final whitelist core-platform-api test-api INSTANCE:Ljava/time/chrono/IsoChronology;
...
# virtual methods
.method public whitelist core-platform-api test-api date(III)Ljava/time/LocalDate;
    .registers 5
...
.method public whitelist core-platform-api test-api date(Ljava/time/chrono/Era;III)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api date(Ljava/time/temporal/TemporalAccessor;)Ljava/time/LocalDate;
    .registers 3
...
.method public whitelist core-platform-api test-api dateEpochDay(J)Ljava/time/LocalDate;
    .registers 4
    .param p1, "epochDay"    # J
...
.method public whitelist core-platform-api test-api dateNow()Ljava/time/LocalDate;
    .registers 2
...
.method public whitelist core-platform-api test-api dateNow(Ljava/time/Clock;)Ljava/time/LocalDate;
    .registers 3
...
.method public whitelist core-platform-api test-api dateNow(Ljava/time/ZoneId;)Ljava/time/LocalDate;
    .registers 3
...
.method public whitelist core-platform-api test-api dateYearDay(II)Ljava/time/LocalDate;
    .registers 4
    .param p1, "prolepticYear"    # I
...
.method public whitelist core-platform-api test-api dateYearDay(Ljava/time/chrono/Era;II)Ljava/time/LocalDate;
    .registers 5
    .param p1, "era"    # Ljava/time/chrono/Era;
    .param p2, "yearOfEra"    # I
...
.method public whitelist core-platform-api test-api eraOf(I)Ljava/time/chrono/IsoEra;
    .registers 3
    .param p1, "eraValue"    # I
...
.method public whitelist core-platform-api test-api localDateTime(Ljava/time/temporal/TemporalAccessor;)Ljava/time/LocalDateTime;
    .registers 3
    .param p1, "temporal"    # Ljava/time/temporal/TemporalAccessor;
...
.method public bridge synthetic whitelist core-platform-api test-api localDateTime(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ChronoLocalDateTime;
    .registers 2
...
.method public whitelist core-platform-api test-api period(III)Ljava/time/Period;
    .registers 5
    .param p1, "years"    # I
    .param p2, "months"    # I
    .param p3, "days"    # I
...
.method public bridge synthetic whitelist core-platform-api test-api period(III)Ljava/time/chrono/ChronoPeriod;
    .registers 4
...
.method public whitelist core-platform-api test-api resolveDate(Ljava/util/Map;Ljava/time/format/ResolverStyle;)Ljava/time/LocalDate;
    .registers 4
...
.method public whitelist core-platform-api test-api zonedDateTime(Ljava/time/Instant;Ljava/time/ZoneId;)Ljava/time/ZonedDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api zonedDateTime(Ljava/time/temporal/TemporalAccessor;)Ljava/time/ZonedDateTime;
    .registers 3
    .param p1, "temporal"    # Ljava/time/temporal/TemporalAccessor;
...
.method public bridge synthetic whitelist core-platform-api test-api zonedDateTime(Ljava/time/Instant;Ljava/time/ZoneId;)Ljava/time/chrono/ChronoZonedDateTime;
    .registers 3
...
.method public bridge synthetic whitelist core-platform-api test-api zonedDateTime(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ChronoZonedDateTime;
    .registers 2
