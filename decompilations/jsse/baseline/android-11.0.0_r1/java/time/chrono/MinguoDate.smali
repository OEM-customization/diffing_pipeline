...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/MinguoDate;
    .registers 2
...
.method public static whitelist core-platform-api test-api now()Ljava/time/chrono/MinguoDate;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/chrono/MinguoDate;
    .registers 3
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/chrono/MinguoDate;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(III)Ljava/time/chrono/MinguoDate;
    .registers 5
...
.method public whitelist core-platform-api test-api getChronology()Ljava/time/chrono/MinguoChronology;
    .registers 2
...
.method public whitelist core-platform-api test-api getEra()Ljava/time/chrono/MinguoEra;
    .registers 3
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/MinguoDate;
    .registers 5
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/MinguoDate;
    .registers 3
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/MinguoDate;
    .registers 5
    .param p1, "amountToAdd"    # J
    .param p3, "unit"    # Ljava/time/temporal/TemporalUnit;
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/MinguoDate;
    .registers 3
    .param p1, "amount"    # Ljava/time/temporal/TemporalAmount;
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/MinguoDate;
    .registers 3
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/MinguoDate;
    .registers 11
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
    ...
    .line 319
    .local v1, "nvalue":I
    sget-object v5, Ljava/time/chrono/MinguoDate$1;->$SwitchMap$java$time$temporal$ChronoField:[I
