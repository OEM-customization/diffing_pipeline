...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/HijrahDate;
    .registers 2
...
.method public static whitelist core-platform-api test-api now()Ljava/time/chrono/HijrahDate;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/chrono/HijrahDate;
    .registers 4
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/chrono/HijrahDate;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(III)Ljava/time/chrono/HijrahDate;
    .registers 4
...
.method public whitelist core-platform-api test-api getChronology()Ljava/time/chrono/HijrahChronology;
    .registers 2
...
.method public whitelist core-platform-api test-api getEra()Ljava/time/chrono/HijrahEra;
    .registers 2
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/HijrahDate;
    .registers 5
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/HijrahDate;
    .registers 3
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/HijrahDate;
    .registers 5
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/HijrahDate;
    .registers 3
    .param p1, "amount"    # Ljava/time/temporal/TemporalAmount;
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/HijrahDate;
    .registers 3
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/HijrahDate;
    .registers 11
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
...
.method public whitelist core-platform-api test-api withVariant(Ljava/time/chrono/HijrahChronology;)Ljava/time/chrono/HijrahDate;
    .registers 6
