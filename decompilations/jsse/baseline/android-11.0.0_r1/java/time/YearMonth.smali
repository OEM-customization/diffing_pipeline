...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/YearMonth;
    .registers 5
...
.method public static whitelist core-platform-api test-api now()Ljava/time/YearMonth;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/YearMonth;
    .registers 4
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/YearMonth;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(II)Ljava/time/YearMonth;
    .registers 5
    .param p0, "year"    # I
    .param p1, "month"    # I
...
.method public static whitelist core-platform-api test-api of(ILjava/time/Month;)Ljava/time/YearMonth;
    .registers 3
    .param p0, "year"    # I
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;)Ljava/time/YearMonth;
    .registers 2
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;Ljava/time/format/DateTimeFormatter;)Ljava/time/YearMonth;
    .registers 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    ...
    .line 289
    sget-object v0, Ljava/time/-$$Lambda$102LK-VjqD_Dw4HKR2kUw-BMsRk;->INSTANCE:Ljava/time/-$$Lambda$102LK-VjqD_Dw4HKR2kUw-BMsRk;
...
.method public whitelist core-platform-api test-api atEndOfMonth()Ljava/time/LocalDate;
    .registers 4
...
.method public whitelist core-platform-api test-api compareTo(Ljava/time/YearMonth;)I
    .registers 5
...
.method public whitelist core-platform-api test-api isAfter(Ljava/time/YearMonth;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/YearMonth;
...
.method public whitelist core-platform-api test-api isBefore(Ljava/time/YearMonth;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/YearMonth;
...
.method public whitelist core-platform-api test-api isValidDay(I)Z
    .registers 4
    .param p1, "dayOfMonth"    # I
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/YearMonth;
    .registers 7
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/YearMonth;
    .registers 3
...
.method public whitelist core-platform-api test-api minusMonths(J)Ljava/time/YearMonth;
    .registers 6
...
.method public whitelist core-platform-api test-api minusYears(J)Ljava/time/YearMonth;
    .registers 6
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/YearMonth;
    .registers 7
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/YearMonth;
    .registers 3
...
.method public whitelist core-platform-api test-api plusMonths(J)Ljava/time/YearMonth;
    .registers 12
    ...
    iget v4, p0, Ljava/time/YearMonth;->month:I
    ...
    .line 848
    .local v2, "newMonth":I
    invoke-direct {p0, v6, v2}, Ljava/time/YearMonth;->with(II)Ljava/time/YearMonth;
...
.method public whitelist core-platform-api test-api plusYears(J)Ljava/time/YearMonth;
    .registers 6
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/YearMonth;
    .registers 3
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/YearMonth;
    .registers 9
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
...
.method public whitelist core-platform-api test-api withMonth(I)Ljava/time/YearMonth;
    .registers 5
    .param p1, "month"    # I
...
.method public whitelist core-platform-api test-api withYear(I)Ljava/time/YearMonth;
    .registers 5
    .param p1, "year"    # I
