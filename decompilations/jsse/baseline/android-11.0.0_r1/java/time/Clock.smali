...
.method public static whitelist core-platform-api test-api fixed(Ljava/time/Instant;Ljava/time/ZoneId;)Ljava/time/Clock;
    .registers 3
...
.method public static whitelist core-platform-api test-api offset(Ljava/time/Clock;Ljava/time/Duration;)Ljava/time/Clock;
    .registers 3
...
.method public static whitelist core-platform-api test-api system(Ljava/time/ZoneId;)Ljava/time/Clock;
    .registers 2
...
.method public static whitelist core-platform-api test-api systemDefaultZone()Ljava/time/Clock;
    .registers 2
...
.method public static whitelist core-platform-api test-api systemUTC()Ljava/time/Clock;
    .registers 2
...
.method public static whitelist core-platform-api test-api tick(Ljava/time/Clock;Ljava/time/Duration;)Ljava/time/Clock;
    .registers 8
    .param p0, "baseClock"    # Ljava/time/Clock;
...
.method public static whitelist core-platform-api test-api tickMinutes(Ljava/time/ZoneId;)Ljava/time/Clock;
    .registers 5
    .param p0, "zone"    # Ljava/time/ZoneId;
...
.method public static whitelist core-platform-api test-api tickSeconds(Ljava/time/ZoneId;)Ljava/time/Clock;
    .registers 5
    .param p0, "zone"    # Ljava/time/ZoneId;
...
.method public abstract whitelist core-platform-api test-api instant()Ljava/time/Instant;
.end method
...
.method public abstract whitelist core-platform-api test-api withZone(Ljava/time/ZoneId;)Ljava/time/Clock;
.end method
