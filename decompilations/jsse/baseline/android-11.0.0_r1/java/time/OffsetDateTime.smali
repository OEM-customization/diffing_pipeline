...
# static fields
.field public static final whitelist core-platform-api test-api MAX:Ljava/time/OffsetDateTime;

.field public static final whitelist core-platform-api test-api MIN:Ljava/time/OffsetDateTime;
...
.method private constructor greylist <init>(Ljava/time/LocalDateTime;Ljava/time/ZoneOffset;)V
    .registers 4
...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/OffsetDateTime;
    .registers 6
...
.method public static synthetic blacklist lambda$d2QSmDYEJWeXCg2rcQuxVNPk3n4(Ljava/time/OffsetDateTime;Ljava/time/OffsetDateTime;)I
    .registers 2
...
.method public static whitelist core-platform-api test-api now()Ljava/time/OffsetDateTime;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/OffsetDateTime;
    .registers 3
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/OffsetDateTime;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(IIIIIIILjava/time/ZoneOffset;)Ljava/time/OffsetDateTime;
    .registers 10
    .param p0, "year"    # I
    .param p1, "month"    # I
...
.method public static whitelist core-platform-api test-api of(Ljava/time/LocalDate;Ljava/time/LocalTime;Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;
    .registers 5
...
.method public static whitelist core-platform-api test-api of(Ljava/time/LocalDateTime;Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;
    .registers 3
...
.method public static whitelist core-platform-api test-api ofInstant(Ljava/time/Instant;Ljava/time/ZoneId;)Ljava/time/OffsetDateTime;
    .registers 7
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;)Ljava/time/OffsetDateTime;
    .registers 2
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;Ljava/time/format/DateTimeFormatter;)Ljava/time/OffsetDateTime;
    .registers 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    ...
    .line 396
    sget-object v0, Ljava/time/-$$Lambda$sdbO4BiAEcJ0Ab-aR8ZYLiX9zuo;->INSTANCE:Ljava/time/-$$Lambda$sdbO4BiAEcJ0Ab-aR8ZYLiX9zuo;
...
.method public static whitelist core-platform-api test-api timeLineOrder()Ljava/util/Comparator;
    ...
    .line 156
    sget-object v0, Ljava/time/-$$Lambda$OffsetDateTime$d2QSmDYEJWeXCg2rcQuxVNPk3n4;->INSTANCE:Ljava/time/-$$Lambda$OffsetDateTime$d2QSmDYEJWeXCg2rcQuxVNPk3n4;
...
.method public whitelist core-platform-api test-api atZoneSameInstant(Ljava/time/ZoneId;)Ljava/time/ZonedDateTime;
    .registers 4
    .param p1, "zone"    # Ljava/time/ZoneId;
...
.method public whitelist core-platform-api test-api atZoneSimilarLocal(Ljava/time/ZoneId;)Ljava/time/ZonedDateTime;
    .registers 4
    .param p1, "zone"    # Ljava/time/ZoneId;
...
.method public whitelist core-platform-api test-api compareTo(Ljava/time/OffsetDateTime;)I
    .registers 5
...
.method public whitelist core-platform-api test-api isAfter(Ljava/time/OffsetDateTime;)Z
    .registers 8
    .param p1, "other"    # Ljava/time/OffsetDateTime;
...
.method public whitelist core-platform-api test-api isBefore(Ljava/time/OffsetDateTime;)Z
    .registers 8
    .param p1, "other"    # Ljava/time/OffsetDateTime;
...
.method public whitelist core-platform-api test-api isEqual(Ljava/time/OffsetDateTime;)Z
    .registers 6
    .param p1, "other"    # Ljava/time/OffsetDateTime;
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/OffsetDateTime;
    .registers 7
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/OffsetDateTime;
    .registers 3
...
.method public whitelist core-platform-api test-api minusDays(J)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "days"    # J
...
.method public whitelist core-platform-api test-api minusHours(J)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "hours"    # J
...
.method public whitelist core-platform-api test-api minusMinutes(J)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "minutes"    # J
...
.method public whitelist core-platform-api test-api minusMonths(J)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "months"    # J
...
.method public whitelist core-platform-api test-api minusNanos(J)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "nanos"    # J
...
.method public whitelist core-platform-api test-api minusSeconds(J)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "seconds"    # J
...
.method public whitelist core-platform-api test-api minusWeeks(J)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "weeks"    # J
...
.method public whitelist core-platform-api test-api minusYears(J)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "years"    # J
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/OffsetDateTime;
    .registers 6
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/OffsetDateTime;
    .registers 3
...
.method public whitelist core-platform-api test-api plusDays(J)Ljava/time/OffsetDateTime;
    .registers 5
    .param p1, "days"    # J
...
.method public whitelist core-platform-api test-api plusHours(J)Ljava/time/OffsetDateTime;
    .registers 5
    .param p1, "hours"    # J
...
.method public whitelist core-platform-api test-api plusMinutes(J)Ljava/time/OffsetDateTime;
    .registers 5
    .param p1, "minutes"    # J
...
.method public whitelist core-platform-api test-api plusMonths(J)Ljava/time/OffsetDateTime;
    .registers 5
    .param p1, "months"    # J
...
.method public whitelist core-platform-api test-api plusNanos(J)Ljava/time/OffsetDateTime;
    .registers 5
    .param p1, "nanos"    # J
...
.method public whitelist core-platform-api test-api plusSeconds(J)Ljava/time/OffsetDateTime;
    .registers 5
    .param p1, "seconds"    # J
...
.method public whitelist core-platform-api test-api plusWeeks(J)Ljava/time/OffsetDateTime;
    .registers 5
    .param p1, "weeks"    # J
...
.method public whitelist core-platform-api test-api plusYears(J)Ljava/time/OffsetDateTime;
    .registers 5
    .param p1, "years"    # J
...
.method public whitelist core-platform-api test-api toOffsetTime()Ljava/time/OffsetTime;
    .registers 3
...
.method public whitelist core-platform-api test-api toZonedDateTime()Ljava/time/ZonedDateTime;
    .registers 3
...
.method public whitelist core-platform-api test-api truncatedTo(Ljava/time/temporal/TemporalUnit;)Ljava/time/OffsetDateTime;
    .registers 4
    .param p1, "unit"    # Ljava/time/temporal/TemporalUnit;
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/OffsetDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/OffsetDateTime;
    .registers 7
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
...
.method public whitelist core-platform-api test-api withDayOfMonth(I)Ljava/time/OffsetDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api withDayOfYear(I)Ljava/time/OffsetDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api withHour(I)Ljava/time/OffsetDateTime;
    .registers 4
    .param p1, "hour"    # I
...
.method public whitelist core-platform-api test-api withMinute(I)Ljava/time/OffsetDateTime;
    .registers 4
    .param p1, "minute"    # I
...
.method public whitelist core-platform-api test-api withMonth(I)Ljava/time/OffsetDateTime;
    .registers 4
    .param p1, "month"    # I
...
.method public whitelist core-platform-api test-api withNano(I)Ljava/time/OffsetDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api withOffsetSameInstant(Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;
    .registers 6
    .param p1, "offset"    # Ljava/time/ZoneOffset;
...
.method public whitelist core-platform-api test-api withOffsetSameLocal(Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;
    .registers 3
    .param p1, "offset"    # Ljava/time/ZoneOffset;
...
.method public whitelist core-platform-api test-api withSecond(I)Ljava/time/OffsetDateTime;
    .registers 4
    .param p1, "second"    # I
...
.method public whitelist core-platform-api test-api withYear(I)Ljava/time/OffsetDateTime;
    .registers 4
    .param p1, "year"    # I
