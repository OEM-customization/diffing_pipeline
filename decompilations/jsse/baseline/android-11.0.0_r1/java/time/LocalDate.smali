...
.field public static final whitelist core-platform-api test-api MAX:Ljava/time/LocalDate;

.field public static final whitelist core-platform-api test-api MIN:Ljava/time/LocalDate;
...
.method private static greylist-max-o create(III)Ljava/time/LocalDate;
    ...
    invoke-virtual {v2, v4, v5}, Ljava/time/chrono/IsoChronology;->isLeapYear(J)Z
...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/LocalDate;
    .registers 5
...
.method public static whitelist core-platform-api test-api now()Ljava/time/LocalDate;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/LocalDate;
    .registers 8
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/LocalDate;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(III)Ljava/time/LocalDate;
    .registers 6
    .param p0, "year"    # I
    .param p1, "month"    # I
    .param p2, "dayOfMonth"    # I
...
.method public static whitelist core-platform-api test-api of(ILjava/time/Month;I)Ljava/time/LocalDate;
    .registers 6
    .param p0, "year"    # I
...
.method public static whitelist core-platform-api test-api ofEpochDay(J)Ljava/time/LocalDate;
    .registers 23
    .param p0, "epochDay"    # J
...
.method public static whitelist core-platform-api test-api ofYearDay(II)Ljava/time/LocalDate;
    .registers 8
    .param p0, "year"    # I
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;)Ljava/time/LocalDate;
    .registers 2
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;Ljava/time/format/DateTimeFormatter;)Ljava/time/LocalDate;
    .registers 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    ...
    .line 394
    sget-object v0, Ljava/time/-$$Lambda$Bq8PKq1YWr8nyVk9SSfRYKrOu4A;->INSTANCE:Ljava/time/-$$Lambda$Bq8PKq1YWr8nyVk9SSfRYKrOu4A;
...
.method public whitelist core-platform-api test-api atStartOfDay()Ljava/time/LocalDateTime;
    .registers 2
...
.method public whitelist core-platform-api test-api atStartOfDay(Ljava/time/ZoneId;)Ljava/time/ZonedDateTime;
    .registers 6
...
.method public whitelist core-platform-api test-api atTime(II)Ljava/time/LocalDateTime;
    .registers 4
    .param p1, "hour"    # I
    .param p2, "minute"    # I
...
.method public whitelist core-platform-api test-api atTime(III)Ljava/time/LocalDateTime;
    .registers 5
    .param p1, "hour"    # I
    .param p2, "minute"    # I
    .param p3, "second"    # I
...
.method public whitelist core-platform-api test-api atTime(IIII)Ljava/time/LocalDateTime;
    .registers 6
    .param p1, "hour"    # I
    .param p2, "minute"    # I
    .param p3, "second"    # I
...
.method public whitelist core-platform-api test-api atTime(Ljava/time/LocalTime;)Ljava/time/LocalDateTime;
    .registers 3
...
.method public whitelist core-platform-api test-api atTime(Ljava/time/OffsetTime;)Ljava/time/OffsetDateTime;
    .registers 4
...
.method public bridge synthetic whitelist core-platform-api test-api atTime(Ljava/time/LocalTime;)Ljava/time/chrono/ChronoLocalDateTime;
    .registers 2
...
.method public whitelist core-platform-api test-api compareTo(Ljava/time/chrono/ChronoLocalDate;)I
    .registers 3
...
.method public whitelist core-platform-api test-api getEra()Ljava/time/chrono/Era;
    .registers 2
...
.method public whitelist core-platform-api test-api isAfter(Ljava/time/chrono/ChronoLocalDate;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/chrono/ChronoLocalDate;
...
.method public whitelist core-platform-api test-api isBefore(Ljava/time/chrono/ChronoLocalDate;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/chrono/ChronoLocalDate;
...
.method public whitelist core-platform-api test-api isEqual(Ljava/time/chrono/ChronoLocalDate;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/chrono/ChronoLocalDate;
...
.method public whitelist core-platform-api test-api isLeapYear()Z
    .registers 4
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/LocalDate;
    .registers 7
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api minusDays(J)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api minusMonths(J)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api minusWeeks(J)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api minusYears(J)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/LocalDate;
    .registers 8
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api plusDays(J)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api plusMonths(J)Ljava/time/LocalDate;
    .registers 12
    ...
    iget-short v4, p0, Ljava/time/LocalDate;->month:S
    ...
    .line 1303
    .local v2, "newMonth":I
    iget-short v3, p0, Ljava/time/LocalDate;->day:S

    invoke-static {v6, v2, v3}, Ljava/time/LocalDate;->resolvePreviousValid(III)Ljava/time/LocalDate;
...
.method public whitelist core-platform-api test-api plusWeeks(J)Ljava/time/LocalDate;
    .registers 5
...
.method public whitelist core-platform-api test-api plusYears(J)Ljava/time/LocalDate;
    .registers 6
...
.method public whitelist core-platform-api test-api until(Ljava/time/chrono/ChronoLocalDate;)Ljava/time/Period;
    .registers 11
...
.method public bridge synthetic whitelist core-platform-api test-api until(Ljava/time/chrono/ChronoLocalDate;)Ljava/time/chrono/ChronoPeriod;
    .registers 2
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/LocalDate;
    .registers 3
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/LocalDate;
    .registers 9
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
...
.method public whitelist core-platform-api test-api withDayOfMonth(I)Ljava/time/LocalDate;
    .registers 4
...
.method public whitelist core-platform-api test-api withDayOfYear(I)Ljava/time/LocalDate;
    .registers 3
    .param p1, "dayOfYear"    # I
...
.method public whitelist core-platform-api test-api withMonth(I)Ljava/time/LocalDate;
    .registers 5
    .param p1, "month"    # I
...
.method public whitelist core-platform-api test-api withYear(I)Ljava/time/LocalDate;
    .registers 5
    .param p1, "year"    # I
