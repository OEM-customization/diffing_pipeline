...
.field public static final whitelist core-platform-api test-api MAX:Ljava/time/LocalTime;

.field static final greylist-max-o MICROS_PER_DAY:J = 0x141dd76000L

.field public static final whitelist core-platform-api test-api MIDNIGHT:Ljava/time/LocalTime;

.field static final greylist-max-o MILLIS_PER_DAY:J = 0x5265c00L

.field public static final whitelist core-platform-api test-api MIN:Ljava/time/LocalTime;
...
.field public static final whitelist core-platform-api test-api NOON:Ljava/time/LocalTime;
...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/LocalTime;
    .registers 5
...
.method public static whitelist core-platform-api test-api now()Ljava/time/LocalTime;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/LocalTime;
    .registers 10
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/LocalTime;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(II)Ljava/time/LocalTime;
    .registers 5
    .param p0, "hour"    # I
    .param p1, "minute"    # I
...
.method public static whitelist core-platform-api test-api of(III)Ljava/time/LocalTime;
    .registers 6
    .param p0, "hour"    # I
    .param p1, "minute"    # I
    .param p2, "second"    # I
...
.method public static whitelist core-platform-api test-api of(IIII)Ljava/time/LocalTime;
    .registers 7
    .param p0, "hour"    # I
    .param p1, "minute"    # I
    .param p2, "second"    # I
...
.method public static whitelist core-platform-api test-api ofNanoOfDay(J)Ljava/time/LocalTime;
    .registers 9
...
.method public static whitelist core-platform-api test-api ofSecondOfDay(J)Ljava/time/LocalTime;
    .registers 6
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;)Ljava/time/LocalTime;
    .registers 2
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;Ljava/time/format/DateTimeFormatter;)Ljava/time/LocalTime;
    .registers 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    ...
    .line 435
    sget-object v0, Ljava/time/-$$Lambda$2Dm_gBEmfWAFyI8wDj_HTrgAgUc;->INSTANCE:Ljava/time/-$$Lambda$2Dm_gBEmfWAFyI8wDj_HTrgAgUc;
...
.method public whitelist core-platform-api test-api atDate(Ljava/time/LocalDate;)Ljava/time/LocalDateTime;
    .registers 3
...
.method public whitelist core-platform-api test-api atOffset(Ljava/time/ZoneOffset;)Ljava/time/OffsetTime;
    .registers 3
...
.method public whitelist core-platform-api test-api compareTo(Ljava/time/LocalTime;)I
    .registers 5
...
.method public whitelist core-platform-api test-api isAfter(Ljava/time/LocalTime;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/LocalTime;
...
.method public whitelist core-platform-api test-api isBefore(Ljava/time/LocalTime;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/LocalTime;
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/LocalTime;
    .registers 7
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/LocalTime;
    .registers 3
...
.method public whitelist core-platform-api test-api minusHours(J)Ljava/time/LocalTime;
    .registers 5
...
.method public whitelist core-platform-api test-api minusMinutes(J)Ljava/time/LocalTime;
    .registers 5
...
.method public whitelist core-platform-api test-api minusNanos(J)Ljava/time/LocalTime;
    .registers 5
...
.method public whitelist core-platform-api test-api minusSeconds(J)Ljava/time/LocalTime;
    .registers 5
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/LocalTime;
    .registers 8
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/LocalTime;
    .registers 3
...
.method public whitelist core-platform-api test-api plusHours(J)Ljava/time/LocalTime;
    .registers 7
...
.method public whitelist core-platform-api test-api plusMinutes(J)Ljava/time/LocalTime;
    .registers 9
...
.method public whitelist core-platform-api test-api plusNanos(J)Ljava/time/LocalTime;
    .registers 15
...
.method public whitelist core-platform-api test-api plusSeconds(J)Ljava/time/LocalTime;
    .registers 9
...
.method public whitelist core-platform-api test-api toNanoOfDay()J
    .registers 7
...
.method public whitelist core-platform-api test-api toSecondOfDay()I
    .registers 3
...
.method public whitelist core-platform-api test-api truncatedTo(Ljava/time/temporal/TemporalUnit;)Ljava/time/LocalTime;
    .registers 9
    .param p1, "unit"    # Ljava/time/temporal/TemporalUnit;
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/LocalTime;
    .registers 3
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/LocalTime;
    .registers 10
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
...
.method public whitelist core-platform-api test-api withHour(I)Ljava/time/LocalTime;
    .registers 5
    .param p1, "hour"    # I
...
.method public whitelist core-platform-api test-api withMinute(I)Ljava/time/LocalTime;
    .registers 5
    .param p1, "minute"    # I
...
.method public whitelist core-platform-api test-api withNano(I)Ljava/time/LocalTime;
    .registers 5
...
.method public whitelist core-platform-api test-api withSecond(I)Ljava/time/LocalTime;
    .registers 5
    .param p1, "second"    # I
