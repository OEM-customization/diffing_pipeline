...
.method public static varargs whitelist core-platform-api test-api open(Ljava/nio/file/Path;Ljava/util/Set;Ljava/util/concurrent/ExecutorService;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/AsynchronousFileChannel;
    .registers 6
...
.method public static varargs whitelist core-platform-api test-api open(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/nio/channels/AsynchronousFileChannel;
    .registers 5
    .param p0, "file"    # Ljava/nio/file/Path;
...
.method public final whitelist core-platform-api test-api lock()Ljava/util/concurrent/Future;
    .registers 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public abstract whitelist core-platform-api test-api lock(JJZ)Ljava/util/concurrent/Future;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JJZ)",
            "Ljava/util/concurrent/Future<",
...
.method public abstract whitelist core-platform-api test-api lock(JJZLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A:",
            "Ljava/lang/Object;",
...
.method public final whitelist core-platform-api test-api lock(Ljava/lang/Object;Ljava/nio/channels/CompletionHandler;)V
    .registers 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A:",
...
.method public abstract whitelist core-platform-api test-api read(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public abstract whitelist core-platform-api test-api read(Ljava/nio/ByteBuffer;JLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A:",
            "Ljava/lang/Object;",
...
.method public abstract whitelist core-platform-api test-api truncate(J)Ljava/nio/channels/AsynchronousFileChannel;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api write(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/nio/ByteBuffer;",
...
.method public abstract whitelist core-platform-api test-api write(Ljava/nio/ByteBuffer;JLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A:",
            "Ljava/lang/Object;",
