...
# virtual methods
.method public whitelist core-platform-api test-api asReadOnlyBuffer()Ljava/nio/LongBuffer;
    .registers 10

    .line 78
    new-instance v8, Ljava/nio/ByteBufferAsLongBuffer;
...
.method public whitelist core-platform-api test-api compact()Ljava/nio/LongBuffer;
    .registers 15
    ...
    .local v3, "rem":I
    :goto_14
    iget-object v4, p0, Ljava/nio/ByteBufferAsLongBuffer;->bb:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0}, Ljava/nio/ByteBufferAsLongBuffer;->ix(I)I

    move-result v5

    iget-object v6, p0, Ljava/nio/ByteBufferAsLongBuffer;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {v6}, Ljava/nio/ByteBuffer;->array()[B

    move-result-object v6

    invoke-virtual {p0, v2}, Ljava/nio/ByteBufferAsLongBuffer;->ix(I)I
    ...
    .line 143
    :goto_42
    invoke-virtual {p0, v3}, Ljava/nio/ByteBufferAsLongBuffer;->position(I)Ljava/nio/Buffer;
    ...
    invoke-virtual {p0, v2}, Ljava/nio/ByteBufferAsLongBuffer;->limit(I)Ljava/nio/Buffer;
...
.method public whitelist core-platform-api test-api duplicate()Ljava/nio/LongBuffer;
    .registers 10
...
.method public whitelist core-platform-api test-api get()J
    .registers 3
...
.method public whitelist core-platform-api test-api get(I)J
    .registers 4
    .param p1, "i"    # I
...
.method public whitelist core-platform-api test-api put(IJ)Ljava/nio/LongBuffer;
    .registers 6
    .param p1, "i"    # I
    .param p2, "x"    # J
...
.method public whitelist core-platform-api test-api put(J)Ljava/nio/LongBuffer;
    .registers 4
    .param p1, "x"    # J
...
.method public whitelist core-platform-api test-api slice()Ljava/nio/LongBuffer;
    .registers 13
    ...
    iget v3, p0, Ljava/nio/ByteBufferAsLongBuffer;->offset:I
    ...
    .line 64
    new-instance v11, Ljava/nio/ByteBufferAsLongBuffer;
    ...
    iget-object v10, p0, Ljava/nio/ByteBufferAsLongBuffer;->order:Ljava/nio/ByteOrder;
    ...
    invoke-direct/range {v3 .. v10}, Ljava/nio/ByteBufferAsLongBuffer;-><init>(Ljava/nio/ByteBuffer;IIIIILjava/nio/ByteOrder;)V
