...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    .registers 5
    .param p1, "source"    # Ljava/io/InputStream;
    .param p2, "charsetName"    # Ljava/lang/String;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/Readable;)V
    .registers 4
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/nio/channels/ReadableByteChannel;)V
    .registers 4
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/nio/channels/ReadableByteChannel;Ljava/lang/String;)V
    .registers 5
    .param p1, "source"    # Ljava/nio/channels/ReadableByteChannel;
    .param p2, "charsetName"    # Ljava/lang/String;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/nio/file/Path;)V
    .registers 3
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/nio/file/Path;Ljava/lang/String;)V
    .registers 5
    .param p1, "source"    # Ljava/nio/file/Path;
    .param p2, "charsetName"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist core-platform-api test-api delimiter()Ljava/util/regex/Pattern;
    .registers 2
...
.method public whitelist core-platform-api test-api findInLine(Ljava/lang/String;)Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api findInLine(Ljava/util/regex/Pattern;)Ljava/lang/String;
    .registers 6
    .param p1, "pattern"    # Ljava/util/regex/Pattern;
    ...
    invoke-direct {p0, v2, v3}, Ljava/util/Scanner;->findPatternInBuffer(Ljava/util/regex/Pattern;I)Ljava/lang/String;
    ...
    .line 1639
    :cond_38
    invoke-virtual {p0, p1, v2}, Ljava/util/Scanner;->findWithinHorizon(Ljava/util/regex/Pattern;I)Ljava/lang/String;
    ...
    .end local v2    # "horizonForLine":I
    :cond_3d
    throw v0
.end method

.method public whitelist core-platform-api test-api findWithinHorizon(Ljava/lang/String;I)Ljava/lang/String;
    .registers 4
    .param p1, "pattern"    # Ljava/lang/String;
    .param p2, "horizon"    # I
...
.method public whitelist core-platform-api test-api findWithinHorizon(Ljava/util/regex/Pattern;I)Ljava/lang/String;
    .registers 6
    .param p1, "pattern"    # Ljava/util/regex/Pattern;
    .param p2, "horizon"    # I
...
.method public whitelist core-platform-api test-api hasNext(Ljava/lang/String;)Z
    .registers 3
    .param p1, "pattern"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api hasNext(Ljava/util/regex/Pattern;)Z
    .registers 3
    .param p1, "pattern"    # Ljava/util/regex/Pattern;
...
.method public whitelist core-platform-api test-api hasNextBigDecimal()Z
    .registers 4
...
.method public whitelist core-platform-api test-api hasNextBigInteger()Z
    .registers 2
...
.method public whitelist core-platform-api test-api hasNextBigInteger(I)Z
    .registers 5
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api hasNextBoolean()Z
    .registers 2
...
.method public whitelist core-platform-api test-api hasNextByte()Z
    .registers 2
...
.method public whitelist core-platform-api test-api hasNextByte(I)Z
    .registers 5
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api hasNextDouble()Z
    .registers 5
...
.method public whitelist core-platform-api test-api hasNextFloat()Z
    .registers 4
...
.method public whitelist core-platform-api test-api hasNextInt()Z
    .registers 2
...
.method public whitelist core-platform-api test-api hasNextInt(I)Z
    .registers 5
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api hasNextLine()Z
    .registers 8
...
.method public whitelist core-platform-api test-api hasNextLong()Z
    .registers 2
...
.method public whitelist core-platform-api test-api hasNextLong(I)Z
    .registers 6
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api hasNextShort()Z
    .registers 2
...
.method public whitelist core-platform-api test-api hasNextShort(I)Z
    .registers 5
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api ioException()Ljava/io/IOException;
    .registers 2
...
.method public whitelist core-platform-api test-api locale()Ljava/util/Locale;
    .registers 2
...
.method public whitelist core-platform-api test-api match()Ljava/util/regex/MatchResult;
    .registers 3
...
.method public whitelist core-platform-api test-api next()Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api next(Ljava/lang/String;)Ljava/lang/String;
    .registers 3
    .param p1, "pattern"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api next(Ljava/util/regex/Pattern;)Ljava/lang/String;
    .registers 4
    .param p1, "pattern"    # Ljava/util/regex/Pattern;
...
.method public whitelist core-platform-api test-api nextBigDecimal()Ljava/math/BigDecimal;
    .registers 4
...
.method public whitelist core-platform-api test-api nextBigInteger()Ljava/math/BigInteger;
    .registers 2
...
.method public whitelist core-platform-api test-api nextBigInteger(I)Ljava/math/BigInteger;
    .registers 5
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api nextByte()B
    .registers 2
...
.method public whitelist core-platform-api test-api nextByte(I)B
    .registers 5
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api nextLine()Ljava/lang/String;
    .registers 7
...
.method public whitelist core-platform-api test-api nextLong(I)J
    .registers 5
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api nextShort()S
    .registers 2
...
.method public whitelist core-platform-api test-api nextShort(I)S
    .registers 5
    .param p1, "radix"    # I
...
.method public whitelist core-platform-api test-api radix()I
    .registers 2
...
.method public whitelist core-platform-api test-api reset()Ljava/util/Scanner;
    .registers 2
...
.method public whitelist core-platform-api test-api skip(Ljava/lang/String;)Ljava/util/Scanner;
    .registers 3
    .param p1, "pattern"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api skip(Ljava/util/regex/Pattern;)Ljava/util/Scanner;
    .registers 4
    .param p1, "pattern"    # Ljava/util/regex/Pattern;
...
.method public whitelist core-platform-api test-api useDelimiter(Ljava/lang/String;)Ljava/util/Scanner;
    .registers 3
    .param p1, "pattern"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api useDelimiter(Ljava/util/regex/Pattern;)Ljava/util/Scanner;
    .registers 2
    .param p1, "pattern"    # Ljava/util/regex/Pattern;
...
.method public whitelist core-platform-api test-api useLocale(Ljava/util/Locale;)Ljava/util/Scanner;
    .registers 8
...
.method public whitelist core-platform-api test-api useRadix(I)Ljava/util/Scanner;
    .registers 5
    .param p1, "radix"    # I
