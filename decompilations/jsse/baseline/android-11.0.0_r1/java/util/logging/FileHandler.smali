...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/String;II)V
    .registers 6
    .param p1, "pattern"    # Ljava/lang/String;
    .param p2, "limit"    # I
    .param p3, "count"    # I
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/String;IIZ)V
    .registers 7
    .param p1, "pattern"    # Ljava/lang/String;
    .param p2, "limit"    # I
    .param p3, "count"    # I
...
.method private greylist-max-o openFiles()V
    ...
    .line 448
    :try_start_42
    sget-object v6, Ljava/util/logging/FileHandler;->locks:Ljava/util/Set;

    iget-object v7, p0, Ljava/util/logging/FileHandler;->lockFileName:Ljava/lang/String;
    ...
    move-result-object v6
    :try_end_56
    .catchall {:try_start_42 .. :try_end_56} :catchall_120
    ...
    move-result-object v8
    :try_end_6e
    .catch Ljava/nio/file/FileAlreadyExistsException; {:try_start_60 .. :try_end_6e} :catch_72
    .catchall {:try_start_60 .. :try_end_6e} :catchall_120
    ...
    move-result v12
    :try_end_83
    .catchall {:try_start_73 .. :try_end_83} :catchall_120
    ...
    move-result-object v8
    :try_end_93
    .catch Ljava/nio/file/NoSuchFileException; {:try_start_85 .. :try_end_93} :catch_97
    .catch Ljava/io/IOException; {:try_start_85 .. :try_end_93} :catch_95
    .catchall {:try_start_85 .. :try_end_93} :catchall_120
    ...
    :try_end_a2
    .catchall {:try_start_9d .. :try_end_a2} :catchall_120
    ...
    :try_end_a6
    .catch Ljava/io/IOException; {:try_start_a2 .. :try_end_a6} :catch_b0
    .catch Ljava/nio/channels/OverlappingFileLockException; {:try_start_a2 .. :try_end_a6} :catch_ac
    .catchall {:try_start_a2 .. :try_end_a6} :catchall_120
    ...
    monitor-exit v5
    :try_end_bd
    .catchall {:try_start_b5 .. :try_end_bd} :catchall_120
...
.method public declared-synchronized whitelist core-platform-api test-api close()V
    ...
    monitor-exit v0
    :try_end_1c
    .catchall {:try_start_14 .. :try_end_1c} :catchall_2d
