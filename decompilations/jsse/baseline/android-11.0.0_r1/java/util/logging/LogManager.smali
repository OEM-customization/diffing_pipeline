...
.field public static final whitelist core-platform-api test-api LOGGING_MXBEAN_NAME:Ljava/lang/String; = "java.util.logging:type=Logging"
...
.method public static whitelist core-platform-api test-api getLogManager()Ljava/util/logging/LogManager;
    .registers 1
...
.method public static declared-synchronized whitelist core-platform-api test-api getLoggingMXBean()Ljava/util/logging/LoggingMXBean;
    .registers 2
...
# virtual methods
.method public whitelist core-platform-api test-api addLogger(Ljava/util/logging/Logger;)Z
    .registers 6
    .param p1, "logger"    # Ljava/util/logging/Logger;
...
.method public whitelist core-platform-api test-api checkAccess()V
    .registers 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/SecurityException;
...
.method greylist getFormatterProperty(Ljava/lang/String;Ljava/util/logging/Formatter;)Ljava/util/logging/Formatter;
    .registers 5
    .param p1, "name"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api getLogger(Ljava/lang/String;)Ljava/util/logging/Logger;
    .registers 3
    .param p1, "name"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api getLoggerNames()Ljava/util/Enumeration;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist core-platform-api test-api readConfiguration()V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api readConfiguration(Ljava/io/InputStream;)V
    .registers 10
