...
.method public whitelist core-platform-api test-api forEachRemaining(Ljava/util/function/Consumer;)V
    ...
    iget v3, p0, Ljava/util/WeakHashMap$ValueSpliterator;->fence:I
    ...
    iput v3, p0, Ljava/util/WeakHashMap$ValueSpliterator;->expectedModCount:I

    .line 1200
    .local v3, "mc":I
    array-length v5, v2

    iput v5, p0, Ljava/util/WeakHashMap$ValueSpliterator;->fence:I
    ...
    .end local v3    # "mc":I
    :cond_15
    iget v3, p0, Ljava/util/WeakHashMap$ValueSpliterator;->expectedModCount:I
    ...
    iget v5, p0, Ljava/util/WeakHashMap$ValueSpliterator;->index:I
    ...
    iput v4, p0, Ljava/util/WeakHashMap$ValueSpliterator;->index:I
    ...
    iput-object v0, p0, Ljava/util/WeakHashMap$ValueSpliterator;->current:Ljava/util/WeakHashMap$Entry;
