...
.method public final whitelist core-platform-api test-api isParallel()Z
    .registers 2
...
.method public whitelist core-platform-api test-api onClose(Ljava/lang/Runnable;)Ljava/util/stream/BaseStream;
    .registers 5
...
.method public greylist-max-o opEvaluateParallelLazy(Ljava/util/stream/PipelineHelper;Ljava/util/Spliterator;)Ljava/util/Spliterator;
    ...
    .local p1, "helper":Ljava/util/stream/PipelineHelper;, "Ljava/util/stream/PipelineHelper<TE_OUT;>;"
    .local p2, "spliterator":Ljava/util/Spliterator;, "Ljava/util/Spliterator<TP_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$AbstractPipeline$wEsmW74nQaCA9FYTjN7e9qkJaXE;->INSTANCE:Ljava/util/stream/-$$Lambda$AbstractPipeline$wEsmW74nQaCA9FYTjN7e9qkJaXE;
...
.method public final whitelist core-platform-api test-api parallel()Ljava/util/stream/BaseStream;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TS;"
...
.method public final whitelist core-platform-api test-api sequential()Ljava/util/stream/BaseStream;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TS;"
...
.method public whitelist core-platform-api test-api spliterator()Ljava/util/Spliterator;
    ...
    .line 367
    :cond_2a
    new-instance v0, Ljava/util/stream/-$$Lambda$AbstractPipeline$ImXhRLJT29W8lJFXpTT_PieAotg;

    invoke-direct {v0, p0}, Ljava/util/stream/-$$Lambda$AbstractPipeline$ImXhRLJT29W8lJFXpTT_PieAotg;-><init>(Ljava/util/stream/AbstractPipeline;)V
...
.method final greylist-max-o wrapSpliterator(Ljava/util/Spliterator;)Ljava/util/Spliterator;
    ...
    .line 535
    :cond_5
    new-instance v0, Ljava/util/stream/-$$Lambda$AbstractPipeline$i18ybop3uEZwLQyKh7zmnuTXiFw;

    invoke-direct {v0, p1}, Ljava/util/stream/-$$Lambda$AbstractPipeline$i18ybop3uEZwLQyKh7zmnuTXiFw;-><init>(Ljava/util/Spliterator;)V
