...
.method public blacklist opEvaluateParallel(Ljava/util/stream/PipelineHelper;Ljava/util/Spliterator;Ljava/util/function/IntFunction;)Ljava/util/stream/Node;
    ...
    new-instance v3, Ljava/util/stream/-$$Lambda$DistinctOps$1$y8chmSlaKpIKb_VPPBaXdCNT51c;

    invoke-direct {v3, v0, v2}, Ljava/util/stream/-$$Lambda$DistinctOps$1$y8chmSlaKpIKb_VPPBaXdCNT51c;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/concurrent/ConcurrentHashMap;)V
...
.method blacklist reduce(Ljava/util/stream/PipelineHelper;Ljava/util/Spliterator;)Ljava/util/stream/Node;
    ...
    .local p1, "helper":Ljava/util/stream/PipelineHelper;, "Ljava/util/stream/PipelineHelper<TT;>;"
    .local p2, "spliterator":Ljava/util/Spliterator;, "Ljava/util/Spliterator<TP_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$VQnU3Jki1-RCSS5B-Yg_Kf6hQAY;->INSTANCE:Ljava/util/stream/-$$Lambda$VQnU3Jki1-RCSS5B-Yg_Kf6hQAY;

    sget-object v1, Ljava/util/stream/-$$Lambda$zcFI7bYCRDtB1UMy72aPExbc6R4;->INSTANCE:Ljava/util/stream/-$$Lambda$zcFI7bYCRDtB1UMy72aPExbc6R4;

    sget-object v2, Ljava/util/stream/-$$Lambda$r6LgDiay3Ow5w51ifJiV4dn8S84;->INSTANCE:Ljava/util/stream/-$$Lambda$r6LgDiay3Ow5w51ifJiV4dn8S84;
