...
.method public whitelist core-platform-api test-api forEachRemaining(Ljava/util/function/Consumer;)V
    ...
    new-instance v1, Ljava/util/stream/-$$Lambda$btpzqYSQDsLykCcQbI2_g5D3-zs;

    invoke-direct {v1, p1}, Ljava/util/stream/-$$Lambda$btpzqYSQDsLykCcQbI2_g5D3-zs;-><init>(Ljava/util/function/Consumer;)V
...
.method blacklist initPartialTraversalState()V
    ...
    new-instance v2, Ljava/util/stream/-$$Lambda$GF-s38TgrG6hfxe__ZFdhGp-wPw;

    invoke-direct {v2, v0}, Ljava/util/stream/-$$Lambda$GF-s38TgrG6hfxe__ZFdhGp-wPw;-><init>(Ljava/util/stream/SpinedBuffer;)V
    ...
    .line 294
    new-instance v1, Ljava/util/stream/-$$Lambda$StreamSpliterators$WrappingSpliterator$Ky6g3CKkCccuRWAvbAL1cAsdkNk;

    invoke-direct {v1, p0}, Ljava/util/stream/-$$Lambda$StreamSpliterators$WrappingSpliterator$Ky6g3CKkCccuRWAvbAL1cAsdkNk;-><init>(Ljava/util/stream/StreamSpliterators$WrappingSpliterator;)V
