...
# virtual methods
.method public whitelist core-platform-api test-api build()Ljava/util/Calendar;
    .registers 8
    ...
    invoke-direct {v0, v1, v2, v6}, Ljava/util/GregorianCalendar;-><init>(Ljava/util/TimeZone;Ljava/util/Locale;Z)V
...
.method public whitelist core-platform-api test-api set(II)Ljava/util/Calendar$Builder;
    .registers 5
    .param p1, "field"    # I
    .param p2, "value"    # I
...
.method public whitelist core-platform-api test-api setCalendarType(Ljava/lang/String;)Ljava/util/Calendar$Builder;
    .registers 5
...
.method public whitelist core-platform-api test-api setDate(III)Ljava/util/Calendar$Builder;
    .registers 7
    .param p1, "year"    # I
    .param p2, "month"    # I
...
.method public varargs whitelist core-platform-api test-api setFields([I)Ljava/util/Calendar$Builder;
    .registers 7
...
.method public whitelist core-platform-api test-api setInstant(J)Ljava/util/Calendar$Builder;
    .registers 4
    .param p1, "instant"    # J
...
.method public whitelist core-platform-api test-api setInstant(Ljava/util/Date;)Ljava/util/Calendar$Builder;
    .registers 4
...
.method public whitelist core-platform-api test-api setLenient(Z)Ljava/util/Calendar$Builder;
    .registers 2
    .param p1, "lenient"    # Z
...
.method public whitelist core-platform-api test-api setLocale(Ljava/util/Locale;)Ljava/util/Calendar$Builder;
    .registers 3
...
.method public whitelist core-platform-api test-api setTimeOfDay(III)Ljava/util/Calendar$Builder;
    .registers 5
...
.method public whitelist core-platform-api test-api setTimeOfDay(IIII)Ljava/util/Calendar$Builder;
    .registers 8
    .param p1, "hourOfDay"    # I
    .param p2, "minute"    # I
    .param p3, "second"    # I
...
.method public whitelist core-platform-api test-api setTimeZone(Ljava/util/TimeZone;)Ljava/util/Calendar$Builder;
    .registers 3
...
.method public whitelist core-platform-api test-api setWeekDate(III)Ljava/util/Calendar$Builder;
    .registers 5
    .param p1, "weekYear"    # I
...
.method public whitelist core-platform-api test-api setWeekDefinition(II)Ljava/util/Calendar$Builder;
    .registers 4
