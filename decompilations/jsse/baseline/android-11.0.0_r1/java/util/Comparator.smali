...
# direct methods
.method public static whitelist core-platform-api test-api comparing(Ljava/util/function/Function;)Ljava/util/Comparator;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 468
    new-instance v0, Ljava/util/-$$Lambda$Comparator$SPB8K9Yj7Pw1mljm7LpasV7zxWw;

    invoke-direct {v0, p0}, Ljava/util/-$$Lambda$Comparator$SPB8K9Yj7Pw1mljm7LpasV7zxWw;-><init>(Ljava/util/function/Function;)V
...
.method public static whitelist core-platform-api test-api comparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 435
    new-instance v0, Ljava/util/-$$Lambda$Comparator$KVN0LWz1D1wyrL2gs1CbubvLa9o;

    invoke-direct {v0, p1, p0}, Ljava/util/-$$Lambda$Comparator$KVN0LWz1D1wyrL2gs1CbubvLa9o;-><init>(Ljava/util/Comparator;Ljava/util/function/Function;)V
...
.method public static whitelist core-platform-api test-api comparingDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 531
    new-instance v0, Ljava/util/-$$Lambda$Comparator$edSxqANnwdmzeJ1aMMcwJWE2wII;

    invoke-direct {v0, p0}, Ljava/util/-$$Lambda$Comparator$edSxqANnwdmzeJ1aMMcwJWE2wII;-><init>(Ljava/util/function/ToDoubleFunction;)V
...
.method public static whitelist core-platform-api test-api comparingInt(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 489
    new-instance v0, Ljava/util/-$$Lambda$Comparator$DNgpxUFZqmT4lOBzlVyPjWwvEvw;

    invoke-direct {v0, p0}, Ljava/util/-$$Lambda$Comparator$DNgpxUFZqmT4lOBzlVyPjWwvEvw;-><init>(Ljava/util/function/ToIntFunction;)V
...
.method public static whitelist core-platform-api test-api comparingLong(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 510
    new-instance v0, Ljava/util/-$$Lambda$Comparator$4V5k8aLimtS0VsEILEAqQ9UGZYo;

    invoke-direct {v0, p0}, Ljava/util/-$$Lambda$Comparator$4V5k8aLimtS0VsEILEAqQ9UGZYo;-><init>(Ljava/util/function/ToLongFunction;)V
...
.method public static whitelist core-platform-api test-api naturalOrder()Ljava/util/Comparator;
    .registers 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
...
.method public static whitelist core-platform-api test-api nullsFirst(Ljava/util/Comparator;)Ljava/util/Comparator;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static whitelist core-platform-api test-api nullsLast(Ljava/util/Comparator;)Ljava/util/Comparator;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
# virtual methods
.method public abstract whitelist core-platform-api test-api compare(Ljava/lang/Object;Ljava/lang/Object;)I
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;TT;)I"
        }
...
.method public whitelist core-platform-api test-api thenComparing(Ljava/util/Comparator;)Ljava/util/Comparator;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 215
    new-instance v0, Ljava/util/-$$Lambda$Comparator$BZSVCoA8i87ehjxxZ1weEounfDQ;

    invoke-direct {v0, p0, p1}, Ljava/util/-$$Lambda$Comparator$BZSVCoA8i87ehjxxZ1weEounfDQ;-><init>(Ljava/util/Comparator;Ljava/util/Comparator;)V
...
.method public whitelist core-platform-api test-api thenComparing(Ljava/util/function/Function;)Ljava/util/Comparator;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U::",
...
.method public whitelist core-platform-api test-api thenComparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
...
.method public whitelist core-platform-api test-api thenComparingDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api thenComparingInt(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api thenComparingLong(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
