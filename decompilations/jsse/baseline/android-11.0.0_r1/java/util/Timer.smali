...
.method public whitelist core-platform-api test-api purge()I
    .registers 6
...
.method public whitelist core-platform-api test-api schedule(Ljava/util/TimerTask;J)V
    .registers 12
    .param p1, "task"    # Ljava/util/TimerTask;
    .param p2, "delay"    # J
...
.method public whitelist core-platform-api test-api schedule(Ljava/util/TimerTask;JJ)V
    .registers 14
    .param p1, "task"    # Ljava/util/TimerTask;
    .param p2, "delay"    # J
    .param p4, "period"    # J
...
.method public whitelist core-platform-api test-api schedule(Ljava/util/TimerTask;Ljava/util/Date;)V
    .registers 9
    .param p1, "task"    # Ljava/util/TimerTask;
...
.method public whitelist core-platform-api test-api schedule(Ljava/util/TimerTask;Ljava/util/Date;J)V
    .registers 12
    .param p1, "task"    # Ljava/util/TimerTask;
...
.method public whitelist core-platform-api test-api scheduleAtFixedRate(Ljava/util/TimerTask;JJ)V
    .registers 14
    .param p1, "task"    # Ljava/util/TimerTask;
    .param p2, "delay"    # J
    .param p4, "period"    # J
...
.method public whitelist core-platform-api test-api scheduleAtFixedRate(Ljava/util/TimerTask;Ljava/util/Date;J)V
    .registers 12
    .param p1, "task"    # Ljava/util/TimerTask;
    .param p2, "firstTime"    # Ljava/util/Date;
    .param p3, "period"    # J
