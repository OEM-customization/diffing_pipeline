...
.method public static whitelist core-platform-api test-api callable(Ljava/lang/Runnable;)Ljava/util/concurrent/Callable;
    .registers 3
    ...
    .line 397
    new-instance v1, Ljava/util/concurrent/Executors$RunnableAdapter;

    invoke-direct {v1, p0, v0}, Ljava/util/concurrent/Executors$RunnableAdapter;-><init>(Ljava/lang/Runnable;Ljava/lang/Object;)V
...
.method public static whitelist core-platform-api test-api callable(Ljava/lang/Runnable;Ljava/lang/Object;)Ljava/util/concurrent/Callable;
    .registers 3
    .param p0, "task"    # Ljava/lang/Runnable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static whitelist core-platform-api test-api callable(Ljava/security/PrivilegedAction;)Ljava/util/concurrent/Callable;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static whitelist core-platform-api test-api callable(Ljava/security/PrivilegedExceptionAction;)Ljava/util/concurrent/Callable;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static whitelist core-platform-api test-api defaultThreadFactory()Ljava/util/concurrent/ThreadFactory;
    .registers 1
...
.method public static whitelist core-platform-api test-api newCachedThreadPool()Ljava/util/concurrent/ExecutorService;
    .registers 8
...
.method public static whitelist core-platform-api test-api newCachedThreadPool(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;
    .registers 10
...
.method public static whitelist core-platform-api test-api newFixedThreadPool(I)Ljava/util/concurrent/ExecutorService;
    .registers 9
    .param p0, "nThreads"    # I
...
.method public static whitelist core-platform-api test-api newFixedThreadPool(ILjava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;
    .registers 11
    .param p0, "nThreads"    # I
...
.method public static whitelist core-platform-api test-api newScheduledThreadPool(I)Ljava/util/concurrent/ScheduledExecutorService;
    .registers 2
...
.method public static whitelist core-platform-api test-api newScheduledThreadPool(ILjava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    .registers 3
    .param p0, "corePoolSize"    # I
    .param p1, "threadFactory"    # Ljava/util/concurrent/ThreadFactory;
...
.method public static whitelist core-platform-api test-api newSingleThreadExecutor()Ljava/util/concurrent/ExecutorService;
    .registers 9
...
.method public static whitelist core-platform-api test-api newSingleThreadExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;
    .registers 11
    .param p0, "threadFactory"    # Ljava/util/concurrent/ThreadFactory;
...
.method public static whitelist core-platform-api test-api newSingleThreadScheduledExecutor()Ljava/util/concurrent/ScheduledExecutorService;
    .registers 3
...
.method public static whitelist core-platform-api test-api newSingleThreadScheduledExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    .registers 4
    .param p0, "threadFactory"    # Ljava/util/concurrent/ThreadFactory;
...
.method public static whitelist core-platform-api test-api newWorkStealingPool()Ljava/util/concurrent/ExecutorService;
    .registers 5
...
.method public static whitelist core-platform-api test-api newWorkStealingPool(I)Ljava/util/concurrent/ExecutorService;
    .registers 5
...
.method public static whitelist core-platform-api test-api privilegedCallable(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static whitelist core-platform-api test-api privilegedCallableUsingCurrentClassLoader(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static whitelist core-platform-api test-api privilegedThreadFactory()Ljava/util/concurrent/ThreadFactory;
    .registers 1
...
.method public static whitelist core-platform-api test-api unconfigurableExecutorService(Ljava/util/concurrent/ExecutorService;)Ljava/util/concurrent/ExecutorService;
    .registers 2
...
.method public static whitelist core-platform-api test-api unconfigurableScheduledExecutorService(Ljava/util/concurrent/ScheduledExecutorService;)Ljava/util/concurrent/ScheduledExecutorService;
    .registers 2
