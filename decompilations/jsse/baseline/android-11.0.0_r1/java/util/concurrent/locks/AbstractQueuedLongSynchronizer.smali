...
.method static constructor blacklist <clinit>()V
    ...
    sput-wide v1, Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer;->STATE:J
    ...
    sput-wide v1, Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer;->HEAD:J
...
# virtual methods
.method public final whitelist core-platform-api test-api acquire(J)V
    .registers 4
    .param p1, "arg"    # J
...
.method public final whitelist core-platform-api test-api acquireInterruptibly(J)V
    .registers 4
    .param p1, "arg"    # J
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final whitelist core-platform-api test-api acquireShared(J)V
    .registers 7
    .param p1, "arg"    # J
...
.method public final whitelist core-platform-api test-api acquireSharedInterruptibly(J)V
    .registers 7
    .param p1, "arg"    # J
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method protected final whitelist core-platform-api test-api compareAndSetState(JJ)Z
    .registers 13
    .param p1, "expect"    # J
    .param p3, "update"    # J
...
.method protected final whitelist core-platform-api test-api getState()J
    .registers 3
...
.method public final whitelist core-platform-api test-api getWaitQueueLength(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)I
    .registers 4
...
.method public final whitelist core-platform-api test-api getWaitingThreads(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)Ljava/util/Collection;
    .registers 4
    .param p1, "condition"    # Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public final whitelist core-platform-api test-api hasWaiters(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)Z
    .registers 4
    .param p1, "condition"    # Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;
...
.method public final whitelist core-platform-api test-api owns(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;)Z
    .registers 3
    .param p1, "condition"    # Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer$ConditionObject;
...
.method public final whitelist core-platform-api test-api release(J)Z
    .registers 5
    .param p1, "arg"    # J
...
.method public final whitelist core-platform-api test-api releaseShared(J)Z
    .registers 4
    .param p1, "arg"    # J
...
.method protected final whitelist core-platform-api test-api setState(J)V
    .registers 9
    .param p1, "newState"    # J
...
.method protected whitelist core-platform-api test-api tryAcquire(J)Z
    .registers 4
    .param p1, "arg"    # J
...
.method public final whitelist core-platform-api test-api tryAcquireNanos(JJ)Z
    .registers 6
    .param p1, "arg"    # J
    .param p3, "nanosTimeout"    # J
    .annotation system Ldalvik/annotation/Throws;
...
.method protected whitelist core-platform-api test-api tryAcquireShared(J)J
    .registers 4
    .param p1, "arg"    # J
...
.method public final whitelist core-platform-api test-api tryAcquireSharedNanos(JJ)Z
    .registers 9
    .param p1, "arg"    # J
    .param p3, "nanosTimeout"    # J
    .annotation system Ldalvik/annotation/Throws;
...
.method protected whitelist core-platform-api test-api tryRelease(J)Z
    .registers 4
    .param p1, "arg"    # J
...
.method protected whitelist core-platform-api test-api tryReleaseShared(J)Z
    .registers 4
    .param p1, "arg"    # J
