...
# virtual methods
.method public final whitelist core-platform-api test-api accumulateAndGet(IJLjava/util/function/LongBinaryOperator;)J
    .registers 22
    .param p1, "i"    # I
    .param p2, "x"    # J
...
.method public whitelist core-platform-api test-api addAndGet(IJ)J
    .registers 6
    .param p1, "i"    # I
    .param p2, "delta"    # J
...
.method public final whitelist core-platform-api test-api compareAndSet(IJJ)Z
    .registers 13
    .param p1, "i"    # I
    .param p2, "expect"    # J
    .param p4, "update"    # J
...
.method public final whitelist core-platform-api test-api decrementAndGet(I)J
    .registers 6
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api get(I)J
    .registers 4
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api getAndAccumulate(IJLjava/util/function/LongBinaryOperator;)J
    .registers 22
    .param p1, "i"    # I
    .param p2, "x"    # J
    .param p4, "accumulatorFunction"    # Ljava/util/function/LongBinaryOperator;
...
.method public final whitelist core-platform-api test-api getAndAdd(IJ)J
    .registers 10
    .param p1, "i"    # I
    .param p2, "delta"    # J
...
.method public final whitelist core-platform-api test-api getAndDecrement(I)J
    .registers 4
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api getAndIncrement(I)J
    .registers 4
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api getAndSet(IJ)J
    .registers 10
    .param p1, "i"    # I
    .param p2, "newValue"    # J
...
.method public final whitelist core-platform-api test-api getAndUpdate(ILjava/util/function/LongUnaryOperator;)J
    .registers 16
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api incrementAndGet(I)J
    .registers 6
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api lazySet(IJ)V
    .registers 10
    .param p1, "i"    # I
    .param p2, "newValue"    # J
...
.method public final whitelist core-platform-api test-api set(IJ)V
    .registers 10
    .param p1, "i"    # I
    .param p2, "newValue"    # J
...
.method public final whitelist core-platform-api test-api updateAndGet(ILjava/util/function/LongUnaryOperator;)J
    .registers 16
    .param p1, "i"    # I
    .param p2, "updateFunction"    # Ljava/util/function/LongUnaryOperator;
...
.method public final whitelist core-platform-api test-api weakCompareAndSet(IJJ)Z
    .registers 7
    .param p1, "i"    # I
    .param p2, "expect"    # J
    .param p4, "update"    # J
