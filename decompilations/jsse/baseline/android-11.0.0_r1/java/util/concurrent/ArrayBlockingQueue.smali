...
.method public constructor whitelist core-platform-api test-api <init>(IZLjava/util/Collection;)V
    .registers 10
    .param p1, "capacity"    # I
    .param p2, "fair"    # Z
    .annotation system Ldalvik/annotation/Signature;
...
.method public whitelist core-platform-api test-api drainTo(Ljava/util/Collection;I)I
    ...
    :try_end_18
    .catchall {:try_start_10 .. :try_end_18} :catchall_91
    ...
    invoke-virtual {v5}, Ljava/util/concurrent/ArrayBlockingQueue$Itrs;->takeIndexWrapped()V
    ...
    invoke-interface {v5}, Ljava/util/concurrent/locks/Condition;->signal()V
    :try_end_8a
    .catchall {:try_start_30 .. :try_end_8a} :catchall_91
...
.method public whitelist core-platform-api test-api toArray()[Ljava/lang/Object;
    ...
    iget v6, p0, Ljava/util/concurrent/ArrayBlockingQueue;->putIndex:I
