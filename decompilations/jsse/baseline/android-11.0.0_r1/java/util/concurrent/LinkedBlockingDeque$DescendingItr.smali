...
# direct methods
.method private constructor blacklist <init>(Ljava/util/concurrent/LinkedBlockingDeque;)V
    .registers 2
...
.method synthetic constructor blacklist <init>(Ljava/util/concurrent/LinkedBlockingDeque;Ljava/util/concurrent/LinkedBlockingDeque$1;)V
    .registers 3
...
# virtual methods
.method greylist-max-o firstNode()Ljava/util/concurrent/LinkedBlockingDeque$Node;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method greylist-max-o nextNode(Ljava/util/concurrent/LinkedBlockingDeque$Node;)Ljava/util/concurrent/LinkedBlockingDeque$Node;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
