...
# instance fields
.field greylist-max-o fn:Ljava/util/function/BiFunction;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor greylist-max-o <init>(Ljava/util/concurrent/Executor;Ljava/util/concurrent/CompletableFuture;Ljava/util/concurrent/CompletableFuture;Ljava/util/concurrent/CompletableFuture;Ljava/util/function/BiFunction;)V
    .registers 6
...
.method final greylist-max-o tryFire(I)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1106
    .local p0, "this":Ljava/util/concurrent/CompletableFuture$BiApply;, "Ljava/util/concurrent/CompletableFuture$BiApply<TT;TU;TV;>;"
    iget-object v0, p0, Ljava/util/concurrent/CompletableFuture$BiApply;->dep:Ljava/util/concurrent/CompletableFuture;
    ...
    iget-object v4, p0, Ljava/util/concurrent/CompletableFuture$BiApply;->snd:Ljava/util/concurrent/CompletableFuture;

    move-object v5, v4

    .local v5, "b":Ljava/util/concurrent/CompletableFuture;, "Ljava/util/concurrent/CompletableFuture<TU;>;"
    iget-object v6, p0, Ljava/util/concurrent/CompletableFuture$BiApply;->fn:Ljava/util/function/BiFunction;
    ...
    :goto_13
    invoke-virtual {v1, v0, v4, v6, v7}, Ljava/util/concurrent/CompletableFuture;->biApply(Ljava/util/concurrent/CompletableFuture;Ljava/util/concurrent/CompletableFuture;Ljava/util/function/BiFunction;Ljava/util/concurrent/CompletableFuture$BiApply;)Z
    ...
    .line 1109
    :cond_1a
    iput-object v2, p0, Ljava/util/concurrent/CompletableFuture$BiApply;->dep:Ljava/util/concurrent/CompletableFuture;

    iput-object v2, p0, Ljava/util/concurrent/CompletableFuture$BiApply;->src:Ljava/util/concurrent/CompletableFuture;

    iput-object v2, p0, Ljava/util/concurrent/CompletableFuture$BiApply;->snd:Ljava/util/concurrent/CompletableFuture;

    iput-object v2, p0, Ljava/util/concurrent/CompletableFuture$BiApply;->fn:Ljava/util/function/BiFunction;
