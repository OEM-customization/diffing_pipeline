...
.field public static final whitelist core-platform-api test-api defaultForkJoinWorkerThreadFactory:Ljava/util/concurrent/ForkJoinPool$ForkJoinWorkerThreadFactory;
...
.method static constructor blacklist <clinit>()V
    ...
    sput-wide v1, Ljava/util/concurrent/ForkJoinPool;->CTL:J
    ...
    sput-wide v0, Ljava/util/concurrent/ForkJoinPool;->RUNSTATE:J
    ...
    :try_end_41
    .catch Ljava/lang/ReflectiveOperationException; {:try_start_8 .. :try_end_41} :catch_8c
    ...
    move-result v3
    :try_end_52
    .catch Ljava/lang/Exception; {:try_start_46 .. :try_end_52} :catch_54
    ...
    throw v1
    :try_end_8c
    .catch Ljava/lang/ReflectiveOperationException; {:try_start_84 .. :try_end_8c} :catch_8c
...
.method public constructor whitelist core-platform-api test-api <init>(ILjava/util/concurrent/ForkJoinPool$ForkJoinWorkerThreadFactory;Ljava/lang/Thread$UncaughtExceptionHandler;Z)V
    .registers 11
    .param p1, "parallelism"    # I
    .param p2, "factory"    # Ljava/util/concurrent/ForkJoinPool$ForkJoinWorkerThreadFactory;
    .param p3, "handler"    # Ljava/lang/Thread$UncaughtExceptionHandler;
...
.method public static whitelist core-platform-api test-api commonPool()Ljava/util/concurrent/ForkJoinPool;
    .registers 1
...
.method public static whitelist core-platform-api test-api getCommonPoolParallelism()I
    .registers 1
...
.method private greylist-max-o helpStealer(Ljava/util/concurrent/ForkJoinPool$WorkQueue;Ljava/util/concurrent/ForkJoinTask;)V
    ...
    .end local v12    # "b":I
    .local v4, "b":I
    iget v5, v15, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->base:I

    if-ne v12, v5, :cond_c5

    .line 2129
    iget-object v5, v9, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->currentJoin:Ljava/util/concurrent/ForkJoinTask;

    if-ne v5, v10, :cond_129

    iget-object v5, v15, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->currentSteal:Ljava/util/concurrent/ForkJoinTask;

    if-ne v5, v10, :cond_129

    iget v5, v10, Ljava/util/concurrent/ForkJoinTask;->status:I
    ...
    .line 2134
    iput v4, v15, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->base:I

    .line 2135
    iput-object v13, v0, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->currentSteal:Ljava/util/concurrent/ForkJoinTask;

    .line 2136
    iget v5, v0, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->top:I
    ...
    .line 2139
    iget v12, v1, Ljava/util/concurrent/ForkJoinTask;->status:I
    ...
    iget v4, v15, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->base:I

    if-ne v12, v4, :cond_fa

    iget v4, v15, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->top:I
    ...
    .line 2152
    iget-object v4, v15, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->currentJoin:Ljava/util/concurrent/ForkJoinTask;
...
.method public static whitelist core-platform-api test-api managedBlock(Ljava/util/concurrent/ForkJoinPool$ManagedBlocker;)V
    .registers 12
...
.method private greylist-max-o scan(Ljava/util/concurrent/ForkJoinPool$WorkQueue;III)I
    ...
    .line 1977
    invoke-virtual {v2, v15, v5, v6}, Lsun/misc/Unsafe;->getObjectVolatile(Ljava/lang/Object;J)Ljava/lang/Object;
    ...
    .end local v13    # "b":I
    .local v3, "b":I
    iget v14, v12, Ljava/util/concurrent/ForkJoinPool$WorkQueue;->base:I
    ...
    .local v25, "a":[Ljava/util/concurrent/ForkJoinTask;, "[Ljava/util/concurrent/ForkJoinTask<*>;"
    ...
    .end local v24    # "m":I
    .end local v25    # "a":[Ljava/util/concurrent/ForkJoinTask;, "[Ljava/util/concurrent/ForkJoinTask<*>;"
    .local v2, "stat":I
    .local v3, "m":I
    .local v5, "wl":I
    ...
    .restart local v25    # "a":[Ljava/util/concurrent/ForkJoinTask;, "[Ljava/util/concurrent/ForkJoinTask<*>;"
    goto :goto_c3
...
.method public whitelist core-platform-api test-api awaitQuiescence(JLjava/util/concurrent/TimeUnit;)Z
    .registers 24
    .param p1, "timeout"    # J
...
.method protected whitelist core-platform-api test-api drainTasksTo(Ljava/util/Collection;)I
    .registers 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api execute(Ljava/util/concurrent/ForkJoinTask;)V
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api getActiveThreadCount()I
    .registers 5
...
.method public whitelist core-platform-api test-api getAsyncMode()Z
    .registers 3
...
.method public whitelist core-platform-api test-api getFactory()Ljava/util/concurrent/ForkJoinPool$ForkJoinWorkerThreadFactory;
    .registers 2
...
.method public whitelist core-platform-api test-api getParallelism()I
    .registers 3
...
.method public whitelist core-platform-api test-api getQueuedSubmissionCount()I
    .registers 6
...
.method public whitelist core-platform-api test-api getQueuedTaskCount()J
    .registers 9
...
.method public whitelist core-platform-api test-api getRunningThreadCount()I
    .registers 6
...
.method public whitelist core-platform-api test-api getStealCount()J
    .registers 10
...
.method public whitelist core-platform-api test-api hasQueuedSubmissions()Z
    .registers 5
...
.method public whitelist core-platform-api test-api invoke(Ljava/util/concurrent/ForkJoinTask;)Ljava/lang/Object;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public whitelist core-platform-api test-api isQuiescent()Z
    .registers 5
...
.method protected whitelist core-platform-api test-api pollSubmission()Ljava/util/concurrent/ForkJoinTask;
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist core-platform-api test-api submit(Ljava/lang/Runnable;)Ljava/util/concurrent/ForkJoinTask;
    .registers 4
    .param p1, "task"    # Ljava/lang/Runnable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public whitelist core-platform-api test-api submit(Ljava/lang/Runnable;Ljava/lang/Object;)Ljava/util/concurrent/ForkJoinTask;
    .registers 4
    .param p1, "task"    # Ljava/lang/Runnable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public whitelist core-platform-api test-api submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/ForkJoinTask;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public whitelist core-platform-api test-api submit(Ljava/util/concurrent/ForkJoinTask;)Ljava/util/concurrent/ForkJoinTask;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public bridge synthetic whitelist core-platform-api test-api submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api submit(Ljava/lang/Runnable;Ljava/lang/Object;)Ljava/util/concurrent/Future;
    .registers 3
...
.method public bridge synthetic whitelist core-platform-api test-api submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
    .registers 2
