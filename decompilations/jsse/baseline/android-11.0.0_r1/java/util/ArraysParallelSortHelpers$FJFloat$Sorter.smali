...
# direct methods
.method constructor blacklist <init>(Ljava/util/concurrent/CountedCompleter;[F[FIIII)V
    .registers 8
    .param p2, "a"    # [F
    .param p3, "w"    # [F
    .param p4, "base"    # I
...
.method public final whitelist core-platform-api test-api compute()V
    ...
    iget-object v15, v0, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;->a:[F

    .local v15, "a":[F
    iget-object v14, v0, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;->w:[F

    .line 803
    .local v14, "w":[F
    iget v13, v0, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;->base:I

    .local v13, "b":I
    iget v2, v0, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;->size:I

    .local v2, "n":I
    iget v12, v0, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;->wbase:I

    .local v12, "wb":I
    iget v11, v0, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;->gran:I
    ...
    new-instance v8, Ljava/util/ArraysParallelSortHelpers$FJFloat$Merger;
    ...
    invoke-direct/range {v4 .. v11}, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;-><init>(Ljava/util/concurrent/CountedCompleter;[F[FIIII)V

    invoke-virtual {v0}, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;->fork()Ljava/util/concurrent/ForkJoinTask;
    ...
    invoke-direct/range {v6 .. v13}, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;-><init>(Ljava/util/concurrent/CountedCompleter;[F[FIIII)V
    ...
    invoke-direct/range {v6 .. v15}, Ljava/util/ArraysParallelSortHelpers$FJFloat$Merger;-><init>(Ljava/util/concurrent/CountedCompleter;[F[FIIIIII)V
    ...
    invoke-virtual {v2}, Ljava/util/ArraysParallelSortHelpers$FJFloat$Sorter;->fork()Ljava/util/concurrent/ForkJoinTask;
    ...
    invoke-static/range {v2 .. v7}, Ljava/util/DualPivotQuicksort;->sort([FII[FII)V
