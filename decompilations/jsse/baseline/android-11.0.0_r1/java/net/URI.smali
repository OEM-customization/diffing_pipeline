...
.field private transient greylist query:Ljava/lang/String;
...
.method static constructor blacklist <clinit>()V
    ...
    invoke-static {v1, v0}, Ljava/net/URI;->highMask(CC)J

    move-result-wide v2

    sput-wide v2, Ljava/net/URI;->H_UPALPHA:J
    ...
    invoke-static {v2, v0}, Ljava/net/URI;->highMask(CC)J

    move-result-wide v3

    sput-wide v3, Ljava/net/URI;->H_LOWALPHA:J

    .line 2585
    sget-wide v5, Ljava/net/URI;->H_UPALPHA:J

    or-long/2addr v3, v5

    sput-wide v3, Ljava/net/URI;->H_ALPHA:J

    .line 2588
    sget-wide v5, Ljava/net/URI;->L_DIGIT:J
    ...
    sput-wide v3, Ljava/net/URI;->H_ALPHANUM:J

    .line 2593
    sput-wide v5, Ljava/net/URI;->L_HEX:J
    ...
    invoke-static {v2, v3}, Ljava/net/URI;->highMask(CC)J
    ...
    sput-wide v1, Ljava/net/URI;->L_MARK:J
    ...
    sget-wide v4, Ljava/net/URI;->L_MARK:J

    or-long/2addr v2, v4

    sput-wide v2, Ljava/net/URI;->L_UNRESERVED:J
    ...
    sput-wide v1, Ljava/net/URI;->L_RESERVED:J
    ...
    .line 2617
    sget-wide v2, Ljava/net/URI;->L_RESERVED:J

    sget-wide v4, Ljava/net/URI;->L_UNRESERVED:J
    ...
    sput-wide v2, Ljava/net/URI;->L_URIC:J
    ...
    sput-wide v1, Ljava/net/URI;->L_DASH:J
    ...
    sput-wide v1, Ljava/net/URI;->L_UNDERSCORE:J
    ...
    sput-wide v1, Ljava/net/URI;->L_DOT:J
    ...
    sget-wide v3, Ljava/net/URI;->H_ALPHANUM:J

    or-long/2addr v0, v3

    sget-wide v3, Ljava/net/URI;->H_DASH:J
    ...
    sput-wide v1, Ljava/net/URI;->L_LEFT_BRACKET:J
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .registers 19
    .param p1, "scheme"    # Ljava/lang/String;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .registers 13
    .param p1, "scheme"    # Ljava/lang/String;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .registers 17
    .param p1, "scheme"    # Ljava/lang/String;
...
.method public static whitelist core-platform-api test-api create(Ljava/lang/String;)Ljava/net/URI;
    .registers 4
...
.method public whitelist core-platform-api test-api compareTo(Ljava/net/URI;)I
    .registers 5
...
.method public whitelist core-platform-api test-api getFragment()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getRawAuthority()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getRawFragment()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getRawPath()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getRawQuery()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getRawSchemeSpecificPart()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getRawUserInfo()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getScheme()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getSchemeSpecificPart()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api isOpaque()Z
    .registers 2
...
.method public whitelist core-platform-api test-api normalize()Ljava/net/URI;
    .registers 2
...
.method public whitelist core-platform-api test-api parseServerAuthority()Ljava/net/URI;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/URISyntaxException;
...
.method public whitelist core-platform-api test-api relativize(Ljava/net/URI;)Ljava/net/URI;
    .registers 3
...
.method public whitelist core-platform-api test-api resolve(Ljava/lang/String;)Ljava/net/URI;
    .registers 3
    .param p1, "str"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api resolve(Ljava/net/URI;)Ljava/net/URI;
    .registers 3
    .param p1, "uri"    # Ljava/net/URI;
...
.method public whitelist core-platform-api test-api toASCIIString()Ljava/lang/String;
    .registers 2
