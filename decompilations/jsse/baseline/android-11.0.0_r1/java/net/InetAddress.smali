...
.method public static greylist core-platform-api clearDnsCache()V
    .registers 1
...
.method public static whitelist core-platform-api test-api getAllByName(Ljava/lang/String;)[Ljava/net/InetAddress;
    .registers 3
...
.method public static greylist core-platform-api getAllByNameOnNet(Ljava/lang/String;I)[Ljava/net/InetAddress;
    .registers 3
    .param p0, "host"    # Ljava/lang/String;
    .param p1, "netId"    # I
    .annotation system Ldalvik/annotation/Throws;
...
.method public static whitelist core-platform-api test-api getByAddress(Ljava/lang/String;[B)Ljava/net/InetAddress;
    .registers 3
    .param p0, "host"    # Ljava/lang/String;
    .param p1, "addr"    # [B
    .annotation system Ldalvik/annotation/Throws;
...
.method public static whitelist core-platform-api test-api getByAddress([B)Ljava/net/InetAddress;
    .registers 2
    .param p0, "addr"    # [B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static whitelist core-platform-api test-api getByName(Ljava/lang/String;)Ljava/net/InetAddress;
    .registers 3
    .param p0, "host"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static greylist-max-o core-platform-api getByNameOnNet(Ljava/lang/String;I)Ljava/net/InetAddress;
    .registers 4
    .param p0, "host"    # Ljava/lang/String;
    .param p1, "netId"    # I
    .annotation system Ldalvik/annotation/Throws;
...
.method private static greylist-max-o getHostFromNameService(Ljava/net/InetAddress;)Ljava/lang/String;
    ...
    :try_end_2c
    .catch Ljava/net/UnknownHostException; {:try_start_1 .. :try_end_2c} :catch_2f
...
.method public static whitelist core-platform-api test-api getLocalHost()Ljava/net/InetAddress;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/UnknownHostException;
...
.method public static whitelist core-platform-api test-api getLoopbackAddress()Ljava/net/InetAddress;
    .registers 2
...
.method public static greylist-max-p core-platform-api isNumeric(Ljava/lang/String;)Z
    .registers 2
...
.method public static greylist-max-p core-platform-api parseNumericAddress(Ljava/lang/String;)Ljava/net/InetAddress;
    .registers 5
...
.method public whitelist core-platform-api test-api getCanonicalHostName()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getHostName()Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api isReachable(I)Z
    .registers 4
    .param p1, "timeout"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api isReachable(Ljava/net/NetworkInterface;II)Z
    .registers 6
