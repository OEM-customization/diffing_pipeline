...
.method public whitelist core-platform-api test-api compareTo(Ljava/nio/file/Path;)I
    .registers 11
...
.method public whitelist core-platform-api test-api endsWith(Ljava/nio/file/Path;)Z
    .registers 14
    .param p1, "other"    # Ljava/nio/file/Path;
...
.method public bridge synthetic whitelist core-platform-api test-api getFileName()Ljava/nio/file/Path;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getFileSystem()Ljava/nio/file/FileSystem;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getName(I)Ljava/nio/file/Path;
    .registers 2
...
.method public whitelist core-platform-api test-api getNameCount()I
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getParent()Ljava/nio/file/Path;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api getRoot()Ljava/nio/file/Path;
    .registers 2
...
.method public whitelist core-platform-api test-api normalize()Ljava/nio/file/Path;
    .registers 16
...
.method public varargs whitelist core-platform-api test-api register(Ljava/nio/file/WatchService;[Ljava/nio/file/WatchEvent$Kind;[Ljava/nio/file/WatchEvent$Modifier;)Ljava/nio/file/WatchKey;
    .registers 5
...
.method public bridge synthetic whitelist core-platform-api test-api relativize(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api resolve(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    .registers 2
...
.method public whitelist core-platform-api test-api startsWith(Ljava/nio/file/Path;)Z
    .registers 11
    .param p1, "other"    # Ljava/nio/file/Path;
...
.method public bridge synthetic whitelist core-platform-api test-api subpath(II)Ljava/nio/file/Path;
    .registers 3
...
.method public bridge synthetic whitelist core-platform-api test-api toAbsolutePath()Ljava/nio/file/Path;
    .registers 2
...
.method public varargs whitelist core-platform-api test-api toRealPath([Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;
    .registers 11
