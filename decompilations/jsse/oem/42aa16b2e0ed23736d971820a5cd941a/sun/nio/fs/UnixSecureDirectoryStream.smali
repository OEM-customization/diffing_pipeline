...
.method private blacklist getFileAttributeViewImpl(Lsun/nio/fs/UnixPath;Ljava/lang/Class;Z)Ljava/nio/file/attribute/FileAttributeView;
    ...
    .line 295
    new-instance v0, Lsun/nio/fs/UnixSecureDirectoryStream$BasicFileAttributeViewImpl;

    invoke-direct {v0, p0, p1, p3}, Lsun/nio/fs/UnixSecureDirectoryStream$BasicFileAttributeViewImpl;-><init>(Lsun/nio/fs/UnixSecureDirectoryStream;Lsun/nio/fs/UnixPath;Z)V
    ...
    :cond_1a
    :goto_1a
    new-instance v0, Lsun/nio/fs/UnixSecureDirectoryStream$PosixFileAttributeViewImpl;

    invoke-direct {v0, p0, p1, p3}, Lsun/nio/fs/UnixSecureDirectoryStream$PosixFileAttributeViewImpl;-><init>(Lsun/nio/fs/UnixSecureDirectoryStream;Lsun/nio/fs/UnixPath;Z)V
...
.method public bridge synthetic whitelist core-platform-api test-api deleteDirectory(Ljava/lang/Object;)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public bridge synthetic whitelist core-platform-api test-api deleteFile(Ljava/lang/Object;)V
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public whitelist core-platform-api test-api getFileAttributeView(Ljava/lang/Class;)Ljava/nio/file/attribute/FileAttributeView;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<V::",
...
.method public bridge synthetic whitelist core-platform-api test-api getFileAttributeView(Ljava/lang/Object;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;
    .registers 4
...
.method public bridge synthetic whitelist core-platform-api test-api move(Ljava/lang/Object;Ljava/nio/file/SecureDirectoryStream;Ljava/lang/Object;)V
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public bridge synthetic whitelist core-platform-api test-api newByteChannel(Ljava/lang/Object;Ljava/util/Set;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/SeekableByteChannel;
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public bridge synthetic whitelist core-platform-api test-api newDirectoryStream(Ljava/lang/Object;[Ljava/nio/file/LinkOption;)Ljava/nio/file/SecureDirectoryStream;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
