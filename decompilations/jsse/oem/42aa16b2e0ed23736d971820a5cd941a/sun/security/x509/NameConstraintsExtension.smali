...
.method public blacklist verify(Lsun/security/x509/GeneralNameInterface;)Z
    ...
    .line 500
    .local v3, "gs":Lsun/security/x509/GeneralSubtree;
    if-nez v3, :cond_20
    ...
    .line 503
    .local v4, "gn":Lsun/security/x509/GeneralName;
    if-nez v4, :cond_27
    ...
    .line 506
    .local v5, "exName":Lsun/security/x509/GeneralNameInterface;
    if-nez v5, :cond_2e
    ...
    .line 511
    :cond_2e
    invoke-interface {v5, p1}, Lsun/security/x509/GeneralNameInterface;->constrains(Lsun/security/x509/GeneralNameInterface;)I
    ...
    .line 498
    .end local v3    # "gs":Lsun/security/x509/GeneralSubtree;
    .end local v4    # "gn":Lsun/security/x509/GeneralName;
    .end local v5    # "exName":Lsun/security/x509/GeneralNameInterface;
    :goto_36
    add-int/lit8 v0, v0, 0x1
    ...
    .line 518
    .restart local v3    # "gs":Lsun/security/x509/GeneralSubtree;
    .restart local v4    # "gn":Lsun/security/x509/GeneralName;
    .restart local v5    # "exName":Lsun/security/x509/GeneralNameInterface;
    :cond_39
    return v1
    ...
    .line 552
    .restart local v4    # "gs":Lsun/security/x509/GeneralSubtree;
    .restart local v5    # "gn":Lsun/security/x509/GeneralName;
    .restart local v6    # "perName":Lsun/security/x509/GeneralNameInterface;
    :cond_79
    return v2
