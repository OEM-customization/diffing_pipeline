...
.method protected constructor whitelist core-platform-api test-api <init>(Ljavax/crypto/KeyAgreementSpi;Ljava/security/Provider;Ljava/lang/String;)V
    .registers 5
...
.method private greylist-max-o chooseProvider(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    .line 389
    iget-object v3, p0, Ljavax/crypto/KeyAgreement;->spi:Ljavax/crypto/KeyAgreementSpi;
    ...
    invoke-direct/range {v2 .. v7}, Ljavax/crypto/KeyAgreement;->implInit(Ljavax/crypto/KeyAgreementSpi;ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    move-result v4
    :try_end_3d
    .catchall {:try_start_3 .. :try_end_3d} :catchall_9b
    ...
    .catchall {:try_start_41 .. :try_end_58} :catchall_9b
    ...
    monitor-exit v0
    :try_end_9d
    .catchall {:try_start_58 .. :try_end_9d} :catchall_9b

    throw v1
.end method

.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;)Ljavax/crypto/KeyAgreement;
    .registers 6
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/KeyAgreement;
    .registers 6
    .param p0, "algorithm"    # Ljava/lang/String;
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/security/Provider;)Ljavax/crypto/KeyAgreement;
    .registers 6
    .param p0, "algorithm"    # Ljava/lang/String;
...
.method public final whitelist core-platform-api test-api doPhase(Ljava/security/Key;Z)Ljava/security/Key;
    .registers 4
...
.method public final whitelist core-platform-api test-api generateSecret([BI)I
    .registers 4
...
.method public final whitelist core-platform-api test-api generateSecret(Ljava/lang/String;)Ljavax/crypto/SecretKey;
    .registers 3
    .param p1, "algorithm"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final whitelist core-platform-api test-api generateSecret()[B
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;
...
.method public final whitelist core-platform-api test-api init(Ljava/security/Key;Ljava/security/SecureRandom;)V
    .registers 5
    .param p1, "key"    # Ljava/security/Key;
    ...
    :try_end_15
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_12 .. :try_end_15} :catch_17
...
.method public final whitelist core-platform-api test-api init(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    .registers 5
    .param p1, "key"    # Ljava/security/Key;
    .param p2, "params"    # Ljava/security/spec/AlgorithmParameterSpec;
