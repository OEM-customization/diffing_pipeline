...
.method private whitelist writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    .line 444
    iget-object v3, p0, Ljava/beans/PropertyChangeSupport;->source:Ljava/lang/Object;

    const-string v4, "source"

    invoke-virtual {v2, v4, v3}, Ljava/io/ObjectOutputStream$PutField;->put(Ljava/lang/String;Ljava/lang/Object;)V

    .line 445
    const/4 v3, 0x2

    const-string v4, "propertyChangeSupportSerializedDataVersion"

    invoke-virtual {v2, v4, v3}, Ljava/io/ObjectOutputStream$PutField;->put(Ljava/lang/String;I)V
...
.method public whitelist core-platform-api test-api addPropertyChangeListener(Ljava/lang/String;Ljava/beans/PropertyChangeListener;)V
    .registers 4
...
.method public whitelist core-platform-api test-api fireIndexedPropertyChange(Ljava/lang/String;III)V
    .registers 7
    .param p1, "propertyName"    # Ljava/lang/String;
    .param p2, "index"    # I
    .param p3, "oldValue"    # I
...
.method public whitelist core-platform-api test-api fireIndexedPropertyChange(Ljava/lang/String;ILjava/lang/Object;Ljava/lang/Object;)V
    .registers 12
    .param p1, "propertyName"    # Ljava/lang/String;
    .param p2, "index"    # I
...
.method public whitelist core-platform-api test-api fireIndexedPropertyChange(Ljava/lang/String;IZZ)V
    .registers 7
    .param p1, "propertyName"    # Ljava/lang/String;
    .param p2, "index"    # I
    .param p3, "oldValue"    # Z
...
.method public whitelist core-platform-api test-api firePropertyChange(Ljava/beans/PropertyChangeEvent;)V
    .registers 7
    .param p1, "event"    # Ljava/beans/PropertyChangeEvent;
...
.method public whitelist core-platform-api test-api firePropertyChange(Ljava/lang/String;II)V
    .registers 6
    .param p1, "propertyName"    # Ljava/lang/String;
    .param p2, "oldValue"    # I
    .param p3, "newValue"    # I
...
.method public whitelist core-platform-api test-api firePropertyChange(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    .registers 6
    .param p1, "propertyName"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api firePropertyChange(Ljava/lang/String;ZZ)V
    .registers 6
    .param p1, "propertyName"    # Ljava/lang/String;
    .param p2, "oldValue"    # Z
    .param p3, "newValue"    # Z
...
.method public whitelist core-platform-api test-api getPropertyChangeListeners()[Ljava/beans/PropertyChangeListener;
    .registers 2
...
.method public whitelist core-platform-api test-api getPropertyChangeListeners(Ljava/lang/String;)[Ljava/beans/PropertyChangeListener;
    .registers 3
    .param p1, "propertyName"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api hasListeners(Ljava/lang/String;)Z
    .registers 3
    .param p1, "propertyName"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api removePropertyChangeListener(Ljava/lang/String;Ljava/beans/PropertyChangeListener;)V
    .registers 4
    .param p1, "propertyName"    # Ljava/lang/String;
    .param p2, "listener"    # Ljava/beans/PropertyChangeListener;
