...
.method public static whitelist core-platform-api test-api fromMethodDescriptorString(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/invoke/MethodType;
    .registers 6
...
.method public static whitelist core-platform-api test-api genericMethodType(I)Ljava/lang/invoke/MethodType;
    .registers 2
...
.method public static whitelist core-platform-api test-api genericMethodType(IZ)Ljava/lang/invoke/MethodType;
    .registers 8
    .param p0, "objectArgCount"    # I
    ...
    .line 338
    .local v2, "mt":Ljava/lang/invoke/MethodType;
    if-eqz v2, :cond_11

    return-object v2

    .line 340
    .end local v2    # "mt":Ljava/lang/invoke/MethodType;
    :cond_11
    add-int v2, p0, v0
    ...
    invoke-static {v3, v2, v4}, Ljava/lang/invoke/MethodType;->makeImpl(Ljava/lang/Class;[Ljava/lang/Class;Z)Ljava/lang/invoke/MethodType;
...
.method static greylist-max-o makeImpl(Ljava/lang/Class;[Ljava/lang/Class;Z)Ljava/lang/invoke/MethodType;
    ...
    invoke-direct {v1, p0, p1, p2}, Ljava/lang/invoke/MethodType;-><init>(Ljava/lang/Class;[Ljava/lang/Class;Z)V
...
.method public static whitelist core-platform-api test-api methodType(Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static whitelist core-platform-api test-api methodType(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static varargs whitelist core-platform-api test-api methodType(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
    .registers 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static whitelist core-platform-api test-api methodType(Ljava/lang/Class;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/MethodType;
    .registers 4
...
.method public static whitelist core-platform-api test-api methodType(Ljava/lang/Class;Ljava/util/List;)Ljava/lang/invoke/MethodType;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public whitelist core-platform-api test-api appendParameterTypes(Ljava/util/List;)Ljava/lang/invoke/MethodType;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public varargs whitelist core-platform-api test-api appendParameterTypes([Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
...
.method public whitelist core-platform-api test-api changeParameterType(ILjava/lang/Class;)Ljava/lang/invoke/MethodType;
    .registers 6
    .param p1, "num"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public whitelist core-platform-api test-api changeReturnType(Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api dropParameterTypes(II)Ljava/lang/invoke/MethodType;
    .registers 8
    .param p1, "start"    # I
    .param p2, "end"    # I
...
.method public whitelist core-platform-api test-api erase()Ljava/lang/invoke/MethodType;
    .registers 2
...
.method public whitelist core-platform-api test-api generic()Ljava/lang/invoke/MethodType;
    .registers 2
...
.method public whitelist core-platform-api test-api hasPrimitives()Z
    .registers 2
...
.method public whitelist core-platform-api test-api hasWrappers()Z
    .registers 2
...
.method public whitelist core-platform-api test-api insertParameterTypes(ILjava/util/List;)Ljava/lang/invoke/MethodType;
    .registers 4
    .param p1, "num"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public varargs whitelist core-platform-api test-api insertParameterTypes(I[Ljava/lang/Class;)Ljava/lang/invoke/MethodType;
    .registers 10
    .param p1, "num"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public whitelist core-platform-api test-api parameterArray()[Ljava/lang/Class;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()[",
...
.method public whitelist core-platform-api test-api parameterCount()I
    .registers 2
...
.method public whitelist core-platform-api test-api parameterList()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist core-platform-api test-api parameterType(I)Ljava/lang/Class;
    .registers 3
    .param p1, "num"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public whitelist core-platform-api test-api returnType()Ljava/lang/Class;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist core-platform-api test-api toMethodDescriptorString()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api unwrap()Ljava/lang/invoke/MethodType;
    .registers 3
...
.method public whitelist core-platform-api test-api wrap()Ljava/lang/invoke/MethodType;
    .registers 2
