...
# static fields
.field static final greylist mainThreadGroup:Ljava/lang/ThreadGroup;
...
.field greylist name:Ljava/lang/String;
...
.method private greylist-max-o enumerate([Ljava/lang/Thread;IZ)I
    ...
    move-result v4
    :try_end_1e
    .catchall {:try_start_3 .. :try_end_1e} :catchall_55
...
.method private greylist-max-o stopOrSuspend(Z)Z
    ...
    monitor-exit p0
    :try_end_3b
    .catchall {:try_start_7 .. :try_end_3b} :catchall_51
...
# virtual methods
.method public whitelist core-platform-api test-api activeCount()I
    .registers 6
...
.method public whitelist core-platform-api test-api activeGroupCount()I
    .registers 6
...
.method greylist add(Ljava/lang/Thread;)V
    .registers 4
    .param p1, "t"    # Ljava/lang/Thread;
...
.method public whitelist core-platform-api test-api allowThreadSuspension(Z)Z
    .registers 3
    .param p1, "b"    # Z
...
.method public final whitelist core-platform-api test-api destroy()V
    .registers 5
...
.method public whitelist core-platform-api test-api enumerate([Ljava/lang/Thread;)I
    .registers 4
    .param p1, "list"    # [Ljava/lang/Thread;
...
.method public whitelist core-platform-api test-api enumerate([Ljava/lang/Thread;Z)I
    .registers 4
    .param p1, "list"    # [Ljava/lang/Thread;
    .param p2, "recurse"    # Z
...
.method public whitelist core-platform-api test-api enumerate([Ljava/lang/ThreadGroup;)I
    .registers 4
    .param p1, "list"    # [Ljava/lang/ThreadGroup;
...
.method public whitelist core-platform-api test-api enumerate([Ljava/lang/ThreadGroup;Z)I
    .registers 4
    .param p1, "list"    # [Ljava/lang/ThreadGroup;
    .param p2, "recurse"    # Z
...
.method public final whitelist core-platform-api test-api getMaxPriority()I
    .registers 2
...
.method public final whitelist core-platform-api test-api getParent()Ljava/lang/ThreadGroup;
    .registers 2
...
.method public final whitelist core-platform-api test-api interrupt()V
    .registers 5
...
.method public declared-synchronized whitelist core-platform-api test-api isDestroyed()Z
    .registers 2
...
.method public whitelist core-platform-api test-api list()V
    .registers 3
...
.method greylist-max-o list(Ljava/io/PrintStream;I)V
    ...
    monitor-exit p0
    :try_end_3c
    .catchall {:try_start_4 .. :try_end_3c} :catchall_48
...
.method public final whitelist core-platform-api test-api parentOf(Ljava/lang/ThreadGroup;)Z
    .registers 3
    .param p1, "g"    # Ljava/lang/ThreadGroup;
...
.method public final whitelist core-platform-api test-api setMaxPriority(I)V
    .registers 6
    .param p1, "pri"    # I
...
.method greylist threadTerminated(Ljava/lang/Thread;)V
    .registers 3
    .param p1, "t"    # Ljava/lang/Thread;
