...
.method protected constructor whitelist core-platform-api test-api <init>(Ljava/security/SecureRandomSpi;Ljava/security/Provider;)V
    .registers 4
...
.method public static whitelist core-platform-api test-api getInstance(Ljava/lang/String;)Ljava/security/SecureRandom;
    .registers 5
...
.method public static whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/lang/String;)Ljava/security/SecureRandom;
    .registers 6
    .param p0, "algorithm"    # Ljava/lang/String;
...
.method public static whitelist core-platform-api test-api getInstance(Ljava/lang/String;Ljava/security/Provider;)Ljava/security/SecureRandom;
    .registers 6
    .param p0, "algorithm"    # Ljava/lang/String;
...
.method public static whitelist core-platform-api test-api getInstanceStrong()Ljava/security/SecureRandom;
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/NoSuchAlgorithmException;
...
.method public static whitelist core-platform-api test-api getSeed(I)[B
    .registers 2
    .param p0, "numBytes"    # I
...
# virtual methods
.method public whitelist core-platform-api test-api generateSeed(I)[B
    .registers 3
    .param p1, "numBytes"    # I
...
.method protected final whitelist core-platform-api test-api next(I)I
    .registers 8
    .param p1, "numBits"    # I
...
.method public declared-synchronized whitelist core-platform-api test-api nextBytes([B)V
    .registers 3
    .param p1, "bytes"    # [B
...
.method public declared-synchronized whitelist core-platform-api test-api setSeed([B)V
    .registers 3
    .param p1, "seed"    # [B
