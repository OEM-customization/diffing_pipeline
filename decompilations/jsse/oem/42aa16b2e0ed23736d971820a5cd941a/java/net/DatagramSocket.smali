...
.method public constructor whitelist core-platform-api test-api <init>(ILjava/net/InetAddress;)V
    .registers 4
    .param p1, "port"    # I
...
.method protected constructor whitelist core-platform-api test-api <init>(Ljava/net/DatagramSocketImpl;)V
    .registers 4
    ...
    iput v1, p0, Ljava/net/DatagramSocket;->connectedPort:I
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/net/SocketAddress;)V
    .registers 4
...
.method private declared-synchronized greylist-max-o connectInternal(Ljava/net/InetAddress;I)V
    ...
    move-result v0
    :try_end_13
    .catchall {:try_start_a .. :try_end_13} :catchall_ba
    ...
    :try_end_44
    .catchall {:try_start_17 .. :try_end_44} :catchall_ba
    ...
    :try_end_46
    .catchall {:try_start_44 .. :try_end_46} :catchall_95
    ...
    :try_end_4d
    .catchall {:try_start_49 .. :try_end_4d} :catchall_8a
    ...
    move-result v1
    :try_end_57
    .catchall {:try_start_4f .. :try_end_57} :catchall_95
    ...
    move-result v4
    :try_end_6c
    .catch Ljava/net/SocketException; {:try_start_5a .. :try_end_6c} :catch_85
    .catchall {:try_start_5a .. :try_end_6c} :catchall_8a
    ...
    :try_end_7c
    .catch Ljava/net/SocketException; {:try_start_72 .. :try_end_7c} :catch_7d
    .catchall {:try_start_72 .. :try_end_7c} :catchall_95
    ...
    throw v1
    :try_end_85
    .catch Ljava/net/SocketException; {:try_start_7f .. :try_end_85} :catch_85
    .catchall {:try_start_7f .. :try_end_85} :catchall_8a
    ...
    iput v3, p0, Ljava/net/DatagramSocket;->connectState:I
    :try_end_8e
    .catchall {:try_start_8c .. :try_end_8e} :catchall_95
    ...
    :try_end_92
    .catchall {:try_start_8e .. :try_end_92} :catchall_ba
    ...
    throw v0
    :try_end_ba
    .catchall {:try_start_96 .. :try_end_ba} :catchall_ba
...
.method public static declared-synchronized whitelist core-platform-api test-api setDatagramSocketImplFactory(Ljava/net/DatagramSocketImplFactory;)V
    .registers 4
...
# virtual methods
.method public declared-synchronized whitelist core-platform-api test-api bind(Ljava/net/SocketAddress;)V
    .registers 8
...
.method public declared-synchronized whitelist core-platform-api test-api getBroadcast()Z
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public declared-synchronized whitelist core-platform-api test-api getReuseAddress()Z
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public declared-synchronized whitelist core-platform-api test-api getTrafficClass()I
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public declared-synchronized whitelist core-platform-api test-api receive(Ljava/net/DatagramPacket;)V
    .registers 10
    .param p1, "p"    # Ljava/net/DatagramPacket;
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    monitor-enter p1
    :try_end_2
    .catchall {:try_start_1 .. :try_end_2} :catchall_ed
    ...
    move-result-object v5
    :try_end_52
    .catchall {:try_start_2 .. :try_end_52} :catchall_e8
    ...
    .catchall {:try_start_53 .. :try_end_56} :catchall_e8
    ...
    monitor-exit p1
    :try_end_dc
    .catchall {:try_start_58 .. :try_end_dc} :catchall_e8
    ...
    monitor-exit p1
    :try_end_ea
    .catchall {:try_start_e9 .. :try_end_ea} :catchall_eb

    :try_start_ea
    throw v0
    :try_end_eb
    .catchall {:try_start_ea .. :try_end_eb} :catchall_ed
...
.method public whitelist core-platform-api test-api send(Ljava/net/DatagramPacket;)V
    ...
    iget-object v3, p0, Ljava/net/DatagramSocket;->pendingConnectException:Ljava/net/SocketException;

    invoke-direct {v1, v2, v3}, Ljava/net/SocketException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    monitor-exit p1
    :try_end_97
    .catchall {:try_start_2 .. :try_end_97} :catchall_95

    throw v1
.end method

.method public declared-synchronized whitelist core-platform-api test-api setBroadcast(Z)V
    .registers 5
    .param p1, "on"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public declared-synchronized whitelist core-platform-api test-api setReuseAddress(Z)V
    .registers 6
    .param p1, "on"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public declared-synchronized whitelist core-platform-api test-api setTrafficClass(I)V
    .registers 5
    .param p1, "tc"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
