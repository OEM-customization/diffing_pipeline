...
# virtual methods
.method public whitelist core-platform-api test-api getInterface()Ljava/net/InetAddress;
    .registers 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    monitor-exit v0
    :try_end_25
    .catchall {:try_start_a .. :try_end_25} :catchall_4f
    ...
    iget-object v5, p0, Ljava/net/MulticastSocket;->infAddress:Ljava/net/InetAddress;
    :try_end_44
    .catch Ljava/lang/Exception; {:try_start_26 .. :try_end_44} :catch_4c
    .catchall {:try_start_26 .. :try_end_44} :catchall_4f
...
.method public whitelist core-platform-api test-api getLoopbackMode()Z
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public whitelist core-platform-api test-api getNetworkInterface()Ljava/net/NetworkInterface;
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/SocketException;
...
.method public whitelist core-platform-api test-api getTTL()B
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public whitelist core-platform-api test-api getTimeToLive()I
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public whitelist core-platform-api test-api joinGroup(Ljava/net/InetAddress;)V
    .registers 5
...
.method public whitelist core-platform-api test-api joinGroup(Ljava/net/SocketAddress;Ljava/net/NetworkInterface;)V
    .registers 6
...
.method public whitelist core-platform-api test-api leaveGroup(Ljava/net/InetAddress;)V
    .registers 5
    .param p1, "mcastaddr"    # Ljava/net/InetAddress;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api leaveGroup(Ljava/net/SocketAddress;Ljava/net/NetworkInterface;)V
    .registers 6
    .param p1, "mcastaddr"    # Ljava/net/SocketAddress;
    .param p2, "netIf"    # Ljava/net/NetworkInterface;
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist core-platform-api test-api send(Ljava/net/DatagramPacket;B)V
    .registers 7
...
.method public whitelist core-platform-api test-api setInterface(Ljava/net/InetAddress;)V
    .registers 5
...
.method public whitelist core-platform-api test-api setLoopbackMode(Z)V
    .registers 5
    .param p1, "disable"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api setNetworkInterface(Ljava/net/NetworkInterface;)V
    .registers 5
...
.method public whitelist core-platform-api test-api setTTL(B)V
    .registers 4
    .param p1, "ttl"    # B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api setTimeToLive(I)V
    .registers 4
    .param p1, "ttl"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
