...
# direct methods
.method public constructor whitelist core-platform-api test-api <init>(IIIIIII)V
    .registers 10
    .param p1, "year"    # I
    .param p2, "month"    # I
    .param p3, "date"    # I
...
.method public static whitelist core-platform-api test-api valueOf(Ljava/lang/String;)Ljava/sql/Timestamp;
    .registers 39
...
# virtual methods
.method public whitelist core-platform-api test-api after(Ljava/sql/Timestamp;)Z
    .registers 3
...
.method public whitelist core-platform-api test-api before(Ljava/sql/Timestamp;)Z
    .registers 3
    .param p1, "ts"    # Ljava/sql/Timestamp;
...
.method public whitelist core-platform-api test-api compareTo(Ljava/sql/Timestamp;)I
    .registers 11
    .param p1, "ts"    # Ljava/sql/Timestamp;
...
.method public whitelist core-platform-api test-api equals(Ljava/sql/Timestamp;)Z
    .registers 5
    .param p1, "ts"    # Ljava/sql/Timestamp;
...
.method public whitelist core-platform-api test-api getNanos()I
    .registers 2
...
.method public whitelist core-platform-api test-api setNanos(I)V
    .registers 4
    .param p1, "n"    # I
