...
.method public static declared-synchronized whitelist core-platform-api test-api deregisterDriver(Ljava/sql/Driver;)V
    .registers 4
    ...
    invoke-static {p0, v2}, Ljava/sql/DriverManager;->isDriverAllowed(Ljava/sql/Driver;Ljava/lang/Class;)Z
...
.method public static whitelist core-platform-api test-api getConnection(Ljava/lang/String;)Ljava/sql/Connection;
    .registers 3
...
.method public static whitelist core-platform-api test-api getConnection(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/sql/Connection;
    .registers 5
    .param p0, "url"    # Ljava/lang/String;
...
.method public static whitelist core-platform-api test-api getConnection(Ljava/lang/String;Ljava/util/Properties;)Ljava/sql/Connection;
    .registers 3
    .param p0, "url"    # Ljava/lang/String;
...
.method public static whitelist core-platform-api test-api getDriver(Ljava/lang/String;)Ljava/sql/Driver;
    .registers 6
    .param p0, "url"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static whitelist core-platform-api test-api getDrivers()Ljava/util/Enumeration;
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public static whitelist core-platform-api test-api getLogStream()Ljava/io/PrintStream;
    .registers 1
...
.method public static whitelist core-platform-api test-api getLogWriter()Ljava/io/PrintWriter;
    .registers 1
...
.method public static whitelist core-platform-api test-api getLoginTimeout()I
    .registers 1
...
.method public static whitelist core-platform-api test-api println(Ljava/lang/String;)V
    .registers 3
...
.method public static declared-synchronized whitelist core-platform-api test-api registerDriver(Ljava/sql/Driver;)V
    .registers 4
    .param p0, "driver"    # Ljava/sql/Driver;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static whitelist core-platform-api test-api setLogStream(Ljava/io/PrintStream;)V
    .registers 3
...
.method public static whitelist core-platform-api test-api setLogWriter(Ljava/io/PrintWriter;)V
    .registers 3
...
.method public static whitelist core-platform-api test-api setLoginTimeout(I)V
    .registers 1
    .param p0, "seconds"    # I
