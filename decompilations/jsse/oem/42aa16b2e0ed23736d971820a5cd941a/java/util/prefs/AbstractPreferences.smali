...
.field protected final whitelist core-platform-api test-api lock:Ljava/lang/Object;

.field private final greylist-max-o name:Ljava/lang/String;

.field protected whitelist core-platform-api test-api newNode:Z
...
.method protected constructor whitelist core-platform-api test-api <init>(Ljava/util/prefs/AbstractPreferences;Ljava/lang/String;)V
    .registers 7
...
# virtual methods
.method public whitelist core-platform-api test-api absolutePath()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api addNodeChangeListener(Ljava/util/prefs/NodeChangeListener;)V
    .registers 5
...
.method public whitelist core-platform-api test-api addPreferenceChangeListener(Ljava/util/prefs/PreferenceChangeListener;)V
    .registers 5
...
.method protected final whitelist core-platform-api test-api cachedChildren()[Ljava/util/prefs/AbstractPreferences;
    .registers 3
...
.method protected abstract whitelist core-platform-api test-api childSpi(Ljava/lang/String;)Ljava/util/prefs/AbstractPreferences;
.end method

.method public whitelist core-platform-api test-api childrenNames()[Ljava/lang/String;
    .registers 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
...
.method protected abstract whitelist core-platform-api test-api childrenNamesSpi()[Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
        }
...
.method public whitelist core-platform-api test-api exportNode(Ljava/io/OutputStream;)V
    .registers 3
...
.method public whitelist core-platform-api test-api exportSubtree(Ljava/io/OutputStream;)V
    .registers 3
    .param p1, "os"    # Ljava/io/OutputStream;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method protected abstract whitelist core-platform-api test-api flushSpi()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
        }
...
.method public whitelist core-platform-api test-api get(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .registers 6
    .param p1, "key"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api getBoolean(Ljava/lang/String;Z)Z
    .registers 6
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "def"    # Z
...
.method public whitelist core-platform-api test-api getByteArray(Ljava/lang/String;[B)[B
    .registers 6
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "def"    # [B
...
.method protected whitelist core-platform-api test-api getChild(Ljava/lang/String;)Ljava/util/prefs/AbstractPreferences;
    .registers 6
...
.method public whitelist core-platform-api test-api getDouble(Ljava/lang/String;D)D
    .registers 9
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "def"    # D
...
.method public whitelist core-platform-api test-api getFloat(Ljava/lang/String;F)F
    .registers 6
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "def"    # F
...
.method public whitelist core-platform-api test-api getInt(Ljava/lang/String;I)I
    .registers 6
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "def"    # I
...
.method public whitelist core-platform-api test-api getLong(Ljava/lang/String;J)J
    .registers 9
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "def"    # J
...
.method protected abstract whitelist core-platform-api test-api getSpi(Ljava/lang/String;)Ljava/lang/String;
.end method

.method protected whitelist core-platform-api test-api isRemoved()Z
    .registers 3
...
.method public whitelist core-platform-api test-api isUserNode()Z
    .registers 2
...
.method public whitelist core-platform-api test-api keys()[Ljava/lang/String;
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
...
.method protected abstract whitelist core-platform-api test-api keysSpi()[Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
        }
...
.method public whitelist core-platform-api test-api node(Ljava/lang/String;)Ljava/util/prefs/Preferences;
    .registers 7
...
.method public whitelist core-platform-api test-api nodeExists(Ljava/lang/String;)Z
    .registers 7
    .param p1, "path"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api parent()Ljava/util/prefs/Preferences;
    .registers 4
...
.method public whitelist core-platform-api test-api put(Ljava/lang/String;Ljava/lang/String;)V
    .registers 6
    .param p1, "key"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api putBoolean(Ljava/lang/String;Z)V
    .registers 4
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "value"    # Z
...
.method public whitelist core-platform-api test-api putByteArray(Ljava/lang/String;[B)V
    .registers 4
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "value"    # [B
...
.method public whitelist core-platform-api test-api putDouble(Ljava/lang/String;D)V
    .registers 5
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "value"    # D
...
.method public whitelist core-platform-api test-api putFloat(Ljava/lang/String;F)V
    .registers 4
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "value"    # F
...
.method public whitelist core-platform-api test-api putInt(Ljava/lang/String;I)V
    .registers 4
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "value"    # I
...
.method public whitelist core-platform-api test-api putLong(Ljava/lang/String;J)V
    .registers 5
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "value"    # J
...
.method protected abstract whitelist core-platform-api test-api putSpi(Ljava/lang/String;Ljava/lang/String;)V
.end method

.method public whitelist core-platform-api test-api remove(Ljava/lang/String;)V
    .registers 5
    .param p1, "key"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api removeNode()V
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
...
.method public whitelist core-platform-api test-api removeNodeChangeListener(Ljava/util/prefs/NodeChangeListener;)V
    .registers 5
    .param p1, "ncl"    # Ljava/util/prefs/NodeChangeListener;
...
.method protected abstract whitelist core-platform-api test-api removeNodeSpi()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
        }
...
.method public whitelist core-platform-api test-api removePreferenceChangeListener(Ljava/util/prefs/PreferenceChangeListener;)V
    .registers 5
    .param p1, "pcl"    # Ljava/util/prefs/PreferenceChangeListener;
...
.method protected abstract whitelist core-platform-api test-api removeSpi(Ljava/lang/String;)V
.end method

.method public whitelist core-platform-api test-api sync()V
    .registers 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
...
.method protected abstract whitelist core-platform-api test-api syncSpi()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
        }
