...
.method public constructor greylist-max-o <init>(Ljava/lang/String;Ljava/io/File;Z)V
    ...
    iput-object v1, p0, Ljava/util/prefs/FileSystemPreferences;->dir:Ljava/io/File;
    ...
    iput-boolean v1, p0, Ljava/util/prefs/FileSystemPreferences;->newNode:Z

    .line 480
    iget-boolean v1, p0, Ljava/util/prefs/FileSystemPreferences;->newNode:Z
    ...
    .line 483
    new-instance v1, Ljava/util/prefs/FileSystemPreferences$NodeCreate;

    invoke-direct {v1, p0, v0}, Ljava/util/prefs/FileSystemPreferences$NodeCreate;-><init>(Ljava/util/prefs/FileSystemPreferences;Ljava/util/prefs/FileSystemPreferences$1;)V

    iput-object v1, p0, Ljava/util/prefs/FileSystemPreferences;->nodeCreate:Ljava/util/prefs/FileSystemPreferences$NodeCreate;
...
.method private constructor greylist-max-o <init>(Ljava/util/prefs/FileSystemPreferences;Ljava/lang/String;)V
    ...
    .line 503
    iget-boolean v1, p1, Ljava/util/prefs/FileSystemPreferences;->isUserNode:Z

    iput-boolean v1, p0, Ljava/util/prefs/FileSystemPreferences;->isUserNode:Z

    .line 504
    new-instance v1, Ljava/io/File;

    iget-object v2, p1, Ljava/util/prefs/FileSystemPreferences;->dir:Ljava/io/File;
    ...
    .line 507
    new-instance v1, Ljava/util/prefs/FileSystemPreferences$4;

    invoke-direct {v1, p0}, Ljava/util/prefs/FileSystemPreferences$4;-><init>(Ljava/util/prefs/FileSystemPreferences;)V
...
# virtual methods
.method protected whitelist core-platform-api test-api childSpi(Ljava/lang/String;)Ljava/util/prefs/AbstractPreferences;
    .registers 3
...
.method protected whitelist core-platform-api test-api childrenNamesSpi()[Ljava/lang/String;
    .registers 2
...
.method protected whitelist core-platform-api test-api flushSpi()V
    .registers 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
...
.method protected whitelist core-platform-api test-api getSpi(Ljava/lang/String;)Ljava/lang/String;
    .registers 3
...
.method protected whitelist core-platform-api test-api keysSpi()[Ljava/lang/String;
    .registers 3
...
.method protected whitelist core-platform-api test-api putSpi(Ljava/lang/String;Ljava/lang/String;)V
    .registers 5
    .param p1, "key"    # Ljava/lang/String;
...
.method protected whitelist core-platform-api test-api removeNodeSpi()V
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
...
.method protected whitelist core-platform-api test-api removeSpi(Ljava/lang/String;)V
    .registers 4
    .param p1, "key"    # Ljava/lang/String;
...
.method public declared-synchronized whitelist core-platform-api test-api sync()V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
...
.method protected whitelist core-platform-api test-api syncSpi()V
    .registers 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/prefs/BackingStoreException;
