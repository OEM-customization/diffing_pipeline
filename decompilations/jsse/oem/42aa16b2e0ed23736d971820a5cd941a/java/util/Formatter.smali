...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/File;Ljava/lang/String;Ljava/util/Locale;)V
    .registers 5
    .param p1, "file"    # Ljava/io/File;
    .param p2, "csn"    # Ljava/lang/String;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Ljava/lang/String;)V
    .registers 4
    .param p1, "os"    # Ljava/io/OutputStream;
    .param p2, "csn"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Ljava/lang/String;Ljava/util/Locale;)V
    .registers 6
    .param p1, "os"    # Ljava/io/OutputStream;
    .param p2, "csn"    # Ljava/lang/String;
    .param p3, "l"    # Ljava/util/Locale;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/PrintStream;)V
    .registers 4
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/Appendable;)V
    .registers 4
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/Appendable;Ljava/util/Locale;)V
    .registers 4
    .param p1, "a"    # Ljava/lang/Appendable;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/Locale;)V
    .registers 6
    .param p1, "fileName"    # Ljava/lang/String;
    .param p2, "csn"    # Ljava/lang/String;
    .param p3, "l"    # Ljava/util/Locale;
...
.method public varargs whitelist core-platform-api test-api format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/util/Formatter;
    .registers 4
...
.method public varargs whitelist core-platform-api test-api format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/util/Formatter;
    .registers 12
    .param p1, "l"    # Ljava/util/Locale;
    ...
    :goto_35
    invoke-interface {v4, v7, p1}, Ljava/util/Formatter$FormatString;->print(Ljava/lang/Object;Ljava/util/Locale;)V
    ...
    invoke-interface {v4, v7, p1}, Ljava/util/Formatter$FormatString;->print(Ljava/lang/Object;Ljava/util/Locale;)V
    :try_end_76
    .catch Ljava/io/IOException; {:try_start_20 .. :try_end_76} :catch_78
...
.method public whitelist core-platform-api test-api out()Ljava/lang/Appendable;
    .registers 2
