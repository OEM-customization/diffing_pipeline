...
.field public static final whitelist core-platform-api test-api AD:I = 0x1

.field public static final whitelist core-platform-api test-api BC:I = 0x0
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/util/TimeZone;)V
    .registers 3
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/util/TimeZone;Ljava/util/Locale;)V
    .registers 5
    .param p1, "zone"    # Ljava/util/TimeZone;
...
.method private greylist-max-o computeFields(II)I
    ...
    if-eq v8, v1, :cond_2f8

    if-ne v10, v8, :cond_2f3
...
.method public static whitelist core-platform-api test-api from(Ljava/time/ZonedDateTime;)Ljava/util/GregorianCalendar;
    .registers 6
...
.method private greylist-max-o getFixedDate(Lsun/util/calendar/BaseCalendar;II)J
    ...
    iget-object v8, v0, Ljava/util/GregorianCalendar;->gdate:Lsun/util/calendar/BaseCalendar$Date;
    ...
    .line 3034
    :goto_3e
    invoke-virtual {v1, v5, v7, v6, v8}, Lsun/util/calendar/BaseCalendar;->getFixedDate(IIILsun/util/calendar/BaseCalendar$Date;)J
    ...
    .line 3053
    invoke-static {v13, v14, v6}, Lsun/util/calendar/BaseCalendar;->getDayOfWeekDateOnOrBefore(JI)J
    ...
    .line 3060
    :cond_88
    invoke-static {v2, v15}, Ljava/util/GregorianCalendar;->isFieldSet(II)Z
    ...
    invoke-static {v9, v10, v4}, Lsun/util/calendar/BaseCalendar;->getDayOfWeekDateOnOrBefore(JI)J
    ...
    invoke-static {v10, v11, v4}, Lsun/util/calendar/BaseCalendar;->getDayOfWeekDateOnOrBefore(JI)J
    ...
    .line 3104
    iget-wide v7, v0, Ljava/util/GregorianCalendar;->gregorianCutoverDate:J
    ...
    .line 3112
    invoke-static {v4, v5, v9}, Lsun/util/calendar/BaseCalendar;->getDayOfWeekDateOnOrBefore(JI)J
    ...
    if-eq v9, v10, :cond_137

    .line 3122
    add-long/2addr v11, v4

    invoke-static {v11, v12, v9}, Lsun/util/calendar/BaseCalendar;->getDayOfWeekDateOnOrBefore(JI)J
...
.method protected whitelist core-platform-api test-api computeTime()V
    ...
    iget v3, v0, Ljava/util/GregorianCalendar;->gregorianCutoverYearJulian:I
    ...
    .end local v13    # "gfd":J
    :cond_e2
    iget v2, v0, Ljava/util/GregorianCalendar;->gregorianCutoverYear:I
...
.method public final whitelist core-platform-api test-api getGregorianChange()Ljava/util/Date;
    .registers 4
...
.method public whitelist core-platform-api test-api isLeapYear(I)Z
    .registers 7
    .param p1, "year"    # I
...
.method public final whitelist core-platform-api test-api isWeekDateSupported()Z
    .registers 2
...
.method public whitelist core-platform-api test-api setGregorianChange(Ljava/util/Date;)V
    .registers 6
