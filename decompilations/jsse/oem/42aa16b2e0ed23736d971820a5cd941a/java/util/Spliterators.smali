...
.method public static whitelist core-platform-api test-api emptyDoubleSpliterator()Ljava/util/Spliterator$OfDouble;
    .registers 1
...
.method public static whitelist core-platform-api test-api emptyIntSpliterator()Ljava/util/Spliterator$OfInt;
    .registers 1
...
.method public static whitelist core-platform-api test-api emptyLongSpliterator()Ljava/util/Spliterator$OfLong;
    .registers 1
...
.method public static whitelist core-platform-api test-api emptySpliterator()Ljava/util/Spliterator;
    .registers 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static whitelist core-platform-api test-api iterator(Ljava/util/Spliterator;)Ljava/util/Iterator;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static whitelist core-platform-api test-api iterator(Ljava/util/Spliterator$OfDouble;)Ljava/util/PrimitiveIterator$OfDouble;
    .registers 2
...
.method public static whitelist core-platform-api test-api iterator(Ljava/util/Spliterator$OfInt;)Ljava/util/PrimitiveIterator$OfInt;
    .registers 2
...
.method public static whitelist core-platform-api test-api iterator(Ljava/util/Spliterator$OfLong;)Ljava/util/PrimitiveIterator$OfLong;
    .registers 2
...
.method public static whitelist core-platform-api test-api spliterator(Ljava/util/PrimitiveIterator$OfDouble;JI)Ljava/util/Spliterator$OfDouble;
    .registers 6
...
.method public static whitelist core-platform-api test-api spliterator([DI)Ljava/util/Spliterator$OfDouble;
    .registers 4
    .param p0, "array"    # [D
...
.method public static whitelist core-platform-api test-api spliterator([DIII)Ljava/util/Spliterator$OfDouble;
    .registers 5
    .param p0, "array"    # [D
...
.method public static whitelist core-platform-api test-api spliterator(Ljava/util/PrimitiveIterator$OfInt;JI)Ljava/util/Spliterator$OfInt;
    .registers 6
...
.method public static whitelist core-platform-api test-api spliterator([II)Ljava/util/Spliterator$OfInt;
    .registers 4
    .param p0, "array"    # [I
    .param p1, "additionalCharacteristics"    # I
...
.method public static whitelist core-platform-api test-api spliterator([IIII)Ljava/util/Spliterator$OfInt;
    .registers 5
    .param p0, "array"    # [I
    .param p1, "fromIndex"    # I
    .param p2, "toIndex"    # I
...
.method public static whitelist core-platform-api test-api spliterator(Ljava/util/PrimitiveIterator$OfLong;JI)Ljava/util/Spliterator$OfLong;
    .registers 6
...
.method public static whitelist core-platform-api test-api spliterator([JI)Ljava/util/Spliterator$OfLong;
    .registers 4
    .param p0, "array"    # [J
    .param p1, "additionalCharacteristics"    # I
...
.method public static whitelist core-platform-api test-api spliterator([JIII)Ljava/util/Spliterator$OfLong;
    .registers 5
    .param p0, "array"    # [J
    .param p1, "fromIndex"    # I
    .param p2, "toIndex"    # I
...
.method public static whitelist core-platform-api test-api spliterator(Ljava/util/Collection;I)Ljava/util/Spliterator;
    .registers 4
...
.method public static whitelist core-platform-api test-api spliterator(Ljava/util/Iterator;JI)Ljava/util/Spliterator;
    .registers 6
    .param p1, "size"    # J
    .param p3, "characteristics"    # I
    .annotation system Ldalvik/annotation/Signature;
...
.method public static whitelist core-platform-api test-api spliterator([Ljava/lang/Object;I)Ljava/util/Spliterator;
    .registers 4
...
.method public static whitelist core-platform-api test-api spliterator([Ljava/lang/Object;III)Ljava/util/Spliterator;
    .registers 5
    .param p0, "array"    # [Ljava/lang/Object;
    .param p1, "fromIndex"    # I
    .param p2, "toIndex"    # I
...
.method public static whitelist core-platform-api test-api spliteratorUnknownSize(Ljava/util/PrimitiveIterator$OfDouble;I)Ljava/util/Spliterator$OfDouble;
    .registers 4
    .param p0, "iterator"    # Ljava/util/PrimitiveIterator$OfDouble;
    .param p1, "characteristics"    # I
...
.method public static whitelist core-platform-api test-api spliteratorUnknownSize(Ljava/util/PrimitiveIterator$OfInt;I)Ljava/util/Spliterator$OfInt;
    .registers 4
    .param p0, "iterator"    # Ljava/util/PrimitiveIterator$OfInt;
    .param p1, "characteristics"    # I
...
.method public static whitelist core-platform-api test-api spliteratorUnknownSize(Ljava/util/PrimitiveIterator$OfLong;I)Ljava/util/Spliterator$OfLong;
    .registers 4
    .param p0, "iterator"    # Ljava/util/PrimitiveIterator$OfLong;
    .param p1, "characteristics"    # I
...
.method public static whitelist core-platform-api test-api spliteratorUnknownSize(Ljava/util/Iterator;I)Ljava/util/Spliterator;
    .registers 4
    .param p1, "characteristics"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
