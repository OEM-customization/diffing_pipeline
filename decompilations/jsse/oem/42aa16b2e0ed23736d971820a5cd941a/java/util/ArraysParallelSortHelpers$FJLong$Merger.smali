...
# direct methods
.method constructor blacklist <init>(Ljava/util/concurrent/CountedCompleter;[J[JIIIIII)V
    .registers 10
    .param p2, "a"    # [J
    .param p3, "w"    # [J
    .param p4, "lbase"    # I
...
.method public final whitelist core-platform-api test-api compute()V
    ...
    iget-object v11, v10, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->a:[J

    .local v11, "a":[J
    iget-object v12, v10, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->w:[J

    .line 728
    .local v12, "w":[J
    iget v13, v10, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->lbase:I

    .local v13, "lb":I
    iget v0, v10, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->lsize:I

    .local v0, "ln":I
    iget v14, v10, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->rbase:I

    .line 729
    .local v14, "rb":I
    iget v1, v10, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->rsize:I

    .local v1, "rn":I
    iget v15, v10, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->wbase:I

    .local v15, "k":I
    iget v9, v10, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->gran:I
    ...
    .local v17, "lh":I
    :goto_98
    new-instance v18, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;
    ...
    .end local v9    # "g":I
    .local v21, "g":I
    invoke-direct/range {v0 .. v9}, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;-><init>(Ljava/util/concurrent/CountedCompleter;[J[JIIIIII)V

    .line 762
    .local v0, "m":Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;
    move/from16 v7, v16
    ...
    invoke-virtual {v10, v11}, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->addToPendingCount(I)V

    .line 765
    invoke-virtual {v0}, Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;->fork()Ljava/util/concurrent/ForkJoinTask;

    .line 766
    .end local v0    # "m":Ljava/util/ArraysParallelSortHelpers$FJLong$Merger;
