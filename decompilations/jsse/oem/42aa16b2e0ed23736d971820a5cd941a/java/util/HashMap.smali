...
.method public whitelist core-platform-api test-api compute(Ljava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;
    ...
    .line 1180
    .local v3, "old":Ljava/util/HashMap$Node;, "Ljava/util/HashMap$Node<TK;TV;>;"
    iget v4, v6, Ljava/util/HashMap;->size:I

    iget v5, v6, Ljava/util/HashMap;->threshold:I

    if-gt v4, v5, :cond_23

    iget-object v4, v6, Ljava/util/HashMap;->table:[Ljava/util/HashMap$Node;

    move-object v5, v4

    .local v5, "tab":[Ljava/util/HashMap$Node;, "[Ljava/util/HashMap$Node<TK;TV;>;"
    if-eqz v4, :cond_23
    ...
    .line 1182
    .end local v5    # "tab":[Ljava/util/HashMap$Node;, "[Ljava/util/HashMap$Node<TK;TV;>;"
    .end local v10    # "n":I
    :cond_23
    :goto_23
    ...
    .restart local v5    # "tab":[Ljava/util/HashMap$Node;, "[Ljava/util/HashMap$Node<TK;TV;>;"
    array-length v10, v4
    ...
    .line 1184
    instance-of v4, v13, Ljava/util/HashMap$TreeNode;
    ...
    invoke-virtual {v4, v9, v7}, Ljava/util/HashMap$TreeNode;->getTreeNode(ILjava/lang/Object;)Ljava/util/HashMap$TreeNode;
    ...
    .end local v3    # "old":Ljava/util/HashMap$Node;, "Ljava/util/HashMap$Node<TK;TV;>;"
...
.method public whitelist core-platform-api test-api computeIfAbsent(Ljava/lang/Object;Ljava/util/function/Function;)Ljava/lang/Object;
    ...
    .line 1125
    invoke-virtual {v6, v3}, Ljava/util/HashMap;->afterNodeAccess(Ljava/util/HashMap$Node;)V
...
.method public whitelist core-platform-api test-api computeIfPresent(Ljava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;
    ...
    .line 1156
    .local v7, "hash":I
    invoke-virtual {p0, v7, p1}, Ljava/util/HashMap;->getNode(ILjava/lang/Object;)Ljava/util/HashMap$Node;
    ...
    iget-object v1, v8, Ljava/util/HashMap$Node;->value:Ljava/lang/Object;
    ...
    .line 1160
    iput-object v10, v8, Ljava/util/HashMap$Node;->value:Ljava/lang/Object;

    .line 1161
    invoke-virtual {p0, v8}, Ljava/util/HashMap;->afterNodeAccess(Ljava/util/HashMap$Node;)V
    ...
    invoke-virtual/range {v1 .. v6}, Ljava/util/HashMap;->removeNode(ILjava/lang/Object;Ljava/lang/Object;ZZ)Ljava/util/HashMap$Node;
