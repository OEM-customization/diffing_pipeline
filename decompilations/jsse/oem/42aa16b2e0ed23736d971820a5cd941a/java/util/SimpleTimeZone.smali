...
.field public static final whitelist core-platform-api test-api STANDARD_TIME:I = 0x1

.field public static final whitelist core-platform-api test-api UTC_TIME:I = 0x2

.field public static final whitelist core-platform-api test-api WALL_TIME:I = 0x0
...
.method public constructor whitelist core-platform-api test-api <init>(ILjava/lang/String;)V
    .registers 4
...
.method public constructor whitelist core-platform-api test-api <init>(ILjava/lang/String;IIIIIIII)V
    .registers 25
    .param p1, "rawOffset"    # I
    .param p2, "ID"    # Ljava/lang/String;
...
.method public constructor whitelist core-platform-api test-api <init>(ILjava/lang/String;IIIIIIIII)V
    .registers 26
    .param p1, "rawOffset"    # I
    .param p2, "ID"    # Ljava/lang/String;
    .param p3, "startMonth"    # I
...
.method public constructor whitelist core-platform-api test-api <init>(ILjava/lang/String;IIIIIIIIIII)V
    .registers 30
    .param p1, "rawOffset"    # I
    .param p2, "ID"    # Ljava/lang/String;
    .param p3, "startMonth"    # I
...
.method private greylist-max-o getOffset(Lsun/util/calendar/BaseCalendar;Lsun/util/calendar/BaseCalendar$Date;IJ)I
    ...
    monitor-exit p0
    :try_end_28
    .catchall {:try_start_1 .. :try_end_28} :catchall_8c
...
.method public whitelist core-platform-api test-api getOffset(IIIIII)I
    .registers 25
    .param p1, "era"    # I
    .param p2, "year"    # I
    .param p3, "month"    # I
...
.method greylist-max-o getOffsets(J[I)I
    ...
    monitor-exit p0
    :try_end_22
    .catchall {:try_start_8 .. :try_end_22} :catchall_5b
...
.method public whitelist core-platform-api test-api getRawOffset()I
    .registers 2
...
.method public whitelist core-platform-api test-api inDaylightTime(Ljava/util/Date;)Z
    .registers 4
...
.method public whitelist core-platform-api test-api setDSTSavings(I)V
    .registers 5
...
.method public whitelist core-platform-api test-api setEndRule(III)V
    .registers 5
    .param p1, "endMonth"    # I
    .param p2, "endDay"    # I
    .param p3, "endTime"    # I
...
.method public whitelist core-platform-api test-api setEndRule(IIII)V
    .registers 6
    .param p1, "endMonth"    # I
    .param p2, "endDay"    # I
...
.method public whitelist core-platform-api test-api setEndRule(IIIIZ)V
    .registers 8
    .param p1, "endMonth"    # I
    .param p2, "endDay"    # I
    .param p3, "endDayOfWeek"    # I
...
.method public whitelist core-platform-api test-api setRawOffset(I)V
    .registers 2
...
.method public whitelist core-platform-api test-api setStartRule(III)V
    .registers 5
...
.method public whitelist core-platform-api test-api setStartRule(IIII)V
    .registers 6
    .param p1, "startMonth"    # I
    .param p2, "startDay"    # I
...
.method public whitelist core-platform-api test-api setStartRule(IIIIZ)V
    .registers 8
    .param p1, "startMonth"    # I
    .param p2, "startDay"    # I
    .param p3, "startDayOfWeek"    # I
...
.method public whitelist core-platform-api test-api setStartYear(I)V
    .registers 2
    .param p1, "year"    # I
...
.method public whitelist core-platform-api test-api useDaylightTime()Z
    .registers 2
