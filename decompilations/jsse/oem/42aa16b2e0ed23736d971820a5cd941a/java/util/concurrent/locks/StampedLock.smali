...
.method static constructor blacklist <clinit>()V
    ...
    sput-wide v1, Ljava/util/concurrent/locks/StampedLock;->STATE:J
    ...
    sput-wide v1, Ljava/util/concurrent/locks/StampedLock;->WHEAD:J
    ...
    sput-wide v0, Ljava/util/concurrent/locks/StampedLock;->WTAIL:J

    .line 1419
    sget-object v0, Ljava/util/concurrent/locks/StampedLock;->U:Lsun/misc/Unsafe;

    const-class v1, Ljava/util/concurrent/locks/StampedLock$WNode;
    ...
    sput-wide v0, Ljava/util/concurrent/locks/StampedLock;->WSTATUS:J
    ...
    sput-wide v0, Ljava/util/concurrent/locks/StampedLock;->WNEXT:J
    ...
    sput-wide v0, Ljava/util/concurrent/locks/StampedLock;->WCOWAIT:J
    ...
    :try_end_96
    .catch Ljava/lang/ReflectiveOperationException; {:try_start_2e .. :try_end_96} :catch_98
...
.method private greylist-max-o acquireRead(ZJ)J
    ...
    sget-object v23, Ljava/util/concurrent/locks/StampedLock;->U:Lsun/misc/Unsafe;

    sget-wide v25, Ljava/util/concurrent/locks/StampedLock;->WCOWAIT:J

    iget-object v0, v1, Ljava/util/concurrent/locks/StampedLock$WNode;->cowait:Ljava/util/concurrent/locks/StampedLock$WNode;
    ...
    iget-wide v3, v8, Ljava/util/concurrent/locks/StampedLock;->state:J
    ...
    :cond_1af
    iget-object v3, v8, Ljava/util/concurrent/locks/StampedLock;->whead:Ljava/util/concurrent/locks/StampedLock$WNode;

    if-ne v3, v9, :cond_1bc

    iget-object v3, v12, Ljava/util/concurrent/locks/StampedLock$WNode;->prev:Ljava/util/concurrent/locks/StampedLock$WNode;

    if-ne v3, v11, :cond_1bc
    ...
    .line 1229
    :cond_1bc
    iput-object v14, v10, Ljava/util/concurrent/locks/StampedLock$WNode;->thread:Ljava/lang/Thread;
    ...
    invoke-virtual {v3, v2, v4, v5, v14}, Lsun/misc/Unsafe;->putObject(Ljava/lang/Object;JLjava/lang/Object;)V
    ...
    .line 1233
    invoke-direct {v8, v10, v12, v13}, Ljava/util/concurrent/locks/StampedLock;->cancelWaiter(Ljava/util/concurrent/locks/StampedLock$WNode;Ljava/util/concurrent/locks/StampedLock$WNode;Z)J
    ...
    .line 1255
    iput-object v14, v10, Ljava/util/concurrent/locks/StampedLock$WNode;->prev:Ljava/util/concurrent/locks/StampedLock$WNode;
    ...
    .local v13, "c":Ljava/util/concurrent/locks/StampedLock$WNode;
    if-eqz v0, :cond_282
    ...
    iget-object v5, v13, Ljava/util/concurrent/locks/StampedLock$WNode;->cowait:Ljava/util/concurrent/locks/StampedLock$WNode;
    ...
    iget-object v0, v13, Ljava/util/concurrent/locks/StampedLock$WNode;->thread:Ljava/lang/Thread;
    ...
    .line 1251
    .end local v6    # "s":J
    .end local v13    # "c":Ljava/util/concurrent/locks/StampedLock$WNode;
    .end local v31    # "ns":J
    .restart local v33    # "s":J
    :cond_28c
    move-wide/from16 v6, v33
    ...
    iget-object v1, v2, Ljava/util/concurrent/locks/StampedLock$WNode;->cowait:Ljava/util/concurrent/locks/StampedLock$WNode;
    ...
    iget-object v1, v2, Ljava/util/concurrent/locks/StampedLock$WNode;->thread:Ljava/lang/Thread;
    ...
    invoke-virtual {v1, v3}, Lsun/misc/Unsafe;->unpark(Ljava/lang/Object;)V
    ...
    .line 1301
    iget v6, v12, Ljava/util/concurrent/locks/StampedLock$WNode;->status:I

    if-gez v6, :cond_362

    if-ne v12, v11, :cond_352
    ...
    :goto_354
    iget-object v6, v8, Ljava/util/concurrent/locks/StampedLock;->whead:Ljava/util/concurrent/locks/StampedLock$WNode;

    if-ne v6, v11, :cond_364

    iget-object v6, v10, Ljava/util/concurrent/locks/StampedLock$WNode;->prev:Ljava/util/concurrent/locks/StampedLock$WNode;

    if-ne v6, v12, :cond_364
    ...
    iput-object v6, v10, Ljava/util/concurrent/locks/StampedLock$WNode;->thread:Ljava/lang/Thread;

    .line 1306
    sget-object v13, Ljava/util/concurrent/locks/StampedLock;->U:Lsun/misc/Unsafe;

    sget-wide v7, Ljava/util/concurrent/locks/StampedLock;->PARKBLOCKER:J

    invoke-virtual {v13, v1, v7, v8, v6}, Lsun/misc/Unsafe;->putObject(Ljava/lang/Object;JLjava/lang/Object;)V
    ...
    invoke-direct {v7, v10, v10, v8}, Ljava/util/concurrent/locks/StampedLock;->cancelWaiter(Ljava/util/concurrent/locks/StampedLock$WNode;Ljava/util/concurrent/locks/StampedLock$WNode;Z)J
...
.method private greylist-max-o acquireWrite(ZJ)J
    ...
    .line 1090
    sget-object v22, Ljava/util/concurrent/locks/StampedLock;->U:Lsun/misc/Unsafe;

    sget-wide v24, Ljava/util/concurrent/locks/StampedLock;->WCOWAIT:J

    iget-object v2, v3, Ljava/util/concurrent/locks/StampedLock$WNode;->cowait:Ljava/util/concurrent/locks/StampedLock$WNode;
    ...
    invoke-virtual/range {v22 .. v27}, Lsun/misc/Unsafe;->compareAndSwapObject(Ljava/lang/Object;JLjava/lang/Object;Ljava/lang/Object;)Z

    move-result v2

    if-eqz v2, :cond_e8

    iget-object v2, v3, Ljava/util/concurrent/locks/StampedLock$WNode;->thread:Ljava/lang/Thread;
    ...
    invoke-virtual {v2, v4}, Lsun/misc/Unsafe;->unpark(Ljava/lang/Object;)V
    ...
    sget-wide v24, Ljava/util/concurrent/locks/StampedLock;->WSTATUS:J
    ...
    invoke-virtual {v2, v13, v5, v6}, Lsun/misc/Unsafe;->park(ZJ)V
    ...
    :cond_197
    :goto_197
    iput-object v0, v9, Ljava/util/concurrent/locks/StampedLock$WNode;->thread:Ljava/lang/Thread;
    ...
    invoke-direct {v8, v9, v9, v2}, Ljava/util/concurrent/locks/StampedLock;->cancelWaiter(Ljava/util/concurrent/locks/StampedLock$WNode;Ljava/util/concurrent/locks/StampedLock$WNode;Z)J
...
.method private greylist-max-o tryDecReaderOverflow(J)J
    ...
    sget-wide v3, Ljava/util/concurrent/locks/StampedLock;->STATE:J
...
# virtual methods
.method public whitelist core-platform-api test-api asReadLock()Ljava/util/concurrent/locks/Lock;
    .registers 3
...
.method public whitelist core-platform-api test-api asReadWriteLock()Ljava/util/concurrent/locks/ReadWriteLock;
    .registers 3
...
.method public whitelist core-platform-api test-api asWriteLock()Ljava/util/concurrent/locks/Lock;
    .registers 3
...
.method public whitelist core-platform-api test-api getReadLockCount()I
    .registers 3
...
.method public whitelist core-platform-api test-api isReadLocked()Z
    .registers 5
...
.method public whitelist core-platform-api test-api isWriteLocked()Z
    .registers 5
...
.method public whitelist core-platform-api test-api readLock()J
    .registers 13
...
.method public whitelist core-platform-api test-api readLockInterruptibly()J
    .registers 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api tryConvertToOptimisticRead(J)J
    .registers 26
    .param p1, "stamp"    # J
...
.method public whitelist core-platform-api test-api tryConvertToReadLock(J)J
    .registers 22
    .param p1, "stamp"    # J
...
.method public whitelist core-platform-api test-api tryConvertToWriteLock(J)J
    .registers 24
    .param p1, "stamp"    # J
...
.method public whitelist core-platform-api test-api tryOptimisticRead()J
    .registers 7
...
.method public whitelist core-platform-api test-api tryReadLock()J
    .registers 15
...
.method public whitelist core-platform-api test-api tryReadLock(JLjava/util/concurrent/TimeUnit;)J
    .registers 28
    .param p1, "time"    # J
...
.method public whitelist core-platform-api test-api tryUnlockRead()Z
    .registers 17
...
.method public whitelist core-platform-api test-api tryUnlockWrite()Z
    .registers 15
...
.method public whitelist core-platform-api test-api tryWriteLock()J
    .registers 15
...
.method public whitelist core-platform-api test-api tryWriteLock(JLjava/util/concurrent/TimeUnit;)J
    .registers 14
    .param p1, "time"    # J
    .param p3, "unit"    # Ljava/util/concurrent/TimeUnit;
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist core-platform-api test-api unlock(J)V
    .registers 22
    .param p1, "stamp"    # J
...
.method public whitelist core-platform-api test-api unlockRead(J)V
    .registers 18
    .param p1, "stamp"    # J
...
.method public whitelist core-platform-api test-api unlockWrite(J)V
    .registers 15
    .param p1, "stamp"    # J
...
.method public whitelist core-platform-api test-api validate(J)Z
    .registers 9
    .param p1, "stamp"    # J
...
.method public whitelist core-platform-api test-api writeLock()J
    .registers 15
...
.method public whitelist core-platform-api test-api writeLockInterruptibly()J
    .registers 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/InterruptedException;
