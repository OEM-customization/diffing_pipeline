...
.field private greylist needDict:Z
...
.method public constructor whitelist core-platform-api test-api <init>(Z)V
    ...
    invoke-direct {v0, v1, v2}, Ljava/util/zip/ZStreamRef;-><init>(J)V
...
.method public whitelist core-platform-api test-api getRemaining()I
    .registers 3
...
.method public whitelist core-platform-api test-api inflate([B)I
    .registers 4
    .param p1, "b"    # [B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist core-platform-api test-api inflate([BII)I
    .registers 13
    .param p1, "b"    # [B
    .param p2, "off"    # I
    .param p3, "len"    # I
...
.method public whitelist core-platform-api test-api needsDictionary()Z
    .registers 3
