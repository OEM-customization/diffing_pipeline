...
.field protected whitelist core-platform-api test-api def:Ljava/util/zip/Deflater;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Ljava/util/zip/Deflater;)V
    .registers 5
    .param p1, "out"    # Ljava/io/OutputStream;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Ljava/util/zip/Deflater;I)V
    .registers 5
    .param p1, "out"    # Ljava/io/OutputStream;
    .param p2, "def"    # Ljava/util/zip/Deflater;
    .param p3, "size"    # I
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Ljava/util/zip/Deflater;IZ)V
    .registers 7
    .param p1, "out"    # Ljava/io/OutputStream;
    .param p2, "def"    # Ljava/util/zip/Deflater;
    .param p3, "size"    # I
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Ljava/util/zip/Deflater;Z)V
    .registers 5
    .param p1, "out"    # Ljava/io/OutputStream;
    .param p2, "def"    # Ljava/util/zip/Deflater;
...
.method protected whitelist core-platform-api test-api deflate()V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
