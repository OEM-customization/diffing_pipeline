...
.field protected final whitelist core-platform-api test-api inf:Ljava/util/zip/Inflater;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Ljava/util/zip/Inflater;)V
    .registers 4
    .param p1, "out"    # Ljava/io/OutputStream;
...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/OutputStream;Ljava/util/zip/Inflater;I)V
    .registers 6
    .param p1, "out"    # Ljava/io/OutputStream;
    .param p2, "infl"    # Ljava/util/zip/Inflater;
    .param p3, "bufLen"    # I
...
.method public whitelist core-platform-api test-api flush()V
    ...
    :try_end_36
    .catch Ljava/util/zip/DataFormatException; {:try_start_b .. :try_end_36} :catch_37
...
.method public whitelist core-platform-api test-api write([BII)V
    ...
    throw v1
    :try_end_5b
    .catch Ljava/util/zip/DataFormatException; {:try_start_10 .. :try_end_5b} :catch_5b
