...
.method public whitelist core-platform-api test-api forEachRemaining(Ljava/util/function/IntConsumer;)V
    ...
    new-instance v1, Ljava/util/stream/-$$Lambda$C9lt_0Cg-SARhdNFJsMyHSsCsGA;

    invoke-direct {v1, p1}, Ljava/util/stream/-$$Lambda$C9lt_0Cg-SARhdNFJsMyHSsCsGA;-><init>(Ljava/util/function/IntConsumer;)V
...
.method blacklist initPartialTraversalState()V
    ...
    new-instance v2, Ljava/util/stream/-$$Lambda$ZgCkHA78fnu8poGzKYmvya-ev3U;

    invoke-direct {v2, v0}, Ljava/util/stream/-$$Lambda$ZgCkHA78fnu8poGzKYmvya-ev3U;-><init>(Ljava/util/stream/SpinedBuffer$OfInt;)V
    ...
    .line 347
    new-instance v1, Ljava/util/stream/-$$Lambda$StreamSpliterators$IntWrappingSpliterator$js67IRBzuEwtfp5Z3OTF-GfmUTw;

    invoke-direct {v1, p0}, Ljava/util/stream/-$$Lambda$StreamSpliterators$IntWrappingSpliterator$js67IRBzuEwtfp5Z3OTF-GfmUTw;-><init>(Ljava/util/stream/StreamSpliterators$IntWrappingSpliterator;)V
