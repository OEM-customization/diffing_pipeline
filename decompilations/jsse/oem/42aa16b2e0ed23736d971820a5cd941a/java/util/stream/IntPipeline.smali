...
.method private static greylist-max-o adapt(Ljava/util/stream/Sink;)Ljava/util/function/IntConsumer;
    ...
    new-instance v0, Ljava/util/stream/-$$Lambda$wDsxx48ovPSGeNEb3P6H9u7YX0k;

    invoke-direct {v0, p0}, Ljava/util/stream/-$$Lambda$wDsxx48ovPSGeNEb3P6H9u7YX0k;-><init>(Ljava/util/stream/Sink;)V
...
# virtual methods
.method public final whitelist core-platform-api test-api allMatch(Ljava/util/function/IntPredicate;)Z
    .registers 3
...
.method public final whitelist core-platform-api test-api anyMatch(Ljava/util/function/IntPredicate;)Z
    .registers 3
    .param p1, "predicate"    # Ljava/util/function/IntPredicate;
...
.method public final whitelist core-platform-api test-api asLongStream()Ljava/util/stream/LongStream;
    .registers 5
...
.method public final whitelist core-platform-api test-api average()Ljava/util/OptionalDouble;
    ...
    .line 451
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$IntPipeline$MrivqBp4YhHB_ix11jxmkPQ1lbE;->INSTANCE:Ljava/util/stream/-$$Lambda$IntPipeline$MrivqBp4YhHB_ix11jxmkPQ1lbE;

    sget-object v1, Ljava/util/stream/-$$Lambda$IntPipeline$0s_rkIyKzlnj_M-bqfCTpum_W2c;->INSTANCE:Ljava/util/stream/-$$Lambda$IntPipeline$0s_rkIyKzlnj_M-bqfCTpum_W2c;

    sget-object v2, Ljava/util/stream/-$$Lambda$IntPipeline$hMFCZ84F0UujzJhdWtPfESTkN2A;->INSTANCE:Ljava/util/stream/-$$Lambda$IntPipeline$hMFCZ84F0UujzJhdWtPfESTkN2A;
...
.method public final whitelist core-platform-api test-api boxed()Ljava/util/stream/Stream;
    ...
    .line 229
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$wFoiz-RiPqYBPe0X4aSzbj2iL3g;->INSTANCE:Ljava/util/stream/-$$Lambda$wFoiz-RiPqYBPe0X4aSzbj2iL3g;
...
.method public final whitelist core-platform-api test-api collect(Ljava/util/function/Supplier;Ljava/util/function/ObjIntConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    new-instance v0, Ljava/util/stream/-$$Lambda$IntPipeline$gTDhYg7hsRI2br4NmAxtQnW5i6Y;

    .local v0, "operator":Ljava/util/function/BinaryOperator;, "Ljava/util/function/BinaryOperator<TR;>;"
    invoke-direct {v0, p3}, Ljava/util/stream/-$$Lambda$IntPipeline$gTDhYg7hsRI2br4NmAxtQnW5i6Y;-><init>(Ljava/util/function/BiConsumer;)V
...
.method public final whitelist core-platform-api test-api count()J
    ...
    .line 446
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$IntPipeline$Q_Wb7uDnZZMCasMbsGNAwSlprMo;->INSTANCE:Ljava/util/stream/-$$Lambda$IntPipeline$Q_Wb7uDnZZMCasMbsGNAwSlprMo;
...
.method public final whitelist core-platform-api test-api distinct()Ljava/util/stream/IntStream;
    .registers 3
    ...
    sget-object v1, Ljava/util/stream/-$$Lambda$IntPipeline$R-E7oGjPWog3HR9X-8MdhU1ZGRE;->INSTANCE:Ljava/util/stream/-$$Lambda$IntPipeline$R-E7oGjPWog3HR9X-8MdhU1ZGRE;
...
.method public final whitelist core-platform-api test-api filter(Ljava/util/function/IntPredicate;)Ljava/util/stream/IntStream;
    .registers 9
    .param p1, "predicate"    # Ljava/util/function/IntPredicate;
...
.method public final whitelist core-platform-api test-api findAny()Ljava/util/OptionalInt;
    .registers 2
...
.method public final whitelist core-platform-api test-api findFirst()Ljava/util/OptionalInt;
    .registers 2
...
.method public final whitelist core-platform-api test-api flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final whitelist core-platform-api test-api iterator()Ljava/util/PrimitiveIterator$OfInt;
    .registers 2
...
.method public final whitelist core-platform-api test-api limit(J)Ljava/util/stream/IntStream;
    .registers 6
    .param p1, "maxSize"    # J
...
.method public final whitelist core-platform-api test-api map(Ljava/util/function/IntUnaryOperator;)Ljava/util/stream/IntStream;
    .registers 9
...
.method public final whitelist core-platform-api test-api mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    .registers 9
...
.method public final whitelist core-platform-api test-api mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    .registers 9
...
.method public final whitelist core-platform-api test-api mapToObj(Ljava/util/function/IntFunction;)Ljava/util/stream/Stream;
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
...
.method public final whitelist core-platform-api test-api max()Ljava/util/OptionalInt;
    .registers 2

    .line 441
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$HJTpjoyUrBGPZyR69XwKllqU1YY;->INSTANCE:Ljava/util/stream/-$$Lambda$HJTpjoyUrBGPZyR69XwKllqU1YY;
...
.method public final whitelist core-platform-api test-api min()Ljava/util/OptionalInt;
    .registers 2

    .line 436
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$FZ2W1z3RReutoY2tFnI_NsF0lTk;->INSTANCE:Ljava/util/stream/-$$Lambda$FZ2W1z3RReutoY2tFnI_NsF0lTk;
...
.method public final whitelist core-platform-api test-api noneMatch(Ljava/util/function/IntPredicate;)Z
    .registers 3
    .param p1, "predicate"    # Ljava/util/function/IntPredicate;
...
.method public final whitelist core-platform-api test-api peek(Ljava/util/function/IntConsumer;)Ljava/util/stream/IntStream;
    .registers 9
    .param p1, "action"    # Ljava/util/function/IntConsumer;
...
.method public final whitelist core-platform-api test-api reduce(ILjava/util/function/IntBinaryOperator;)I
    .registers 4
    .param p1, "identity"    # I
...
.method public final whitelist core-platform-api test-api reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    .registers 3
...
.method public final whitelist core-platform-api test-api skip(J)Ljava/util/stream/IntStream;
    .registers 6
    .param p1, "n"    # J
...
.method public final whitelist core-platform-api test-api sorted()Ljava/util/stream/IntStream;
    .registers 2
...
.method public final whitelist core-platform-api test-api spliterator()Ljava/util/Spliterator$OfInt;
    .registers 2
...
.method public final whitelist core-platform-api test-api sum()I
    .registers 3

    .line 431
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$ono9Bp0lMrKbIRfAAYdycY0_qag;->INSTANCE:Ljava/util/stream/-$$Lambda$ono9Bp0lMrKbIRfAAYdycY0_qag;
...
.method public final whitelist core-platform-api test-api summaryStatistics()Ljava/util/IntSummaryStatistics;
    .registers 4

    .line 467
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$_Ea_sNpqZAwihIOCRBaP7hHgWWI;->INSTANCE:Ljava/util/stream/-$$Lambda$_Ea_sNpqZAwihIOCRBaP7hHgWWI;

    sget-object v1, Ljava/util/stream/-$$Lambda$UowTf7vzuMsu4sv1-eMs5iEeNh0;->INSTANCE:Ljava/util/stream/-$$Lambda$UowTf7vzuMsu4sv1-eMs5iEeNh0;

    sget-object v2, Ljava/util/stream/-$$Lambda$YcgMAuDDScc4HC6CSMDq1R0qa40;->INSTANCE:Ljava/util/stream/-$$Lambda$YcgMAuDDScc4HC6CSMDq1R0qa40;
...
.method public final whitelist core-platform-api test-api toArray()[I
    .registers 2

    .line 519
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    sget-object v0, Ljava/util/stream/-$$Lambda$IntPipeline$ozedusDMANE_B8aDthWCd1L-na4;->INSTANCE:Ljava/util/stream/-$$Lambda$IntPipeline$ozedusDMANE_B8aDthWCd1L-na4;
