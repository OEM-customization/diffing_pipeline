...
# direct methods
.method public static whitelist core-platform-api test-api builder()Ljava/util/stream/LongStream$Builder;
    .registers 1
...
.method public static whitelist core-platform-api test-api concat(Ljava/util/stream/LongStream;Ljava/util/stream/LongStream;)Ljava/util/stream/LongStream;
    .registers 5
...
.method public static whitelist core-platform-api test-api empty()Ljava/util/stream/LongStream;
    .registers 2
...
.method public static whitelist core-platform-api test-api generate(Ljava/util/function/LongSupplier;)Ljava/util/stream/LongStream;
    .registers 4
...
.method public static whitelist core-platform-api test-api iterate(JLjava/util/function/LongUnaryOperator;)Ljava/util/stream/LongStream;
    .registers 6
    .param p0, "seed"    # J
...
.method public static whitelist core-platform-api test-api of(J)Ljava/util/stream/LongStream;
    .registers 4
    .param p0, "t"    # J
...
.method public static varargs whitelist core-platform-api test-api of([J)Ljava/util/stream/LongStream;
    .registers 2
    .param p0, "values"    # [J
...
.method public static whitelist core-platform-api test-api range(JJ)Ljava/util/stream/LongStream;
    .registers 13
...
.method public static whitelist core-platform-api test-api rangeClosed(JJ)Ljava/util/stream/LongStream;
    .registers 13
    .param p0, "startInclusive"    # J
...
# virtual methods
.method public abstract whitelist core-platform-api test-api allMatch(Ljava/util/function/LongPredicate;)Z
.end method

.method public abstract whitelist core-platform-api test-api anyMatch(Ljava/util/function/LongPredicate;)Z
.end method
...
.method public abstract whitelist core-platform-api test-api collect(Ljava/util/function/Supplier;Ljava/util/function/ObjLongConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
            "Ljava/lang/Object;",
...
.method public abstract whitelist core-platform-api test-api distinct()Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api filter(Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api findAny()Ljava/util/OptionalLong;
.end method

.method public abstract whitelist core-platform-api test-api findFirst()Ljava/util/OptionalLong;
.end method

.method public abstract whitelist core-platform-api test-api flatMap(Ljava/util/function/LongFunction;)Ljava/util/stream/LongStream;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public abstract whitelist core-platform-api test-api forEach(Ljava/util/function/LongConsumer;)V
.end method

.method public abstract whitelist core-platform-api test-api forEachOrdered(Ljava/util/function/LongConsumer;)V
.end method
...
.method public abstract whitelist core-platform-api test-api iterator()Ljava/util/PrimitiveIterator$OfLong;
.end method

.method public abstract whitelist core-platform-api test-api limit(J)Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api map(Ljava/util/function/LongUnaryOperator;)Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api mapToDouble(Ljava/util/function/LongToDoubleFunction;)Ljava/util/stream/DoubleStream;
.end method

.method public abstract whitelist core-platform-api test-api mapToInt(Ljava/util/function/LongToIntFunction;)Ljava/util/stream/IntStream;
.end method

.method public abstract whitelist core-platform-api test-api mapToObj(Ljava/util/function/LongFunction;)Ljava/util/stream/Stream;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
            "Ljava/lang/Object;",
...
.method public abstract whitelist core-platform-api test-api max()Ljava/util/OptionalLong;
.end method

.method public abstract whitelist core-platform-api test-api min()Ljava/util/OptionalLong;
.end method

.method public abstract whitelist core-platform-api test-api noneMatch(Ljava/util/function/LongPredicate;)Z
.end method
...
.method public abstract whitelist core-platform-api test-api parallel()Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api peek(Ljava/util/function/LongConsumer;)Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api reduce(JLjava/util/function/LongBinaryOperator;)J
.end method

.method public abstract whitelist core-platform-api test-api reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
.end method
...
.method public abstract whitelist core-platform-api test-api sequential()Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api skip(J)Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api sorted()Ljava/util/stream/LongStream;
.end method

.method public abstract whitelist core-platform-api test-api spliterator()Ljava/util/Spliterator$OfLong;
.end method
...
.method public abstract whitelist core-platform-api test-api sum()J
.end method

.method public abstract whitelist core-platform-api test-api summaryStatistics()Ljava/util/LongSummaryStatistics;
.end method

.method public abstract whitelist core-platform-api test-api toArray()[J
.end method
