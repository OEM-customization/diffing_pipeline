...
.method public constructor whitelist core-platform-api test-api <init>(Ljava/io/InputStream;)V
    ...
    .line 348
    new-instance v1, Ljava/io/ObjectInputStream$HandleTable;

    const/16 v2, 0xa

    invoke-direct {v1, v2}, Ljava/io/ObjectInputStream$HandleTable;-><init>(I)V

    iput-object v1, p0, Ljava/io/ObjectInputStream;->handles:Ljava/io/ObjectInputStream$HandleTable;

    .line 349
    new-instance v1, Ljava/io/ObjectInputStream$ValidationList;

    invoke-direct {v1}, Ljava/io/ObjectInputStream$ValidationList;-><init>()V
...
.method public whitelist core-platform-api test-api defaultReadObject()V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method protected whitelist core-platform-api test-api enableResolveObject(Z)Z
    .registers 4
    .param p1, "enable"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method protected whitelist core-platform-api test-api readClassDescriptor()Ljava/io/ObjectStreamClass;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method public whitelist core-platform-api test-api readFields()Ljava/io/ObjectInputStream$GetField;
    .registers 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method public final whitelist core-platform-api test-api readObject()Ljava/lang/Object;
    .registers 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method protected whitelist core-platform-api test-api readObjectOverride()Ljava/lang/Object;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method protected whitelist core-platform-api test-api readStreamHeader()V
    .registers 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method greylist-max-o readTypeString()Ljava/lang/String;
    ...
    :cond_2f
    :goto_2f
    invoke-direct {p0, v3}, Ljava/io/ObjectInputStream;->readString(Z)Ljava/lang/String;
    ...
    :cond_36
    :try_start_36
    invoke-direct {p0, v3}, Ljava/io/ObjectInputStream;->readHandle(Z)Ljava/lang/Object;
    ...
    check-cast v2, Ljava/lang/String;
    :try_end_45
    .catchall {:try_start_3f .. :try_end_45} :catchall_48
...
.method public whitelist core-platform-api test-api readUnshared()Ljava/lang/Object;
    .registers 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method public whitelist core-platform-api test-api registerValidation(Ljava/io/ObjectInputValidation;I)V
    .registers 5
...
.method protected whitelist core-platform-api test-api resolveObject(Ljava/lang/Object;)Ljava/lang/Object;
    .registers 2
    .param p1, "obj"    # Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method protected whitelist core-platform-api test-api resolveProxyClass([Ljava/lang/String;)Ljava/lang/Class;
    .registers 10
