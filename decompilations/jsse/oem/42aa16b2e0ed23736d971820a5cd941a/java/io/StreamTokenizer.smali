...
.field public static final whitelist core-platform-api test-api TT_EOF:I = -0x1

.field public static final whitelist core-platform-api test-api TT_EOL:I = 0xa

.field private static final greylist-max-o TT_NOTHING:I = -0x4

.field public static final whitelist core-platform-api test-api TT_NUMBER:I = -0x2

.field public static final whitelist core-platform-api test-api TT_WORD:I = -0x3
...
.field public whitelist core-platform-api test-api nval:D
...
.field public whitelist core-platform-api test-api sval:Ljava/lang/String;

.field public whitelist core-platform-api test-api ttype:I
...
# virtual methods
.method public whitelist core-platform-api test-api commentChar(I)V
    .registers 4
    .param p1, "ch"    # I
...
.method public whitelist core-platform-api test-api eolIsSignificant(Z)V
    .registers 2
    .param p1, "flag"    # Z
...
.method public whitelist core-platform-api test-api lineno()I
    .registers 2
...
.method public whitelist core-platform-api test-api lowerCaseMode(Z)V
    .registers 2
    .param p1, "fl"    # Z
...
.method public whitelist core-platform-api test-api nextToken()I
    .registers 16
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    if-eq v2, v8, :cond_19f

    const/16 v8, 0x66

    if-eq v2, v8, :cond_19c

    const/16 v8, 0x6e

    if-eq v2, v8, :cond_199

    const/16 v8, 0x72

    if-eq v2, v8, :cond_196

    const/16 v8, 0x74

    if-eq v2, v8, :cond_193
    ...
    if-eq v1, v5, :cond_250

    if-eq v2, v11, :cond_250
    ...
    if-eq v1, v5, :cond_26c

    if-eq v2, v11, :cond_26c
...
.method public whitelist core-platform-api test-api ordinaryChar(I)V
    .registers 4
    .param p1, "ch"    # I
...
.method public whitelist core-platform-api test-api ordinaryChars(II)V
    .registers 6
    .param p1, "low"    # I
    .param p2, "hi"    # I
...
.method public whitelist core-platform-api test-api parseNumbers()V
    .registers 4
...
.method public whitelist core-platform-api test-api pushBack()V
    .registers 3
...
.method public whitelist core-platform-api test-api quoteChar(I)V
    .registers 4
    .param p1, "ch"    # I
...
.method public whitelist core-platform-api test-api resetSyntax()V
    .registers 4
...
.method public whitelist core-platform-api test-api slashSlashComments(Z)V
    .registers 2
    .param p1, "flag"    # Z
...
.method public whitelist core-platform-api test-api slashStarComments(Z)V
    .registers 2
    .param p1, "flag"    # Z
...
.method public whitelist core-platform-api test-api whitespaceChars(II)V
    .registers 6
    .param p1, "low"    # I
    .param p2, "hi"    # I
...
.method public whitelist core-platform-api test-api wordChars(II)V
    .registers 6
    .param p1, "low"    # I
    .param p2, "hi"    # I
