...
.field public static final enum whitelist core-platform-api test-api APRIL:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api AUGUST:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api DECEMBER:Ljava/time/Month;

.field private static final greylist-max-o ENUMS:[Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api FEBRUARY:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api JANUARY:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api JULY:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api JUNE:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api MARCH:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api MAY:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api NOVEMBER:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api OCTOBER:Ljava/time/Month;

.field public static final enum whitelist core-platform-api test-api SEPTEMBER:Ljava/time/Month;
...
.method static constructor blacklist <clinit>()V
    ...
    invoke-direct {v0, v1, v8}, Ljava/time/Month;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v1, v9}, Ljava/time/Month;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v1, v10}, Ljava/time/Month;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v1, v11}, Ljava/time/Month;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v1, v12}, Ljava/time/Month;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v1, v13}, Ljava/time/Month;-><init>(Ljava/lang/String;I)V
    ...
    new-array v1, v1, [Ljava/time/Month;

    sget-object v14, Ljava/time/Month;->JANUARY:Ljava/time/Month;
    ...
    sput-object v1, Ljava/time/Month;->$VALUES:[Ljava/time/Month;
...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/Month;
    .registers 5
...
.method public static whitelist core-platform-api test-api of(I)Ljava/time/Month;
    .registers 4
    .param p0, "month"    # I
...
.method public static whitelist core-platform-api test-api valueOf(Ljava/lang/String;)Ljava/time/Month;
    .registers 2
...
.method public static whitelist core-platform-api test-api values()[Ljava/time/Month;
    .registers 1
...
.method public whitelist core-platform-api test-api firstDayOfYear(Z)I
    .registers 5
    .param p1, "leapYear"    # Z
...
.method public whitelist core-platform-api test-api firstMonthOfQuarter()Ljava/time/Month;
    .registers 3
...
.method public whitelist core-platform-api test-api length(Z)I
    .registers 4
    .param p1, "leapYear"    # Z
...
.method public whitelist core-platform-api test-api maxLength()I
    .registers 3
...
.method public whitelist core-platform-api test-api minLength()I
    .registers 3
...
.method public whitelist core-platform-api test-api minus(J)Ljava/time/Month;
    .registers 5
    .param p1, "months"    # J
...
.method public whitelist core-platform-api test-api plus(J)Ljava/time/Month;
    .registers 7
    .param p1, "months"    # J
