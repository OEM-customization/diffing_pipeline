...
# direct methods
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/Chronology;
    .registers 3
...
.method public static whitelist core-platform-api test-api getAvailableChronologies()Ljava/util/Set;
    .registers 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public static whitelist core-platform-api test-api of(Ljava/lang/String;)Ljava/time/chrono/Chronology;
    .registers 2
...
.method public static whitelist core-platform-api test-api ofLocale(Ljava/util/Locale;)Ljava/time/chrono/Chronology;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api compareTo(Ljava/time/chrono/Chronology;)I
.end method

.method public abstract whitelist core-platform-api test-api date(III)Ljava/time/chrono/ChronoLocalDate;
.end method

.method public whitelist core-platform-api test-api date(Ljava/time/chrono/Era;III)Ljava/time/chrono/ChronoLocalDate;
    .registers 6
...
.method public abstract whitelist core-platform-api test-api date(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/ChronoLocalDate;
.end method

.method public abstract whitelist core-platform-api test-api dateEpochDay(J)Ljava/time/chrono/ChronoLocalDate;
.end method

.method public whitelist core-platform-api test-api dateNow()Ljava/time/chrono/ChronoLocalDate;
    .registers 2
...
.method public whitelist core-platform-api test-api dateNow(Ljava/time/Clock;)Ljava/time/chrono/ChronoLocalDate;
    .registers 3
...
.method public whitelist core-platform-api test-api dateNow(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoLocalDate;
    .registers 3
...
.method public abstract whitelist core-platform-api test-api dateYearDay(II)Ljava/time/chrono/ChronoLocalDate;
.end method

.method public whitelist core-platform-api test-api dateYearDay(Ljava/time/chrono/Era;II)Ljava/time/chrono/ChronoLocalDate;
    .registers 5
    .param p1, "era"    # Ljava/time/chrono/Era;
    .param p2, "yearOfEra"    # I
...
.method public abstract whitelist core-platform-api test-api eraOf(I)Ljava/time/chrono/Era;
.end method

.method public abstract whitelist core-platform-api test-api eras()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
...
.method public abstract whitelist core-platform-api test-api getCalendarType()Ljava/lang/String;
.end method
...
.method public abstract whitelist core-platform-api test-api isLeapYear(J)Z
.end method
...
.method public whitelist core-platform-api test-api period(III)Ljava/time/chrono/ChronoPeriod;
    .registers 5
    .param p1, "years"    # I
    .param p2, "months"    # I
    .param p3, "days"    # I
...
.method public abstract whitelist core-platform-api test-api prolepticYear(Ljava/time/chrono/Era;I)I
.end method

.method public abstract whitelist core-platform-api test-api range(Ljava/time/temporal/ChronoField;)Ljava/time/temporal/ValueRange;
.end method

.method public abstract whitelist core-platform-api test-api resolveDate(Ljava/util/Map;Ljava/time/format/ResolverStyle;)Ljava/time/chrono/ChronoLocalDate;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/Map<",
