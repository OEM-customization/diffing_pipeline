...
# static fields
.field public static final whitelist core-platform-api test-api MAX:Ljava/time/LocalDateTime;

.field public static final whitelist core-platform-api test-api MIN:Ljava/time/LocalDateTime;
...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/LocalDateTime;
    .registers 5
...
.method public static whitelist core-platform-api test-api now()Ljava/time/LocalDateTime;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/LocalDateTime;
    .registers 6
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/LocalDateTime;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(IIIII)Ljava/time/LocalDateTime;
    .registers 8
    .param p0, "year"    # I
    .param p1, "month"    # I
...
.method public static whitelist core-platform-api test-api of(IIIIII)Ljava/time/LocalDateTime;
    .registers 9
    .param p0, "year"    # I
    .param p1, "month"    # I
    .param p2, "dayOfMonth"    # I
...
.method public static whitelist core-platform-api test-api of(IIIIIII)Ljava/time/LocalDateTime;
    .registers 10
    .param p0, "year"    # I
    .param p1, "month"    # I
    .param p2, "dayOfMonth"    # I
...
.method public static whitelist core-platform-api test-api of(ILjava/time/Month;III)Ljava/time/LocalDateTime;
    .registers 8
    .param p0, "year"    # I
...
.method public static whitelist core-platform-api test-api of(ILjava/time/Month;IIII)Ljava/time/LocalDateTime;
    .registers 9
    .param p0, "year"    # I
    .param p1, "month"    # Ljava/time/Month;
    .param p2, "dayOfMonth"    # I
...
.method public static whitelist core-platform-api test-api of(ILjava/time/Month;IIIII)Ljava/time/LocalDateTime;
    .registers 10
    .param p0, "year"    # I
    .param p1, "month"    # Ljava/time/Month;
    .param p2, "dayOfMonth"    # I
...
.method public static whitelist core-platform-api test-api of(Ljava/time/LocalDate;Ljava/time/LocalTime;)Ljava/time/LocalDateTime;
    .registers 3
...
.method public static whitelist core-platform-api test-api ofEpochSecond(JILjava/time/ZoneOffset;)Ljava/time/LocalDateTime;
    .registers 14
    ...
    invoke-direct {v7, v3, v6}, Ljava/time/LocalDateTime;-><init>(Ljava/time/LocalDate;Ljava/time/LocalTime;)V

    return-object v7
.end method

.method public static whitelist core-platform-api test-api ofInstant(Ljava/time/Instant;Ljava/time/ZoneId;)Ljava/time/LocalDateTime;
    .registers 7
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;)Ljava/time/LocalDateTime;
    .registers 2
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;Ljava/time/format/DateTimeFormatter;)Ljava/time/LocalDateTime;
    .registers 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    ...
    .line 486
    sget-object v0, Ljava/time/-$$Lambda$JBWLm7jbzHiLhHxYdB_IuO_vFO8;->INSTANCE:Ljava/time/-$$Lambda$JBWLm7jbzHiLhHxYdB_IuO_vFO8;
...
.method public whitelist core-platform-api test-api atOffset(Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;
    .registers 3
...
.method public whitelist core-platform-api test-api atZone(Ljava/time/ZoneId;)Ljava/time/ZonedDateTime;
    .registers 3
    .param p1, "zone"    # Ljava/time/ZoneId;
...
.method public bridge synthetic whitelist core-platform-api test-api atZone(Ljava/time/ZoneId;)Ljava/time/chrono/ChronoZonedDateTime;
    .registers 2
...
.method public whitelist core-platform-api test-api compareTo(Ljava/time/chrono/ChronoLocalDateTime;)I
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api isAfter(Ljava/time/chrono/ChronoLocalDateTime;)Z
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api isBefore(Ljava/time/chrono/ChronoLocalDateTime;)Z
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api isEqual(Ljava/time/chrono/ChronoLocalDateTime;)Z
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/LocalDateTime;
    .registers 7
...
.method public whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/LocalDateTime;
    .registers 5
...
.method public bridge synthetic whitelist core-platform-api test-api minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ChronoLocalDateTime;
    .registers 4
...
.method public bridge synthetic whitelist core-platform-api test-api minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/ChronoLocalDateTime;
    .registers 2
...
.method public whitelist core-platform-api test-api minusDays(J)Ljava/time/LocalDateTime;
    .registers 6
    .param p1, "days"    # J
...
.method public whitelist core-platform-api test-api minusHours(J)Ljava/time/LocalDateTime;
    .registers 14
    .param p1, "hours"    # J
...
.method public whitelist core-platform-api test-api minusMinutes(J)Ljava/time/LocalDateTime;
    .registers 14
    .param p1, "minutes"    # J
...
.method public whitelist core-platform-api test-api minusMonths(J)Ljava/time/LocalDateTime;
    .registers 6
    .param p1, "months"    # J
...
.method public whitelist core-platform-api test-api minusNanos(J)Ljava/time/LocalDateTime;
    .registers 14
    .param p1, "nanos"    # J
...
.method public whitelist core-platform-api test-api minusSeconds(J)Ljava/time/LocalDateTime;
    .registers 14
    .param p1, "seconds"    # J
...
.method public whitelist core-platform-api test-api minusWeeks(J)Ljava/time/LocalDateTime;
    .registers 6
    .param p1, "weeks"    # J
...
.method public whitelist core-platform-api test-api minusYears(J)Ljava/time/LocalDateTime;
    .registers 6
    .param p1, "years"    # J
...
.method public whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/LocalDateTime;
    .registers 10
...
.method public whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/LocalDateTime;
    .registers 5
...
.method public bridge synthetic whitelist core-platform-api test-api plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/ChronoLocalDateTime;
    .registers 4
...
.method public bridge synthetic whitelist core-platform-api test-api plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/ChronoLocalDateTime;
    .registers 2
...
.method public whitelist core-platform-api test-api plusDays(J)Ljava/time/LocalDateTime;
    .registers 5
    .param p1, "days"    # J
...
.method public whitelist core-platform-api test-api plusHours(J)Ljava/time/LocalDateTime;
    .registers 14
    .param p1, "hours"    # J
...
.method public whitelist core-platform-api test-api plusMinutes(J)Ljava/time/LocalDateTime;
    .registers 14
    .param p1, "minutes"    # J
...
.method public whitelist core-platform-api test-api plusMonths(J)Ljava/time/LocalDateTime;
    .registers 5
    .param p1, "months"    # J
...
.method public whitelist core-platform-api test-api plusNanos(J)Ljava/time/LocalDateTime;
    .registers 14
    .param p1, "nanos"    # J
...
.method public whitelist core-platform-api test-api plusSeconds(J)Ljava/time/LocalDateTime;
    .registers 14
    .param p1, "seconds"    # J
...
.method public whitelist core-platform-api test-api plusWeeks(J)Ljava/time/LocalDateTime;
    .registers 5
    .param p1, "weeks"    # J
...
.method public whitelist core-platform-api test-api plusYears(J)Ljava/time/LocalDateTime;
    .registers 5
    .param p1, "years"    # J
...
.method public whitelist core-platform-api test-api truncatedTo(Ljava/time/temporal/TemporalUnit;)Ljava/time/LocalDateTime;
    .registers 4
    .param p1, "unit"    # Ljava/time/temporal/TemporalUnit;
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/LocalDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/LocalDateTime;
    .registers 7
    .param p1, "field"    # Ljava/time/temporal/TemporalField;
    .param p2, "newValue"    # J
...
.method public bridge synthetic whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/ChronoLocalDateTime;
    .registers 2
...
.method public bridge synthetic whitelist core-platform-api test-api with(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/ChronoLocalDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api withDayOfMonth(I)Ljava/time/LocalDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api withDayOfYear(I)Ljava/time/LocalDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api withHour(I)Ljava/time/LocalDateTime;
    .registers 4
    .param p1, "hour"    # I
...
.method public whitelist core-platform-api test-api withMinute(I)Ljava/time/LocalDateTime;
    .registers 4
    .param p1, "minute"    # I
...
.method public whitelist core-platform-api test-api withMonth(I)Ljava/time/LocalDateTime;
    .registers 4
    .param p1, "month"    # I
...
.method public whitelist core-platform-api test-api withNano(I)Ljava/time/LocalDateTime;
    .registers 4
...
.method public whitelist core-platform-api test-api withSecond(I)Ljava/time/LocalDateTime;
    .registers 4
    .param p1, "second"    # I
...
.method public whitelist core-platform-api test-api withYear(I)Ljava/time/LocalDateTime;
    .registers 4
    .param p1, "year"    # I
