...
.method public static whitelist core-platform-api test-api from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/MonthDay;
    .registers 5
...
.method public static whitelist core-platform-api test-api now()Ljava/time/MonthDay;
    .registers 1
...
.method public static whitelist core-platform-api test-api now(Ljava/time/Clock;)Ljava/time/MonthDay;
    .registers 4
...
.method public static whitelist core-platform-api test-api now(Ljava/time/ZoneId;)Ljava/time/MonthDay;
    .registers 2
...
.method public static whitelist core-platform-api test-api of(II)Ljava/time/MonthDay;
    .registers 3
    .param p0, "month"    # I
...
.method public static whitelist core-platform-api test-api of(Ljava/time/Month;I)Ljava/time/MonthDay;
    .registers 5
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;)Ljava/time/MonthDay;
    .registers 2
...
.method public static whitelist core-platform-api test-api parse(Ljava/lang/CharSequence;Ljava/time/format/DateTimeFormatter;)Ljava/time/MonthDay;
    .registers 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    ...
    .line 303
    sget-object v0, Ljava/time/-$$Lambda$sL_1zXqh7GXCv2G9X40ozp_OBMA;->INSTANCE:Ljava/time/-$$Lambda$sL_1zXqh7GXCv2G9X40ozp_OBMA;
...
.method public whitelist core-platform-api test-api atYear(I)Ljava/time/LocalDate;
    .registers 4
    .param p1, "year"    # I
...
.method public whitelist core-platform-api test-api compareTo(Ljava/time/MonthDay;)I
    .registers 5
...
.method public whitelist core-platform-api test-api isAfter(Ljava/time/MonthDay;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/MonthDay;
...
.method public whitelist core-platform-api test-api isBefore(Ljava/time/MonthDay;)Z
    .registers 3
    .param p1, "other"    # Ljava/time/MonthDay;
...
.method public whitelist core-platform-api test-api isValidYear(I)Z
    .registers 6
    .param p1, "year"    # I
...
.method public whitelist core-platform-api test-api with(Ljava/time/Month;)Ljava/time/MonthDay;
    .registers 5
...
.method public whitelist core-platform-api test-api withDayOfMonth(I)Ljava/time/MonthDay;
    .registers 3
    .param p1, "dayOfMonth"    # I
...
.method public whitelist core-platform-api test-api withMonth(I)Ljava/time/MonthDay;
    .registers 3
    .param p1, "month"    # I
