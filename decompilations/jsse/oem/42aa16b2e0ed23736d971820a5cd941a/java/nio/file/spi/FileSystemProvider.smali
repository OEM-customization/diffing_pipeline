...
.method public static whitelist core-platform-api test-api installedProviders()Ljava/util/List;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
# virtual methods
.method public varargs abstract whitelist core-platform-api test-api checkAccess(Ljava/nio/file/Path;[Ljava/nio/file/AccessMode;)V
...
.method public varargs abstract whitelist core-platform-api test-api copy(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public varargs abstract whitelist core-platform-api test-api createDirectory(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/nio/file/Path;",
...
.method public whitelist core-platform-api test-api createLink(Ljava/nio/file/Path;Ljava/nio/file/Path;)V
    .registers 4
...
.method public varargs whitelist core-platform-api test-api createSymbolicLink(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)V
    .registers 5
    .param p1, "link"    # Ljava/nio/file/Path;
...
.method public abstract whitelist core-platform-api test-api delete(Ljava/nio/file/Path;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public whitelist core-platform-api test-api deleteIfExists(Ljava/nio/file/Path;)Z
    .registers 4
...
.method public varargs abstract whitelist core-platform-api test-api getFileAttributeView(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<V::",
...
.method public abstract whitelist core-platform-api test-api getFileStore(Ljava/nio/file/Path;)Ljava/nio/file/FileStore;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api getFileSystem(Ljava/net/URI;)Ljava/nio/file/FileSystem;
.end method

.method public abstract whitelist core-platform-api test-api getPath(Ljava/net/URI;)Ljava/nio/file/Path;
.end method

.method public abstract whitelist core-platform-api test-api getScheme()Ljava/lang/String;
.end method

.method public abstract whitelist core-platform-api test-api isHidden(Ljava/nio/file/Path;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api isSameFile(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public varargs abstract whitelist core-platform-api test-api move(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public varargs whitelist core-platform-api test-api newAsynchronousFileChannel(Ljava/nio/file/Path;Ljava/util/Set;Ljava/util/concurrent/ExecutorService;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/AsynchronousFileChannel;
    .registers 6
    .param p1, "path"    # Ljava/nio/file/Path;
...
.method public varargs abstract whitelist core-platform-api test-api newByteChannel(Ljava/nio/file/Path;Ljava/util/Set;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/SeekableByteChannel;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/nio/file/Path;",
...
.method public abstract whitelist core-platform-api test-api newDirectoryStream(Ljava/nio/file/Path;Ljava/nio/file/DirectoryStream$Filter;)Ljava/nio/file/DirectoryStream;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/nio/file/Path;",
...
.method public varargs whitelist core-platform-api test-api newFileChannel(Ljava/nio/file/Path;Ljava/util/Set;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/FileChannel;
    .registers 5
    .param p1, "path"    # Ljava/nio/file/Path;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public abstract whitelist core-platform-api test-api newFileSystem(Ljava/net/URI;Ljava/util/Map;)Ljava/nio/file/FileSystem;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/net/URI;",
...
.method public whitelist core-platform-api test-api newFileSystem(Ljava/nio/file/Path;Ljava/util/Map;)Ljava/nio/file/FileSystem;
    .registers 4
    .param p1, "path"    # Ljava/nio/file/Path;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public varargs whitelist core-platform-api test-api newInputStream(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/InputStream;
    .registers 7
    .param p1, "path"    # Ljava/nio/file/Path;
...
.method public varargs whitelist core-platform-api test-api newOutputStream(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/OutputStream;
    .registers 10
    .param p1, "path"    # Ljava/nio/file/Path;
    .param p2, "options"    # [Ljava/nio/file/OpenOption;
    .annotation system Ldalvik/annotation/Throws;
...
.method public varargs abstract whitelist core-platform-api test-api readAttributes(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A::",
...
.method public varargs abstract whitelist core-platform-api test-api readAttributes(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/LinkOption;)Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/nio/file/Path;",
...
.method public whitelist core-platform-api test-api readSymbolicLink(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    .registers 3
    .param p1, "link"    # Ljava/nio/file/Path;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public varargs abstract whitelist core-platform-api test-api setAttribute(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/Object;[Ljava/nio/file/LinkOption;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
