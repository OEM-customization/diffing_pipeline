...
.method public static whitelist core-platform-api test-api allocate(I)Ljava/nio/CharBuffer;
    .registers 2
    .param p0, "capacity"    # I
...
.method public static whitelist core-platform-api test-api wrap(Ljava/lang/CharSequence;)Ljava/nio/CharBuffer;
    .registers 3
...
.method public static whitelist core-platform-api test-api wrap(Ljava/lang/CharSequence;II)Ljava/nio/CharBuffer;
    .registers 5
    .param p0, "csq"    # Ljava/lang/CharSequence;
    .param p1, "start"    # I
    .param p2, "end"    # I
...
.method public static whitelist core-platform-api test-api wrap([C)Ljava/nio/CharBuffer;
    .registers 3
    .param p0, "array"    # [C
...
.method public static whitelist core-platform-api test-api wrap([CII)Ljava/nio/CharBuffer;
    .registers 5
    .param p0, "array"    # [C
    .param p1, "offset"    # I
    .param p2, "length"    # I
...
.method public whitelist core-platform-api test-api append(C)Ljava/nio/CharBuffer;
    .registers 3
    .param p1, "c"    # C
...
.method public whitelist core-platform-api test-api append(Ljava/lang/CharSequence;)Ljava/nio/CharBuffer;
    .registers 3
...
.method public whitelist core-platform-api test-api append(Ljava/lang/CharSequence;II)Ljava/nio/CharBuffer;
    .registers 6
    .param p1, "csq"    # Ljava/lang/CharSequence;
    .param p2, "start"    # I
    .param p3, "end"    # I
...
.method public final whitelist core-platform-api test-api array()[C
    .registers 3
...
.method public abstract whitelist core-platform-api test-api asReadOnlyBuffer()Ljava/nio/CharBuffer;
.end method
...
.method public whitelist core-platform-api test-api chars()Ljava/util/stream/IntStream;
    .registers 4

    .line 1271
    new-instance v0, Ljava/nio/-$$Lambda$CharBuffer$Nm0aKlKPFJdqsfIc00Gd0NEZ8I0;

    invoke-direct {v0, p0}, Ljava/nio/-$$Lambda$CharBuffer$Nm0aKlKPFJdqsfIc00Gd0NEZ8I0;-><init>(Ljava/nio/CharBuffer;)V
...
.method public bridge synthetic whitelist clear()Ljava/nio/CharBuffer;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api compact()Ljava/nio/CharBuffer;
.end method
...
.method public whitelist core-platform-api test-api compareTo(Ljava/nio/CharBuffer;)I
    .registers 7
...
.method public abstract whitelist core-platform-api test-api duplicate()Ljava/nio/CharBuffer;
.end method
...
.method public bridge synthetic whitelist flip()Ljava/nio/CharBuffer;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api get()C
.end method

.method public abstract whitelist core-platform-api test-api get(I)C
.end method

.method public whitelist core-platform-api test-api get([C)Ljava/nio/CharBuffer;
    .registers 4
    .param p1, "dst"    # [C
...
.method public bridge synthetic whitelist limit(I)Ljava/nio/CharBuffer;
    .registers 2
...
.method public bridge synthetic whitelist mark()Ljava/nio/CharBuffer;
    .registers 2
...
.method public bridge synthetic whitelist position(I)Ljava/nio/CharBuffer;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api put(C)Ljava/nio/CharBuffer;
.end method

.method public abstract whitelist core-platform-api test-api put(IC)Ljava/nio/CharBuffer;
.end method

.method public final whitelist core-platform-api test-api put(Ljava/lang/String;)Ljava/nio/CharBuffer;
    .registers 4
...
.method public whitelist core-platform-api test-api put(Ljava/lang/String;II)Ljava/nio/CharBuffer;
    .registers 6
    .param p1, "src"    # Ljava/lang/String;
    .param p2, "start"    # I
    .param p3, "end"    # I
...
.method public bridge synthetic whitelist reset()Ljava/nio/CharBuffer;
    .registers 2
...
.method public bridge synthetic whitelist rewind()Ljava/nio/CharBuffer;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api slice()Ljava/nio/CharBuffer;
.end method
...
.method public abstract whitelist core-platform-api test-api subSequence(II)Ljava/nio/CharBuffer;
.end method
...
.method abstract greylist toString(II)Ljava/lang/String;
.end method
