...
.field final greylist hb:[B

.field greylist isReadOnly:Z

.field greylist-max-o nativeByteOrder:Z

.field final greylist offset:I
...
.method public static whitelist core-platform-api test-api allocate(I)Ljava/nio/ByteBuffer;
    .registers 2
    .param p0, "capacity"    # I
...
.method public static whitelist core-platform-api test-api allocateDirect(I)Ljava/nio/ByteBuffer;
    .registers 3
    .param p0, "capacity"    # I
...
.method public static whitelist core-platform-api test-api wrap([B)Ljava/nio/ByteBuffer;
    .registers 3
    .param p0, "array"    # [B
...
.method public static whitelist core-platform-api test-api wrap([BII)Ljava/nio/ByteBuffer;
    .registers 5
    .param p0, "array"    # [B
    .param p1, "offset"    # I
    .param p2, "length"    # I
...
.method public final whitelist core-platform-api test-api array()[B
    .registers 3
...
.method public abstract whitelist core-platform-api test-api asCharBuffer()Ljava/nio/CharBuffer;
.end method

.method public abstract whitelist core-platform-api test-api asDoubleBuffer()Ljava/nio/DoubleBuffer;
.end method

.method public abstract whitelist core-platform-api test-api asFloatBuffer()Ljava/nio/FloatBuffer;
.end method

.method public abstract whitelist core-platform-api test-api asIntBuffer()Ljava/nio/IntBuffer;
.end method

.method public abstract whitelist core-platform-api test-api asLongBuffer()Ljava/nio/LongBuffer;
.end method

.method public abstract whitelist core-platform-api test-api asReadOnlyBuffer()Ljava/nio/ByteBuffer;
.end method

.method public abstract whitelist core-platform-api test-api asShortBuffer()Ljava/nio/ShortBuffer;
.end method
...
.method public bridge synthetic whitelist clear()Ljava/nio/ByteBuffer;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api compact()Ljava/nio/ByteBuffer;
.end method
...
.method public whitelist core-platform-api test-api compareTo(Ljava/nio/ByteBuffer;)I
    .registers 7
...
.method public abstract whitelist core-platform-api test-api duplicate()Ljava/nio/ByteBuffer;
.end method
...
.method public bridge synthetic whitelist flip()Ljava/nio/ByteBuffer;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api get()B
.end method

.method public abstract whitelist core-platform-api test-api get(I)B
.end method

.method public whitelist core-platform-api test-api get([B)Ljava/nio/ByteBuffer;
    .registers 4
    .param p1, "dst"    # [B
...
.method public abstract whitelist core-platform-api test-api getChar()C
.end method

.method public abstract whitelist core-platform-api test-api getChar(I)C
.end method

.method abstract greylist-max-o getCharUnchecked(I)C
.end method

.method public abstract whitelist core-platform-api test-api getDouble()D
.end method
...
.method public abstract whitelist core-platform-api test-api getFloat()F
.end method
...
.method public abstract whitelist core-platform-api test-api getInt()I
.end method
...
.method public abstract whitelist core-platform-api test-api getLong()J
.end method
...
.method public abstract whitelist core-platform-api test-api getShort()S
.end method
...
.method public bridge synthetic whitelist limit(I)Ljava/nio/ByteBuffer;
    .registers 2
...
.method public bridge synthetic whitelist mark()Ljava/nio/ByteBuffer;
    .registers 2
...
.method public final whitelist core-platform-api test-api order(Ljava/nio/ByteOrder;)Ljava/nio/ByteBuffer;
    .registers 7
...
.method public final whitelist core-platform-api test-api order()Ljava/nio/ByteOrder;
    .registers 2
...
.method public bridge synthetic whitelist position(I)Ljava/nio/ByteBuffer;
    .registers 2
...
.method public abstract whitelist core-platform-api test-api put(B)Ljava/nio/ByteBuffer;
.end method

.method public abstract whitelist core-platform-api test-api put(IB)Ljava/nio/ByteBuffer;
.end method

.method public whitelist core-platform-api test-api put(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    .registers 12
...
.method public final whitelist core-platform-api test-api put([B)Ljava/nio/ByteBuffer;
    .registers 4
    .param p1, "src"    # [B
...
.method public abstract whitelist core-platform-api test-api putChar(C)Ljava/nio/ByteBuffer;
.end method

.method public abstract whitelist core-platform-api test-api putChar(IC)Ljava/nio/ByteBuffer;
.end method

.method abstract greylist-max-o putCharUnchecked(IC)V
.end method

.method public abstract whitelist core-platform-api test-api putDouble(D)Ljava/nio/ByteBuffer;
.end method

.method public abstract whitelist core-platform-api test-api putDouble(ID)Ljava/nio/ByteBuffer;
.end method

.method abstract greylist-max-o putDoubleUnchecked(ID)V
.end method

.method public abstract whitelist core-platform-api test-api putFloat(F)Ljava/nio/ByteBuffer;
.end method

.method public abstract whitelist core-platform-api test-api putFloat(IF)Ljava/nio/ByteBuffer;
.end method

.method abstract greylist-max-o putFloatUnchecked(IF)V
.end method

.method public abstract whitelist core-platform-api test-api putInt(I)Ljava/nio/ByteBuffer;
.end method

.method public abstract whitelist core-platform-api test-api putInt(II)Ljava/nio/ByteBuffer;
.end method

.method abstract greylist-max-o putIntUnchecked(II)V
.end method

.method public abstract whitelist core-platform-api test-api putLong(IJ)Ljava/nio/ByteBuffer;
.end method

.method public abstract whitelist core-platform-api test-api putLong(J)Ljava/nio/ByteBuffer;
.end method

.method abstract greylist-max-o putLongUnchecked(IJ)V
.end method

.method public abstract whitelist core-platform-api test-api putShort(IS)Ljava/nio/ByteBuffer;
.end method

.method public abstract whitelist core-platform-api test-api putShort(S)Ljava/nio/ByteBuffer;
.end method
...
.method public bridge synthetic whitelist reset()Ljava/nio/ByteBuffer;
    .registers 2
...
.method public bridge synthetic whitelist rewind()Ljava/nio/ByteBuffer;
    .registers 2
...
.method public greylist-max-o core-platform-api setAccessible(Z)V
    .registers 3
    .param p1, "value"    # Z
...
.method public abstract whitelist core-platform-api test-api slice()Ljava/nio/ByteBuffer;
.end method
