...
.method public static whitelist core-platform-api test-api open()Ljava/nio/channels/ServerSocketChannel;
    .registers 1
...
# virtual methods
.method public abstract whitelist core-platform-api test-api accept()Ljava/nio/channels/SocketChannel;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public final whitelist core-platform-api test-api bind(Ljava/net/SocketAddress;)Ljava/nio/channels/ServerSocketChannel;
    .registers 3
...
.method public abstract whitelist core-platform-api test-api bind(Ljava/net/SocketAddress;I)Ljava/nio/channels/ServerSocketChannel;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api setOption(Ljava/net/SocketOption;Ljava/lang/Object;)Ljava/nio/channels/ServerSocketChannel;
...
.method public abstract whitelist core-platform-api test-api socket()Ljava/net/ServerSocket;
.end method
