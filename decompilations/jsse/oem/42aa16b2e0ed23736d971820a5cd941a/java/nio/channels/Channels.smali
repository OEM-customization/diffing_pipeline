...
.method public static whitelist core-platform-api test-api newChannel(Ljava/io/InputStream;)Ljava/nio/channels/ReadableByteChannel;
    .registers 3
...
.method public static whitelist core-platform-api test-api newChannel(Ljava/io/OutputStream;)Ljava/nio/channels/WritableByteChannel;
    .registers 2
...
.method public static whitelist core-platform-api test-api newInputStream(Ljava/nio/channels/AsynchronousByteChannel;)Ljava/io/InputStream;
    .registers 2
...
.method public static whitelist core-platform-api test-api newInputStream(Ljava/nio/channels/ReadableByteChannel;)Ljava/io/InputStream;
    .registers 2
...
.method public static whitelist core-platform-api test-api newOutputStream(Ljava/nio/channels/AsynchronousByteChannel;)Ljava/io/OutputStream;
    .registers 2
    .param p0, "ch"    # Ljava/nio/channels/AsynchronousByteChannel;
...
.method public static whitelist core-platform-api test-api newOutputStream(Ljava/nio/channels/WritableByteChannel;)Ljava/io/OutputStream;
    .registers 2
...
.method public static whitelist core-platform-api test-api newReader(Ljava/nio/channels/ReadableByteChannel;Ljava/lang/String;)Ljava/io/Reader;
    .registers 4
    .param p0, "ch"    # Ljava/nio/channels/ReadableByteChannel;
...
.method public static whitelist core-platform-api test-api newReader(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/charset/CharsetDecoder;I)Ljava/io/Reader;
    .registers 4
    .param p0, "ch"    # Ljava/nio/channels/ReadableByteChannel;
...
.method public static whitelist core-platform-api test-api newWriter(Ljava/nio/channels/WritableByteChannel;Ljava/lang/String;)Ljava/io/Writer;
    .registers 4
    .param p0, "ch"    # Ljava/nio/channels/WritableByteChannel;
    .param p1, "csName"    # Ljava/lang/String;
...
.method public static whitelist core-platform-api test-api newWriter(Ljava/nio/channels/WritableByteChannel;Ljava/nio/charset/CharsetEncoder;I)Ljava/io/Writer;
    .registers 4
    .param p0, "ch"    # Ljava/nio/channels/WritableByteChannel;
