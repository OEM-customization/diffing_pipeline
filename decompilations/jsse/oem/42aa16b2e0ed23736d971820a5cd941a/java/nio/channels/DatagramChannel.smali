...
.method public static whitelist core-platform-api test-api open()Ljava/nio/channels/DatagramChannel;
    .registers 1
...
.method public static whitelist core-platform-api test-api open(Ljava/net/ProtocolFamily;)Ljava/nio/channels/DatagramChannel;
    .registers 2
...
# virtual methods
.method public abstract whitelist core-platform-api test-api bind(Ljava/net/SocketAddress;)Ljava/nio/channels/DatagramChannel;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api connect(Ljava/net/SocketAddress;)Ljava/nio/channels/DatagramChannel;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api disconnect()Ljava/nio/channels/DatagramChannel;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api receive(Ljava/nio/ByteBuffer;)Ljava/net/SocketAddress;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api send(Ljava/nio/ByteBuffer;Ljava/net/SocketAddress;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract whitelist core-platform-api test-api setOption(Ljava/net/SocketOption;Ljava/lang/Object;)Ljava/nio/channels/DatagramChannel;
...
.method public abstract whitelist core-platform-api test-api socket()Ljava/net/DatagramSocket;
.end method
