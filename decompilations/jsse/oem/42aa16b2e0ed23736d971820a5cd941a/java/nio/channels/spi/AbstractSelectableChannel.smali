...
# virtual methods
.method public final whitelist core-platform-api test-api blockingLock()Ljava/lang/Object;
    .registers 2
...
.method public final whitelist core-platform-api test-api configureBlocking(Z)Ljava/nio/channels/SelectableChannel;
    .registers 4
    .param p1, "block"    # Z
...
.method protected final whitelist core-platform-api test-api implCloseChannel()V
    .registers 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method protected abstract whitelist core-platform-api test-api implCloseSelectableChannel()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method protected abstract whitelist core-platform-api test-api implConfigureBlocking(Z)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public final whitelist core-platform-api test-api isBlocking()Z
    .registers 3
...
.method public final whitelist core-platform-api test-api keyFor(Ljava/nio/channels/Selector;)Ljava/nio/channels/SelectionKey;
    .registers 3
    .param p1, "sel"    # Ljava/nio/channels/Selector;
...
.method public final whitelist core-platform-api test-api provider()Ljava/nio/channels/spi/SelectorProvider;
    .registers 2
...
.method public final whitelist core-platform-api test-api register(Ljava/nio/channels/Selector;ILjava/lang/Object;)Ljava/nio/channels/SelectionKey;
    .registers 8
    .param p1, "sel"    # Ljava/nio/channels/Selector;
    .param p2, "ops"    # I
