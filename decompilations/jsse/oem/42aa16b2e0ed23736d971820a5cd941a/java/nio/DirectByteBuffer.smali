...
.method public constructor greylist-max-o core-platform-api <init>(IJLjava/io/FileDescriptor;Ljava/lang/Runnable;Z)V
    .registers 13
    .param p1, "cap"    # I
    .param p2, "addr"    # J
...
.method private constructor greylist <init>(JI)V
    .registers 6
    .param p1, "addr"    # J
    .param p3, "cap"    # I
...
.method public final blacklist core-platform-api address()J
    .registers 3
...
.method public final whitelist core-platform-api test-api asCharBuffer()Ljava/nio/CharBuffer;
    .registers 14
...
.method public final whitelist core-platform-api test-api asDoubleBuffer()Ljava/nio/DoubleBuffer;
    .registers 14
...
.method public final whitelist core-platform-api test-api asFloatBuffer()Ljava/nio/FloatBuffer;
    .registers 14
...
.method public final whitelist core-platform-api test-api asIntBuffer()Ljava/nio/IntBuffer;
    .registers 14
...
.method public final whitelist core-platform-api test-api asLongBuffer()Ljava/nio/LongBuffer;
    .registers 14
...
.method public final whitelist core-platform-api test-api asReadOnlyBuffer()Ljava/nio/ByteBuffer;
    .registers 10
...
.method public final whitelist core-platform-api test-api asShortBuffer()Ljava/nio/ShortBuffer;
    .registers 14
...
.method public final whitelist core-platform-api test-api compact()Ljava/nio/ByteBuffer;
    .registers 9
...
.method public final whitelist core-platform-api test-api duplicate()Ljava/nio/ByteBuffer;
    .registers 10
...
.method public final whitelist core-platform-api test-api get()B
    .registers 3
...
.method public final whitelist core-platform-api test-api get(I)B
    .registers 4
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api getChar()C
    .registers 5
...
.method public final whitelist core-platform-api test-api getChar(I)C
    .registers 5
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api getDouble()D
    .registers 3
...
.method public final whitelist core-platform-api test-api getDouble(I)D
    .registers 4
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api getFloat()F
    .registers 3
...
.method public final whitelist core-platform-api test-api getFloat(I)F
    .registers 4
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api getLong()J
    .registers 3
...
.method public final whitelist core-platform-api test-api getLong(I)J
    .registers 4
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api getShort()S
    .registers 3
...
.method public final whitelist core-platform-api test-api getShort(I)S
    .registers 4
    .param p1, "i"    # I
...
.method public final whitelist core-platform-api test-api isDirect()Z
    .registers 2
...
.method public final whitelist core-platform-api test-api put(IB)Ljava/nio/ByteBuffer;
    .registers 5
    .param p1, "i"    # I
    .param p2, "x"    # B
...
.method public final whitelist core-platform-api test-api putChar(C)Ljava/nio/ByteBuffer;
    .registers 4
    .param p1, "x"    # C
...
.method public final whitelist core-platform-api test-api putChar(IC)Ljava/nio/ByteBuffer;
    .registers 5
    .param p1, "i"    # I
    .param p2, "x"    # C
...
.method public final whitelist core-platform-api test-api putDouble(D)Ljava/nio/ByteBuffer;
    .registers 5
    .param p1, "x"    # D
...
.method public final whitelist core-platform-api test-api putDouble(ID)Ljava/nio/ByteBuffer;
    .registers 6
    .param p1, "i"    # I
    .param p2, "x"    # D
...
.method public final whitelist core-platform-api test-api putFloat(F)Ljava/nio/ByteBuffer;
    .registers 4
    .param p1, "x"    # F
...
.method public final whitelist core-platform-api test-api putFloat(IF)Ljava/nio/ByteBuffer;
    .registers 5
    .param p1, "i"    # I
    .param p2, "x"    # F
...
.method public final whitelist core-platform-api test-api putInt(I)Ljava/nio/ByteBuffer;
    .registers 4
    .param p1, "x"    # I
...
.method public final whitelist core-platform-api test-api putInt(II)Ljava/nio/ByteBuffer;
    .registers 5
    .param p1, "i"    # I
    .param p2, "x"    # I
...
.method public final whitelist core-platform-api test-api putLong(IJ)Ljava/nio/ByteBuffer;
    .registers 6
    .param p1, "i"    # I
    .param p2, "x"    # J
...
.method public final whitelist core-platform-api test-api putLong(J)Ljava/nio/ByteBuffer;
    .registers 5
    .param p1, "x"    # J
...
.method public final whitelist core-platform-api test-api putShort(IS)Ljava/nio/ByteBuffer;
    .registers 5
    .param p1, "i"    # I
    .param p2, "x"    # S
...
.method public final whitelist core-platform-api test-api putShort(S)Ljava/nio/ByteBuffer;
    .registers 4
    .param p1, "x"    # S
...
.method public final greylist-max-o core-platform-api setAccessible(Z)V
    .registers 3
    .param p1, "value"    # Z
...
.method public final whitelist core-platform-api test-api slice()Ljava/nio/ByteBuffer;
    .registers 13
