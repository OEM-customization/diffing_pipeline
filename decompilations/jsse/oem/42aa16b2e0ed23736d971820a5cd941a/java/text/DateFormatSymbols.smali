...
.method private static greylist-max-o getCachedInstance(Ljava/util/Locale;)Ljava/text/DateFormatSymbols;
    ...
    .line 437
    sget-object v2, Ljava/text/DateFormatSymbols;->cachedInstances:Ljava/util/concurrent/ConcurrentMap;
    ...
    check-cast v4, Ljava/text/DateFormatSymbols;

    .line 440
    .local v4, "y":Ljava/text/DateFormatSymbols;
    if-eqz v4, :cond_37
    ...
    .line 444
    :cond_37
    sget-object v5, Ljava/text/DateFormatSymbols;->cachedInstances:Ljava/util/concurrent/ConcurrentMap;

    invoke-interface {v5, v0, v1}, Ljava/util/concurrent/ConcurrentMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 448
    .end local v2    # "x":Ljava/lang/ref/SoftReference;, "Ljava/lang/ref/SoftReference<Ljava/text/DateFormatSymbols;>;"
    .end local v4    # "y":Ljava/text/DateFormatSymbols;
    :cond_3c
    :goto_3c
    return-object v3
.end method

.method public static final whitelist core-platform-api test-api getInstance()Ljava/text/DateFormatSymbols;
    .registers 1
...
.method public static final whitelist core-platform-api test-api getInstance(Ljava/util/Locale;)Ljava/text/DateFormatSymbols;
    .registers 2
    .param p0, "locale"    # Ljava/util/Locale;
...
.method public whitelist core-platform-api test-api getAmPmStrings()[Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api getEras()[Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api getLocalPatternChars()Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api getMonths()[Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api getShortMonths()[Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api getShortWeekdays()[Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api getWeekdays()[Ljava/lang/String;
    .registers 3
...
.method public whitelist core-platform-api test-api getZoneStrings()[[Ljava/lang/String;
    .registers 2
...
.method public whitelist core-platform-api test-api setAmPmStrings([Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setEras([Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setLocalPatternChars(Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setMonths([Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setShortMonths([Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setShortWeekdays([Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setWeekdays([Ljava/lang/String;)V
    .registers 3
...
.method public whitelist core-platform-api test-api setZoneStrings([[Ljava/lang/String;)V
    .registers 6
