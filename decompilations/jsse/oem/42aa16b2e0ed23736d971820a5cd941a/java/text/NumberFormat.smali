...
.field public static final whitelist core-platform-api test-api FRACTION_FIELD:I = 0x1

.field private static final greylist-max-o INTEGERSTYLE:I = 0x3

.field public static final whitelist core-platform-api test-api INTEGER_FIELD:I = 0x0
...
.method public static final whitelist core-platform-api test-api getCurrencyInstance()Ljava/text/NumberFormat;
    .registers 2
...
.method public static whitelist core-platform-api test-api getCurrencyInstance(Ljava/util/Locale;)Ljava/text/NumberFormat;
    .registers 2
...
.method public static final whitelist core-platform-api test-api getInstance()Ljava/text/NumberFormat;
    .registers 2
...
.method public static whitelist core-platform-api test-api getInstance(Ljava/util/Locale;)Ljava/text/NumberFormat;
    .registers 2
    .param p0, "inLocale"    # Ljava/util/Locale;
...
.method private static greylist getInstance(Ljava/util/Locale;I)Ljava/text/NumberFormat;
    .registers 11
...
.method public static final whitelist core-platform-api test-api getIntegerInstance()Ljava/text/NumberFormat;
    .registers 2
...
.method public static whitelist core-platform-api test-api getIntegerInstance(Ljava/util/Locale;)Ljava/text/NumberFormat;
    .registers 2
    .param p0, "inLocale"    # Ljava/util/Locale;
...
.method public static final whitelist core-platform-api test-api getNumberInstance()Ljava/text/NumberFormat;
    .registers 2
...
.method public static whitelist core-platform-api test-api getNumberInstance(Ljava/util/Locale;)Ljava/text/NumberFormat;
    .registers 2
    .param p0, "inLocale"    # Ljava/util/Locale;
...
.method public static final whitelist core-platform-api test-api getPercentInstance()Ljava/text/NumberFormat;
    .registers 2
...
.method public static whitelist core-platform-api test-api getPercentInstance(Ljava/util/Locale;)Ljava/text/NumberFormat;
    .registers 2
    .param p0, "inLocale"    # Ljava/util/Locale;
...
.method public final whitelist core-platform-api test-api format(D)Ljava/lang/String;
    .registers 5
    .param p1, "number"    # D
...
.method public final whitelist core-platform-api test-api format(J)Ljava/lang/String;
    .registers 5
    .param p1, "number"    # J
...
.method public abstract whitelist core-platform-api test-api format(DLjava/lang/StringBuffer;Ljava/text/FieldPosition;)Ljava/lang/StringBuffer;
.end method

.method public abstract whitelist core-platform-api test-api format(JLjava/lang/StringBuffer;Ljava/text/FieldPosition;)Ljava/lang/StringBuffer;
.end method

.method public whitelist core-platform-api test-api format(Ljava/lang/Object;Ljava/lang/StringBuffer;Ljava/text/FieldPosition;)Ljava/lang/StringBuffer;
    .registers 6
...
.method public whitelist core-platform-api test-api parse(Ljava/lang/String;)Ljava/lang/Number;
    .registers 7
...
.method public abstract whitelist core-platform-api test-api parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/lang/Number;
.end method

.method public final whitelist core-platform-api test-api parseObject(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/lang/Object;
    .registers 4
    .param p1, "source"    # Ljava/lang/String;
