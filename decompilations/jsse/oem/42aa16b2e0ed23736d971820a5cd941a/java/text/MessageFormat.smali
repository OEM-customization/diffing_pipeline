...
.method private greylist-max-o makeFormat(II[Ljava/lang/StringBuilder;)V
    ...
    move-result v2
    :try_end_1e
    .catch Ljava/lang/NumberFormatException; {:try_start_18 .. :try_end_1e} :catch_14d
    ...
    .line 1464
    .local v4, "newFormat":Ljava/text/Format;
    ...
    sget-object v7, Ljava/text/MessageFormat;->TYPE_KEYWORDS:[Ljava/lang/String;

    invoke-static {v6, v7}, Ljava/text/MessageFormat;->findKeyword(Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-direct {v1, v5}, Ljava/text/ChoiceFormat;-><init>(Ljava/lang/String;)V
    :try_end_82
    ...
    iput v3, p0, Ljava/text/MessageFormat;->maxOffset:I
    ...
    invoke-direct {v5, v7, v1}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v8}, Ljava/text/MessageFormat;->findKeyword(Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v5, v7}, Ljava/text/DateFormat;->getDateInstance(ILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {v5, v7}, Ljava/text/DateFormat;->getTimeInstance(ILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    :try_end_ec
    .catch Ljava/lang/IllegalArgumentException; {:try_start_e3 .. :try_end_ec} :catch_ee
    ...
    sget-object v9, Ljava/text/MessageFormat;->NUMBER_MODIFIER_KEYWORDS:[Ljava/lang/String;

    invoke-static {v8, v9}, Ljava/text/MessageFormat;->findKeyword(Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-direct {v1, v5, v7}, Ljava/text/DecimalFormat;-><init>(Ljava/lang/String;Ljava/text/DecimalFormatSymbols;)V
    :try_end_10f
    .catch Ljava/lang/IllegalArgumentException; {:try_start_102 .. :try_end_10f} :catch_111
    ...
    .line 1440
    .end local v3    # "oldMaxOffset":I
    .end local v4    # "newFormat":Ljava/text/Format;
    :cond_136
    new-instance v1, Ljava/lang/IllegalArgumentException;
...
.method public whitelist core-platform-api test-api getFormats()[Ljava/text/Format;
    .registers 5
...
.method public whitelist core-platform-api test-api getFormatsByArgumentIndex()[Ljava/text/Format;
    .registers 6
...
.method public whitelist core-platform-api test-api parse(Ljava/lang/String;)[Ljava/lang/Object;
    .registers 7
...
.method public whitelist core-platform-api test-api parse(Ljava/lang/String;Ljava/text/ParsePosition;)[Ljava/lang/Object;
    .registers 15
    .param p1, "source"    # Ljava/lang/String;
...
.method public whitelist core-platform-api test-api setFormat(ILjava/text/Format;)V
    .registers 6
...
.method public whitelist core-platform-api test-api setFormatByArgumentIndex(ILjava/text/Format;)V
    .registers 5
...
.method public whitelist core-platform-api test-api setFormats([Ljava/text/Format;)V
    .registers 6
...
.method public whitelist core-platform-api test-api setFormatsByArgumentIndex([Ljava/text/Format;)V
    .registers 6
    .param p1, "newFormats"    # [Ljava/text/Format;
...
.method public whitelist core-platform-api test-api setLocale(Ljava/util/Locale;)V
    .registers 2
...
.method public whitelist core-platform-api test-api toPattern()Ljava/lang/String;
    ...
    .line 553
    .end local v5    # "df":Ljava/text/DateFormat;
    :cond_d9
