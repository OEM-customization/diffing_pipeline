...
def create_decomp_structure():
    ...
    directories = [
        ...
        "jsse",
        "root_certs",
        "jce/bouncycastle/baseline",
        "jce/bouncycastle/oem",
    ...
    for root, dirs, files in os.walk(baseline_path):
        for file in files:
            ...
            if file == 'okhttp.jar':
                ...
                target_folder = os.path.join(config.current_path,'decompilations/jce/okhttp/baseline')
            ...
            if file == 'bouncycastle.jar':
                core_path = os.path.join(root, file)
                
                target_folder = os.path.join(config.current_path,'decompilations/jce/bouncycastle/baseline')
